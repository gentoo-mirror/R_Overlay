...
SRC_URI="https://inla.r-inla-download.org/R/stable/src/contrib/INLA_23.04.24.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_deldir r_suggests_deriv r_suggests_devtools
	...
	r_suggests_matrix r_suggests_mlogit r_suggests_mvtnorm
	r_suggests_numderiv r_suggests_pixmap r_suggests_rgl
	r_suggests_rgraphviz r_suggests_rmarkdown r_suggests_sf
