...
SRC_URI="https://inla.r-inla-download.org/R/stable/src/contrib/INLA_20.03.17.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_deriv r_suggests_devtools r_suggests_doparallel
	r_suggests_dplyr r_suggests_fields r_suggests_graph
	...
	r_suggests_rgeos r_suggests_rgl r_suggests_rgraphviz
	r_suggests_rmarkdown r_suggests_sn r_suggests_spdep
	r_suggests_splancs"
R_SUGGESTS="
