...
SRC_URI="https://inla.r-inla-download.org/R/stable/src/contrib/INLA_24.06.27.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_deldir r_suggests_deriv r_suggests_devtools
	...
	r_suggests_sf r_suggests_shiny r_suggests_sn r_suggests_spdep
	r_suggests_splancs r_suggests_terra r_suggests_testthat"
R_SUGGESTS="
