...
DESCRIPTION='Plot customizable linear genomes... (see metadata)'
SRC_URI="http://master.bioconductor.org/packages/3.9/bioc/src/contrib/karyoploteR_1.10.4.tar.gz"
LICENSE='Artistic-2'

IUSE="${IUSE-} r_suggests_biocstyle r_suggests_knitr r_suggests_magrittr
	r_suggests_org_hs_eg_db r_suggests_org_mm_eg_db
	r_suggests_pasillabamsubset r_suggests_testthat
