...
SRC_URI="http://master.bioconductor.org/packages/3.2/bioc/src/contrib/ChIPpeakAnno_3.4.6.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_biocstyle r_suggests_bsgenome_celegans_ucsc_ce10
	...
	r_suggests_reactome_db r_suggests_rtracklayer r_suggests_runit
