...
IUSE="${IUSE-} r_suggests_affy r_suggests_e1071 r_suggests_earth
	...
	r_suggests_kernlab r_suggests_klar r_suggests_knitr r_suggests_mda
	r_suggests_mlbench r_suggests_party r_suggests_pls r_suggests_proc
	r_suggests_proxy r_suggests_r[-minimal] r_suggests_rann
	r_suggests_spls"
R_SUGGESTS="
