...
SRC_URI="http://master.bioconductor.org/packages/3.2/bioc/src/contrib/GenomicRanges_1.22.4.tar.gz"
LICENSE='Artistic-2'
...
"
DEPEND=">=sci-BIOC/BiocGenerics-0.16.1
	>=sci-BIOC/IRanges-2.4.6
	>=sci-BIOC/GenomeInfoDb-1.1.20
	>=sci-BIOC/S4Vectors-0.8.6
	sci-BIOC/XVector
"
RDEPEND="${DEPEND-}
	sci-BIOC/S4Vectors
