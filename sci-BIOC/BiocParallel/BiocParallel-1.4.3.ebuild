...
IUSE="${IUSE-} r_suggests_batchjobs r_suggests_bbmisc
	r_suggests_biocgenerics r_suggests_biocstyle r_suggests_doparallel
	r_suggests_foreach r_suggests_genomicalignments
	r_suggests_genomicranges r_suggests_knitr r_suggests_r[-minimal]
	r_suggests_rmpi r_suggests_rnaseqdata_hnrnpc_bam_chr14
	r_suggests_rsamtools r_suggests_runit r_suggests_shortread"
R_SUGGESTS="
