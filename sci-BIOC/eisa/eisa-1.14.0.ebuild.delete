...
SRC_URI="http://master.bioconductor.org/packages/2.13/bioc/src/contrib/eisa_1.14.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_all r_suggests_biclust r_suggests_go_db
	r_suggests_gostats r_suggests_hgu95av2_db r_suggests_igraph
	r_suggests_kegg_db r_suggests_org_hs_eg_db
	r_suggests_targetscan_hs_eg_db r_suggests_xtable"
R_SUGGESTS="
