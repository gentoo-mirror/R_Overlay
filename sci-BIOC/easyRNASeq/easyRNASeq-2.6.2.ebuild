...
SRC_URI="http://master.bioconductor.org/packages/3.2/bioc/src/contrib/easyRNASeq_2.6.2.tar.gz"
LICENSE='Artistic-2'
...
"
DEPEND=">=sci-BIOC/SummarizedExperiment-1.0.1
	sci-CRAN/locfit
