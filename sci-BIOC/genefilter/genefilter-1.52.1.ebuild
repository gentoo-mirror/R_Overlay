...
IUSE="${IUSE-} r_suggests_all r_suggests_biocstyle r_suggests_deseq
	r_suggests_hgu95av2_db r_suggests_knitr r_suggests_pasilla
	r_suggests_r[-minimal] r_suggests_roc r_suggests_tkwidgets"
R_SUGGESTS="
