...
SRC_URI="http://master.bioconductor.org/packages/3.2/bioc/src/contrib/GenomicFeatures_1.22.13.tar.gz"
LICENSE='Artistic-2'

IUSE="${IUSE-} r_suggests_biocstyle r_suggests_bsgenome
	r_suggests_fdb_ucsc_trnas r_suggests_genomicalignments
	r_suggests_knitr r_suggests_mirbase_db r_suggests_org_hs_eg_db
