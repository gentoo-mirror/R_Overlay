...
SRC_URI="http://master.bioconductor.org/packages/3.2/bioc/src/contrib/VariantAnnotation_1.16.4.tar.gz"
LICENSE='Artistic-2'

IUSE="${IUSE-} r_suggests_biocstyle r_suggests_ggplot2
	r_suggests_polyphen_hsapiens_dbsnp131 r_suggests_runit
	r_suggests_sift_hsapiens_dbsnp132 r_suggests_sift_hsapiens_dbsnp137
