...
SRC_URI="http://master.bioconductor.org/packages/3.2/bioc/src/contrib/EDASeq_2.4.0.tar.gz"
LICENSE='Artistic-2'

IUSE="${IUSE-} r_suggests_biocstyle r_suggests_edger r_suggests_knitr
	r_suggests_leebamviews r_suggests_yeastrnaseq"
R_SUGGESTS="
...
"
DEPEND=">=sci-BIOC/ShortRead-1.11.42
