...
SRC_URI="http://master.bioconductor.org/packages/2.13/data/experiment/src/contrib/ind1KG_0.1.17.tar.gz"
LICENSE='Artistic-2'
...
IUSE="${IUSE-} r_suggests_genomicfeatures r_suggests_ggbase
	...
	r_suggests_snplocs_hsapiens_dbsnp_20090506
...
R_SUGGESTS="
	...
	r_suggests_snplocs_hsapiens_dbsnp_20090506? ( sci-BIOC/SNPlocs_Hsapiens_dbSNP_20090506 )
