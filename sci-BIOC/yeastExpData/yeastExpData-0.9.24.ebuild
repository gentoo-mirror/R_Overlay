...
SRC_URI="http://master.bioconductor.org/packages/2.13/data/experiment/src/contrib/yeastExpData_0.9.24.tar.gz -> bioc-2.13_experiment_yeastExpData_0.9.24.tar.gz"
LICENSE='GPL-2+'
