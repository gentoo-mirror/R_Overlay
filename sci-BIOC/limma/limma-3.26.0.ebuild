...
SRC_URI="http://master.bioconductor.org/packages/3.2/bioc/src/contrib/limma_3.26.0.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_affy r_suggests_annotationdbi r_suggests_biasedurn
	...
	r_suggests_illuminaio r_suggests_keggrest r_suggests_locfit
	r_suggests_org_hs_eg_db r_suggests_statmod r_suggests_vsn"
R_SUGGESTS="
