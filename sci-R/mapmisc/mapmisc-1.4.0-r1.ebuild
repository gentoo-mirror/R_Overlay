...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/mapmisc_1.4.0.tar.gz -> r-forge_mapmisc_1.4.0-r1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_classint r_suggests_geonames r_suggests_geosphere
