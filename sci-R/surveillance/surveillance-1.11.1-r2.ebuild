...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/surveillance_1.11.1.tar.gz -> surveillance_1.11.1-r2.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_animation r_suggests_coda r_suggests_colorspace
	...
	r_suggests_r[-minimal] r_suggests_rgeos r_suggests_runjags
	r_suggests_scales r_suggests_spc r_suggests_spdep r_suggests_splancs
