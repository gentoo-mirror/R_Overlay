...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/surveillance_1.10-0.tar.gz -> surveillance_1.10-0-r20.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_animation r_suggests_coda r_suggests_colorspace
	...
	r_suggests_gsl r_suggests_intervals r_suggests_maptools
	r_suggests_maxlik r_suggests_memoise r_suggests_msm
