...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/R2BayesX_1.1-0.tar.gz -> R2BayesX_1.1-0-r3.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'

IUSE="${IUSE-} r_suggests_akima r_suggests_coda r_suggests_maps
	r_suggests_maptools r_suggests_mba r_suggests_shapefiles
