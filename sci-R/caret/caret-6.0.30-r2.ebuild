...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/caret_6.0-30.tar.gz -> caret_6.0-30-r2.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_affy r_suggests_e1071 r_suggests_earth
	...
	r_suggests_kernlab r_suggests_klar r_suggests_mass r_suggests_mda
	r_suggests_mgcv r_suggests_mlbench r_suggests_nnet r_suggests_party
