...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/countreg_0.1-5.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'

IUSE="${IUSE-} r_suggests_aer r_suggests_car r_suggests_flexmix
	r_suggests_gamlss r_suggests_gamlss_dist r_suggests_ggplot2
	r_suggests_lmtest r_suggests_mboost r_suggests_sandwich"
R_SUGGESTS="
