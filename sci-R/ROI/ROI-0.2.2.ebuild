...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/ROI_0.2-2.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_numderiv r_suggests_roi_plugin_glpk
	r_suggests_roi_plugin_ipop r_suggests_roi_plugin_quadprog
	r_suggests_roi_plugin_symphony"
R_SUGGESTS="
	r_suggests_numderiv? ( sci-R/numDeriv )
	r_suggests_roi_plugin_glpk? ( sci-R/ROI_plugin_glpk )
	r_suggests_roi_plugin_ipop? ( sci-R/ROI_plugin_ipop )
