...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/car_2.0-22.tar.gz -> car_2.0-22-r11.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_alr4 r_suggests_leaps r_suggests_lme4
	r_suggests_lmtest r_suggests_matrixmodels r_suggests_pbkrtest
	r_suggests_quantreg r_suggests_rgl r_suggests_sandwich
