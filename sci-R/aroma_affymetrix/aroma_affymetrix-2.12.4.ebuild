...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/aroma.affymetrix_2.12.4.tar.gz"
LICENSE='LGPL-2.1+'

IUSE="${IUSE-} r_suggests_affxparser r_suggests_affy
	r_suggests_affymetrixdatatestfiles r_suggests_affyplm
	r_suggests_biobase r_suggests_dbi r_suggests_dchipio r_suggests_gcrma
