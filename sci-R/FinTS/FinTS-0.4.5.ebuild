...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/FinTS_0.4-5.tar.gz -> r-forge_FinTS_0.4-5.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_chron r_suggests_distrex r_suggests_e1071
	r_suggests_funitroots r_suggests_gparotation r_suggests_lmtest
	r_suggests_moments r_suggests_polynom r_suggests_psych
	r_suggests_sandwich r_suggests_tseries r_suggests_urca"
R_SUGGESTS="
