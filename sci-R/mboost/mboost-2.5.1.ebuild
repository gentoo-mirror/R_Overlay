...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/mboost_2.5-1.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_bayesx r_suggests_fields r_suggests_gbm
	r_suggests_mlbench r_suggests_randomforest r_suggests_rcolorbrewer"
R_SUGGESTS="
