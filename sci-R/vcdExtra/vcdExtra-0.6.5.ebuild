...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/vcdExtra_0.6-5.tar.gz -> r-forge_vcdExtra_0.6-5.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_aer r_suggests_ca r_suggests_car
	r_suggests_effects r_suggests_fahrmeir r_suggests_ggplot2
	r_suggests_gmodels r_suggests_lmtest r_suggests_plyr r_suggests_rgl
