...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/MPAgenomics_1.0.3.tar.gz -> MPAgenomics_1.0.3-r1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_aroma_cn r_suggests_cghcall r_suggests_hdpenreg
	r_suggests_snowfall"
R_SUGGESTS="
...
_UNRESOLVED_PACKAGES=( 'sci-R/aroma_affymetrix' )
