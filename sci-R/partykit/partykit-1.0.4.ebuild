...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/partykit_1.0-4.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'

IUSE="${IUSE-} r_suggests_aer r_suggests_coin r_suggests_formula
	r_suggests_mlbench r_suggests_mvtnorm r_suggests_pmml
	r_suggests_psychotools r_suggests_psychotree r_suggests_rjava
...
R_SUGGESTS="
	...
	r_suggests_formula? ( >=sci-CRAN/Formula-1.2.1 )
