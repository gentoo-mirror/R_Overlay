...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/Ecdat_0.3-0.tar.gz -> Ecdat_0.3-0-r5.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_car r_suggests_catools r_suggests_gdata
	...
	r_suggests_optimx r_suggests_r[-minimal] r_suggests_rcurl
