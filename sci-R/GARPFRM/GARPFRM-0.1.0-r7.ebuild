...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/GARPFRM_0.1.0.tar.gz -> GARPFRM_0.1.0-r7.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_portfolioanalytics r_suggests_psych
	r_suggests_rugarch"
R_SUGGESTS="
	r_suggests_portfolioanalytics? ( >=sci-R/PortfolioAnalytics-0.9.0 )
	r_suggests_psych? ( >=sci-CRAN/psych-1.4.4 )
