...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/dplR_1.6.1.tar.gz -> dplR_1.6.1-r4.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_biobase r_suggests_dichromat r_suggests_foreach
	...
	r_suggests_runit r_suggests_tikzdevice r_suggests_waveslim"
R_SUGGESTS="
	r_suggests_biobase? ( sci-BIOC/Biobase )
	r_suggests_dichromat? ( >=sci-CRAN/dichromat-1.2.1 )
