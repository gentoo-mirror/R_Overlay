...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/Rcmdr2_2.0-0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_abind r_suggests_aplpack r_suggests_colorspace
	r_suggests_e1071 r_suggests_effects r_suggests_hmisc r_suggests_leaps
