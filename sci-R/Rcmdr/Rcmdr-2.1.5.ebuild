...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/Rcmdr_2.1-5.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_aplpack r_suggests_colorspace r_suggests_e1071
	...
	r_suggests_relimp r_suggests_rgl r_suggests_rjava r_suggests_sem"
R_SUGGESTS="
