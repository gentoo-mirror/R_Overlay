...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/hyperSpec_0.98-20141112.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_baseline r_suggests_deldir r_suggests_fastcluster
	...
	r_suggests_plotrix r_suggests_pls r_suggests_r_matlab r_suggests_rcpp
	r_suggests_rgl r_suggests_sp r_suggests_svunit r_suggests_testthat
	r_suggests_tripack"
R_SUGGESTS="
