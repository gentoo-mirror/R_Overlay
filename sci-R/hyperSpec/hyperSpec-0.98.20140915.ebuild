...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/hyperSpec_0.98-20140915.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_baseline r_suggests_deldir r_suggests_fastcluster
	...
	r_suggests_playwith r_suggests_plotrix r_suggests_pls r_suggests_rcpp
