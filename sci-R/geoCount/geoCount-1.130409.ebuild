...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/geoCount_1.130409.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_coda r_suggests_distrex r_suggests_multicore
	r_suggests_reldist r_suggests_snow r_suggests_snowfall"
R_SUGGESTS="
