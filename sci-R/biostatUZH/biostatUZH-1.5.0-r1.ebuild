...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/biostatUZH_1.5.0.tar.gz -> biostatUZH_1.5.0-r1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_cmprsk r_suggests_hmisc r_suggests_lme4
	r_suggests_prodlim r_suggests_psy r_suggests_surveillance
	r_suggests_xtable"
R_SUGGESTS="
