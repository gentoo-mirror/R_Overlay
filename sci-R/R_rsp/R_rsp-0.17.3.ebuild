...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/R.rsp_0.17.3.tar.gz"
LICENSE='LGPL-2.1+'
...
R_SUGGESTS="
	...
	r_suggests_markdown? ( >=sci-CRAN/markdown-0.6.5 )
	r_suggests_r_devices? ( >=sci-R/R_devices-2.8.2 )
"
DEPEND=">=sci-R/R_oo-1.18.0
