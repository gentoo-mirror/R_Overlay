...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/aroma.core_2.12.4.tar.gz"
LICENSE='LGPL-2.1+'

IUSE="${IUSE-} r_suggests_cairo r_suggests_dnacopy r_suggests_ebimage
	r_suggests_expectile r_suggests_glad r_suggests_haarseg
	r_suggests_mpcbs r_suggests_png r_suggests_preprocesscore
	r_suggests_sfit"
R_SUGGESTS="
