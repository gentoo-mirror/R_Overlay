...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/Sleuth3_1.0-1.tar.gz -> r-forge_Sleuth3_1.0-1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_agricolae r_suggests_car r_suggests_cca
	r_suggests_gmodels r_suggests_hmisc r_suggests_knitr r_suggests_leaps
	r_suggests_mosaic r_suggests_multcomp r_suggests_r[-minimal]"
R_SUGGESTS="
