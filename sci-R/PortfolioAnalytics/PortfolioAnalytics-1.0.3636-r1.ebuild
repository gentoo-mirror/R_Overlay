...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/PortfolioAnalytics_1.0.3636.tar.gz -> PortfolioAnalytics_1.0.3636-r1.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_corpcor r_suggests_deoptim r_suggests_fgarch
	...
	r_suggests_r[-minimal] r_suggests_rglpk r_suggests_robustbase
