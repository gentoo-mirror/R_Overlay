...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/PortfolioAnalytics_0.9.0.tar.gz -> PortfolioAnalytics_0.9.0-r3.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_corpcor r_suggests_deoptim r_suggests_fgarch
	...
	r_suggests_rglpk r_suggests_roi r_suggests_testthat"
R_SUGGESTS="
