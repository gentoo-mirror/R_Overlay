...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/PortfolioAnalytics_0.9.0.tar.gz -> PortfolioAnalytics_0.9.0-r2.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_corpcor r_suggests_deoptim r_suggests_fgarch
	...
	r_suggests_pso r_suggests_quadprog r_suggests_quantmod
	r_suggests_rglpk r_suggests_roi r_suggests_roi_plugin_glpk
...
R_SUGGESTS="
	...
	r_suggests_roi_plugin_glpk? ( >=sci-R/ROI_plugin_glpk-0.0.2 )
	r_suggests_roi_plugin_quadprog? ( >=sci-R/ROI_plugin_quadprog-0.0.2 )
