...
SRC_URI="http://download.r-forge.r-project.org/src/contrib/Ecfun_0.1-1.tar.gz -> Ecfun_0.1-1-r3.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_car r_suggests_ecdat r_suggests_fda
	r_suggests_gdata r_suggests_jpeg r_suggests_lmtest r_suggests_maps
	r_suggests_pryr r_suggests_rcurl r_suggests_sandwich r_suggests_sem
