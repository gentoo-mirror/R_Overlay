...
SRC_URI="http://cran.r-project.org/src/contrib/VizTest_0.5.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_cardata r_suggests_collapse r_suggests_knitr
	r_suggests_lme4 r_suggests_marginaleffects r_suggests_mvtnorm
	r_suggests_patchwork r_suggests_rmarkdown r_suggests_sandwich
