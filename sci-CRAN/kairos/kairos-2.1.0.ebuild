...
SRC_URI="http://cran.r-project.org/src/contrib/kairos_2.1.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_folio r_suggests_knitr r_suggests_markdown
	...
	r_suggests_tinytest"
R_SUGGESTS="
	r_suggests_folio? ( >=sci-CRAN/folio-1.4.0 )
	r_suggests_knitr? ( sci-CRAN/knitr )
	r_suggests_markdown? ( sci-CRAN/markdown )
	r_suggests_svglite? ( sci-CRAN/svglite )
	r_suggests_tabula? ( >=sci-CRAN/tabula-3.0.1 )
	r_suggests_tinysnapshot? ( sci-CRAN/tinysnapshot )
	r_suggests_tinytest? ( sci-CRAN/tinytest )
"
DEPEND=">=dev-lang/R-3.5
	>=sci-CRAN/aion-1.0.2
	>=sci-CRAN/dimensio-0.6.0
	sci-CRAN/extraDistr
