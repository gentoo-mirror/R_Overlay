...
SRC_URI="http://cran.r-project.org/src/contrib/pak_0.7.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_callr r_suggests_cli r_suggests_covr
	...
	r_suggests_pkgbuild r_suggests_pkgcache r_suggests_pkgdepends
	r_suggests_pkgsearch r_suggests_prettyunits r_suggests_processx
	r_suggests_ps r_suggests_rprojroot r_suggests_rstudioapi
