...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/pak_0.3.0.tar.gz"
LICENSE='GPL-3'
...
R_SUGGESTS="
	...
	r_suggests_pkgcache? ( >=sci-CRAN/pkgcache-2.0.1 )
	r_suggests_pkgdepends? ( >=sci-CRAN/pkgdepends-0.3.0 )
	r_suggests_pkgsearch? ( >=sci-CRAN/pkgsearch-3.1.0 )
	r_suggests_prettyunits? ( sci-CRAN/prettyunits )
	r_suggests_processx? ( >=sci-CRAN/processx-3.5.2 )
