...
SRC_URI="http://cran.r-project.org/src/contrib/parsnip_1.2.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_c50 r_suggests_covr r_suggests_dials
	...
	r_suggests_nlme r_suggests_prodlim r_suggests_ranger
	r_suggests_remotes r_suggests_rmarkdown r_suggests_rpart
