...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/parsnip_0.1.7.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_c50 r_suggests_covr r_suggests_dials
	r_suggests_earth r_suggests_kernlab r_suggests_kknn r_suggests_knitr
