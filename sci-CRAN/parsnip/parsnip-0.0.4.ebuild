...
SRC_URI="http://cran.r-project.org/src/contrib/parsnip_0.0.4.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_c50 r_suggests_covr r_suggests_earth
	r_suggests_glmnet r_suggests_kernlab r_suggests_kknn r_suggests_knitr
	r_suggests_mass r_suggests_nlme r_suggests_randomforest
