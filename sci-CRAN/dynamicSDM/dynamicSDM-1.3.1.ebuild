...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/dynamicSDM_1.3.1.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_ape r_suggests_covr r_suggests_gargle
	...
	r_suggests_matrix r_suggests_rmarkdown r_suggests_spthin
	r_suggests_stars r_suggests_testthat r_suggests_viridis"
R_SUGGESTS="
