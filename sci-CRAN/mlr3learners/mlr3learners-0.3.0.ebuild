...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3learners_0.3.0.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_bibtex r_suggests_checkmate r_suggests_dicekriging
	r_suggests_distr6 r_suggests_e1071 r_suggests_glmnet r_suggests_kknn
	r_suggests_knitr r_suggests_lgr r_suggests_mass r_suggests_mlr3proba
...
R_SUGGESTS="
	...
	r_suggests_mlr3proba? ( >=sci-CRAN/mlr3proba-0.2.1 )
