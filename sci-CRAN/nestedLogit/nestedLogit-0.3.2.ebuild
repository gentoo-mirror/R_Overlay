...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/nestedLogit_0.3.2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_cardata r_suggests_ggeffects r_suggests_ggplot2
	r_suggests_here r_suggests_knitr r_suggests_lobstr r_suggests_nnet
