...
SRC_URI="http://cran.r-project.org/src/contrib/GGally_2.4.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_airports r_suggests_broom r_suggests_broom_helpers
...
R_SUGGESTS="
	r_suggests_airports? ( sci-CRAN/airports )
