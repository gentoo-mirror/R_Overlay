...
SRC_URI="http://cran.r-project.org/src/contrib/GGally_1.3.2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_broom r_suggests_chemometrics r_suggests_geosphere
	r_suggests_igraph r_suggests_intergraph r_suggests_mapproj
	r_suggests_maps r_suggests_network r_suggests_packagedocs
