...
IUSE="${IUSE-} r_suggests_arm r_suggests_broom r_suggests_geosphere
	r_suggests_ggmap r_suggests_igraph r_suggests_maps r_suggests_network
	r_suggests_rcolorbrewer r_suggests_roxygen2 r_suggests_scagnostics
	r_suggests_scales r_suggests_sna r_suggests_survival
	r_suggests_testthat r_suggests_tnet"
R_SUGGESTS="
	r_suggests_arm? ( >=sci-R/arm-1.8.6 )
