...
SRC_URI="http://cran.r-project.org/src/contrib/HistData_0.9-1.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_car r_suggests_dplyr r_suggests_effects
	...
	r_suggests_lubridate r_suggests_maps r_suggests_mass r_suggests_plyr
	r_suggests_proto r_suggests_reshape r_suggests_rmarkdown
	r_suggests_scales r_suggests_sp r_suggests_vcd"
R_SUGGESTS="
