...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.21.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_geepack r_suggests_ggeffects r_suggests_ggplot2
	r_suggests_glmmadaptive r_suggests_glmmtmb r_suggests_gparotation
	r_suggests_gt r_suggests_haven r_suggests_hmisc r_suggests_httr
	r_suggests_ivprobit r_suggests_ivreg r_suggests_knitr
	r_suggests_lavaan r_suggests_lfe r_suggests_lm_beta r_suggests_lme4
	r_suggests_lmertest r_suggests_lmtest r_suggests_logspline
	...
	r_suggests_multcomp r_suggests_mumin r_suggests_nbclust
	r_suggests_nestedlogit r_suggests_nfactors r_suggests_nlme
	r_suggests_nnet r_suggests_openxlsx r_suggests_ordinal
	r_suggests_panelr r_suggests_pbkrtest r_suggests_pcdimension
	r_suggests_performance r_suggests_plm r_suggests_pmcmrplus
	r_suggests_poorman r_suggests_posterior r_suggests_proreg
	r_suggests_pscl r_suggests_psych r_suggests_pvclust
	...
	r_suggests_testthat r_suggests_tidyselect r_suggests_tmb
	r_suggests_truncreg r_suggests_vgam r_suggests_withr r_suggests_wrs2"
R_SUGGESTS="
	...
	r_suggests_ggeffects? ( >=sci-CRAN/ggeffects-1.2.0 )
	...
	r_suggests_performance? ( >=sci-CRAN/performance-0.10.1 )
