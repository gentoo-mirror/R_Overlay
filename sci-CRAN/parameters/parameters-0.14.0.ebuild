...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.14.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_cluster r_suggests_cplm r_suggests_dplyr r_suggests_drr
	r_suggests_effectsize r_suggests_eganet r_suggests_emmeans
	...
	r_suggests_lavaan r_suggests_lavasearch2 r_suggests_lm_beta
	...
	r_suggests_mgcv r_suggests_mice r_suggests_multcomp
	...
	r_suggests_pmcmrplus r_suggests_pscl r_suggests_psych
...
R_SUGGESTS="
	...
	r_suggests_effectsize? ( >=sci-CRAN/effectsize-0.4.4.1 )
