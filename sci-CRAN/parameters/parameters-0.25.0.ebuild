...
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.25.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_cluster r_suggests_cobalt r_suggests_coda r_suggests_coxme
	r_suggests_cplm r_suggests_curl r_suggests_dbscan r_suggests_did
	...
	r_suggests_rmarkdown r_suggests_rms r_suggests_rstan
	r_suggests_rstanarm r_suggests_sandwich r_suggests_see
	r_suggests_serp r_suggests_sparsepca r_suggests_survey
	r_suggests_survival r_suggests_svylme r_suggests_testthat
	r_suggests_tidyselect r_suggests_tinytable r_suggests_tmb
	r_suggests_truncreg r_suggests_vdiffr r_suggests_vgam
	r_suggests_weightit r_suggests_withr r_suggests_wrs2"
R_SUGGESTS="
