...
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.24.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_cplm r_suggests_dbscan r_suggests_did
	...
	r_suggests_glmmtmb r_suggests_glmtoolbox r_suggests_gparotation
	r_suggests_gt r_suggests_haven r_suggests_hmisc r_suggests_httr2
	r_suggests_ivreg r_suggests_knitr r_suggests_lavaan r_suggests_lfe
	r_suggests_lm_beta r_suggests_lme4 r_suggests_lmertest
	r_suggests_lmtest r_suggests_logistf r_suggests_logitr
	...
	r_suggests_mmrm r_suggests_modelbased r_suggests_multcomp
	r_suggests_mumin r_suggests_nbclust r_suggests_nestedlogit
