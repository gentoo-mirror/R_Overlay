...
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.9.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_aod r_suggests_bayesfactor
	...
	r_suggests_brms r_suggests_caic4 r_suggests_car r_suggests_cluster
	r_suggests_covr r_suggests_cplm r_suggests_dplyr r_suggests_drr
	r_suggests_effectsize r_suggests_eganet r_suggests_factominer
	r_suggests_fastica r_suggests_gamlss r_suggests_gee
	r_suggests_geepack r_suggests_ggplot2 r_suggests_glmmadaptive
	r_suggests_glmmtmb r_suggests_gparotation r_suggests_knitr
	r_suggests_lavaan r_suggests_lavasearch2 r_suggests_lfe
	r_suggests_lme4 r_suggests_lmertest r_suggests_logspline
	r_suggests_m3c r_suggests_mass r_suggests_matrix r_suggests_mclust
	r_suggests_mcmcglmm r_suggests_metabma r_suggests_metafor
	...
	r_suggests_plm r_suggests_projpred r_suggests_pscl r_suggests_psych
