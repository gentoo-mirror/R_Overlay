...
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.3.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_aod r_suggests_bayesfactor
	...
	r_suggests_cluster r_suggests_clvalid r_suggests_covr
	r_suggests_dplyr r_suggests_drr r_suggests_effectsize
	r_suggests_eganet r_suggests_factominer r_suggests_fastica
	r_suggests_gamlss r_suggests_gee r_suggests_geepack
	r_suggests_glmmadaptive r_suggests_glmmtmb r_suggests_knitr
	r_suggests_lavaan r_suggests_lme4 r_suggests_lmertest
	r_suggests_logspline r_suggests_mass r_suggests_matrix
	r_suggests_mclust r_suggests_mcmcglmm r_suggests_mgcv
	r_suggests_multimode r_suggests_mumin r_suggests_nbclust
	r_suggests_nfactors r_suggests_nlme r_suggests_panelr
	r_suggests_pbkrtest r_suggests_plm r_suggests_projpred
	...
	r_suggests_testthat r_suggests_tmb r_suggests_vgam r_suggests_zelig"
R_SUGGESTS="
