...
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.22.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_coxme r_suggests_cplm r_suggests_dbscan r_suggests_domir
	r_suggests_drc r_suggests_drr r_suggests_effectsize r_suggests_eganet
	...
	r_suggests_ggeffects r_suggests_ggplot2 r_suggests_glmmadaptive
	r_suggests_glmmtmb r_suggests_gparotation r_suggests_gt
	r_suggests_haven r_suggests_hmisc r_suggests_httr r_suggests_ivreg
	...
	r_suggests_quantreg r_suggests_randomforest r_suggests_rcppeigen
	r_suggests_rmarkdown r_suggests_rms r_suggests_rstanarm
	...
	r_suggests_vdiffr r_suggests_vgam r_suggests_withr r_suggests_wrs2"
R_SUGGESTS="
	...
	r_suggests_marginaleffects? ( >=sci-CRAN/marginaleffects-0.20.1 )
	...
	r_suggests_performance? ( >=sci-CRAN/performance-0.12.0 )
