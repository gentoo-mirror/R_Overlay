...
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.21.4.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_brglm2 r_suggests_brms r_suggests_broom r_suggests_caic4
	r_suggests_car r_suggests_cardata r_suggests_class
	r_suggests_clubsandwich r_suggests_cluster r_suggests_coda
	r_suggests_cplm r_suggests_dbscan r_suggests_domir r_suggests_drc
	r_suggests_drr r_suggests_effectsize r_suggests_eganet
	r_suggests_emmeans r_suggests_estimatr r_suggests_factoextra
	r_suggests_factominer r_suggests_faraway r_suggests_fastica
	r_suggests_fixest r_suggests_fpc r_suggests_gam r_suggests_gamlss
	r_suggests_gee r_suggests_geepack r_suggests_ggeffects
	r_suggests_ggplot2 r_suggests_glmmadaptive r_suggests_glmmtmb
	r_suggests_gparotation r_suggests_gt r_suggests_haven
	r_suggests_hmisc r_suggests_httr r_suggests_ivprobit r_suggests_ivreg
	...
	r_suggests_logistf r_suggests_logspline r_suggests_lqmm
	r_suggests_m3c r_suggests_marginaleffects r_suggests_mass
	r_suggests_matrix r_suggests_mclogit r_suggests_mclust
	r_suggests_mcmcglmm r_suggests_mediation r_suggests_merderiv
	r_suggests_metabma r_suggests_metafor r_suggests_mfx r_suggests_mgcv
	r_suggests_mice r_suggests_mmrm r_suggests_multcomp r_suggests_mumin
	r_suggests_nbclust r_suggests_nestedlogit r_suggests_nfactors
	...
	r_suggests_rms r_suggests_rstanarm r_suggests_sandwich r_suggests_see
	r_suggests_sparsepca r_suggests_survey r_suggests_survival
	r_suggests_testthat r_suggests_tidyselect r_suggests_tinytable
	r_suggests_tmb r_suggests_truncreg r_suggests_vgam r_suggests_withr
	r_suggests_wrs2"
R_SUGGESTS="
	...
	r_suggests_marginaleffects? ( >=sci-CRAN/marginaleffects-0.16.0 )
	...
	r_suggests_performance? ( >=sci-CRAN/performance-0.10.8 )
