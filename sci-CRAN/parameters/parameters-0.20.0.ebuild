...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.20.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_brms r_suggests_broom r_suggests_caic4 r_suggests_car
	r_suggests_class r_suggests_clubsandwich r_suggests_cluster
	r_suggests_cplm r_suggests_dbscan r_suggests_domir r_suggests_drc
	r_suggests_drr r_suggests_effectsize r_suggests_eganet
	r_suggests_emmeans r_suggests_factoextra r_suggests_factominer
	...
	r_suggests_lfe r_suggests_lm_beta r_suggests_lme4 r_suggests_lmertest
	...
	r_suggests_mediation r_suggests_merderiv r_suggests_metabma
	...
	r_suggests_rstanarm r_suggests_rsvd r_suggests_sandwich
	r_suggests_see r_suggests_sparsepca r_suggests_survey
	r_suggests_survival r_suggests_testthat r_suggests_tidyselect
	r_suggests_tmb r_suggests_truncreg r_suggests_vgam r_suggests_wrs2"
R_SUGGESTS="
	...
	r_suggests_effectsize? ( >=sci-CRAN/effectsize-0.8.0 )
...
DEPEND=">=dev-lang/R-3.6
	>=sci-CRAN/datawizard-0.6.3
	>=sci-CRAN/bayestestR-0.13.0
	>=sci-CRAN/insight-0.18.6
"
