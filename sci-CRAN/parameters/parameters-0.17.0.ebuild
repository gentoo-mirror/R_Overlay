...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.17.0.tar.gz"
LICENSE='GPL-3'
...
R_SUGGESTS="
	...
	r_suggests_effectsize? ( >=sci-CRAN/effectsize-0.5.0 )
	...
	r_suggests_see? ( >=sci-CRAN/see-0.6.8 )
...
"
DEPEND=">=sci-CRAN/datawizard-0.2.3
