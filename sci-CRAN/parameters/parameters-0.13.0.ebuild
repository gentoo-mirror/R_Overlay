...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.13.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_lmertest r_suggests_logspline r_suggests_lqmm
	r_suggests_m3c r_suggests_magrittr r_suggests_mass r_suggests_matrix
	...
	r_suggests_panelr r_suggests_pbkrtest r_suggests_performance
	r_suggests_plm r_suggests_pmcmrplus r_suggests_pscl r_suggests_psych
