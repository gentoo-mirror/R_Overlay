...
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.8.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_aod r_suggests_bayesfactor
	r_suggests_betareg r_suggests_boot r_suggests_brglm2 r_suggests_brms
	...
	r_suggests_lfe r_suggests_lme4 r_suggests_lmertest
	r_suggests_logspline r_suggests_m3c r_suggests_mass r_suggests_matrix
	r_suggests_mclust r_suggests_mcmcglmm r_suggests_metafor
	r_suggests_mfx r_suggests_mgcv r_suggests_multimode r_suggests_mumin
	r_suggests_nbclust r_suggests_nfactors r_suggests_nlme
	r_suggests_performance r_suggests_plm r_suggests_projpred
	...
	r_suggests_tmb r_suggests_truncreg r_suggests_vgam"
R_SUGGESTS="
