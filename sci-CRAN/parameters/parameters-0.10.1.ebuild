...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.10.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_lavasearch2 r_suggests_lme4 r_suggests_lmertest
	r_suggests_logspline r_suggests_m3c r_suggests_magrittr
	r_suggests_mass r_suggests_matrix r_suggests_mclust
	r_suggests_mcmcglmm r_suggests_mediation r_suggests_metafor
	...
	r_suggests_nfactors r_suggests_nlme r_suggests_performance
