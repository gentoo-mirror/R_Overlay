...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.12.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_emmeans r_suggests_factominer r_suggests_fastica
	r_suggests_gam r_suggests_gamlss r_suggests_gee r_suggests_geepack
...
R_SUGGESTS="
	...
	r_suggests_effectsize? ( >=sci-CRAN/effectsize-0.4.3 )
	...
	r_suggests_performance? ( >=sci-CRAN/performance-0.7.0 )
