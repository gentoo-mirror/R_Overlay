...
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.21.6.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_haven r_suggests_hmisc r_suggests_httr r_suggests_ivprobit
	...
	r_suggests_vgam r_suggests_withr r_suggests_wrs2"
R_SUGGESTS="
