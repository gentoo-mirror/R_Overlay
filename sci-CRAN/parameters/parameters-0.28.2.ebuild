...
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.28.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_sampleselection r_suggests_sandwich r_suggests_see
	r_suggests_serp r_suggests_sparsepca r_suggests_survey
	r_suggests_survival r_suggests_svylme r_suggests_testthat
	r_suggests_tidyselect r_suggests_tinytable r_suggests_truncreg
...
R_SUGGESTS="
	...
	r_suggests_effectsize? ( >=sci-CRAN/effectsize-1.0.1 )
	...
	r_suggests_marginaleffects? ( >=sci-CRAN/marginaleffects-0.29.0 )
