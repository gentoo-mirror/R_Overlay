...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.16.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_factominer r_suggests_fastica r_suggests_fpc
	...
	r_suggests_gparotation r_suggests_gt r_suggests_ivprobit
	r_suggests_ivreg r_suggests_knitr r_suggests_lavaan
	r_suggests_lavasearch2 r_suggests_lfe r_suggests_lm_beta
	r_suggests_lme4 r_suggests_lmertest r_suggests_logspline
	r_suggests_lqmm r_suggests_m3c r_suggests_magrittr r_suggests_mass
	r_suggests_matrix r_suggests_mclust r_suggests_mcmcglmm
	r_suggests_mediation r_suggests_metafor r_suggests_mfx
	r_suggests_mgcv r_suggests_mice r_suggests_multcomp r_suggests_mumin
	...
	r_suggests_pvclust r_suggests_quantreg r_suggests_randomforest
