...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.15.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_dbscan r_suggests_dplyr r_suggests_drc r_suggests_drr
	...
	r_suggests_openxlsx r_suggests_panelr r_suggests_pbkrtest
	r_suggests_pcdimension r_suggests_performance r_suggests_plm
	r_suggests_pmcmrplus r_suggests_proreg r_suggests_pscl
...
R_SUGGESTS="
	...
	r_suggests_effectsize? ( >=sci-CRAN/effectsize-0.5 )
