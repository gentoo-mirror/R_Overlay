...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/parameters_0.18.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_dbscan r_suggests_domir r_suggests_drc r_suggests_drr
	r_suggests_effectsize r_suggests_eganet r_suggests_emmeans
	r_suggests_factoextra r_suggests_factominer r_suggests_fastica
	...
	r_suggests_gt r_suggests_hmisc r_suggests_httr r_suggests_ivprobit
