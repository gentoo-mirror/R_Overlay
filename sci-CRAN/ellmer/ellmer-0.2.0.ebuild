...
SRC_URI="http://cran.r-project.org/src/contrib/ellmer_0.2.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_base64enc r_suggests_connectcreds r_suggests_curl
	r_suggests_gargle r_suggests_gitcreds r_suggests_knitr
...
"
DEPEND=">=sci-CRAN/promises-1.3.1
