...
SRC_URI="http://cran.r-project.org/src/contrib/ellmer_0.1.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_base64enc r_suggests_bslib r_suggests_connectcreds
	r_suggests_curl r_suggests_gitcreds r_suggests_knitr
