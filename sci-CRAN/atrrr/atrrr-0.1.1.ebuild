...
SRC_URI="http://cran.r-project.org/src/contrib/atrrr_0.1.1.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_askpass r_suggests_curl r_suggests_dplyr
	...
	r_suggests_magick r_suggests_mime r_suggests_rmarkdown
	r_suggests_testthat r_suggests_tidygraph r_suggests_webshot2"
R_SUGGESTS="
