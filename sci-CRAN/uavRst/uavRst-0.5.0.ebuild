...
SRC_URI="http://cran.r-project.org/src/contrib/uavRst_0.5-0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_caret r_suggests_cast r_suggests_crayon
	...
	r_suggests_proc r_suggests_randomforest r_suggests_rcpp
	r_suggests_reshape2 r_suggests_rgdal r_suggests_rgeos
	r_suggests_rgrass7 r_suggests_rlas r_suggests_rlidar
	r_suggests_rmarkdown r_suggests_sf r_suggests_sp r_suggests_spatial
	r_suggests_stringr r_suggests_velox r_suggests_zoo"
R_SUGGESTS="
