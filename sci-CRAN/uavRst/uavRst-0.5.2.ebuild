...
SRC_URI="http://cran.r-project.org/src/contrib/uavRst_0.5-2.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_caret r_suggests_cast r_suggests_crayon
	...
	r_suggests_proc r_suggests_r_utils r_suggests_randomforest
	r_suggests_rcpp r_suggests_reshape2 r_suggests_rgdal r_suggests_rgeos
