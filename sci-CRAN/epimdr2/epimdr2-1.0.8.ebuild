...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/epimdr2_1.0-8.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_ade4 r_suggests_bbmle r_suggests_fields
	...
	r_suggests_plotrix r_suggests_polspline r_suggests_pomp
	r_suggests_rootsolve r_suggests_rwave r_suggests_rworldmap
	r_suggests_scatterplot3d r_suggests_statnet"
R_SUGGESTS="
