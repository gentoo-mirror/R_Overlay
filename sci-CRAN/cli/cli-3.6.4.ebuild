...
SRC_URI="http://cran.r-project.org/src/contrib/cli_3.6.4.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_callr r_suggests_covr r_suggests_crayon
	r_suggests_digest r_suggests_glue r_suggests_htmltools
	r_suggests_htmlwidgets r_suggests_knitr r_suggests_processx
	r_suggests_ps r_suggests_rlang r_suggests_rmarkdown
	r_suggests_rprojroot r_suggests_rstudioapi r_suggests_testthat
	r_suggests_tibble r_suggests_whoami r_suggests_withr"
R_SUGGESTS="
