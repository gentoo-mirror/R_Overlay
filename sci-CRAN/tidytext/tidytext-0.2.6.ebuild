...
SRC_URI="http://cran.r-project.org/src/contrib/tidytext_0.2.6.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_broom r_suggests_covr r_suggests_data_table
	...
	r_suggests_scales r_suggests_stm r_suggests_stopwords
	r_suggests_testthat r_suggests_textdata r_suggests_tidyr
	r_suggests_tm r_suggests_topicmodels r_suggests_vdiffr
