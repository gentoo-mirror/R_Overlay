...
SRC_URI="http://cran.r-project.org/src/contrib/tidytext_0.2.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_broom r_suggests_data_table r_suggests_ggplot2
	r_suggests_gutenbergr r_suggests_knitr r_suggests_mallet
	r_suggests_nlp r_suggests_quanteda r_suggests_readr
