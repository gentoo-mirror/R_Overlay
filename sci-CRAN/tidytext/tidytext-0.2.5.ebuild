...
SRC_URI="http://cran.r-project.org/src/contrib/tidytext_0.2.5.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_broom r_suggests_covr r_suggests_data_table
	...
	r_suggests_mallet r_suggests_nlp r_suggests_readr r_suggests_reshape2
	r_suggests_rmarkdown r_suggests_scales r_suggests_stm
	r_suggests_stopwords r_suggests_testthat r_suggests_textdata
