...
SRC_URI="http://cran.r-project.org/src/contrib/grattan_1.9.0.0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_covr r_suggests_curl r_suggests_dplyr
	r_suggests_dtplyr r_suggests_future r_suggests_future_apply
	r_suggests_ggplot2 r_suggests_ggrepel r_suggests_hutilscpp
	r_suggests_knitr r_suggests_lattice r_suggests_mgcv r_suggests_rlang
