...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/broom_1.0.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_aer r_suggests_auc r_suggests_bbmle
	r_suggests_betareg r_suggests_biglm r_suggests_bingroup
	r_suggests_boot r_suggests_btergm r_suggests_car r_suggests_caret
	r_suggests_cluster r_suggests_cmprsk r_suggests_coda r_suggests_covr
	r_suggests_drc r_suggests_e1071 r_suggests_emmeans r_suggests_epir
	r_suggests_ergm r_suggests_fixest r_suggests_gam r_suggests_gee
	r_suggests_geepack r_suggests_glmnet r_suggests_glmnetutils
	r_suggests_gmm r_suggests_hmisc r_suggests_interp r_suggests_irlba
	r_suggests_joinerml r_suggests_kendall r_suggests_knitr r_suggests_ks
	r_suggests_lahman r_suggests_lavaan r_suggests_leaps r_suggests_lfe
	r_suggests_lm_beta r_suggests_lme4 r_suggests_lmodel2
	r_suggests_lmtest r_suggests_lsmeans r_suggests_maps
	r_suggests_maptools r_suggests_margins r_suggests_mass
	r_suggests_matrix r_suggests_mclust r_suggests_mediation
	r_suggests_metafor r_suggests_mfx r_suggests_mgcv r_suggests_mlogit
	...
	r_suggests_systemfit r_suggests_testthat r_suggests_tseries
