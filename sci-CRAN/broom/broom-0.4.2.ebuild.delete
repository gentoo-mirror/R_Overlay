...
SRC_URI="http://cran.r-project.org/src/contrib/broom_0.4.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_akima r_suggests_auc r_suggests_bbmle
	r_suggests_betareg r_suggests_biglm r_suggests_bingroup
	r_suggests_boot r_suggests_brms r_suggests_btergm r_suggests_coda
	...
	r_suggests_mclust r_suggests_mgcv r_suggests_multcomp
	r_suggests_network r_suggests_nnet r_suggests_orcutt r_suggests_plm
	r_suggests_polca r_suggests_purrr r_suggests_robust r_suggests_rstan
	r_suggests_rstanarm r_suggests_sp r_suggests_statnet_common
