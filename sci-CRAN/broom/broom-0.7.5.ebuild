...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/broom_0.7.5.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_akima r_suggests_auc
	...
	r_suggests_hmisc r_suggests_irlba r_suggests_joinerml
	...
	r_suggests_quantreg r_suggests_rchoice r_suggests_rgeos
