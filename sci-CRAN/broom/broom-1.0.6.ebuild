...
SRC_URI="http://cran.r-project.org/src/contrib/broom_1.0.6.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_auc r_suggests_bbmle
	...
	r_suggests_lmtest r_suggests_lsmeans r_suggests_maps r_suggests_mass
	...
	r_suggests_quantreg r_suggests_rmarkdown r_suggests_robust
	r_suggests_robustbase r_suggests_rsample r_suggests_sandwich
