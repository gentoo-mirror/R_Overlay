...
SRC_URI="http://cran.r-project.org/src/contrib/broom_0.4.3.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_akima r_suggests_auc
	...
	r_suggests_coda r_suggests_covr r_suggests_emmeans r_suggests_ergm
	r_suggests_gam r_suggests_gamlss r_suggests_geepack
	r_suggests_ggplot2 r_suggests_glmnet r_suggests_gmm r_suggests_hmisc
	r_suggests_knitr r_suggests_ks r_suggests_lahman r_suggests_lfe
	...
	r_suggests_nnet r_suggests_orcutt r_suggests_plm r_suggests_polca
	r_suggests_purrr r_suggests_robust r_suggests_rstan
	r_suggests_rstanarm r_suggests_sp r_suggests_speedglm
	r_suggests_statnet_common r_suggests_survival r_suggests_testthat
	r_suggests_tibble r_suggests_xergm r_suggests_zoo"
R_SUGGESTS="
