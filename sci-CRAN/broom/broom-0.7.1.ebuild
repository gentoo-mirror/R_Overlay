...
SRC_URI="http://cran.r-project.org/src/contrib/broom_0.7.1.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_akima r_suggests_auc
	...
	r_suggests_maps r_suggests_maptools r_suggests_margins
	r_suggests_mass r_suggests_matrix r_suggests_mclogit
	r_suggests_mclust r_suggests_mediation r_suggests_metafor
	r_suggests_mfx r_suggests_mgcv r_suggests_mlogit r_suggests_modeldata
...
R_SUGGESTS="
	...
	r_suggests_fixest? ( >=sci-CRAN/fixest-0.5.0 )
