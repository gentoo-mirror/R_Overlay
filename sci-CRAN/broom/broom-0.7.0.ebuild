...
SRC_URI="http://cran.r-project.org/src/contrib/broom_0.7.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_aer r_suggests_akima r_suggests_auc
	r_suggests_bbmle r_suggests_betareg r_suggests_biglm
	r_suggests_bingroup r_suggests_boot r_suggests_btergm r_suggests_car
	r_suggests_caret r_suggests_cluster r_suggests_coda r_suggests_covr
	r_suggests_drc r_suggests_e1071 r_suggests_emmeans r_suggests_epir
	r_suggests_ergm r_suggests_fixest r_suggests_gam r_suggests_gamlss
	r_suggests_gamlss_data r_suggests_gamlss_dist r_suggests_gee
	r_suggests_geepack r_suggests_ggplot2 r_suggests_glmnet
	r_suggests_glmnetutils r_suggests_gmm r_suggests_hmisc
	r_suggests_irlba r_suggests_joinerml r_suggests_kendall
	r_suggests_knitr r_suggests_ks r_suggests_lahman r_suggests_lavaan
	r_suggests_leaps r_suggests_lfe r_suggests_lm_beta r_suggests_lme4
	r_suggests_lmodel2 r_suggests_lmtest r_suggests_lsmeans
	r_suggests_maps r_suggests_maptools r_suggests_mass r_suggests_matrix
	r_suggests_mclogit r_suggests_mclust r_suggests_mediation
	r_suggests_metafor r_suggests_mfx r_suggests_mgcv
	r_suggests_modeldata r_suggests_modeltests r_suggests_muhaz
	r_suggests_multcomp r_suggests_network r_suggests_nnet
	r_suggests_orcutt r_suggests_ordinal r_suggests_plm r_suggests_polca
	r_suggests_psych r_suggests_quantreg r_suggests_rgeos
	r_suggests_rmarkdown r_suggests_robust r_suggests_robustbase
	r_suggests_rsample r_suggests_sandwich r_suggests_sp
	r_suggests_spatial r_suggests_spdep r_suggests_speedglm
	r_suggests_spelling r_suggests_statnet_common r_suggests_survey
...
R_SUGGESTS="
	...
	r_suggests_fixest? ( >=sci-CRAN/fixest-0.3.1 )
