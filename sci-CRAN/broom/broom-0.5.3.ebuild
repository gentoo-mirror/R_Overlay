...
SRC_URI="http://cran.r-project.org/src/contrib/broom_0.5.3.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_akima r_suggests_auc
	...
	r_suggests_gmm r_suggests_hmisc r_suggests_irlba r_suggests_joinerml
	r_suggests_kendall r_suggests_knitr r_suggests_ks r_suggests_lahman
	r_suggests_lavaan r_suggests_lfe r_suggests_lme4 r_suggests_lmodel2
	r_suggests_lmtest r_suggests_lsmeans r_suggests_maps
	r_suggests_maptools r_suggests_mass r_suggests_matrix
	r_suggests_mclust r_suggests_mgcv r_suggests_muhaz
	r_suggests_multcomp r_suggests_network r_suggests_nnet
	r_suggests_orcutt r_suggests_ordinal r_suggests_plm r_suggests_plyr
	r_suggests_polca r_suggests_psych r_suggests_quantreg
