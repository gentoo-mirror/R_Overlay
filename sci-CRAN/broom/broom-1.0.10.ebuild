...
SRC_URI="http://cran.r-project.org/src/contrib/broom_1.0.10.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_auc r_suggests_bbmle
	...
	r_suggests_glmnet r_suggests_glmnetutils r_suggests_gmm
	r_suggests_hmisc r_suggests_interp r_suggests_irlba
	...
	r_suggests_network r_suggests_nnet r_suggests_ordinal r_suggests_plm
	r_suggests_polca r_suggests_psych r_suggests_quantreg
	r_suggests_rmarkdown r_suggests_robust r_suggests_robustbase
	r_suggests_rsample r_suggests_sandwich r_suggests_spatial
	r_suggests_spdep r_suggests_speedglm r_suggests_spelling
	r_suggests_survey r_suggests_survival r_suggests_systemfit
	r_suggests_testthat r_suggests_tseries r_suggests_vars r_suggests_zoo"
R_SUGGESTS="
	r_suggests_aer? ( sci-CRAN/AER )
	r_suggests_auc? ( sci-CRAN/AUC )
	r_suggests_bbmle? ( sci-CRAN/bbmle )
	r_suggests_betareg? ( >=sci-CRAN/betareg-3.2.1 )
	...
	r_suggests_epir? ( >=sci-CRAN/epiR-2.0.85 )
	...
	r_suggests_lavaan? ( >=sci-CRAN/lavaan-0.6.18 )
	...
	r_suggests_modeltests? ( >=sci-CRAN/modeltests-0.1.6 )
