...
SRC_URI="http://cran.r-project.org/src/contrib/broom_0.3.4.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_ggplot2 r_suggests_glmnet r_suggests_knitr
	r_suggests_lahman r_suggests_lfe r_suggests_lme4 r_suggests_maps
	r_suggests_maptools r_suggests_multcomp r_suggests_sp
