...
IUSE="${IUSE-} r_suggests_auc r_suggests_bbmle r_suggests_biglm
	r_suggests_bingroup r_suggests_btergm r_suggests_coda r_suggests_ergm
	...
	r_suggests_lmtest r_suggests_maps r_suggests_maptools
	r_suggests_multcomp r_suggests_network r_suggests_plm
	r_suggests_r[-minimal] r_suggests_rstan r_suggests_sp
	r_suggests_statnet_common r_suggests_testthat r_suggests_xergm
	r_suggests_zoo"
R_SUGGESTS="
