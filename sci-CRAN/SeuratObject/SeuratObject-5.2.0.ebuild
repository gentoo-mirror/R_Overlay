...
SRC_URI="http://cran.r-project.org/src/contrib/SeuratObject_5.2.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_delayedarray r_suggests_fs r_suggests_ggplot2
	r_suggests_hdf5array r_suggests_rmarkdown r_suggests_sf
	r_suggests_testthat"
R_SUGGESTS="
	...
	r_suggests_sf? ( >=sci-CRAN/sf-1.0.0 )
