...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/golem_0.4.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_attachment r_suggests_cli r_suggests_covr
	r_suggests_crayon r_suggests_desc r_suggests_devtools
	r_suggests_dockerfiler r_suggests_fs r_suggests_knitr
	r_suggests_pkgbuild r_suggests_pkgload r_suggests_processx
	r_suggests_purrr r_suggests_rcmdcheck r_suggests_renv
