...
SRC_URI="http://cran.r-project.org/src/contrib/mev_2.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_boot r_suggests_cobs r_suggests_evd
	r_suggests_expint r_suggests_gmm r_suggests_ismev r_suggests_knitr
	r_suggests_mass r_suggests_mvpot r_suggests_mvtnorm
	r_suggests_revdbayes r_suggests_rmarkdown r_suggests_tinytest
