...
SRC_URI="http://cran.r-project.org/src/contrib/Ecfun_0.3-6.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_bayesplot r_suggests_bssm r_suggests_car
	...
	r_suggests_plyr r_suggests_prodlim r_suggests_pryr r_suggests_purrr
	r_suggests_raster r_suggests_readxl r_suggests_rmarkdown
	r_suggests_tibble r_suggests_trampr r_suggests_zoo"
R_SUGGESTS="
