...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/surveillance_1.20.0.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_animation r_suggests_coda r_suggests_colorspace
	...
	r_suggests_maptools r_suggests_maxlik r_suggests_memoise
	r_suggests_mglm r_suggests_msm r_suggests_numderiv
