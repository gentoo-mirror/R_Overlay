...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/surveillance_1.21.0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_animation r_suggests_coda r_suggests_colorspace
	r_suggests_fanplot r_suggests_gamlss r_suggests_gpclib
	r_suggests_gridextra r_suggests_gsl r_suggests_hhh4contacts
	r_suggests_intervals r_suggests_knitr r_suggests_lattice
	...
	r_suggests_rgeos r_suggests_runjags r_suggests_scales r_suggests_sf
	r_suggests_spc r_suggests_spdep r_suggests_splancs
	r_suggests_tinytest"
R_SUGGESTS="
