...
SRC_URI="http://cran.r-project.org/src/contrib/surveillance_1.7-0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_animation r_suggests_coda r_suggests_colorspace
	r_suggests_digest r_suggests_gamlss r_suggests_gpclib
	...
	r_suggests_runit r_suggests_spc r_suggests_spdep r_suggests_splancs"
R_SUGGESTS="
...
DEPEND="sci-CRAN/Rcpp
	>=sci-CRAN/spatstat-1.34.0
	>=sci-CRAN/polyCub-0.4.0
	>=sci-CRAN/sp-1.0.6
	sci-CRAN/xtable
	>=dev-lang/R-2.15.2
"
