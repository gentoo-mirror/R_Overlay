...
SRC_URI="http://cran.r-project.org/src/contrib/surveillance_1.15.0.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_animation r_suggests_coda r_suggests_colorspace
	...
	r_suggests_hhh4contacts r_suggests_intervals r_suggests_knitr
	r_suggests_lattice r_suggests_maptools r_suggests_maxlik
