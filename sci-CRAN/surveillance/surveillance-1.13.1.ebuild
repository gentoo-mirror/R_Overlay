...
SRC_URI="http://cran.r-project.org/src/contrib/surveillance_1.13.1.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_animation r_suggests_coda r_suggests_colorspace
	...
	r_suggests_gpclib r_suggests_gridextra r_suggests_gsl
