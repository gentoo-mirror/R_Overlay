...
SRC_URI="http://cran.r-project.org/src/contrib/spatstat.geom_3.6-0.tar.gz"
LICENSE='GPL-2+'
...
R_SUGGESTS="
	...
	r_suggests_spatstat_explore? ( >=sci-CRAN/spatstat_explore-3.4 )
	r_suggests_spatstat_model? ( >=sci-CRAN/spatstat_model-3.3 )
	r_suggests_spatstat_random? ( >=sci-CRAN/spatstat_random-3.4 )
"
DEPEND=">=sci-CRAN/polyclip-1.10
	>=dev-lang/R-3.5.0
	>=sci-CRAN/spatstat_utils-3.2.0
