...
SRC_URI="http://cran.r-project.org/src/contrib/spatstat.geom_3.3-4.tar.gz"
LICENSE='GPL-2+'
...
R_SUGGESTS="
	...
	r_suggests_spatstat? ( >=sci-CRAN/spatstat-3.2 )
...
"
DEPEND=">=sci-CRAN/polyclip-1.10.0
	>=sci-CRAN/spatstat_utils-3.1.1
	>=dev-lang/R-3.5.0
	>=sci-CRAN/spatstat_univar-3.1.0
