...
SRC_URI="http://cran.r-project.org/src/contrib/wrswoR_1.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_batchexperiments r_suggests_dplyr
	...
	r_suggests_rticles r_suggests_sampling r_suggests_testthat
	r_suggests_tidyr r_suggests_tikzdevice"
R_SUGGESTS="
