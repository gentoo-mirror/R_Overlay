...
IUSE="${IUSE-} r_suggests_batchexperiments r_suggests_biocmanager
	...
	r_suggests_kimisc r_suggests_knitr r_suggests_metap
	r_suggests_rmarkdown r_suggests_roxygen2 r_suggests_rticles
	r_suggests_sampling r_suggests_testthat r_suggests_tidyr
