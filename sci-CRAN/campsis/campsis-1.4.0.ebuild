...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/campsis_1.4.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_bookdown r_suggests_devtools r_suggests_gridextra
	...
	r_suggests_roxygen2 r_suggests_rxode2 r_suggests_stringr
...
"
DEPEND=">=sci-CRAN/campsismod-1.0.0
	sci-CRAN/digest
	>=dev-lang/R-4.0.0
	sci-CRAN/dplyr
	sci-CRAN/furrr
