...
SRC_URI="http://cran.r-project.org/src/contrib/tidyfit_0.7.4.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_arm r_suggests_bestglm r_suggests_bms
	r_suggests_boomspikeslab r_suggests_corelearn r_suggests_e1071
	r_suggests_gaselect r_suggests_gets r_suggests_gglasso
	r_suggests_ggplot2 r_suggests_glmnet r_suggests_hfr r_suggests_iml
	r_suggests_kableextra r_suggests_knitr r_suggests_lme4
	r_suggests_lmtest r_suggests_lubridate r_suggests_markdown
	r_suggests_mboost r_suggests_monomvn r_suggests_mrmre r_suggests_mswm
	r_suggests_nnet r_suggests_pls r_suggests_quantreg
	r_suggests_quantregforest r_suggests_randomforest
	r_suggests_rmarkdown r_suggests_sandwich r_suggests_sensitivity
	r_suggests_shrinktvp r_suggests_stringr r_suggests_testthat"
R_SUGGESTS="
