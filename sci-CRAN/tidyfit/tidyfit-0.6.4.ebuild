...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/tidyfit_0.6.4.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_arm r_suggests_bestglm r_suggests_bms
	...
	r_suggests_monomvn r_suggests_mrmre r_suggests_mswm r_suggests_pls
	r_suggests_quantreg r_suggests_randomforest r_suggests_rmarkdown
	r_suggests_sandwich r_suggests_shrinktvp r_suggests_stringr
	r_suggests_testthat"
R_SUGGESTS="
