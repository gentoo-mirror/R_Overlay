...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/bench_1.1.2.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_dplyr r_suggests_forcats
	...
	r_suggests_jsonlite r_suggests_mockery r_suggests_scales
	r_suggests_testthat r_suggests_tidyr r_suggests_vctrs
	r_suggests_withr"
R_SUGGESTS="
