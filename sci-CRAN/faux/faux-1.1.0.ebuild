...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/faux_1.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_broom r_suggests_broom_mixed r_suggests_covr
	r_suggests_cowplot r_suggests_ggextra r_suggests_glue
	r_suggests_knitr r_suggests_lmertest r_suggests_openssl
	r_suggests_psych r_suggests_purrr r_suggests_readr
