...
SRC_URI="http://cran.r-project.org/src/contrib/r5r_2.3.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_accessibility r_suggests_covr r_suggests_dplyr
	r_suggests_fs r_suggests_ggplot2 r_suggests_gtfstools
	r_suggests_interp r_suggests_knitr r_suggests_mapview
	r_suggests_patchwork r_suggests_rjavaenv r_suggests_rmarkdown
	r_suggests_testthat"
R_SUGGESTS="
