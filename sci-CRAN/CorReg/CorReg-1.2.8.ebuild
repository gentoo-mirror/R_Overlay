...
SRC_URI="http://cran.r-project.org/src/contrib/CorReg_1.2.8.tar.gz"
LICENSE='CeCILL-C'

IUSE="${IUSE-} r_suggests_clere r_suggests_knitr r_suggests_missmda
	r_suggests_parcor r_suggests_rmarkdown r_suggests_spikeslab
	r_suggests_tuner"
R_SUGGESTS="
