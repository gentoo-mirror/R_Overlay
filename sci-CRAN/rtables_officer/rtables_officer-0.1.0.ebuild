...
SRC_URI="http://cran.r-project.org/src/contrib/rtables.officer_0.1.0.tar.gz"
LICENSE='Apache-2.0'

IUSE="${IUSE-} r_suggests_broom r_suggests_car r_suggests_dplyr
	r_suggests_knitr r_suggests_r2rtf r_suggests_rmarkdown
	r_suggests_survival r_suggests_tern r_suggests_testthat
...
R_SUGGESTS="
	...
	r_suggests_tern? ( >=sci-CRAN/tern-0.9.7 )
