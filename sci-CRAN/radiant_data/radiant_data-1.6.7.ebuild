...
SRC_URI="http://cran.r-project.org/src/contrib/radiant.data_1.6.7.tar.gz"
LICENSE='AGPL-3'

IUSE="${IUSE-} r_suggests_arrow r_suggests_dbi r_suggests_dbplyr
	r_suggests_pkgdown r_suggests_rpostgres r_suggests_rsqlite
	r_suggests_testthat"
R_SUGGESTS="
	r_suggests_arrow? ( >=sci-CRAN/arrow-12.0.1 )
