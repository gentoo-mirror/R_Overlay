...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/MARVEL_1.3.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_cluster r_suggests_factoextra
	...
	r_suggests_ksamples r_suggests_markdown r_suggests_plyr
	r_suggests_reshape2 r_suggests_rmarkdown r_suggests_stringr
	r_suggests_textclean r_suggests_twosamples"
R_SUGGESTS="
