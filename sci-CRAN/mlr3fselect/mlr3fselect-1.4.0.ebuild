...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3fselect_1.4.0.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_e1071 r_suggests_fastvoter r_suggests_genalg
	r_suggests_mirai r_suggests_mlr3learners r_suggests_mlr3pipelines
...
"
DEPEND=">=sci-CRAN/mlr3-1.0.1
	>=sci-CRAN/checkmate-2.0.0
	>=dev-lang/R-3.1.0
	sci-CRAN/cli
	>=sci-CRAN/bbotk-1.6.0
	sci-CRAN/data_table
	sci-CRAN/lgr
