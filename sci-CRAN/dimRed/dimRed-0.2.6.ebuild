...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/dimRed_0.2.6.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_cccd r_suggests_coranking r_suggests_diffusionmap
	...
	r_suggests_igraph r_suggests_kernlab r_suggests_knitr r_suggests_loe
	r_suggests_mass r_suggests_matrix r_suggests_nmf r_suggests_optimx
