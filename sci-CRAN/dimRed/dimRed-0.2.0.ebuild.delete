...
SRC_URI="http://cran.r-project.org/src/contrib/dimRed_0.2.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_cccd r_suggests_coranking r_suggests_diffusionmap
	...
	r_suggests_loe r_suggests_mass r_suggests_matrix r_suggests_optimx
	r_suggests_pcal1 r_suggests_pcapp r_suggests_rann
