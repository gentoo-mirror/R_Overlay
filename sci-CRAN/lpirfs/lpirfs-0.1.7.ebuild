...
SRC_URI="http://cran.r-project.org/src/contrib/lpirfs_0.1.7.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ggpubr r_suggests_httr r_suggests_knitr
	r_suggests_quantmod r_suggests_readxl r_suggests_rmarkdown
