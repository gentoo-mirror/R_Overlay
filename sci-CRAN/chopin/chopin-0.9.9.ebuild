...
SRC_URI="http://cran.r-project.org/src/contrib/chopin_0.9.9.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_covr r_suggests_devtools r_suggests_dggridr
	r_suggests_diagrammer r_suggests_future_mirai r_suggests_h3r
	r_suggests_knitr r_suggests_lifecycle r_suggests_rmarkdown
	r_suggests_spatstat_random r_suggests_targets r_suggests_testthat
	r_suggests_units r_suggests_withr"
R_SUGGESTS="
	r_suggests_covr? ( sci-CRAN/covr )
	r_suggests_devtools? ( sci-CRAN/devtools )
	r_suggests_dggridr? ( sci-CRAN/dggridR )
	r_suggests_diagrammer? ( sci-CRAN/DiagrammeR )
	r_suggests_future_mirai? ( sci-CRAN/future_mirai )
	r_suggests_h3r? ( sci-CRAN/h3r )
