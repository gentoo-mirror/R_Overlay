...
SRC_URI="http://cran.r-project.org/src/contrib/mosaic_1.9.0.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_broom r_suggests_covr r_suggests_formatr
	...
	r_suggests_nhanes r_suggests_palmerpenguins r_suggests_rcurl
	r_suggests_readr r_suggests_rgl r_suggests_rmarkdown r_suggests_sp
