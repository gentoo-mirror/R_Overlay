...
SRC_URI="http://cran.r-project.org/src/contrib/modelStudio_1.2.0.tar.gz"
LICENSE='GPL-3'
...
R_SUGGESTS="
	r_suggests_dalex? ( >=sci-CRAN/DALEX-1.0 )
...
DEPEND="sci-CRAN/progress
	sci-CRAN/jsonlite
	sci-CRAN/r2d3
	>=sci-CRAN/iBreakDown-1.1.0
	sci-CRAN/digest
	>=sci-CRAN/ingredients-1.0.0
	>=dev-lang/R-3.5
"
