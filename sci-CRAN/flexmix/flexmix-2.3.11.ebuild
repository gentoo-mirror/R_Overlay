...
SRC_URI="http://cran.r-project.org/src/contrib/flexmix_2.3-11.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_diptest r_suggests_ellipse r_suggests_gclus
	r_suggests_lme4 r_suggests_mlbench r_suggests_mlogit
	r_suggests_multcomp r_suggests_mvtnorm"
R_SUGGESTS="
