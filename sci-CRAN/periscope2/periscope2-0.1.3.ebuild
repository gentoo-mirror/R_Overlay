...
SRC_URI="http://cran.r-project.org/src/contrib/periscope2_0.1.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_assertthat r_suggests_canvasxpress
	r_suggests_ggplot2 r_suggests_knitr r_suggests_lattice
	r_suggests_openxlsx r_suggests_rmarkdown r_suggests_shinyalert
	r_suggests_shinyjs r_suggests_spelling r_suggests_testthat
	r_suggests_waiter"
R_SUGGESTS="
