...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/multcomp_1.4-25.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_coin r_suggests_coxme r_suggests_fixest
	r_suggests_foreign r_suggests_glmmtmb r_suggests_iswr r_suggests_lme4
	r_suggests_lmtest r_suggests_mass r_suggests_nlme
	r_suggests_robustbase r_suggests_simcomp r_suggests_tram
	r_suggests_xtable"
R_SUGGESTS="
