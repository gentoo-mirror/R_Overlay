...
SRC_URI="http://cran.r-project.org/src/contrib/multcomp_1.4-15.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_coin r_suggests_coxme r_suggests_foreign
	r_suggests_iswr r_suggests_lme4 r_suggests_lmtest r_suggests_mass
...
"
DEPEND=">=sci-CRAN/sandwich-2.3.0
	virtual/codetools
