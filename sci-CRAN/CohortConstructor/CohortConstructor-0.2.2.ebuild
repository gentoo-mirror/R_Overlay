...
SRC_URI="http://cran.r-project.org/src/contrib/CohortConstructor_0.2.2.tar.gz"

IUSE="${IUSE-} r_suggests_codelistgenerator r_suggests_covr r_suggests_dbi
	r_suggests_drugutilisation r_suggests_duckdb
...
"
DEPEND=">=sci-CRAN/omopgenerics-0.2.1
	sci-CRAN/tidyr
