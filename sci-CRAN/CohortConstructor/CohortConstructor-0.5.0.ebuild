...
SRC_URI="http://cran.r-project.org/src/contrib/CohortConstructor_0.5.0.tar.gz"

IUSE="${IUSE-} r_suggests_circer r_suggests_codelistgenerator
	r_suggests_cohortcharacteristics r_suggests_covr r_suggests_dbi
	r_suggests_diagrammer r_suggests_drugutilisation r_suggests_duckdb
	r_suggests_ggplot2 r_suggests_ggpubr r_suggests_gt r_suggests_here
	...
	r_suggests_scales r_suggests_sqlrender r_suggests_stringr
	r_suggests_testthat r_suggests_tibble r_suggests_tictoc
	r_suggests_visomopresults"
R_SUGGESTS="
	r_suggests_circer? ( sci-CRAN/CirceR )
	r_suggests_codelistgenerator? ( >=sci-CRAN/CodelistGenerator-3.4.1 )
