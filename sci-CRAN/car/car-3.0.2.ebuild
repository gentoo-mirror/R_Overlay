...
SRC_URI="http://cran.r-project.org/src/contrib/car_3.0-2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_alr4 r_suggests_boot r_suggests_coxme
	r_suggests_leaps r_suggests_lmtest r_suggests_matrix r_suggests_rgl
