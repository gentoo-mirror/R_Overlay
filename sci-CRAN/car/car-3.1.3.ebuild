...
SRC_URI="http://cran.r-project.org/src/contrib/car_3.1-3.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_alr4 r_suggests_boot r_suggests_coxme
	r_suggests_effects r_suggests_knitr r_suggests_leaps
	r_suggests_lmtest r_suggests_matrix r_suggests_mvtnorm
	r_suggests_ordinal r_suggests_plotrix r_suggests_rgl r_suggests_rio
