...
SRC_URI="http://cran.r-project.org/src/contrib/gaawr2_0.0.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bglr r_suggests_biomart r_suggests_blr
	r_suggests_bookdown r_suggests_gmmat r_suggests_haplo_stats
	r_suggests_hardyweinberg r_suggests_httpuv r_suggests_httr
	r_suggests_jsonlite r_suggests_kableextra r_suggests_knitr
	r_suggests_mcmcglmm r_suggests_powereqtl r_suggests_regress
	r_suggests_snpassoc r_suggests_testthat r_suggests_tidyr"
R_SUGGESTS="
