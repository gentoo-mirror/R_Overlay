...
SRC_URI="http://cran.r-project.org/src/contrib/emmeans_1.10.5.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'

IUSE="${IUSE-} r_suggests_bayesplot r_suggests_bayestestr r_suggests_biglm
	r_suggests_brms r_suggests_car r_suggests_coda
	r_suggests_compositions r_suggests_ggplot2 r_suggests_knitr
