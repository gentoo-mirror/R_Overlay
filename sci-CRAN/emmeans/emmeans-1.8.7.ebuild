...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/emmeans_1.8.7.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'

IUSE="${IUSE-} r_suggests_bayesplot r_suggests_bayestestr r_suggests_biglm
	r_suggests_brms r_suggests_car r_suggests_coda r_suggests_ggplot2
	r_suggests_knitr r_suggests_lattice r_suggests_lme4
	r_suggests_lmertest r_suggests_logspline r_suggests_mass
	r_suggests_mediation r_suggests_mgcv r_suggests_multcomp
	r_suggests_multcompview r_suggests_mumin r_suggests_nlme
	r_suggests_ordinal r_suggests_pbkrtest r_suggests_rmarkdown
	r_suggests_rsm r_suggests_sandwich r_suggests_scales
...
R_SUGGESTS="
	...
	r_suggests_xtable? ( >=sci-CRAN/xtable-1.8.2 )
"
DEPEND=">=sci-CRAN/estimability-1.4.1
	sci-CRAN/mvtnorm
	>=dev-lang/R-4.1.0
	sci-CRAN/numDeriv
"
