...
SRC_URI="http://cran.r-project.org/src/contrib/emmeans_1.2.2.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'

IUSE="${IUSE-} r_suggests_bayesplot r_suggests_brms r_suggests_car
	r_suggests_coda r_suggests_ggplot2 r_suggests_knitr
	r_suggests_lattice r_suggests_lme4 r_suggests_lmertest
	r_suggests_mass r_suggests_mediation r_suggests_multcomp
	r_suggests_multcompview r_suggests_nlme r_suggests_ordinal
