...
SRC_URI="http://cran.r-project.org/src/contrib/hydflood_0.5.5.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_devtools r_suggests_knitr r_suggests_leaflet
	...
	r_suggests_pkgdown r_suggests_plot3d r_suggests_plotrix
	r_suggests_rgrass r_suggests_rmarkdown r_suggests_roxygen2
	r_suggests_shiny r_suggests_shiny_i18n r_suggests_shinyjs
