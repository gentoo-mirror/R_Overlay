...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/EGAnet_1.0.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_corpcor r_suggests_foreign r_suggests_gridextra
	r_suggests_infutil r_suggests_knitr r_suggests_markdown
	r_suggests_mass r_suggests_matrix r_suggests_mirt r_suggests_openmx
