...
IUSE="${IUSE-} r_suggests_corpcor r_suggests_fdrtool r_suggests_fitdistrplus
	r_suggests_ggplot2 r_suggests_ggpubr r_suggests_knitr r_suggests_mass
	r_suggests_matrix r_suggests_mvtnorm r_suggests_openmx
	r_suggests_pbapply r_suggests_plyr r_suggests_psych
