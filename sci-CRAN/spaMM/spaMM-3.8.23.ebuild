...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/spaMM_3.8.23.tar.gz"
LICENSE='CeCILL-2'

IUSE="${IUSE-} r_suggests_blackbox r_suggests_foreach r_suggests_future
	r_suggests_future_apply r_suggests_glpk r_suggests_infusion
	r_suggests_isorix r_suggests_lme4 r_suggests_maps
