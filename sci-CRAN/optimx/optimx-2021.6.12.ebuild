...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/optimx_2021-6.12.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_bb r_suggests_dfoptim r_suggests_knitr
	r_suggests_lbfgs r_suggests_lbfgsb3c r_suggests_markdown
	r_suggests_minqa r_suggests_rmarkdown r_suggests_setrng
	r_suggests_subplex r_suggests_ucminf"
R_SUGGESTS="
