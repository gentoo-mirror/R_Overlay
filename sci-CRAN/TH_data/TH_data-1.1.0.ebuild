...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/TH.data_1.1-0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_atr r_suggests_coin r_suggests_colorspace
	r_suggests_dplyr r_suggests_gdata r_suggests_gridextra
	r_suggests_knitr r_suggests_lattice r_suggests_multcomp
