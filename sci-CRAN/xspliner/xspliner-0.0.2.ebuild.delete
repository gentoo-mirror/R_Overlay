...
SRC_URI="http://cran.r-project.org/src/contrib/xspliner_0.0.2.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_aleplot r_suggests_breakdown r_suggests_caret
	...
	r_suggests_gridextra r_suggests_knitr r_suggests_randomforest
	r_suggests_resourceselection r_suggests_rmarkdown r_suggests_testthat
	r_suggests_xgboost"
R_SUGGESTS="
