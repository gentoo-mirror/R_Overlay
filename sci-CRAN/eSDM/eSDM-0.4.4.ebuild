...
SRC_URI="http://cran.r-project.org/src/contrib/eSDM_0.4.4.tar.gz"
...
IUSE="${IUSE-} r_suggests_colorramps r_suggests_colourpicker
	...
	r_suggests_leaflet r_suggests_maps r_suggests_raster
	r_suggests_rcolorbrewer r_suggests_rmarkdown r_suggests_shinybusy
	r_suggests_shinydashboard r_suggests_shinyjs r_suggests_testthat
	r_suggests_tmap r_suggests_viridis r_suggests_zip"
R_SUGGESTS="
