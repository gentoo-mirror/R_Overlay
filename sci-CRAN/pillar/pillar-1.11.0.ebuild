...
SRC_URI="http://cran.r-project.org/src/contrib/pillar_1.11.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bit64 r_suggests_dbi r_suggests_debugme
	r_suggests_diagrammer r_suggests_dplyr r_suggests_formattable
	r_suggests_ggplot2 r_suggests_knitr r_suggests_lubridate
	r_suggests_nycflights13 r_suggests_palmerpenguins
	r_suggests_rmarkdown r_suggests_scales r_suggests_stringi
	r_suggests_survival r_suggests_testthat r_suggests_tibble
	r_suggests_units r_suggests_vdiffr r_suggests_withr"
R_SUGGESTS="
	...
	r_suggests_units? ( >=sci-CRAN/units-0.7.2 )
	r_suggests_vdiffr? ( sci-CRAN/vdiffr )
	r_suggests_withr? ( sci-CRAN/withr )
"
DEPEND=">=sci-CRAN/cli-2.3.0
