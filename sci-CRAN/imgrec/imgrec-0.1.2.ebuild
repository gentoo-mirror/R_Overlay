...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/imgrec_0.1.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_ggplot2 r_suggests_magick r_suggests_pillar
	r_suggests_rmarkdown r_suggests_rtweet r_suggests_usethis"
R_SUGGESTS="
	r_suggests_ggplot2? ( >=sci-CRAN/ggplot2-3.3.0 )
	r_suggests_magick? ( >=sci-CRAN/magick-2.6.0 )
	r_suggests_pillar? ( >=sci-CRAN/pillar-1.5.0 )
...
"
DEPEND=">=sci-CRAN/base64enc-0.1.0
