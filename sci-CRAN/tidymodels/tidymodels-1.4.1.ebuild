...
SRC_URI="http://cran.r-project.org/src/contrib/tidymodels_1.4.1.tar.gz"
LICENSE='MIT'
...
"
DEPEND=">=sci-CRAN/modeldata-1.5.1
	>=sci-CRAN/workflowsets-1.1.1
	>=sci-CRAN/workflows-1.3.0
	>=sci-CRAN/parsnip-1.3.3
	>=sci-CRAN/recipes-1.3.1
	>=sci-CRAN/broom-1.0.9
	>=sci-CRAN/rstudioapi-0.17.1
	>=sci-CRAN/cli-3.6.5
	>=sci-CRAN/conflicted-1.2.0
	>=sci-CRAN/dials-1.4.2
	>=sci-CRAN/infer-1.0.9
	>=sci-CRAN/rsample-1.3.1
