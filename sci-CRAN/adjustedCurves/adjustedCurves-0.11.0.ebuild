...
SRC_URI="http://cran.r-project.org/src/contrib/adjustedCurves_0.11.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_cmprsk r_suggests_concrete r_suggests_covr
...
R_SUGGESTS="
	...
	r_suggests_concrete? ( >=sci-CRAN/concrete-1.0.5 )
