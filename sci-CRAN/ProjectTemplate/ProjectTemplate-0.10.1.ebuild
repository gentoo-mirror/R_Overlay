...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ProjectTemplate_0.10.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_data_table r_suggests_dbi r_suggests_digest
	...
	r_suggests_pixmap r_suggests_plyr r_suggests_readxl
	...
	r_suggests_tuner r_suggests_whisker r_suggests_xlsx"
R_SUGGESTS="
