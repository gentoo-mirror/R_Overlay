...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ProjectTemplate_0.10.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_data_table r_suggests_dbi r_suggests_foreign
	...
	r_suggests_plyr r_suggests_readxl r_suggests_reshape r_suggests_rjdbc
	r_suggests_rmysql r_suggests_rodbc r_suggests_rpostgresql
