...
SRC_URI="http://cran.r-project.org/src/contrib/ProjectTemplate_0.10.4.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_data_table r_suggests_dbi r_suggests_feather
	r_suggests_foreign r_suggests_formatr r_suggests_gdata
	r_suggests_ggplot2 r_suggests_log4r r_suggests_lubridate
	r_suggests_pixmap r_suggests_plyr r_suggests_qs r_suggests_readxl
	r_suggests_reshape r_suggests_rjdbc r_suggests_rmysql
...
_UNRESOLVED_PACKAGES=( 'sci-CRAN/GetoptLong' )
