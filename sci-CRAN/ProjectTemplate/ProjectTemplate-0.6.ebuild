...
SRC_URI="http://cran.r-project.org/src/contrib/ProjectTemplate_0.6.tar.gz"
LICENSE='Artistic-2'

IUSE="${IUSE-} r_suggests_dbi r_suggests_gdata r_suggests_ggplot2
	r_suggests_log4r r_suggests_lubridate r_suggests_pixmap
	r_suggests_plyr r_suggests_reshape r_suggests_rjdbc r_suggests_rmysql
