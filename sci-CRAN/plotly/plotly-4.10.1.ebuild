...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/plotly_4.10.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_broom r_suggests_cairo r_suggests_curl
	r_suggests_dendextend r_suggests_devtools r_suggests_forcats
	r_suggests_ggalluvial r_suggests_ggally r_suggests_ggthemes
	r_suggests_hexbin r_suggests_irdisplay r_suggests_knitr
	r_suggests_listviewer r_suggests_maps r_suggests_maptools
	r_suggests_mass r_suggests_palmerpenguins r_suggests_plotlygeoassets
	r_suggests_png r_suggests_processx r_suggests_reticulate
	r_suggests_rgeos r_suggests_rmarkdown r_suggests_rversions
