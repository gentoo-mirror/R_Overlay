...
SRC_URI="http://cran.r-project.org/src/contrib/plotly_4.10.3.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_broom r_suggests_cairo r_suggests_curl
	...
	r_suggests_maps r_suggests_mass r_suggests_palmerpenguins
	r_suggests_plotlygeoassets r_suggests_png r_suggests_processx
	r_suggests_reticulate r_suggests_rmarkdown r_suggests_rversions
	r_suggests_sf r_suggests_shiny r_suggests_testthat r_suggests_withr"
R_SUGGESTS="
