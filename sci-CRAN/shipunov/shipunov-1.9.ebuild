...
SRC_URI="http://cran.r-project.org/src/contrib/shipunov_1.9.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_ape r_suggests_class r_suggests_cluster
	...
	r_suggests_meanshiftr r_suggests_nnet r_suggests_pbsmapping
	r_suggests_phangorn r_suggests_randomforest r_suggests_rpart
	r_suggests_smirnov r_suggests_statmatch r_suggests_tree
	r_suggests_vegan"
R_SUGGESTS="
