...
SRC_URI="http://cran.r-project.org/src/contrib/shipunov_1.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_adabag r_suggests_ape r_suggests_class
	r_suggests_cluster r_suggests_dbscan r_suggests_e1071
	r_suggests_effsize r_suggests_ips r_suggests_kernlab r_suggests_mass
	r_suggests_mclust r_suggests_meanshiftr r_suggests_neuralnet
