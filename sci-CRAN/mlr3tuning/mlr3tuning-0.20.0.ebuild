...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3tuning_0.20.0.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_adagio r_suggests_gensa r_suggests_irace
	r_suggests_knitr r_suggests_mlr3learners r_suggests_mlr3pipelines
...
"
DEPEND=">=sci-CRAN/bbotk-0.7.3
	sci-CRAN/data_table
	sci-CRAN/lgr
	>=sci-CRAN/checkmate-2.0.0
	>=dev-lang/R-3.1.0
	>=sci-CRAN/mlr3misc-0.13.0
