...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/sharpshootR_2.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_circlize r_suggests_daymetr r_suggests_dendextend
	...
	r_suggests_lattice r_suggests_mass r_suggests_raster r_suggests_rvest
	r_suggests_sf r_suggests_soiltaxonomy r_suggests_spdep
	r_suggests_terra r_suggests_testthat r_suggests_venn r_suggests_xml2
	r_suggests_zoo"
R_SUGGESTS="
