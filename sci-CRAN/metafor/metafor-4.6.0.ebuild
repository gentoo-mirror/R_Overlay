...
SRC_URI="http://cran.r-project.org/src/contrib/metafor_4.6-0.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_alabama r_suggests_ape r_suggests_bb
	...
	r_suggests_r_rsp r_suggests_rmarkdown r_suggests_rsolnp
	r_suggests_rstudioapi r_suggests_sp r_suggests_subplex
