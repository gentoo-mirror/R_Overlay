...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/metafor_3.8-1.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_alabama r_suggests_ape r_suggests_bb
	...
	r_suggests_epi r_suggests_glmmadaptive r_suggests_glmmtmb
	r_suggests_gsl r_suggests_lbfgsb3c r_suggests_lme4 r_suggests_minqa
	r_suggests_multcomp r_suggests_mvtnorm r_suggests_nloptr
	r_suggests_numderiv r_suggests_optimparallel r_suggests_pracma
	r_suggests_r_rsp r_suggests_rmarkdown r_suggests_rsolnp r_suggests_sp
