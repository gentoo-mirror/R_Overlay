...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/metafor_3.0-1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ape r_suggests_biasedurn r_suggests_boot
	r_suggests_compquadform r_suggests_crayon r_suggests_dfoptim
	r_suggests_epi r_suggests_glmmadaptive r_suggests_gsl r_suggests_lme4
