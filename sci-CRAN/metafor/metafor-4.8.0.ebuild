...
SRC_URI="http://cran.r-project.org/src/contrib/metafor_4.8-0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_alabama r_suggests_amelia r_suggests_ape
	r_suggests_bb r_suggests_biasedurn r_suggests_boot
	r_suggests_calculus r_suggests_car r_suggests_clubsandwich
	r_suggests_compquadform r_suggests_crayon r_suggests_dfoptim
	r_suggests_emmeans r_suggests_epi r_suggests_estmeansd
	r_suggests_glmmadaptive r_suggests_glmmtmb r_suggests_glmulti
	r_suggests_gsl r_suggests_lbfgsb3c r_suggests_lme4
	r_suggests_metablue r_suggests_mice r_suggests_minqa
	r_suggests_multcomp r_suggests_mumin r_suggests_mvtnorm
	r_suggests_nloptr r_suggests_optimparallel r_suggests_optimx
	r_suggests_pracma r_suggests_r_rsp r_suggests_rmarkdown
	r_suggests_rsolnp r_suggests_rstudioapi r_suggests_sp
...
R_SUGGESTS="
	...
	r_suggests_calculus? ( sci-CRAN/calculus )
