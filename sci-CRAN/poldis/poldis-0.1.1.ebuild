...
SRC_URI="http://cran.r-project.org/src/contrib/poldis_0.1.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_fmsb r_suggests_ggplot2 r_suggests_keyatm
	r_suggests_messydates r_suggests_pdftools
