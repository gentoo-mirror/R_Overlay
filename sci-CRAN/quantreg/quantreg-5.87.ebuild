...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/quantreg_5.87.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_akima r_suggests_conquer r_suggests_formula
	r_suggests_logspline r_suggests_mass r_suggests_nor1mix
	r_suggests_r_rsp r_suggests_rgl r_suggests_survival
