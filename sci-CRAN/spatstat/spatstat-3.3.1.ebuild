...
SRC_URI="http://cran.r-project.org/src/contrib/spatstat_3.3-1.tar.gz"
LICENSE='GPL-2+'

DEPEND=">=dev-lang/R-3.5.0
	>=sci-CRAN/spatstat_univar-3.1.1
	>=sci-CRAN/spatstat_geom-3.3.5
	>=sci-CRAN/spatstat_data-3.1.4
	>=sci-CRAN/spatstat_random-3.3.2
	>=sci-CRAN/spatstat_explore-3.3.4
	>=sci-CRAN/spatstat_model-3.3.4
	virtual/nnet
