...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/segclust2d_0.2.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_adehabitatlt r_suggests_depmixs4
	r_suggests_dygraphs r_suggests_htmltools r_suggests_knitr
	r_suggests_leaflet r_suggests_movehmm r_suggests_rmarkdown
	r_suggests_sp r_suggests_testthat r_suggests_xts"
R_SUGGESTS="
