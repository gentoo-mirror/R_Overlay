...
SRC_URI="http://cran.r-project.org/src/contrib/lavaanExtra_0.1.8.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_diagrammersvg r_suggests_flextable
	...
	r_suggests_png r_suggests_rempsyc r_suggests_rmarkdown
	r_suggests_sjlabelled r_suggests_spelling r_suggests_stringdist
	r_suggests_testthat r_suggests_tibble r_suggests_tmvnsim"
R_SUGGESTS="
