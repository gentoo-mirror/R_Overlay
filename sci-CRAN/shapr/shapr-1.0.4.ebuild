...
SRC_URI="http://cran.r-project.org/src/contrib/shapr_1.0.4.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_coro r_suggests_dials r_suggests_forecast
	r_suggests_future r_suggests_gbm r_suggests_ggally
	r_suggests_ggbeeswarm r_suggests_ggplot2 r_suggests_hardhat
	r_suggests_knitr r_suggests_mgcv r_suggests_parsnip r_suggests_party
	r_suggests_partykit r_suggests_progressr r_suggests_ranger
	r_suggests_recipes r_suggests_rmarkdown r_suggests_roxygen2
	r_suggests_rsample r_suggests_testthat r_suggests_tune
	r_suggests_vdiffr r_suggests_waldo r_suggests_workflows
	r_suggests_xgboost r_suggests_yardstick"
R_SUGGESTS="
