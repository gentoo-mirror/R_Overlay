...
SRC_URI="http://cran.r-project.org/src/contrib/FSA_0.8.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_car r_suggests_dplyr r_suggests_dunn_test
	r_suggests_fishmethods r_suggests_fsadata r_suggests_gdata
	r_suggests_gplots r_suggests_hmisc r_suggests_knitr r_suggests_lmtest
