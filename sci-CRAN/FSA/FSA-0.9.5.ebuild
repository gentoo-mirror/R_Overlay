...
SRC_URI="http://cran.r-project.org/src/contrib/FSA_0.9.5.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_desctools r_suggests_dplyr
	...
	r_suggests_nlme r_suggests_nlstools r_suggests_pkgdown
	r_suggests_plyr r_suggests_psych r_suggests_rcapture
