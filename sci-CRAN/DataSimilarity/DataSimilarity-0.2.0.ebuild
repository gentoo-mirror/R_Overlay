...
SRC_URI="http://cran.r-project.org/src/contrib/DataSimilarity_0.2.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_ade4 r_suggests_approxot r_suggests_ball
	...
	r_suggests_mvtnorm r_suggests_nbpmatching r_suggests_nnet
	r_suggests_proc r_suggests_purrr r_suggests_randtoolbox
	r_suggests_rlemon r_suggests_rpart r_suggests_testthat"
R_SUGGESTS="
