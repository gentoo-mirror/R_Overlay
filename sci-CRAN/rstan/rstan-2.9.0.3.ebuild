...
IUSE="${IUSE-} r_suggests_bh r_suggests_kernsmooth r_suggests_loo
	r_suggests_matrix r_suggests_rcppeigen r_suggests_rcurl
	r_suggests_rstudioapi r_suggests_runit r_suggests_stanheaders"
R_SUGGESTS="
