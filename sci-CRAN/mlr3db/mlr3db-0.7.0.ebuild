...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3db_0.7.0.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_dbi r_suggests_dbplyr r_suggests_dplyr
	r_suggests_duckdb r_suggests_future r_suggests_future_apply
	r_suggests_future_callr r_suggests_hms r_suggests_lgr
	r_suggests_rlang r_suggests_rsqlite r_suggests_testthat
	r_suggests_tibble"
R_SUGGESTS="
...
_UNRESOLVED_PACKAGES=( 'polars (>= 1.1.0)' )
