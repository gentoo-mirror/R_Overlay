...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/MSEtool_3.0.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_boot r_suggests_broom r_suggests_covr
	...
	r_suggests_mass r_suggests_openxlsx r_suggests_purrr
	r_suggests_readxl r_suggests_reshape2 r_suggests_rfishbase
