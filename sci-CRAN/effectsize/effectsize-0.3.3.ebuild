...
SRC_URI="http://cran.r-project.org/src/contrib/effectsize_0.3.3.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_afex r_suggests_boot r_suggests_brms
	...
	r_suggests_mumin r_suggests_performance r_suggests_rlang
	r_suggests_rmarkdown r_suggests_rstan r_suggests_rstanarm
	r_suggests_rstantools r_suggests_see r_suggests_testthat
	r_suggests_tidyr"
R_SUGGESTS="
...
"
DEPEND=">=sci-CRAN/bayestestR-0.7.2
	>=sci-CRAN/insight-0.9.5
	>=dev-lang/R-3.5
	>=sci-CRAN/parameters-0.8.5
"
