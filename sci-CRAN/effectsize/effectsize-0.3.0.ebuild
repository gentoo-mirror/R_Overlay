...
SRC_URI="http://cran.r-project.org/src/contrib/effectsize_0.3.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_afex r_suggests_boot r_suggests_brms
	...
	r_suggests_performance r_suggests_rlang r_suggests_rmarkdown
...
"
DEPEND=">=sci-CRAN/insight-0.8.2
	>=sci-CRAN/bayestestR-0.5.3
	>=dev-lang/R-3.2
	>=sci-CRAN/parameters-0.6.0
"
