...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/effectsize_0.7.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_afex r_suggests_bayesfactor r_suggests_biglm
	r_suggests_boot r_suggests_car r_suggests_correlation r_suggests_covr
...
R_SUGGESTS="
	...
	r_suggests_correlation? ( >=sci-CRAN/correlation-0.8.0 )
