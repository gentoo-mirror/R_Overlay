...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/effectsize_0.4.5.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_afex r_suggests_bayesfactor r_suggests_boot
	...
	r_suggests_modelbased r_suggests_mumin r_suggests_performance
	r_suggests_pscl r_suggests_rmarkdown r_suggests_rms r_suggests_see
