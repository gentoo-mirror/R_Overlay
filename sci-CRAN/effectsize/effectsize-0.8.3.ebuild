...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/effectsize_0.8.3.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_afex r_suggests_bayesfactor r_suggests_boot
	...
	r_suggests_lme4 r_suggests_lmertest r_suggests_mass r_suggests_mgcv
	r_suggests_parsnip r_suggests_rmarkdown r_suggests_rms
...
R_SUGGESTS="
	...
	r_suggests_correlation? ( >=sci-CRAN/correlation-0.8.3 )
