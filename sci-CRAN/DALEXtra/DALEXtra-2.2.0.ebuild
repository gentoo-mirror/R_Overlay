...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/DALEXtra_2.2.0.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_auditor r_suggests_gbm r_suggests_ggrepel
	...
	r_suggests_ranger r_suggests_recipes r_suggests_rmarkdown
	r_suggests_rpart r_suggests_stacks r_suggests_testthat
	r_suggests_tidymodels r_suggests_xgboost"
R_SUGGESTS="
...
_UNRESOLVED_PACKAGES=( 'sci-CRAN/iml' )
