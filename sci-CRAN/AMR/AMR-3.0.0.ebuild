...
SRC_URI="http://cran.r-project.org/src/contrib/AMR_3.0.0.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_cleaner r_suggests_cli r_suggests_crayon
	...
	r_suggests_tibble r_suggests_tidymodels r_suggests_tidyselect
	r_suggests_tinytest r_suggests_vctrs r_suggests_xml2"
R_SUGGESTS="
