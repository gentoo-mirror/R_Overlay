...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/AMR_1.4.0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_cleaner r_suggests_curl r_suggests_dplyr
	r_suggests_ggplot2 r_suggests_knitr r_suggests_readxl
	r_suggests_rmarkdown r_suggests_rstudioapi r_suggests_rvest
	r_suggests_skimr r_suggests_testthat r_suggests_tidyr r_suggests_xml2"
R_SUGGESTS="
