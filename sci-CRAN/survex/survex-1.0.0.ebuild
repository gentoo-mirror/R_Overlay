...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/survex_1.0.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_censored r_suggests_covr r_suggests_gbm
	r_suggests_generics r_suggests_glmnet r_suggests_ingredients
	r_suggests_knitr r_suggests_mboost r_suggests_parsnip
	r_suggests_progressr r_suggests_randomforestsrc r_suggests_ranger
