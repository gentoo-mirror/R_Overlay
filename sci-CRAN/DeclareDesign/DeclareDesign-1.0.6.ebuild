...
SRC_URI="http://cran.r-project.org/src/contrib/DeclareDesign_1.0.6.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_betareg r_suggests_biglm
	...
	r_suggests_ggplot2 r_suggests_knitr r_suggests_margins
	r_suggests_mass r_suggests_matching r_suggests_psych
