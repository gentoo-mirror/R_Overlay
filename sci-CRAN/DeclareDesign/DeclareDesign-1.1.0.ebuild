...
SRC_URI="http://cran.r-project.org/src/contrib/DeclareDesign_1.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_aer r_suggests_betareg r_suggests_biglm
	r_suggests_broom r_suggests_causalqueries r_suggests_coin
	r_suggests_data_table r_suggests_designlibrary r_suggests_diffobj
	r_suggests_dplyr r_suggests_future r_suggests_future_apply
	r_suggests_gam r_suggests_ggplot2 r_suggests_knitr
	r_suggests_marginaleffects r_suggests_mass r_suggests_matching
	r_suggests_psych r_suggests_rdrobust r_suggests_rdss
