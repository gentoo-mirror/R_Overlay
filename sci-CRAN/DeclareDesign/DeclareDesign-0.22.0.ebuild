...
SRC_URI="http://cran.r-project.org/src/contrib/DeclareDesign_0.22.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_betareg r_suggests_biglm
	...
	r_suggests_diffobj r_suggests_dplyr r_suggests_future_apply
	r_suggests_gam r_suggests_ggplot2 r_suggests_knitr r_suggests_lfe
	r_suggests_mass r_suggests_matching r_suggests_reshape2
...
"
DEPEND=">=sci-CRAN/randomizr-0.20.0
