...
SRC_URI="http://cran.r-project.org/src/contrib/heplots_1.7.0.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_animation r_suggests_archdata r_suggests_bookdown
	...
	r_suggests_patchwork r_suggests_qqtest r_suggests_reshape
	r_suggests_reshape2 r_suggests_rmarkdown r_suggests_rrcov
	r_suggests_sleuth2 r_suggests_tidyr r_suggests_tinytable"
R_SUGGESTS="
