...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/leiden_0.3.6.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bipartite r_suggests_covr r_suggests_data_table
	...
	r_suggests_markdown r_suggests_mully r_suggests_multinets
	r_suggests_multiplex r_suggests_network r_suggests_rcolorbrewer
...
R_SUGGESTS="
	...
	r_suggests_mully? ( sci-CRAN/mully )
	r_suggests_multinets? ( sci-CRAN/multinets )
