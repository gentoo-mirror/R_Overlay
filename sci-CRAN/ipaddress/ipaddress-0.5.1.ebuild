...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ipaddress_0.5.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_blob r_suggests_crayon r_suggests_dplyr
	r_suggests_fuzzyjoin r_suggests_knitr r_suggests_pillar
