...
SRC_URI="http://cran.r-project.org/src/contrib/BeeBDC_1.3.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_biocmanager r_suggests_class
	...
	r_suggests_inext r_suggests_janitor r_suggests_kableextra
	r_suggests_knitr r_suggests_leaflet r_suggests_magrittr
	r_suggests_pkgdown r_suggests_plotly r_suggests_prettydoc
	r_suggests_purrr r_suggests_r_utils r_suggests_renv r_suggests_rlang
	r_suggests_rmarkdown r_suggests_rmdformats
	r_suggests_rnaturalearthdata r_suggests_rvest r_suggests_spader
	r_suggests_taxadb r_suggests_terra r_suggests_testthat
...
R_SUGGESTS="
	...
	r_suggests_taxadb? ( sci-CRAN/taxadb )
