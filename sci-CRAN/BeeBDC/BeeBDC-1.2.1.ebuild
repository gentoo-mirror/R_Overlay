...
SRC_URI="http://cran.r-project.org/src/contrib/BeeBDC_1.2.1.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_biocmanager r_suggests_class
	r_suggests_countrycode r_suggests_devtools r_suggests_emld
	r_suggests_formatr r_suggests_galah r_suggests_htmltools
	r_suggests_htmlwidgets r_suggests_httr r_suggests_janitor
	...
	r_suggests_rnaturalearthdata r_suggests_rvest r_suggests_taxadb
