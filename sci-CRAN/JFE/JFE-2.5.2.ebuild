...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/JFE_2.5.2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_burstfin r_suggests_data_table
	r_suggests_desctools r_suggests_fassets r_suggests_fbasics
	r_suggests_forecast r_suggests_frapo r_suggests_h2o r_suggests_iclick
	r_suggests_mass r_suggests_quantmod r_suggests_rugarch
	r_suggests_tibble r_suggests_timedate r_suggests_timeseries
	r_suggests_timetk"
R_SUGGESTS="
