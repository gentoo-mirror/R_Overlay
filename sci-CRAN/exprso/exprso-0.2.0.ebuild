...
SRC_URI="http://cran.r-project.org/src/contrib/exprso_0.2.0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_biobase r_suggests_edger r_suggests_geoquery
	r_suggests_h2o r_suggests_knitr r_suggests_limma r_suggests_mrmre
	r_suggests_pathclass r_suggests_propr r_suggests_rmarkdown
	r_suggests_testthat"
R_SUGGESTS="
