...
SRC_URI="http://cran.r-project.org/src/contrib/ChemoSpec_6.3.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_amap r_suggests_baseline r_suggests_chemometrics
	r_suggests_cluster r_suggests_elasticnet r_suggests_idpmisc
	r_suggests_irlba r_suggests_js r_suggests_jsonlite r_suggests_mass
	r_suggests_mclust r_suggests_nbclust r_suggests_pcapp r_suggests_pls
	r_suggests_r_utils r_suggests_rcolorbrewer r_suggests_roxut
	r_suggests_seriation r_suggests_signal r_suggests_speaq
	r_suggests_tinytest"
R_SUGGESTS="
