...
SRC_URI="http://cran.r-project.org/src/contrib/ChemoSpec_4.3.34.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_amap r_suggests_baseline r_suggests_clustercrit
	r_suggests_excon r_suggests_gsubfn r_suggests_idpmisc
	r_suggests_jsonlite r_suggests_knitr r_suggests_lattice
	r_suggests_mass r_suggests_mclust r_suggests_mvbutils
	r_suggests_nbclust r_suggests_pcapp r_suggests_pls r_suggests_r_utils
	r_suggests_rcolorbrewer r_suggests_robustbase r_suggests_seriation
	r_suggests_signal r_suggests_sna r_suggests_speaq"
R_SUGGESTS="
	r_suggests_amap? ( sci-CRAN/amap )
	r_suggests_baseline? ( sci-CRAN/baseline )
	r_suggests_clustercrit? ( sci-CRAN/clusterCrit )
	r_suggests_excon? ( sci-CRAN/exCon )
