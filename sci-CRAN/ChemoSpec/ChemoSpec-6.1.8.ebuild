...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ChemoSpec_6.1.8.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_amap r_suggests_baseline r_suggests_bookdown
	r_suggests_chemometrics r_suggests_elasticnet r_suggests_gsubfn
	...
	r_suggests_rmarkdown r_suggests_robustbase r_suggests_roxut
...
"
DEPEND=">=sci-CRAN/ChemoSpecUtils-1.0
	sci-CRAN/magrittr
	sci-CRAN/plyr
	sci-CRAN/reshape2
	>=dev-lang/R-3.5
