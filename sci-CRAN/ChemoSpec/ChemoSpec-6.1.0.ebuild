...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ChemoSpec_6.1.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_amap r_suggests_baseline r_suggests_bookdown
	r_suggests_boot r_suggests_chemometrics r_suggests_cluster
	r_suggests_elasticnet r_suggests_gsubfn r_suggests_httr
	...
	r_suggests_mass r_suggests_mclust r_suggests_mixomics
