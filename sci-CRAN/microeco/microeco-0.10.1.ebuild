...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/microeco_0.10.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_agricolae r_suggests_ggdendro r_suggests_ggpubr
	r_suggests_ggrepel r_suggests_gridextra r_suggests_gunifrac
	r_suggests_igraph r_suggests_mass r_suggests_mice r_suggests_pheatmap
	r_suggests_picante r_suggests_randomforest r_suggests_rgexf"
R_SUGGESTS="
