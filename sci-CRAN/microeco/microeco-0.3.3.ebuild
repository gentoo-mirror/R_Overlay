...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/microeco_0.3.3.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_agricolae r_suggests_ggdendro r_suggests_ggpubr
	...
	r_suggests_pheatmap r_suggests_phyloseq r_suggests_picante
	r_suggests_randomforest r_suggests_reshape2 r_suggests_rgexf
	r_suggests_tidytree"
R_SUGGESTS="
