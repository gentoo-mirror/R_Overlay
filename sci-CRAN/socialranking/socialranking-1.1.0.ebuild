...
SRC_URI="http://cran.r-project.org/src/contrib/socialranking_1.1.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_knitr r_suggests_partitions
	r_suggests_rmarkdown r_suggests_testthat r_suggests_xfun"
R_SUGGESTS="
