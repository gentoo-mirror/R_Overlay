...
SRC_URI="http://cran.r-project.org/src/contrib/apsimx_2.6.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bayesiantools r_suggests_chirps r_suggests_daymetr
	...
	r_suggests_maps r_suggests_metrica r_suggests_mvtnorm
	r_suggests_nasapower r_suggests_nloptr r_suggests_reactr
	r_suggests_rmarkdown r_suggests_sensitivity r_suggests_sf
	r_suggests_soildb r_suggests_sp r_suggests_spdata r_suggests_ucminf"
R_SUGGESTS="
