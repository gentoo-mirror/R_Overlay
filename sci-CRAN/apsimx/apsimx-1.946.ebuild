...
SRC_URI="http://cran.r-project.org/src/contrib/apsimx_1.946.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_feddata r_suggests_ggplot2 r_suggests_listviewer
	r_suggests_nasapower r_suggests_raster r_suggests_reactr
