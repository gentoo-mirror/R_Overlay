...
SRC_URI="http://cran.r-project.org/src/contrib/apsimx_1.964.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bayesiantools r_suggests_feddata
	r_suggests_ggplot2 r_suggests_gsodr r_suggests_listviewer
	r_suggests_mvtnorm r_suggests_nasapower r_suggests_nloptr
	r_suggests_raster r_suggests_reactr r_suggests_rmarkdown
	r_suggests_sf r_suggests_sp r_suggests_spdata"
R_SUGGESTS="
