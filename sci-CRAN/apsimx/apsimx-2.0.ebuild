...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/apsimx_2.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bayesiantools r_suggests_daymetr
	...
	r_suggests_rmarkdown r_suggests_sensitivity r_suggests_sf
	r_suggests_soildb r_suggests_sp r_suggests_spdata"
R_SUGGESTS="
