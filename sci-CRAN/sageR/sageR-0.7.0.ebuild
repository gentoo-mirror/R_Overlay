...
SRC_URI="http://cran.r-project.org/src/contrib/sageR_0.7.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_actuar r_suggests_car r_suggests_caret
	...
	r_suggests_factominer r_suggests_ggally r_suggests_ggiraphextra
	r_suggests_knitr r_suggests_lattice r_suggests_learnr
	r_suggests_markdown r_suggests_matrix r_suggests_mgcv
