...
SRC_URI="http://cran.r-project.org/src/contrib/magick_2.5.2.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_av r_suggests_gapminder r_suggests_ggplot2
	...
	r_suggests_knitr r_suggests_pdftools r_suggests_rmarkdown
	r_suggests_spelling r_suggests_webp"
R_SUGGESTS="
