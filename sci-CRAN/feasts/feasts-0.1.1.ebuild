...
SRC_URI="http://cran.r-project.org/src/contrib/feasts_0.1.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_foreca r_suggests_fracdiff
