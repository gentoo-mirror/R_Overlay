...
SRC_URI="http://cran.r-project.org/src/contrib/ratlas_0.1.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_cowplot r_suggests_dichromat
	...
	r_suggests_rmarkdown r_suggests_spelling r_suggests_systemfonts
	r_suggests_testthat r_suggests_tinytex r_suggests_usethis
	r_suggests_vdiffr r_suggests_viridis r_suggests_withr"
R_SUGGESTS="
