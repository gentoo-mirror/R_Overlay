...
SRC_URI="http://cran.r-project.org/src/contrib/modelbased_0.1.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_brms r_suggests_coda r_suggests_covr
	r_suggests_dplyr r_suggests_gganimate r_suggests_ggplot2
	r_suggests_knitr r_suggests_lme4 r_suggests_mass r_suggests_mertools
