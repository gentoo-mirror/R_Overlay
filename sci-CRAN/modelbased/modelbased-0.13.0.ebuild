...
SRC_URI="http://cran.r-project.org/src/contrib/modelbased_0.13.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_afex r_suggests_betareg r_suggests_bh
	...
	r_suggests_collapse r_suggests_correlation r_suggests_coxme
	r_suggests_curl r_suggests_discovr r_suggests_easystats
	...
	r_suggests_mvtnorm r_suggests_nanoparquet r_suggests_nnet
	r_suggests_ordinal r_suggests_palmerpenguins r_suggests_patchwork
	r_suggests_pbkrtest r_suggests_performance r_suggests_poorman
	r_suggests_pscl r_suggests_rcppeigen r_suggests_rdatasets
	r_suggests_report r_suggests_rmarkdown r_suggests_rstanarm
	r_suggests_rtdists r_suggests_rwiener r_suggests_sandwich
	r_suggests_see r_suggests_survival r_suggests_testthat
	r_suggests_tinyplot r_suggests_tinytable r_suggests_vdiffr
	r_suggests_withr"
R_SUGGESTS="
