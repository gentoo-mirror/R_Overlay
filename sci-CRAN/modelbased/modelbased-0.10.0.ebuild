...
SRC_URI="http://cran.r-project.org/src/contrib/modelbased_0.10.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_betareg r_suggests_bh r_suggests_boot
	...
	r_suggests_nanoparquet r_suggests_ordinal r_suggests_patchwork
	r_suggests_pbkrtest r_suggests_performance r_suggests_poorman
	r_suggests_pscl r_suggests_rcppeigen r_suggests_report
	r_suggests_rmarkdown r_suggests_rstanarm r_suggests_rtdists
	r_suggests_sandwich r_suggests_see r_suggests_testthat
