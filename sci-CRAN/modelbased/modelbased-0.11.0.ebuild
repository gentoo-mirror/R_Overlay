...
SRC_URI="http://cran.r-project.org/src/contrib/modelbased_0.11.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_betareg r_suggests_bh r_suggests_boot
	r_suggests_brms r_suggests_coda r_suggests_collapse
	r_suggests_correlation r_suggests_curl r_suggests_easystats
	r_suggests_effectsize r_suggests_emmeans r_suggests_formula
	r_suggests_gamm4 r_suggests_gganimate r_suggests_ggplot2
	r_suggests_glmmtmb r_suggests_httr2 r_suggests_knitr r_suggests_lme4
	r_suggests_lmertest r_suggests_logspline r_suggests_marginaleffects
	r_suggests_mass r_suggests_matrix r_suggests_mgcv r_suggests_mice
	r_suggests_nanoparquet r_suggests_ordinal r_suggests_palmerpenguins
	r_suggests_patchwork r_suggests_pbkrtest r_suggests_performance
	r_suggests_poorman r_suggests_pscl r_suggests_rcppeigen
	r_suggests_report r_suggests_rmarkdown r_suggests_rstanarm
	r_suggests_rtdists r_suggests_rwiener r_suggests_sandwich
	r_suggests_see r_suggests_testthat r_suggests_vdiffr r_suggests_withr"
R_SUGGESTS="
...
DEPEND=">=dev-lang/R-3.6
	>=sci-CRAN/datawizard-1.0.2
	>=sci-CRAN/parameters-0.25.0
	>=sci-CRAN/bayestestR-0.15.3
