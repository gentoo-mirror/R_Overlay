...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/sfdep_0.2.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_broom r_suggests_dbscan r_suggests_dplyr
	r_suggests_ggplot2 r_suggests_kendall r_suggests_knitr
	r_suggests_magrittr r_suggests_patchwork r_suggests_pracma
	r_suggests_purrr r_suggests_readr r_suggests_rmarkdown
	r_suggests_sfnetworks r_suggests_stringr r_suggests_testthat
	r_suggests_tibble r_suggests_tidyr r_suggests_vctrs r_suggests_yaml
	r_suggests_zoo"
R_SUGGESTS="
