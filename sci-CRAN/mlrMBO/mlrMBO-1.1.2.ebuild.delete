...
SRC_URI="http://cran.r-project.org/src/contrib/mlrMBO_1.1.2.tar.gz"
LICENSE='BSD-2'

IUSE="${IUSE-} r_suggests_akima r_suggests_cmaesr r_suggests_covr
	r_suggests_dicekriging r_suggests_diceoptim r_suggests_earth
	...
	r_suggests_randomforest r_suggests_rcolorbrewer r_suggests_rgenoud
