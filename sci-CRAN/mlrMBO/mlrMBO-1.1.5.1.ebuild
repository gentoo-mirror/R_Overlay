...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mlrMBO_1.1.5.1.tar.gz"
LICENSE='BSD-2'

IUSE="${IUSE-} r_suggests_cmaesr r_suggests_covr r_suggests_dicekriging
	...
	r_suggests_randomforest r_suggests_reshape2 r_suggests_rgenoud
