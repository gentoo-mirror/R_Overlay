...
SRC_URI="http://cran.r-project.org/src/contrib/LDAvis_0.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_gistr r_suggests_knitr r_suggests_lda
	r_suggests_mallet r_suggests_servr r_suggests_shiny
