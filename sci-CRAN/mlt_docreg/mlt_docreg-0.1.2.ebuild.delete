...
SRC_URI="http://cran.r-project.org/src/contrib/mlt.docreg_0.1-2.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_aer r_suggests_alabama r_suggests_basefun
	r_suggests_bshazard r_suggests_coin r_suggests_colorspace
	r_suggests_coxinterval r_suggests_dynsurv r_suggests_eha
	r_suggests_flexsurv r_suggests_gamlss r_suggests_gamlss_data
	...
	r_suggests_latticeextra r_suggests_logspline r_suggests_mass
	r_suggests_matrix r_suggests_mgcv r_suggests_miicd r_suggests_mlbench
	r_suggests_muhaz r_suggests_multcomp r_suggests_nnet r_suggests_np
	r_suggests_ordinal r_suggests_polspline r_suggests_prodlim
	r_suggests_sandwich r_suggests_survival r_suggests_survivalmpl
	r_suggests_th_data r_suggests_timereg r_suggests_transmodel
	r_suggests_truncreg r_suggests_variables r_suggests_vgam"
R_SUGGESTS="
