...
IUSE="${IUSE-} r_suggests_aer r_suggests_basefun r_suggests_bshazard
	...
	r_suggests_intcox r_suggests_knitr r_suggests_latticeextra
	r_suggests_logspline r_suggests_miicd r_suggests_mlbench
	r_suggests_muhaz r_suggests_multcomp r_suggests_np r_suggests_ordinal
	r_suggests_polspline r_suggests_prodlim r_suggests_r[-minimal]
	r_suggests_sandwich r_suggests_survivalmpl r_suggests_th_data
...
R_SUGGESTS="
	...
	r_suggests_r[-minimal]? ( dev-lang/R[-minimal] dev-lang/R[-minimal] dev-lang/R[-minimal] dev-lang/R[-minimal] dev-lang/R[-minimal] dev-lang/R[-minimal] )
