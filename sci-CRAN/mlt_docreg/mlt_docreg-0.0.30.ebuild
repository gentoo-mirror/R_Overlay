...
SRC_URI="http://cran.r-project.org/src/contrib/mlt.docreg_0.0-30.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_basefun r_suggests_bshazard
	...
	r_suggests_intcox r_suggests_knitr r_suggests_lattice
...
R_SUGGESTS="
	...
	r_suggests_intcox? ( sci-CRAN/intcox )
