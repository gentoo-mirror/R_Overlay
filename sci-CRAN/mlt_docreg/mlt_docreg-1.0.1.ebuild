...
SRC_URI="http://cran.r-project.org/src/contrib/mlt.docreg_1.0-1.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_basefun r_suggests_bshazard
	...
	r_suggests_knitr r_suggests_lattice r_suggests_logspline
	r_suggests_mass r_suggests_matrix r_suggests_mgcv r_suggests_miicd
	r_suggests_mlbench r_suggests_muhaz r_suggests_multcomp
	r_suggests_nnet r_suggests_np r_suggests_ordinal r_suggests_polspline
	r_suggests_prodlim r_suggests_sandwich r_suggests_survival
	r_suggests_th_data r_suggests_timereg r_suggests_tram
	r_suggests_transmodel r_suggests_truncreg r_suggests_variables
	r_suggests_vgam"
R_SUGGESTS="
