...
SRC_URI="http://cran.r-project.org/src/contrib/mlt.docreg_1.1-9.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_aer r_suggests_basefun r_suggests_coin
	r_suggests_colorspace r_suggests_gamlss_data r_suggests_gridextra
	r_suggests_hsaur3 r_suggests_knitr r_suggests_lattice r_suggests_mass
	r_suggests_matrix r_suggests_mgcv r_suggests_mlbench r_suggests_nnet
	r_suggests_prodlim r_suggests_rms r_suggests_sandwich
	r_suggests_th_data r_suggests_tram r_suggests_variables"
R_SUGGESTS="
