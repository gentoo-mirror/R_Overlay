...
SRC_URI="http://cran.r-project.org/src/contrib/bomrang_0.5.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_asgs_foyer r_suggests_covr r_suggests_ggplot2
	...
	r_suggests_mapproj r_suggests_maps r_suggests_pkgdown
	r_suggests_rappdirs r_suggests_rmarkdown r_suggests_roxygen2
	r_suggests_testthat"
R_SUGGESTS="
