...
SRC_URI="http://cran.r-project.org/src/contrib/curl_4.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_askpass r_suggests_httpuv r_suggests_jsonlite
	r_suggests_knitr r_suggests_magrittr r_suggests_rmarkdown
	r_suggests_spelling r_suggests_testthat r_suggests_webutils"
R_SUGGESTS="
