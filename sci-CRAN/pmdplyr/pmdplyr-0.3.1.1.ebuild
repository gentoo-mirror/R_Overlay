...
SRC_URI="http://cran.r-project.org/src/contrib/pmdplyr_0.3.1.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_covr r_suggests_haven r_suggests_knitr
	r_suggests_panelr r_suggests_plm r_suggests_rmarkdown
	r_suggests_sjlabelled r_suggests_testthat r_suggests_tsibble"
R_SUGGESTS="
