...
SRC_URI="http://cran.r-project.org/src/contrib/kyotil_2020.8-22.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_abind r_suggests_copula r_suggests_hmisc
	...
	r_suggests_pracma r_suggests_r_rsp r_suggests_rcolorbrewer
	r_suggests_runit r_suggests_survival r_suggests_vgam
