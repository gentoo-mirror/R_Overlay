...
SRC_URI="http://cran.r-project.org/src/contrib/spacetime_1.1-5.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_adehabitatlt r_suggests_cshapes
	r_suggests_divemove r_suggests_googlevis r_suggests_gstat
	r_suggests_isocodes r_suggests_knitr r_suggests_mapdata
	r_suggests_maps r_suggests_maptools r_suggests_plm
	r_suggests_r[-minimal] r_suggests_raster r_suggests_rcolorbrewer
	r_suggests_rgdal r_suggests_rgeos r_suggests_rpostgresql"
R_SUGGESTS="
