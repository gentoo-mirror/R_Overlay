...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/spacetime_1.2-7.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_adehabitatlt r_suggests_foreign
	...
	r_suggests_maptools r_suggests_markdown r_suggests_plm
	r_suggests_raster r_suggests_rcolorbrewer r_suggests_rgeos
	r_suggests_rmarkdown r_suggests_rpostgresql r_suggests_sf"
R_SUGGESTS="
