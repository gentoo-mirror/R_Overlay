...
SRC_URI="http://cran.r-project.org/src/contrib/spacetime_1.3-2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_adehabitatlt r_suggests_foreign r_suggests_gstat
	r_suggests_isocodes r_suggests_knitr r_suggests_mapdata
	r_suggests_maps r_suggests_markdown r_suggests_plm r_suggests_raster
