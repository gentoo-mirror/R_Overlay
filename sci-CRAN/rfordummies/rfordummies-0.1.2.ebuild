...
SRC_URI="http://cran.r-project.org/src/contrib/rfordummies_0.1.2.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'

IUSE="${IUSE-} r_suggests_fortunes r_suggests_ggplot2 r_suggests_r[-minimal]
	r_suggests_reshape2 r_suggests_sos r_suggests_stringr
