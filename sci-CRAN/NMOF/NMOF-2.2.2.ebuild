...
SRC_URI="http://cran.r-project.org/src/contrib/NMOF_2.2-2.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_datetimeutils r_suggests_glpk r_suggests_mass
	r_suggests_pmwr r_suggests_quadprog r_suggests_readxl
	r_suggests_runit r_suggests_tinytest"
R_SUGGESTS="
