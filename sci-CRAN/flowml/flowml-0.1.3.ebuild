...
SRC_URI="http://cran.r-project.org/src/contrib/flowml_0.1.3.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_adabag r_suggests_arm
	...
	r_suggests_ggplot2 r_suggests_glmnet r_suggests_h2o r_suggests_hda
	r_suggests_ipred r_suggests_kernlab r_suggests_kknn r_suggests_klar
	r_suggests_knitr r_suggests_kohonen r_suggests_lars r_suggests_leaps
	r_suggests_liblinear r_suggests_logicreg r_suggests_mass
	r_suggests_matrix r_suggests_mboost r_suggests_mda r_suggests_mgcv
	r_suggests_monomvn r_suggests_neuralnet r_suggests_nnet
	r_suggests_nnls r_suggests_pamr r_suggests_partdsa r_suggests_party
	r_suggests_partykit r_suggests_penalized r_suggests_pls
	r_suggests_plyr r_suggests_proxy r_suggests_quantregforest
	r_suggests_randomforest r_suggests_ranger r_suggests_rferns
	r_suggests_rmarkdown r_suggests_rpart r_suggests_rrcov
	r_suggests_rrcovhd r_suggests_rsnns r_suggests_rweka r_suggests_sda
	r_suggests_shapviz r_suggests_spls r_suggests_superpc r_suggests_vgam
	r_suggests_xgboost"
R_SUGGESTS="
