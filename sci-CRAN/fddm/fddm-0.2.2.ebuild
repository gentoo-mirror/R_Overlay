...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/fddm_0.2-2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ggnewscale r_suggests_ggplot2 r_suggests_knitr
	r_suggests_reshape2 r_suggests_rmarkdown r_suggests_rtdists
	r_suggests_rwiener r_suggests_testthat"
R_SUGGESTS="
