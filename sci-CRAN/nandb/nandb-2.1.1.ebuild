...
SRC_URI="http://cran.r-project.org/src/contrib/nandb_2.1.1.tar.gz"
LICENSE='BSD'

IUSE="${IUSE-} r_suggests_abind r_suggests_covr r_suggests_gridextra
	r_suggests_knitr r_suggests_magick r_suggests_matrix
	r_suggests_pacman r_suggests_rmarkdown r_suggests_spelling
