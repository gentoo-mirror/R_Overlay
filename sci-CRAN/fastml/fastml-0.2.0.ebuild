...
SRC_URI="http://cran.r-project.org/src/contrib/fastml_0.2.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_baguette r_suggests_bonsai r_suggests_c50
	r_suggests_crayon r_suggests_discrim r_suggests_glmnet
	r_suggests_kernlab r_suggests_knitr r_suggests_lightgbm
	r_suggests_plsmod r_suggests_ranger r_suggests_rmarkdown
...
R_SUGGESTS="
	...
	r_suggests_plsmod? ( sci-CRAN/plsmod )
