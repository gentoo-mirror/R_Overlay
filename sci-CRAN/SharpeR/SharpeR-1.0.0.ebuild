...
SRC_URI="http://cran.r-project.org/src/contrib/SharpeR_1.0.0.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_knitr r_suggests_quantmod r_suggests_sandwich
	r_suggests_testthat r_suggests_timeseries r_suggests_ttr
	r_suggests_xtable r_suggests_xts"
R_SUGGESTS="
