...
SRC_URI="http://cran.r-project.org/src/contrib/gstat_2.0-6.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_fields r_suggests_future r_suggests_future_apply
	...
	r_suggests_raster r_suggests_rgdal r_suggests_rgeos r_suggests_sf
	r_suggests_stars r_suggests_xts"
R_SUGGESTS="
