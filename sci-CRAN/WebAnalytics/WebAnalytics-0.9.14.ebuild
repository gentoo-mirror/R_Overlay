...
SRC_URI="http://cran.r-project.org/src/contrib/WebAnalytics_0.9.14.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_testthat r_suggests_tinytex r_suggests_whoami"
R_SUGGESTS="
	r_suggests_testthat? ( >=sci-CRAN/testthat-3.1 )
	r_suggests_tinytex? ( >=sci-CRAN/tinytex-0.57 )
