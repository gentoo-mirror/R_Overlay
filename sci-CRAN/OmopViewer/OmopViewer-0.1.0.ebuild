...
SRC_URI="http://cran.r-project.org/src/contrib/OmopViewer_0.1.0.tar.gz"
...
IUSE="${IUSE-} r_suggests_cdmconnector r_suggests_codelistgenerator
	...
	r_suggests_ggplot2 r_suggests_gt r_suggests_here
	r_suggests_htmlwidgets r_suggests_incidenceprevalence
	r_suggests_knitr r_suggests_omock r_suggests_omopsketch
	r_suggests_patientprofiles r_suggests_plotly r_suggests_rmarkdown
	r_suggests_rpostgres r_suggests_shinycssloaders
...
"
DEPEND=">=sci-CRAN/visOmopResults-0.4.0
	sci-CRAN/DT
	sci-CRAN/snakecase
	sci-CRAN/usethis
	sci-CRAN/tidyr
