...
SRC_URI="http://cran.r-project.org/src/contrib/OmopViewer_0.4.0.tar.gz"
...
IUSE="${IUSE-} r_suggests_cdmconnector r_suggests_codelistgenerator
	...
	r_suggests_shiny_fluent r_suggests_shinycssloaders
	r_suggests_shinytree r_suggests_shinywidgets r_suggests_sortable
	r_suggests_testthat r_suggests_webshot2 r_suggests_zip"
R_SUGGESTS="
	r_suggests_cdmconnector? ( sci-CRAN/CDMConnector )
	r_suggests_codelistgenerator? ( >=sci-CRAN/CodelistGenerator-3.2.0 )
	r_suggests_cohortcharacteristics? ( >=sci-CRAN/CohortCharacteristics-1.0.0 )
	...
	r_suggests_shiny_fluent? ( sci-CRAN/shiny_fluent )
	r_suggests_shinycssloaders? ( sci-CRAN/shinycssloaders )
	r_suggests_shinytree? ( sci-CRAN/shinyTree )
	r_suggests_shinywidgets? ( >=sci-CRAN/shinyWidgets-0.9.0 )
