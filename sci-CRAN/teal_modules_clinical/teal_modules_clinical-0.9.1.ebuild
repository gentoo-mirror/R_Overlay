...
SRC_URI="http://cran.r-project.org/src/contrib/teal.modules.clinical_0.9.1.tar.gz"
LICENSE='Apache-2.0'
...
IUSE="${IUSE-} r_suggests_forcats r_suggests_knitr r_suggests_logger
	...
	r_suggests_shinytest2 r_suggests_styler r_suggests_testthat
	r_suggests_withr"
R_SUGGESTS="
...
DEPEND=">=sci-CRAN/tern_gee-0.1.3
	...
	>=dev-lang/R-4.0
	sci-CRAN/shinyjs
	>=sci-CRAN/teal_logger-0.2.0
	>=sci-CRAN/teal-0.15.2
	>=sci-CRAN/tern-0.9.4
