...
SRC_URI="http://cran.r-project.org/src/contrib/rayshader_0.37.3.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_ambient r_suggests_car r_suggests_elevatr
	...
	r_suggests_osmdata r_suggests_reshape2 r_suggests_sf r_suggests_terra
