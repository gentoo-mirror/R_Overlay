...
SRC_URI="http://cran.r-project.org/src/contrib/SpaDES.tools_0.2.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_deoptim r_suggests_dplyr r_suggests_gdalutils
	...
	r_suggests_profvis r_suggests_rcolorbrewer r_suggests_rgeos
...
"
DEPEND=">=sci-CRAN/RandomFields-3.1.24
	>=sci-CRAN/bit-1.1.12
