...
SRC_URI="http://cran.r-project.org/src/contrib/SpaDES.tools_0.3.5.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_animation r_suggests_deoptim r_suggests_dplyr
	r_suggests_fasterize r_suggests_ff r_suggests_ffbase
	r_suggests_gdalutils r_suggests_knitr r_suggests_mgcv
	r_suggests_randomfields r_suggests_rcolorbrewer r_suggests_rmarkdown
...
R_SUGGESTS="
	...
	r_suggests_ff? ( >=sci-CRAN/ff-2.2.13 )
	r_suggests_ffbase? ( >=sci-CRAN/ffbase-0.12.3 )
...
"
DEPEND=">=sci-CRAN/fpCompare-0.2.1
