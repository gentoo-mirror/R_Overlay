...
SRC_URI="http://cran.r-project.org/src/contrib/shiny.react_0.4.0.tar.gz"
LICENSE='LGPL-3+'

IUSE="${IUSE-} r_suggests_chromote r_suggests_covr r_suggests_knitr
	r_suggests_leaflet r_suggests_lintr r_suggests_rcmdcheck
	r_suggests_rmarkdown r_suggests_shinytest2 r_suggests_styler
