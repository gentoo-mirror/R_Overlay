...
SRC_URI="http://cran.r-project.org/src/contrib/orbital_0.2.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_arrow r_suggests_dbi r_suggests_dbplyr
	r_suggests_dtplyr r_suggests_duckdb r_suggests_embed r_suggests_glue
	r_suggests_hardhat r_suggests_jsonlite r_suggests_kknn
	...
	r_suggests_themis r_suggests_tidypredict r_suggests_workflows"
R_SUGGESTS="
