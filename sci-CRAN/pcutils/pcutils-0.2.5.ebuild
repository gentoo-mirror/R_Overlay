...
SRC_URI="http://cran.r-project.org/src/contrib/pcutils_0.2.5.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_agricolae r_suggests_aplot r_suggests_biocmanager
	...
	r_suggests_devtools r_suggests_dosnow r_suggests_fitdistrplus
	r_suggests_foreach r_suggests_ggalluvial r_suggests_ggbeeswarm
	r_suggests_gghalves r_suggests_ggimage r_suggests_ggpmisc
	r_suggests_ggpubr r_suggests_ggraph r_suggests_ggrepel
	r_suggests_ggsci r_suggests_ggvenndiagram r_suggests_grimport2
	r_suggests_htmltools r_suggests_htmlwidgets r_suggests_httr
	r_suggests_igraph r_suggests_jsonlite r_suggests_kableextra
	r_suggests_knitr r_suggests_leaflet r_suggests_lintr
	r_suggests_magick r_suggests_multcompview r_suggests_nortest
	r_suggests_openssl r_suggests_pagedown r_suggests_plotly
	r_suggests_plotrix r_suggests_pmcmrplus r_suggests_readr
	r_suggests_relaimpo r_suggests_rio r_suggests_rlang
