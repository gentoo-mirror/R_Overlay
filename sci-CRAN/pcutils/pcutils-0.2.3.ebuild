...
SRC_URI="http://cran.r-project.org/src/contrib/pcutils_0.2.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_agricolae r_suggests_aplot r_suggests_biocmanager
	r_suggests_biomformat r_suggests_bookdown r_suggests_circlize
	r_suggests_clipr r_suggests_devtools r_suggests_dosnow
	...
	r_suggests_pmcmrplus r_suggests_prettydoc r_suggests_rcolorbrewer
	r_suggests_readr r_suggests_relaimpo r_suggests_rio r_suggests_rlang
	r_suggests_rmarkdown r_suggests_sf r_suggests_showtext
	r_suggests_snow r_suggests_spatial r_suggests_stringr
	r_suggests_styler r_suggests_sysfonts r_suggests_tibble
	r_suggests_tidyr r_suggests_treemap r_suggests_upsetr
	r_suggests_vegan r_suggests_voronoitreemap"
R_SUGGESTS="
