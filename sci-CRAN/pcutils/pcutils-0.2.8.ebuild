...
SRC_URI="http://cran.r-project.org/src/contrib/pcutils_0.2.8.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_agricolae r_suggests_aplot r_suggests_biocmanager
	...
	r_suggests_ggraph r_suggests_ggrepel r_suggests_ggsci
	r_suggests_ggvenndiagram r_suggests_grimport2 r_suggests_htmltools
	r_suggests_htmlwidgets r_suggests_httr r_suggests_igraph
	r_suggests_jsonlite r_suggests_kableextra r_suggests_knitr
	r_suggests_leaflet r_suggests_lintr r_suggests_magick
	r_suggests_multcompview r_suggests_nortest r_suggests_openssl
	r_suggests_pagedown r_suggests_plotly r_suggests_plotrix
	r_suggests_pmcmrplus r_suggests_r_proxy r_suggests_readr
	r_suggests_relaimpo r_suggests_revtools r_suggests_rio
	r_suggests_rlang r_suggests_rmarkdown r_suggests_sf
	r_suggests_showtext r_suggests_snow r_suggests_spatial
	r_suggests_stringr r_suggests_styler r_suggests_sysfonts
	r_suggests_treemap r_suggests_upsetr r_suggests_vegan
	r_suggests_voronoitreemap"
R_SUGGESTS="
