...
SRC_URI="http://cran.r-project.org/src/contrib/tsibble_0.9.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_furrr r_suggests_ggplot2
	r_suggests_hms r_suggests_knitr r_suggests_nycflights13
	r_suggests_rmarkdown r_suggests_scales r_suggests_spelling
	r_suggests_testthat r_suggests_tidyr r_suggests_timedate"
R_SUGGESTS="
