...
SRC_URI="http://cran.r-project.org/src/contrib/discord_1.2.4.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bgmisc r_suggests_broom r_suggests_dplyr
	r_suggests_ggpedigree r_suggests_ggplot2 r_suggests_gridextra
	r_suggests_janitor r_suggests_kableextra r_suggests_knitr
	r_suggests_magrittr r_suggests_nlsylinks r_suggests_rmarkdown
	r_suggests_scales r_suggests_snakecase r_suggests_stargazer
