...
SRC_URI="http://cran.r-project.org/src/contrib/ggformula_0.6.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_dplyr r_suggests_knitr r_suggests_lattice
	...
	r_suggests_rmarkdown r_suggests_statisticalmodeling
	r_suggests_testthat r_suggests_weatherdata"
R_SUGGESTS="
