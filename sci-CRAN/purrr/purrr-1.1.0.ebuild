...
SRC_URI="http://cran.r-project.org/src/contrib/purrr_1.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_carrier r_suggests_covr r_suggests_dplyr
	r_suggests_httr r_suggests_knitr r_suggests_lubridate
	r_suggests_mirai r_suggests_rmarkdown r_suggests_testthat
	r_suggests_tibble r_suggests_tidyselect"
R_SUGGESTS="
	r_suggests_carrier? ( >=sci-CRAN/carrier-0.2.0 )
