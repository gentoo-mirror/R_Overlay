...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/extras_0.6.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_aods3 r_suggests_covr r_suggests_ggplot2
	r_suggests_hms r_suggests_knitr r_suggests_mass r_suggests_rlang
