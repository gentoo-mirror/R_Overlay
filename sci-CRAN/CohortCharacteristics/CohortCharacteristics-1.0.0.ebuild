...
SRC_URI="http://cran.r-project.org/src/contrib/CohortCharacteristics_1.0.0.tar.gz"
...
R_SUGGESTS="
	...
	r_suggests_dt? ( sci-CRAN/DT sci-CRAN/DT )
	...
	r_suggests_reactable? ( sci-CRAN/reactable sci-CRAN/reactable )
