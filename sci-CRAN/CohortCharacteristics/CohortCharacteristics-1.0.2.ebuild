...
SRC_URI="http://cran.r-project.org/src/contrib/CohortCharacteristics_1.0.2.tar.gz"
...
IUSE="${IUSE-} r_suggests_codelistgenerator r_suggests_cohortconstructor
	...
	r_suggests_drugutilisation r_suggests_dt r_suggests_duckdb
	r_suggests_flextable r_suggests_ggplot2 r_suggests_ggpubr
	r_suggests_glue r_suggests_gt r_suggests_here r_suggests_hmisc
	r_suggests_htmltools r_suggests_knitr r_suggests_odbc
	r_suggests_omock r_suggests_plotly r_suggests_png
...
"
DEPEND=">=sci-CRAN/PatientProfiles-1.3.1
	sci-CRAN/clock
	sci-CRAN/dplyr
