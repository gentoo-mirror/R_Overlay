...
SRC_URI="http://cran.r-project.org/src/contrib/CohortCharacteristics_0.2.2.tar.gz"
...
IUSE="${IUSE-} r_suggests_codelistgenerator r_suggests_covr
	...
	r_suggests_ggpubr r_suggests_ggraph r_suggests_glue r_suggests_gt
	r_suggests_here r_suggests_knitr r_suggests_magick r_suggests_odbc
	r_suggests_plotly r_suggests_rmarkdown r_suggests_rpostgres
