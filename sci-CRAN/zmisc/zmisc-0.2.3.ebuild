...
SRC_URI="http://cran.r-project.org/src/contrib/zmisc_0.2.3.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_desc r_suggests_dplyr r_suggests_haven
	r_suggests_knitr r_suggests_labelled r_suggests_purrr
