...
SRC_URI="http://cran.r-project.org/src/contrib/ClustAssess_1.0.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_biocmanager r_suggests_colourpicker
	r_suggests_data_table r_suggests_devtools r_suggests_doparallel
	r_suggests_knitr r_suggests_leidenbase r_suggests_matrix
	r_suggests_patchwork r_suggests_ragg r_suggests_reticulate
	r_suggests_rhdf5 r_suggests_rhpcblasctl r_suggests_rmarkdown
	r_suggests_scales r_suggests_seuratobject r_suggests_styler
	r_suggests_testthat"
R_SUGGESTS="
