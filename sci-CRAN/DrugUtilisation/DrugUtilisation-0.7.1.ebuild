...
SRC_URI="http://cran.r-project.org/src/contrib/DrugUtilisation_0.7.1.tar.gz"

IUSE="${IUSE-} r_suggests_covr r_suggests_dbi r_suggests_duckdb
	r_suggests_flextable r_suggests_ggplot2 r_suggests_ggtext
	r_suggests_gt r_suggests_here r_suggests_knitr r_suggests_odbc
