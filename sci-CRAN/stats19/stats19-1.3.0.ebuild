...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/stats19_1.3.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_curl r_suggests_dplyr r_suggests_geojsonsf
	r_suggests_ggplot2 r_suggests_htmltools r_suggests_jsonlite
	r_suggests_knitr r_suggests_leaflet r_suggests_lubridate
	r_suggests_osmdata r_suggests_pct r_suggests_rmarkdown
	r_suggests_spatstat r_suggests_stringr r_suggests_testthat
