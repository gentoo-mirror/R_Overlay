...
SRC_URI="http://cran.r-project.org/src/contrib/stats19_3.4.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_clock r_suggests_covr r_suggests_geojsonsf
	r_suggests_ggplot2 r_suggests_gt r_suggests_htmltools
	r_suggests_kableextra r_suggests_knitr r_suggests_leaflet
	r_suggests_osmdata r_suggests_pkgdown r_suggests_readods
