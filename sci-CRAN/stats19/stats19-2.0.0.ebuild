...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/stats19_2.0.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_curl r_suggests_dplyr
	...
	r_suggests_lubridate r_suggests_osmdata r_suggests_pct
	r_suggests_rmarkdown r_suggests_spatstat r_suggests_spatstat_core
	r_suggests_spatstat_geom r_suggests_stringr r_suggests_testthat
	r_suggests_tidyr r_suggests_tmap"
R_SUGGESTS="
