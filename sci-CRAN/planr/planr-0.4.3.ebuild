...
SRC_URI="http://cran.r-project.org/src/contrib/planr_0.4.3.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_diagrammer r_suggests_dt r_suggests_highcharter
	r_suggests_knitr r_suggests_networkd3 r_suggests_reactable
	r_suggests_reactablefmtr r_suggests_rmarkdown r_suggests_shiny
	r_suggests_sparkline r_suggests_testthat r_suggests_tidyverse"
R_SUGGESTS="
