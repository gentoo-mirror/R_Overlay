...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/protti_0.2.2.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_dendextend r_suggests_drc
	...
	r_suggests_limma r_suggests_pheatmap r_suggests_rmarkdown
	r_suggests_seriation r_suggests_stringdb r_suggests_stringi
	r_suggests_testthat"
R_SUGGESTS="
