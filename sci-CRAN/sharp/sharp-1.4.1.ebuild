...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/sharp_1.4.1.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_cluster r_suggests_corpcor r_suggests_dbscan
	...
	r_suggests_randomcolor r_suggests_regsem r_suggests_rmarkdown
	r_suggests_rpart r_suggests_sgpls r_suggests_survival
...
R_SUGGESTS="
	...
	r_suggests_regsem? ( sci-CRAN/regsem )
