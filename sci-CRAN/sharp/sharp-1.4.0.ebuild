...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/sharp_1.4.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_cluster r_suggests_corpcor r_suggests_dbscan
	...
	r_suggests_nnet r_suggests_openmx r_suggests_plotrix
	r_suggests_randomcolor r_suggests_rmarkdown r_suggests_rpart
	r_suggests_sgpls r_suggests_sparcl r_suggests_survival
