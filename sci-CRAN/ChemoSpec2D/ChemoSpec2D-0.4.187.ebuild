...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ChemoSpec2D_0.4.187.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bookdown r_suggests_cmls r_suggests_irlba
	...
	r_suggests_pinp r_suggests_r_utils r_suggests_rcpproll
	r_suggests_rmarkdown r_suggests_robustbase r_suggests_smoof
