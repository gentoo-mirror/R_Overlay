...
SRC_URI="http://cran.r-project.org/src/contrib/eq5d_0.15.5.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_covr r_suggests_dt r_suggests_fsa
	r_suggests_ggiraph r_suggests_ggiraphextra r_suggests_ggplot2
	r_suggests_knitr r_suggests_lifecycle r_suggests_mime
	r_suggests_pmcmrplus r_suggests_readxl r_suggests_rmarkdown
