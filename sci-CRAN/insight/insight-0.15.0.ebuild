...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/insight_0.15.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_lme4 r_suggests_lmtest r_suggests_logistf r_suggests_mass
	...
	r_suggests_plm r_suggests_poorman r_suggests_pscl r_suggests_psych
	r_suggests_quantreg r_suggests_rmarkdown r_suggests_rms
	r_suggests_robustbase r_suggests_robustlmm r_suggests_rstudioapi
	r_suggests_sandwich r_suggests_speedglm r_suggests_spelling
