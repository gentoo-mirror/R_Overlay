...
SRC_URI="http://cran.r-project.org/src/contrib/insight_0.7.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	r_suggests_bayesfactor r_suggests_bayestestr r_suggests_betareg
	r_suggests_biglm r_suggests_blavaan r_suggests_blme r_suggests_brms
	r_suggests_censreg r_suggests_coxme r_suggests_crch
	...
	r_suggests_gmnl r_suggests_hrqol r_suggests_httr r_suggests_knitr
	r_suggests_lavaan r_suggests_lfe r_suggests_lme4 r_suggests_logistf
	r_suggests_mass r_suggests_matrix r_suggests_mcmcglmm r_suggests_mgcv
	r_suggests_mlogit r_suggests_multgee r_suggests_nlme r_suggests_nnet
	r_suggests_ordinal r_suggests_panelr r_suggests_plm r_suggests_pscl
	r_suggests_quantreg r_suggests_rmarkdown r_suggests_rms
	r_suggests_robust r_suggests_robustbase r_suggests_robustlmm
	r_suggests_rstanarm r_suggests_rstudioapi r_suggests_speedglm
	r_suggests_spelling r_suggests_survey r_suggests_survival
	r_suggests_testthat r_suggests_truncreg r_suggests_vgam"
R_SUGGESTS="
