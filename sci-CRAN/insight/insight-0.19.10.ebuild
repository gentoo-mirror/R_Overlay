...
SRC_URI="http://cran.r-project.org/src/contrib/insight_0.19.10.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	r_suggests_bayesfactor r_suggests_bayestestr r_suggests_bbmle
	r_suggests_betareg r_suggests_bife r_suggests_biglm
	...
	r_suggests_clubsandwich r_suggests_coxme r_suggests_cplm
	r_suggests_crch r_suggests_curl r_suggests_datawizard
	r_suggests_effectsize r_suggests_emmeans r_suggests_epir
	r_suggests_estimatr r_suggests_feisr r_suggests_fixest
	r_suggests_fungible r_suggests_gam r_suggests_gamlss
	...
	r_suggests_gt r_suggests_httr r_suggests_interp r_suggests_ivreg
	r_suggests_jm r_suggests_knitr r_suggests_lavaan
	r_suggests_lavasearch2 r_suggests_lfe r_suggests_lme4
	r_suggests_lmertest r_suggests_lmtest r_suggests_logistf
	r_suggests_logitr r_suggests_marginaleffects r_suggests_mass
	r_suggests_matrix r_suggests_mclogit r_suggests_mclust
	r_suggests_mcmcglmm r_suggests_mertools r_suggests_metabma
	r_suggests_metadat r_suggests_metafor r_suggests_metaplus
	r_suggests_mgcv r_suggests_mhurdle r_suggests_mice r_suggests_mlogit
	...
	r_suggests_quantreg r_suggests_rcpp r_suggests_rmarkdown
	r_suggests_rms r_suggests_robustbase r_suggests_robustlmm
	r_suggests_rpart r_suggests_rstanarm r_suggests_rstantools
	r_suggests_rstudioapi r_suggests_sandwich r_suggests_serp
	r_suggests_speedglm r_suggests_statmod r_suggests_survey
	r_suggests_survival r_suggests_testthat r_suggests_tinytable
	r_suggests_tmb r_suggests_truncreg r_suggests_tweedie r_suggests_vgam
	r_suggests_withr"
R_SUGGESTS="
