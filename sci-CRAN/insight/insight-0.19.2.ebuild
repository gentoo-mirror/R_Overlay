...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/insight_0.19.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_geepack r_suggests_geor r_suggests_glmmadaptive
	r_suggests_glmmtmb r_suggests_gmnl r_suggests_gt r_suggests_httr
	...
	r_suggests_metaplus r_suggests_mgcv r_suggests_mhurdle
	r_suggests_mice r_suggests_mlogit r_suggests_mmrm r_suggests_multgee
