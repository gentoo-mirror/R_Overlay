...
SRC_URI="http://cran.r-project.org/src/contrib/insight_0.9.6.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_estimatr r_suggests_feisr r_suggests_fixest r_suggests_gam
	...
	r_suggests_gmnl r_suggests_httr r_suggests_knitr r_suggests_lavaan
	r_suggests_lfe r_suggests_lme4 r_suggests_logistf r_suggests_mass
	...
	r_suggests_ordinal r_suggests_plm r_suggests_pscl r_suggests_quantreg
	r_suggests_rmarkdown r_suggests_rms r_suggests_robustbase
	r_suggests_robustlmm r_suggests_rstanarm r_suggests_rstudioapi
