...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/insight_0.18.8.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_metabma r_suggests_mgcv r_suggests_mhurdle r_suggests_mice
	r_suggests_mlogit r_suggests_multgee r_suggests_nlme r_suggests_nnet
	...
	r_suggests_testthat r_suggests_truncreg r_suggests_tweedie
	r_suggests_vgam"
R_SUGGESTS="
