...
SRC_URI="http://cran.r-project.org/src/contrib/insight_1.3.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod r_suggests_ape
	...
	r_suggests_pbkrtest r_suggests_performance r_suggests_phylolm
	r_suggests_plm r_suggests_poorman r_suggests_proreg r_suggests_pscl
	...
	r_suggests_rwiener r_suggests_sandwich r_suggests_serp
	r_suggests_speedglm r_suggests_statmod r_suggests_survey
	r_suggests_survival r_suggests_svylme r_suggests_testthat
	r_suggests_tinytable r_suggests_tmb r_suggests_truncreg
	r_suggests_tune r_suggests_tweedie r_suggests_vgam
