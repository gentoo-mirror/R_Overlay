...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/insight_0.19.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_cplm r_suggests_crch r_suggests_datawizard
	r_suggests_effectsize r_suggests_emmeans r_suggests_epir
	r_suggests_estimatr r_suggests_feisr r_suggests_fixest
	r_suggests_fungible r_suggests_gam r_suggests_gamlss r_suggests_gamm4
	...
	r_suggests_mmrm r_suggests_multgee r_suggests_nlme r_suggests_nnet
	r_suggests_nonnest2 r_suggests_ordinal r_suggests_panelr
	r_suggests_parameters r_suggests_parsnip r_suggests_pbkrtest
	r_suggests_performance r_suggests_plm r_suggests_poorman
	...
	r_suggests_rstudioapi r_suggests_sandwich r_suggests_speedglm
	r_suggests_statmod r_suggests_survey r_suggests_survival
	r_suggests_testthat r_suggests_tmb r_suggests_truncreg
