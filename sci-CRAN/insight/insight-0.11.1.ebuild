...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/insight_0.11.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_httr r_suggests_ivreg r_suggests_jm r_suggests_knitr
	r_suggests_lavaan r_suggests_lme4 r_suggests_logistf r_suggests_mass
	...
	r_suggests_ordinal r_suggests_parameters r_suggests_performance
	r_suggests_plm r_suggests_pscl r_suggests_quantreg
	r_suggests_rmarkdown r_suggests_rms r_suggests_robustbase
	r_suggests_robustlmm r_suggests_rstudioapi r_suggests_speedglm
	r_suggests_spelling r_suggests_statmod r_suggests_survey
	r_suggests_survival r_suggests_testthat r_suggests_tripack
