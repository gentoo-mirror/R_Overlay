...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/insight_0.18.6.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_mcmcglmm r_suggests_mertools r_suggests_mgcv
	...
	r_suggests_survival r_suggests_testthat r_suggests_truncreg
