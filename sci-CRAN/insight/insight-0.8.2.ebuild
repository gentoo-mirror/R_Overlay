...
SRC_URI="http://cran.r-project.org/src/contrib/insight_0.8.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_censreg r_suggests_cgam r_suggests_coxme r_suggests_cplm
	r_suggests_crch r_suggests_estimatr r_suggests_feisr
	...
	r_suggests_hrqol r_suggests_httr r_suggests_knitr r_suggests_lavaan
