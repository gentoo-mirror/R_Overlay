...
SRC_URI="http://cran.r-project.org/src/contrib/insight_0.10.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	r_suggests_bayesfactor r_suggests_bayestestr r_suggests_bbmle
	r_suggests_betareg r_suggests_bggm r_suggests_biglm
	r_suggests_blavaan r_suggests_blme r_suggests_brms r_suggests_censreg
	r_suggests_cgam r_suggests_coxme r_suggests_cplm r_suggests_crch
	...
	r_suggests_httr r_suggests_knitr r_suggests_lavaan r_suggests_lfe
	r_suggests_lme4 r_suggests_logistf r_suggests_mass r_suggests_matrix
	...
	r_suggests_parameters r_suggests_plm r_suggests_pscl
	...
	r_suggests_testthat r_suggests_tripack r_suggests_truncreg
	r_suggests_vgam"
R_SUGGESTS="
