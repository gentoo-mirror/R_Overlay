...
SRC_URI="http://cran.r-project.org/src/contrib/insight_1.4.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod r_suggests_ape
	...
	r_suggests_mice r_suggests_mlogit r_suggests_mmrm
	r_suggests_modelbased r_suggests_multgee r_suggests_mumin
	r_suggests_mvtnorm r_suggests_nestedlogit r_suggests_nlme
	...
	r_suggests_plm r_suggests_proreg r_suggests_pscl r_suggests_psych
	...
	r_suggests_sampleselection r_suggests_sandwich r_suggests_sdmtmb
	r_suggests_serp r_suggests_speedglm r_suggests_statmod
	r_suggests_survey r_suggests_survival r_suggests_svylme
	r_suggests_testthat r_suggests_tinytable r_suggests_truncreg
