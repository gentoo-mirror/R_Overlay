...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/insight_0.13.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	r_suggests_bayesfactor r_suggests_bayestestr r_suggests_bbmle
	r_suggests_betareg r_suggests_bggm r_suggests_biglm r_suggests_blme
	r_suggests_censreg r_suggests_clubsandwich r_suggests_coxme
	r_suggests_cplm r_suggests_crch r_suggests_dplyr
	r_suggests_effectsize r_suggests_emmeans r_suggests_estimatr
	r_suggests_feisr r_suggests_fixest r_suggests_gam r_suggests_gamlss
	r_suggests_gamm4 r_suggests_gbm r_suggests_gee r_suggests_geepack
	r_suggests_glmmadaptive r_suggests_glmmtmb r_suggests_gmnl
	r_suggests_gt r_suggests_httr r_suggests_ivreg r_suggests_jm
	r_suggests_knitr r_suggests_lavaan r_suggests_lfe r_suggests_lme4
	r_suggests_lmtest r_suggests_logistf r_suggests_mass
	r_suggests_matrix r_suggests_mclust r_suggests_mcmcglmm
	r_suggests_mertools r_suggests_mgcv r_suggests_mice r_suggests_mlogit
	r_suggests_multgee r_suggests_nlme r_suggests_nnet
	r_suggests_nonnest2 r_suggests_ordinal r_suggests_panelr
	r_suggests_parameters r_suggests_parsnip r_suggests_performance
	r_suggests_plm r_suggests_pscl r_suggests_quantreg
	r_suggests_rmarkdown r_suggests_rms r_suggests_robustbase
	r_suggests_robustlmm r_suggests_rstudioapi r_suggests_sandwich
	r_suggests_speedglm r_suggests_spelling r_suggests_statmod
