...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/insight_0.12.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_censreg r_suggests_coxme r_suggests_cplm r_suggests_crch
	...
	r_suggests_knitr r_suggests_lavaan r_suggests_lme4 r_suggests_lmtest
	r_suggests_logistf r_suggests_mass r_suggests_matrix
	r_suggests_mcmcglmm r_suggests_mgcv r_suggests_mice r_suggests_mlogit
	r_suggests_multgee r_suggests_nlme r_suggests_nnet
	r_suggests_nonnest2 r_suggests_ordinal r_suggests_parameters
	r_suggests_performance r_suggests_plm r_suggests_pscl
