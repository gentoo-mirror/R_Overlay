...
SRC_URI="http://cran.r-project.org/src/contrib/insight_1.4.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod r_suggests_ape
	...
	r_suggests_dbarts r_suggests_effectsize r_suggests_emmeans
	r_suggests_epir r_suggests_estimatr r_suggests_feisr
	r_suggests_fixest r_suggests_fungible r_suggests_fwb r_suggests_gam
	r_suggests_gamlss r_suggests_gamlss_data r_suggests_gamm4
	r_suggests_gbm r_suggests_gee r_suggests_geepack r_suggests_geor
	r_suggests_glmmadaptive r_suggests_glmmtmb r_suggests_glmtoolbox
	r_suggests_gmnl r_suggests_gt r_suggests_httptest2 r_suggests_httr2
	r_suggests_interp r_suggests_ivreg r_suggests_jm r_suggests_knitr
	...
	r_suggests_mumin r_suggests_mvtnorm r_suggests_nestedlogit
	r_suggests_nlme r_suggests_nnet r_suggests_nonnest2
	r_suggests_ordinal r_suggests_panelr r_suggests_parameters
	r_suggests_parsnip r_suggests_pbkrtest r_suggests_performance
	r_suggests_phylolm r_suggests_plm r_suggests_proreg r_suggests_pscl
	r_suggests_psych r_suggests_quantreg r_suggests_rcpp
	r_suggests_rcppeigen r_suggests_rmarkdown r_suggests_rms
	r_suggests_robustbase r_suggests_robustlmm r_suggests_rpart
	r_suggests_rstanarm r_suggests_rstantools r_suggests_rstudioapi
	r_suggests_rwiener r_suggests_sampleselection r_suggests_sandwich
	r_suggests_sdmtmb r_suggests_serp r_suggests_speedglm
	r_suggests_statmod r_suggests_survey r_suggests_survival
	r_suggests_svylme r_suggests_testthat r_suggests_tinytable
	r_suggests_truncreg r_suggests_tune r_suggests_tweedie
	r_suggests_vgam r_suggests_weightit r_suggests_withr"
R_SUGGESTS="
	...
	r_suggests_datawizard? ( >=sci-CRAN/datawizard-1.2.0 )
	...
	r_suggests_tinytable? ( >=sci-CRAN/tinytable-0.8.0 )
