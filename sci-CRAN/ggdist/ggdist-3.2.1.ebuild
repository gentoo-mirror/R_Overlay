...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ggdist_3.2.1.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_beeswarm r_suggests_broom r_suggests_covr
	r_suggests_cowplot r_suggests_fda r_suggests_forcats r_suggests_knitr
	r_suggests_modelr r_suggests_palmerpenguins r_suggests_patchwork
