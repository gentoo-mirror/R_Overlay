...
SRC_URI="http://cran.r-project.org/src/contrib/renv_0.12.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_cli r_suggests_covr r_suggests_devtools
	r_suggests_knitr r_suggests_packrat r_suggests_r6 r_suggests_remotes
	r_suggests_reticulate r_suggests_rmarkdown r_suggests_rstudioapi
	r_suggests_testthat r_suggests_uuid r_suggests_yaml"
R_SUGGESTS="
