...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/renv_0.15.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_biocmanager r_suggests_cli r_suggests_covr
	r_suggests_devtools r_suggests_knitr r_suggests_miniui
	...
	r_suggests_shiny r_suggests_testthat r_suggests_uuid r_suggests_yaml"
R_SUGGESTS="
