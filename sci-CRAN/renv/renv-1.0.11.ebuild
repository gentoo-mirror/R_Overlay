...
SRC_URI="http://cran.r-project.org/src/contrib/renv_1.0.11.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_biocmanager r_suggests_cli r_suggests_covr
	r_suggests_cpp11 r_suggests_devtools r_suggests_gitcreds
	r_suggests_jsonlite r_suggests_jsonvalidate r_suggests_knitr
	r_suggests_miniui r_suggests_modules r_suggests_packrat
	r_suggests_pak r_suggests_r6 r_suggests_remotes r_suggests_reticulate
	r_suggests_rmarkdown r_suggests_rstudioapi r_suggests_shiny
	r_suggests_testthat r_suggests_uuid r_suggests_waldo
