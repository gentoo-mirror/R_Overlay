...
SRC_URI="http://cran.r-project.org/src/contrib/renv_1.1.5.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_biocmanager r_suggests_cli r_suggests_covr
	r_suggests_cpp11 r_suggests_devtools r_suggests_generics
	r_suggests_gitcreds r_suggests_jsonlite r_suggests_jsonvalidate
	r_suggests_knitr r_suggests_miniui r_suggests_modules
