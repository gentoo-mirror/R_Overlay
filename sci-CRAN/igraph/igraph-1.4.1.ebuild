...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/igraph_1.4.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ape r_suggests_digest r_suggests_graph
	r_suggests_igraphdata r_suggests_knitr r_suggests_rgl
	r_suggests_rmarkdown r_suggests_scales r_suggests_testthat
	r_suggests_tk r_suggests_vdiffr r_suggests_withr"
R_SUGGESTS="
