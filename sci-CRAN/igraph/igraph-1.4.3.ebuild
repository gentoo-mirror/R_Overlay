...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/igraph_1.4.3.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ape r_suggests_decor r_suggests_digest
	r_suggests_graph r_suggests_igraphdata r_suggests_knitr
