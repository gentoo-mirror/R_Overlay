...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/leaflet.extras2_1.2.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_fontawesome r_suggests_geojsonsf
	r_suggests_htmlwidgets r_suggests_jsonlite r_suggests_sf
	r_suggests_shiny r_suggests_sp r_suggests_testthat"
R_SUGGESTS="
