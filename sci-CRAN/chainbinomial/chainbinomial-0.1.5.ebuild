...
DESCRIPTION='Chain Binomial Models for Analys... (see metadata)'
KEYWORDS="~amd64 ~x64-macos ~arm64-macos"
SRC_URI="http://cran.r-project.org/src/contrib/chainbinomial_0.1.5.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_dplyr r_suggests_knitr r_suggests_numderiv
	...
	r_suggests_tidyr"
R_SUGGESTS="
	r_suggests_dplyr? ( >=sci-CRAN/dplyr-1.1.3 )
