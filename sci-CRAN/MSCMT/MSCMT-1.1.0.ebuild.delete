...
SRC_URI="http://cran.r-project.org/src/contrib/MSCMT_1.1.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_cmaes r_suggests_deoptim r_suggests_deoptimr
	r_suggests_ga r_suggests_gensa r_suggests_hydropso r_suggests_knitr
	r_suggests_nloptr r_suggests_nmof r_suggests_optimx r_suggests_pso
	r_suggests_rgenoud r_suggests_rmalschains r_suggests_rmarkdown
	r_suggests_soma r_suggests_synth"
R_SUGGESTS="
