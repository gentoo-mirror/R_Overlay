...
SRC_URI="http://cran.r-project.org/src/contrib/NMsim_0.2.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_coveffectsplot r_suggests_ggplot2
	r_suggests_kableextra r_suggests_knitr r_suggests_nmcalc
	r_suggests_patchwork r_suggests_rmarkdown r_suggests_testthat
	r_suggests_tidyvpc r_suggests_tracee"
R_SUGGESTS="
...
DEPEND=">=dev-lang/R-3.5.0
	...
	sci-CRAN/R_utils
	virtual/MASS
	>=sci-CRAN/NMdata-0.1.6
	sci-CRAN/fst
	sci-CRAN/xfun
"
RDEPEND="${DEPEND-} ${R_SUGGESTS-}"

_UNRESOLVED_PACKAGES=( 'simpar' )
