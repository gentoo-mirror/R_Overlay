...
SRC_URI="http://cran.r-project.org/src/contrib/lavaSearch2_1.2.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_clubsandwich r_suggests_data_table
	r_suggests_doparallel r_suggests_foreach r_suggests_lava_tobit
	r_suggests_lme4 r_suggests_lmertest r_suggests_numderiv
	r_suggests_pbapply r_suggests_pbkrtest r_suggests_riskregression
