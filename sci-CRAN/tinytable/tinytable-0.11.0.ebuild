...
SRC_URI="http://cran.r-project.org/src/contrib/tinytable_0.11.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_base64enc r_suggests_data_table
	...
	r_suggests_htmltools r_suggests_litedown r_suggests_magrittr
	r_suggests_marginaleffects r_suggests_modelsummary r_suggests_pandoc
	r_suggests_rdatasets r_suggests_rmarkdown r_suggests_rstudioapi
	r_suggests_scales r_suggests_stringi r_suggests_tibble
	r_suggests_tinysnapshot r_suggests_tinytest r_suggests_tinytex
	r_suggests_webshot2 r_suggests_xfun"
R_SUGGESTS="
