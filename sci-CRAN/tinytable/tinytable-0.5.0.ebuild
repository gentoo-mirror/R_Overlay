...
SRC_URI="http://cran.r-project.org/src/contrib/tinytable_0.5.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_base64enc r_suggests_data_table r_suggests_fansi
	r_suggests_ggplot2 r_suggests_gh r_suggests_marginaleffects
	r_suggests_markdown r_suggests_pandoc r_suggests_rmarkdown
