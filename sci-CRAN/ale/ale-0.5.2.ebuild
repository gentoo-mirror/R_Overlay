...
SRC_URI="http://cran.r-project.org/src/contrib/ale_0.5.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_gbm r_suggests_knitr r_suggests_mgcv
	r_suggests_nnet r_suggests_readr r_suggests_rmarkdown
