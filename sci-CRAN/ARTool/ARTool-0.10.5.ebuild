...
SRC_URI="http://cran.r-project.org/src/contrib/ARTool_0.10.5.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_cluster r_suggests_desctools r_suggests_emmeans
