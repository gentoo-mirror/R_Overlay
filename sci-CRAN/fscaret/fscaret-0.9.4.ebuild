...
SRC_URI="http://cran.r-project.org/src/contrib/fscaret_0.9.4.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_arm r_suggests_boruta
	...
	r_suggests_mboost r_suggests_mda r_suggests_mlbench
	r_suggests_neuralnet r_suggests_nodeharvest r_suggests_obliquerf
