...
DESCRIPTION='Automated Feature Selection from caret'
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/fscaret_0.9.4.4.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'

IUSE="${IUSE-} r_suggests_ada r_suggests_arm r_suggests_boruta
	r_suggests_bst r_suggests_c50 r_suggests_car r_suggests_catools
	r_suggests_class r_suggests_cubist r_suggests_e1071 r_suggests_earth
	r_suggests_elasticnet r_suggests_ellipse r_suggests_evtree
	r_suggests_extratrees r_suggests_fastica r_suggests_gam
	r_suggests_gbm r_suggests_glmnet r_suggests_hda r_suggests_hmisc
	...
	r_suggests_logicreg r_suggests_mass r_suggests_mboost r_suggests_mda
	r_suggests_mgcv r_suggests_mlbench r_suggests_neuralnet
	r_suggests_nnet r_suggests_nodeharvest r_suggests_obliquerf
	r_suggests_pamr r_suggests_partdsa r_suggests_party
	r_suggests_penalized r_suggests_penalizedlda r_suggests_pls
	r_suggests_proc r_suggests_proxy r_suggests_qrnn
	r_suggests_quantregforest r_suggests_randomforest r_suggests_rann
	r_suggests_relaxo r_suggests_rferns r_suggests_rocc r_suggests_rpart
	r_suggests_rrcov r_suggests_rrf r_suggests_rrlda r_suggests_rsnns
	r_suggests_rweka r_suggests_sda r_suggests_sparselda r_suggests_spls
