...
SRC_URI="http://cran.r-project.org/src/contrib/aroma.core_3.1.3.tar.gz"
LICENSE='LGPL-2.1+'
...
DEPEND=">=sci-CRAN/R_methodsS3-1.7.1
	...
	>=sci-CRAN/R_filesets-2.12.1
	sci-CRAN/future
	>=sci-CRAN/matrixStats-0.53.1
	>=sci-CRAN/PSCBS-0.63.0
"
