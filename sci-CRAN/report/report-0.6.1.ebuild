...
SRC_URI="http://cran.r-project.org/src/contrib/report_0.6.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bayesfactor r_suggests_bh r_suggests_brms
	r_suggests_collapse r_suggests_dplyr r_suggests_emmeans
	r_suggests_formula r_suggests_ivreg r_suggests_knitr
