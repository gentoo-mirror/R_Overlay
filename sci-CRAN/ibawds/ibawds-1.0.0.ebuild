...
SRC_URI="http://cran.r-project.org/src/contrib/ibawds_1.0.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_biocmanager r_suggests_caret r_suggests_clvalid
	r_suggests_covr r_suggests_cowplot r_suggests_deldir r_suggests_dt
	r_suggests_ggally r_suggests_ggfortify r_suggests_ggrepel
	r_suggests_gutenbergr r_suggests_hexbin r_suggests_histdata
	r_suggests_kableextra r_suggests_knitr r_suggests_lahman
	r_suggests_lubridate r_suggests_party r_suggests_patchwork
	r_suggests_ranger r_suggests_rann r_suggests_reshape2
