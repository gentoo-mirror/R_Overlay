...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/multilevelmod_0.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_contrast r_suggests_covr r_suggests_gee
	r_suggests_knitr r_suggests_nlme r_suggests_rmarkdown
	r_suggests_spelling r_suggests_testthat r_suggests_tidymodels"
R_SUGGESTS="
	r_suggests_contrast? ( sci-CRAN/contrast )
