...
SRC_URI="http://cran.r-project.org/src/contrib/highfrequency_0.4.tar.gz -> highfrequency_0.4-r1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_bms r_suggests_chron r_suggests_cubature
	r_suggests_fkf r_suggests_mass r_suggests_mvtnorm r_suggests_numderiv
