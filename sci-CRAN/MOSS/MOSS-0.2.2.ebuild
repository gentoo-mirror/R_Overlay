...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/MOSS_0.2.2.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_annotate r_suggests_bigparallelr
	r_suggests_bigstatsr r_suggests_clvalid r_suggests_fpc
	r_suggests_future_apply r_suggests_ggplot2 r_suggests_ggpmisc
	r_suggests_ggthemes r_suggests_gridextra r_suggests_irlba
	r_suggests_knitr r_suggests_mass r_suggests_rmarkdown
	r_suggests_scatterpie r_suggests_spelling r_suggests_testthat
	r_suggests_venndiagram r_suggests_viridis"
R_SUGGESTS="
