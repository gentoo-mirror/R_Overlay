...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/Guerry_1.7.4.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_ade4 r_suggests_adegraphics r_suggests_candisc
	...
	r_suggests_knitr r_suggests_maptools r_suggests_patchwork
	r_suggests_rcolorbrewer r_suggests_rmarkdown r_suggests_spatial
	r_suggests_spdep"
R_SUGGESTS="
