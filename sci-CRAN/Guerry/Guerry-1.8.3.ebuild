...
SRC_URI="http://cran.r-project.org/src/contrib/Guerry_1.8.3.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_ade4 r_suggests_adegraphics r_suggests_candisc
	...
	r_suggests_dplyr r_suggests_effects r_suggests_ggpcp
	r_suggests_ggplot2 r_suggests_ggrepel r_suggests_heplots
	r_suggests_here r_suggests_knitr r_suggests_patchwork
	r_suggests_rcolorbrewer r_suggests_remotes r_suggests_rmarkdown
	r_suggests_scales r_suggests_sf r_suggests_spatial r_suggests_spdep
	r_suggests_tidyr"
R_SUGGESTS="
	...
	r_suggests_ggpcp? ( sci-CRAN/ggpcp )
