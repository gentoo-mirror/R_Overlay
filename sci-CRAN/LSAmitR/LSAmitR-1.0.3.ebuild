...
DESCRIPTION='Daten, Beispiele und Funktionen ... (see metadata)'
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/LSAmitR_1.0-3.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_bifiesurvey r_suggests_car r_suggests_combinat
	...
	r_suggests_lattice r_suggests_lavaan r_suggests_matrix
