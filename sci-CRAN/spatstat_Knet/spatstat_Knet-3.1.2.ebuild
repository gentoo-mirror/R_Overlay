...
SRC_URI="http://cran.r-project.org/src/contrib/spatstat.Knet_3.1-2.tar.gz"
LICENSE='GPL-2+'

DEPEND=">=sci-CRAN/spatstat-3.1.1
	>=sci-CRAN/spatstat_utils-3.0.5
	>=sci-CRAN/spatstat_geom-3.3.0
	>=sci-CRAN/spatstat_data-3.1.0
	>=dev-lang/R-3.5.0
