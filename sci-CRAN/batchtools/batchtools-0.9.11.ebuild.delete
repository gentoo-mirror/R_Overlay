...
SRC_URI="http://cran.r-project.org/src/contrib/batchtools_0.9.11.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_debugme r_suggests_dompi r_suggests_doparallel
	r_suggests_e1071 r_suggests_foreach r_suggests_future
	r_suggests_future_batchtools r_suggests_knitr r_suggests_parallelmap
...
"
DEPEND=">=sci-CRAN/data_table-1.11.2
