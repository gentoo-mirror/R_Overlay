...
SRC_URI="http://cran.r-project.org/src/contrib/purgeR_1.8.2.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_caret r_suggests_coda r_suggests_dplyr
	r_suggests_e1071 r_suggests_ggplot2 r_suggests_ggraph
	r_suggests_glmnet r_suggests_gtable r_suggests_igraph
...
R_SUGGESTS="
	...
	r_suggests_ggraph? ( >=sci-CRAN/ggraph-2.1.0 )
	r_suggests_glmnet? ( >=sci-CRAN/glmnet-4.0.2 )
	r_suggests_gtable? ( >=sci-CRAN/gtable-0.3.0 )
	r_suggests_igraph? ( >=sci-CRAN/igraph-1.5.0.1 )
