...
SRC_URI="http://cran.r-project.org/src/contrib/metR_0.18.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_cftime r_suggests_covr r_suggests_gridextra
	r_suggests_gsignal r_suggests_here r_suggests_irlba r_suggests_knitr
	r_suggests_kriging r_suggests_maps r_suggests_markdown
	r_suggests_ncdf4 r_suggests_pkgdown r_suggests_proj4
