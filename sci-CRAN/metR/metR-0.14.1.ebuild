...
SRC_URI="http://cran.r-project.org/src/contrib/metR_0.14.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_gridextra r_suggests_gsignal
	...
	r_suggests_maps r_suggests_ncdf4 r_suggests_pcict r_suggests_pkgdown
	r_suggests_proj4 r_suggests_reshape2 r_suggests_rmarkdown
