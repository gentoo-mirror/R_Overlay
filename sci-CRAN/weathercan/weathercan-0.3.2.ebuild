...
SRC_URI="http://cran.r-project.org/src/contrib/weathercan_0.3.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_devtools r_suggests_ggmap r_suggests_ggplot2
	...
	r_suggests_lutz r_suggests_naniar r_suggests_rmarkdown r_suggests_sf
