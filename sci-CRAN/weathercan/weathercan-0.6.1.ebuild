...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/weathercan_0.6.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_devtools r_suggests_ggplot2 r_suggests_htmltools
	r_suggests_knitr r_suggests_leaflet r_suggests_lutz
	r_suggests_mockery r_suggests_naniar r_suggests_rmarkdown
	r_suggests_sf r_suggests_sp r_suggests_testthat r_suggests_vcr"
R_SUGGESTS="
	...
	r_suggests_vcr? ( >=sci-CRAN/vcr-1.0.2 )
"
