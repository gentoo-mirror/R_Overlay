...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/CAST_0.7.1.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_doparallel r_suggests_gridextra r_suggests_knitr
	...
	r_suggests_randomforest r_suggests_raster r_suggests_rgeos
	r_suggests_rmarkdown r_suggests_rnaturalearth r_suggests_scales
	r_suggests_scam r_suggests_sf r_suggests_sp r_suggests_stars
	r_suggests_terra r_suggests_viridis r_suggests_virtualspecies"
R_SUGGESTS="
