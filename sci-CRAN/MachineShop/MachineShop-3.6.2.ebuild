...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/MachineShop_3.6.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_adabag r_suggests_bart r_suggests_c50
	...
	r_suggests_gridextra r_suggests_hmisc r_suggests_kknn
	r_suggests_knitr r_suggests_lars r_suggests_mass r_suggests_mboost
	r_suggests_mda r_suggests_parbayesianoptimization r_suggests_parsnip
