...
SRC_URI="http://cran.r-project.org/src/contrib/MachineShop_2.0.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_adabag r_suggests_bart r_suggests_c50
	r_suggests_doparallel r_suggests_e1071 r_suggests_earth
	r_suggests_gbm r_suggests_glmnet r_suggests_gridextra
	r_suggests_hmisc r_suggests_kableextra r_suggests_kknn
	r_suggests_knitr r_suggests_lars r_suggests_mass r_suggests_mboost
	r_suggests_mda r_suggests_nnet r_suggests_partykit r_suggests_pls
