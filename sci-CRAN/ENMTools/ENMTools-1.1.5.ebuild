...
SRC_URI="http://cran.r-project.org/src/contrib/ENMTools_1.1.5.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_ape r_suggests_calibratr r_suggests_caret
	r_suggests_ecospat r_suggests_fastshap r_suggests_hypervolume
	r_suggests_leaflet r_suggests_mgcv r_suggests_pdp r_suggests_progress
	r_suggests_randomforest r_suggests_ranger r_suggests_reshape2
	r_suggests_resourceselection r_suggests_rmarkdown r_suggests_sf
	r_suggests_testthat r_suggests_vip r_suggests_viridis"
R_SUGGESTS="
	r_suggests_ape? ( sci-CRAN/ape )
	r_suggests_calibratr? ( sci-CRAN/CalibratR )
	r_suggests_caret? ( sci-CRAN/caret )
	r_suggests_ecospat? ( >=sci-CRAN/ecospat-3.2.1 )
