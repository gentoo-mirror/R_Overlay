...
SRC_URI="http://cran.r-project.org/src/contrib/ggfortify_0.4.10.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_changepoint r_suggests_cluster r_suggests_dlm
	...
	r_suggests_lintr r_suggests_mapdata r_suggests_mass r_suggests_mswm
	r_suggests_nlme r_suggests_raster r_suggests_rocr r_suggests_sp
	r_suggests_strucchange r_suggests_survival r_suggests_testthat
	r_suggests_timeseries r_suggests_tseries r_suggests_vars
