...
IUSE="${IUSE-} r_suggests_changepoint r_suggests_dlm r_suggests_fgarch
	r_suggests_forecast r_suggests_glmnet r_suggests_kfas
	r_suggests_knitr r_suggests_lfda r_suggests_mswm
	r_suggests_r[-minimal] r_suggests_strucchange r_suggests_testthat
