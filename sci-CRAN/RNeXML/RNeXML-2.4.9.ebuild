...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/RNeXML_2.4.9.tar.gz"
LICENSE='BSD'

IUSE="${IUSE-} r_suggests_covr r_suggests_geiger r_suggests_knitcitations
	r_suggests_knitr r_suggests_phytools r_suggests_progress
	r_suggests_rfigshare r_suggests_rmarkdown r_suggests_spelling
	r_suggests_taxalight r_suggests_testthat r_suggests_xslt"
R_SUGGESTS="
