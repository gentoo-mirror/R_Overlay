...
DESCRIPTION='Seasonal Trend Decomposition Using Regression'
KEYWORDS="~amd64 ~x64-macos ~arm64-macos"
SRC_URI="http://cran.r-project.org/src/contrib/stR_0.7.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_demography r_suggests_doparallel r_suggests_knitr
	...
	r_suggests_seasonal r_suggests_testthat"
R_SUGGESTS="
