...
SRC_URI="http://cran.r-project.org/src/contrib/PlackettLuce_0.3.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bayesmallows r_suggests_biocstyle
	r_suggests_bookdown r_suggests_bradleyterry2 r_suggests_covr
	r_suggests_gnm r_suggests_hyper2 r_suggests_kableextra
	r_suggests_knitr r_suggests_lbfgs r_suggests_plmix r_suggests_pmr
