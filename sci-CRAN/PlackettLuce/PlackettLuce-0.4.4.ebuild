...
SRC_URI="http://cran.r-project.org/src/contrib/PlackettLuce_0.4.4.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bayesmallows r_suggests_biocstyle
	...
	r_suggests_prefmod r_suggests_rmarkdown r_suggests_rologit
	r_suggests_statrank r_suggests_survival r_suggests_testthat"
R_SUGGESTS="
