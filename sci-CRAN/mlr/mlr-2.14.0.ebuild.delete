...
SRC_URI="http://cran.r-project.org/src/contrib/mlr_2.14.0.tar.gz"
LICENSE='BSD-2'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_adabag r_suggests_batchtools
	...
	r_suggests_clvalid r_suggests_cmaes r_suggests_cowplot
	...
	r_suggests_fda_usc r_suggests_fdboost r_suggests_flare r_suggests_fnn
	r_suggests_fpc r_suggests_frbs r_suggests_fselector
	r_suggests_fselectorrcpp r_suggests_gbm r_suggests_gensa
	r_suggests_ggpubr r_suggests_glmnet r_suggests_gpfit r_suggests_h2o
	r_suggests_hmisc r_suggests_hrbrthemes r_suggests_irace
	r_suggests_kernlab r_suggests_kknn r_suggests_klar r_suggests_knitr
	r_suggests_lagp r_suggests_liblinear r_suggests_lintr
	r_suggests_liquidsvm r_suggests_mass r_suggests_mboost r_suggests_mco
	r_suggests_mda r_suggests_memoise r_suggests_mlbench r_suggests_mldr
	r_suggests_mlrmbo r_suggests_mmpf r_suggests_modeltools
	r_suggests_mrmre r_suggests_neuralnet r_suggests_nnet
	r_suggests_nodeharvest r_suggests_numderiv r_suggests_pamr
	r_suggests_pander r_suggests_party r_suggests_penalized
	r_suggests_pls r_suggests_pmcmr r_suggests_praznik
	r_suggests_randomforest r_suggests_randomforestsrc r_suggests_ranger
	r_suggests_rappdirs r_suggests_refund r_suggests_rex
	r_suggests_rferns r_suggests_rgenoud r_suggests_rknn
	...
	r_suggests_rsnns r_suggests_rweka r_suggests_sda r_suggests_sf
	r_suggests_smoof r_suggests_sparselda r_suggests_stepplr
	r_suggests_survauc r_suggests_svglite r_suggests_swarmsvm
	r_suggests_testthat r_suggests_tgp r_suggests_th_data
	r_suggests_wavelets r_suggests_xgboost"
R_SUGGESTS="
