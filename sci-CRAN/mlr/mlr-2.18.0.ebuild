...
IUSE="${IUSE-} r_suggests_ada r_suggests_adabag r_suggests_batchtools
	...
	r_suggests_cmaes r_suggests_cowplot r_suggests_coxboost
	r_suggests_crs r_suggests_cubist r_suggests_deepnet
	r_suggests_dicekriging r_suggests_discriminer r_suggests_e1071
	r_suggests_earth r_suggests_elasticnet r_suggests_emoa
