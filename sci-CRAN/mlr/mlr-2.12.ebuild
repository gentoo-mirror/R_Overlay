...
SRC_URI="http://cran.r-project.org/src/contrib/mlr_2.12.tar.gz"
LICENSE='BSD-2'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_adabag r_suggests_bartmachine
	...
	r_suggests_evtree r_suggests_extratrees r_suggests_fda_usc
	r_suggests_fdboost r_suggests_fields r_suggests_flare r_suggests_fnn
	...
	r_suggests_hmisc r_suggests_ipred r_suggests_irace r_suggests_kernlab
	r_suggests_kknn r_suggests_klar r_suggests_knitr r_suggests_lagp
	r_suggests_liblinear r_suggests_lintr r_suggests_lqa r_suggests_mass
	...
	r_suggests_pmcmr r_suggests_randomforest r_suggests_randomforestsrc
	r_suggests_ranger r_suggests_refund r_suggests_rex r_suggests_rferns
	...
	r_suggests_sparselda r_suggests_stepplr r_suggests_survauc
	r_suggests_svglite r_suggests_swarmsvm r_suggests_testthat
	r_suggests_tgp r_suggests_th_data r_suggests_wavelets
	r_suggests_xgboost"
R_SUGGESTS="
