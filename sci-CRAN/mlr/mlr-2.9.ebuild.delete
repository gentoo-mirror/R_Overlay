...
SRC_URI="http://cran.r-project.org/src/contrib/mlr_2.9.tar.gz"
LICENSE='BSD-2'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_adabag r_suggests_bartmachine
	...
	r_suggests_gbm r_suggests_gensa r_suggests_glmnet r_suggests_gpfit
	r_suggests_h2o r_suggests_hmisc r_suggests_irace r_suggests_kernlab
	r_suggests_kknn r_suggests_klar r_suggests_knitr r_suggests_kohonen
	r_suggests_lagp r_suggests_liblinear r_suggests_lqa r_suggests_mass
	...
	r_suggests_rmarkdown r_suggests_robustbase r_suggests_rocr
	r_suggests_rotationforest r_suggests_rpart r_suggests_rrf
	r_suggests_rrlda r_suggests_rsm r_suggests_rsnns r_suggests_rweka
	r_suggests_sda r_suggests_smoof r_suggests_sparsediscrim
	r_suggests_sparselda r_suggests_stepplr r_suggests_svglite
	r_suggests_swarmsvm r_suggests_testthat r_suggests_tgp
	r_suggests_th_data r_suggests_xgboost r_suggests_xml"
R_SUGGESTS="
	...
	r_suggests_ranger? ( >=sci-CRAN/ranger-0.5.0 )
