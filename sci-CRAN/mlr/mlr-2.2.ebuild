...
SRC_URI="http://cran.r-project.org/src/contrib/mlr_2.2.tar.gz"
LICENSE='BSD'

IUSE="${IUSE-} r_suggests_ada r_suggests_adabag r_suggests_bartmachine
	r_suggests_care r_suggests_caret r_suggests_clue
	...
	r_suggests_mrmre r_suggests_party r_suggests_penalized r_suggests_pls
	...
	r_suggests_rrlda r_suggests_rsm r_suggests_rweka r_suggests_sda
	r_suggests_stepplr r_suggests_testthat"
R_SUGGESTS="
