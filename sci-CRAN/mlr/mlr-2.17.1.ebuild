...
SRC_URI="http://cran.r-project.org/src/contrib/mlr_2.17.1.tar.gz"
LICENSE='BSD-2'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_adabag r_suggests_batchtools
	...
	r_suggests_gpfit r_suggests_h2o r_suggests_hmisc
	r_suggests_hrbrthemes r_suggests_irace r_suggests_kernlab
