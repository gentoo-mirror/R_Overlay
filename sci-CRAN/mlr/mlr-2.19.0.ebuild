...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mlr_2.19.0.tar.gz"
LICENSE='BSD-2'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_adabag r_suggests_batchtools
	...
	r_suggests_elasticnet r_suggests_emoa r_suggests_evtree
	r_suggests_extratrees r_suggests_fda_usc r_suggests_fdboost
	r_suggests_fnn r_suggests_forecast r_suggests_fpc r_suggests_frbs
	...
	r_suggests_pamr r_suggests_pander r_suggests_party r_suggests_pec
	r_suggests_penalized r_suggests_pls r_suggests_pmcmrplus
	...
	r_suggests_rrlda r_suggests_rsm r_suggests_rsnns r_suggests_rucrdtw
	r_suggests_rweka r_suggests_sda r_suggests_sf r_suggests_smoof
	r_suggests_snow r_suggests_sparselda r_suggests_stepplr
	r_suggests_survauc r_suggests_svglite r_suggests_swarmsvm
	r_suggests_testthat r_suggests_tgp r_suggests_th_data
	r_suggests_tidyr r_suggests_tsfeatures r_suggests_vdiffr
	r_suggests_wavelets"
R_SUGGESTS="
...
_UNRESOLVED_PACKAGES=( '>=sci-CRAN/xgboost-0.7' )
