...
SRC_URI="http://cran.r-project.org/src/contrib/mlr_2.3.tar.gz"
LICENSE='BSD'

IUSE="${IUSE-} r_suggests_ada r_suggests_adabag r_suggests_bartmachine
	r_suggests_brnn r_suggests_care r_suggests_caret r_suggests_clue
	...
	r_suggests_e1071 r_suggests_earth r_suggests_elmnn r_suggests_emoa
	r_suggests_extratrees r_suggests_fnn r_suggests_fselector
	...
	r_suggests_kohonen r_suggests_lagp r_suggests_liblinear
	r_suggests_lqa r_suggests_mboost r_suggests_mco r_suggests_mda
	r_suggests_mlbench r_suggests_modeltools r_suggests_mrmre
	r_suggests_nodeharvest r_suggests_party r_suggests_penalized
	r_suggests_pls r_suggests_proc r_suggests_randomforest
	r_suggests_randomforestsrc r_suggests_randomuniformforest
	r_suggests_rcurl r_suggests_rjson r_suggests_robustbase
	r_suggests_rocr r_suggests_rrlda r_suggests_rsm r_suggests_rweka
	r_suggests_sda r_suggests_stepplr r_suggests_testthat r_suggests_tgp
	r_suggests_xgboost"
R_SUGGESTS="
	...
	r_suggests_randomuniformforest? ( sci-CRAN/randomUniformForest )
