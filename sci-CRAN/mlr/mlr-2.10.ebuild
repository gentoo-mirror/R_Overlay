...
SRC_URI="http://cran.r-project.org/src/contrib/mlr_2.10.tar.gz"
LICENSE='BSD-2'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_adabag r_suggests_bartmachine
	...
	r_suggests_rfast r_suggests_rferns r_suggests_rjson r_suggests_rknn
	...
	r_suggests_sda r_suggests_shiny r_suggests_smoof
