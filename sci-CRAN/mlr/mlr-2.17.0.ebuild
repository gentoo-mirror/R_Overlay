...
SRC_URI="http://cran.r-project.org/src/contrib/mlr_2.17.0.tar.gz"
LICENSE='BSD-2'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_adabag r_suggests_batchtools
	...
	r_suggests_h2o r_suggests_hmisc r_suggests_hrbrthemes
	r_suggests_irace r_suggests_kernlab r_suggests_kknn r_suggests_klar
	r_suggests_knitr r_suggests_lagp r_suggests_liblinear
	r_suggests_lintr r_suggests_mass r_suggests_mboost r_suggests_mco
	...
	r_suggests_th_data r_suggests_tsfeatures r_suggests_vdiffr
...
R_SUGGESTS="
	...
	r_suggests_class? ( virtual/class virtual/class )
