...
SRC_URI="http://cran.r-project.org/src/contrib/mlr_2.0.tar.gz"
LICENSE='BSD'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_adabag r_suggests_cmaes
	...
	r_suggests_klar r_suggests_liblinear r_suggests_mboost r_suggests_mda
	r_suggests_mlbench r_suggests_mrmre r_suggests_party
