...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mlr_2.19.1.tar.gz"
LICENSE='BSD-2'

IUSE="${IUSE-} r_suggests_ada r_suggests_adabag r_suggests_batchtools
	r_suggests_bit64 r_suggests_brnn r_suggests_bst r_suggests_c50
	r_suggests_care r_suggests_caret r_suggests_class r_suggests_clue
	r_suggests_cluster r_suggests_cmaes r_suggests_cowplot r_suggests_crs
	r_suggests_cubist r_suggests_deepnet r_suggests_dicekriging
	r_suggests_e1071 r_suggests_earth r_suggests_elasticnet
	r_suggests_emoa r_suggests_evtree r_suggests_fda_usc
	r_suggests_fdboost r_suggests_fnn r_suggests_forecast r_suggests_fpc
	r_suggests_frbs r_suggests_fselector r_suggests_fselectorrcpp
	r_suggests_gbm r_suggests_gensa r_suggests_ggpubr r_suggests_glmnet
	r_suggests_gpfit r_suggests_h2o r_suggests_hmisc r_suggests_irace
	r_suggests_kernlab r_suggests_kknn r_suggests_klar r_suggests_knitr
	r_suggests_lagp r_suggests_liblinear r_suggests_lintr r_suggests_mass
	...
	r_suggests_nnet r_suggests_numderiv r_suggests_pamr r_suggests_pander
	r_suggests_party r_suggests_pec r_suggests_penalized r_suggests_pls
	r_suggests_pmcmrplus r_suggests_praznik r_suggests_randomforest
	r_suggests_ranger r_suggests_rappdirs r_suggests_refund
	r_suggests_rex r_suggests_rferns r_suggests_rgenoud
	r_suggests_rmarkdown r_suggests_rmpi r_suggests_rocr
	r_suggests_rotationforest r_suggests_rpart r_suggests_rrf
	r_suggests_rsm r_suggests_rsnns r_suggests_rucrdtw r_suggests_rweka
	r_suggests_sda r_suggests_sf r_suggests_smoof r_suggests_sparselda
	...
	r_suggests_vdiffr r_suggests_wavelets r_suggests_xgboost"
R_SUGGESTS="
	...
	r_suggests_fselectorrcpp? ( >=sci-CRAN/FSelectorRcpp-0.3.5 )
	...
	r_suggests_xgboost? ( >=sci-CRAN/xgboost-0.7 )
"
