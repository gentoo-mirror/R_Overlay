...
SRC_URI="http://cran.r-project.org/src/contrib/expss_0.11.7.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_dt r_suggests_foreign r_suggests_fst
	r_suggests_ggplot2 r_suggests_htmltools r_suggests_knitr
	r_suggests_openxlsx r_suggests_repr r_suggests_rmarkdown
	r_suggests_testthat"
R_SUGGESTS="
