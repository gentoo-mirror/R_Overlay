...
SRC_URI="http://cran.r-project.org/src/contrib/CDMConnector_1.3.1.tar.gz"

IUSE="${IUSE-} r_suggests_bigrquery r_suggests_covr
	r_suggests_databaseconnector r_suggests_duckdb r_suggests_ggplot2
	r_suggests_knitr r_suggests_lubridate r_suggests_odbc r_suggests_pool
	r_suggests_rjava r_suggests_rmarkdown r_suggests_rpostgres
	r_suggests_rsqlite r_suggests_snakecase r_suggests_sqlrender
	r_suggests_testthat r_suggests_tibble r_suggests_visr"
R_SUGGESTS="
