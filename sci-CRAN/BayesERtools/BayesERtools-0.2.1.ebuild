...
SRC_URI="http://cran.r-project.org/src/contrib/BayesERtools_0.2.1.tar.gz"
LICENSE='Apache-2.0'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_digest r_suggests_ggforce
	...
	r_suggests_rsample r_suggests_rstan r_suggests_scales
	r_suggests_testthat r_suggests_xgxr r_suggests_yardstick"
R_SUGGESTS="
...
"
DEPEND=">=sci-CRAN/rstanemax-0.1.8
	sci-CRAN/rstanarm
	sci-CRAN/bayestestR
	>=dev-lang/R-4.1
	sci-CRAN/ggplot2
