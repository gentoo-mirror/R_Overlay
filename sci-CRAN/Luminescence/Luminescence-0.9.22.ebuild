...
SRC_URI="http://cran.r-project.org/src/contrib/Luminescence_0.9.22.tar.gz"
LICENSE='GPL-3'
...
"
DEPEND=">=sci-CRAN/DEoptim-2.2.8
	>=sci-CRAN/readxl-1.4.3
	>=sci-CRAN/bbmle-1.0.25
	>=sci-CRAN/httr-1.4.6
	>=sci-CRAN/XML-3.99.0.14
	>=dev-lang/R-4.1
	>=sci-CRAN/data_table-1.14.6.8
	>=sci-CRAN/lamW-2.1.2
	virtual/Matrix
...
RDEPEND="${DEPEND-}
	>=sci-CRAN/Rcpp-1.0.11
	>=sci-CRAN/RcppArmadillo-0.12.4.1.0
	${R_SUGGESTS-}
"
