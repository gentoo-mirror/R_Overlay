...
SRC_URI="http://cran.r-project.org/src/contrib/BioStatR_4.0.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_agricolae r_suggests_e1071 r_suggests_gdata
	...
	r_suggests_gridextra r_suggests_hcci r_suggests_hmisc
	r_suggests_lattice r_suggests_lmperm r_suggests_lmtest
	r_suggests_mass r_suggests_multcomp r_suggests_multcompview
	r_suggests_onetwosamples r_suggests_plyr r_suggests_qcc
	r_suggests_reshape r_suggests_sandwich r_suggests_scales
	r_suggests_teachingdemos r_suggests_vcd r_suggests_xlsx"
R_SUGGESTS="
