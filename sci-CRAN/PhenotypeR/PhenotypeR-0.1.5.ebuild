...
SRC_URI="http://cran.r-project.org/src/contrib/PhenotypeR_0.1.5.tar.gz"
...
IUSE="${IUSE-} r_suggests_bslib r_suggests_cdmconnector r_suggests_dbi
	...
	r_suggests_rpostgres r_suggests_scales r_suggests_shiny
	r_suggests_shinycssloaders r_suggests_shinywidgets
	r_suggests_sortable r_suggests_stringr r_suggests_testthat
	r_suggests_tidyr r_suggests_usethis r_suggests_visomopresults"
R_SUGGESTS="
