...
SRC_URI="http://cran.r-project.org/src/contrib/PhenotypeR_0.1.4.tar.gz"
...
"
DEPEND=">=sci-CRAN/OmopSketch-0.3.1
	sci-CRAN/purrr
	...
	>=sci-CRAN/CohortCharacteristics-0.5.1
	sci-CRAN/dplyr
	>=sci-CRAN/IncidencePrevalence-1.2.0
	>=sci-CRAN/omopgenerics-1.1.1
	sci-CRAN/rlang
	sci-CRAN/magrittr
"
