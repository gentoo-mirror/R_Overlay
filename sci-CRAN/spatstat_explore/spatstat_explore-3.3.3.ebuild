...
SRC_URI="http://cran.r-project.org/src/contrib/spatstat.explore_3.3-3.tar.gz"
LICENSE='GPL-2+'
...
"
DEPEND=">=sci-CRAN/spatstat_utils-3.1.0
	virtual/nlme
	>=dev-lang/R-3.5.0
	>=sci-CRAN/goftest-1.2.2
	virtual/Matrix
	>=sci-CRAN/spatstat_geom-3.3.2
	>=sci-CRAN/spatstat_random-3.3.1
