...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/spatstat.explore_3.1-0.tar.gz"
LICENSE='GPL-2+'
...
R_SUGGESTS="
	...
	r_suggests_spatstat? ( >=sci-CRAN/spatstat-3.0.3 )
	r_suggests_spatstat_model? ( >=sci-CRAN/spatstat_model-3.2.1 )
"
