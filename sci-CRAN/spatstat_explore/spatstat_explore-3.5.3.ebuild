...
SRC_URI="http://cran.r-project.org/src/contrib/spatstat.explore_3.5-3.tar.gz"
LICENSE='GPL-2+'
...
R_SUGGESTS="
	...
	r_suggests_spatstat? ( >=sci-CRAN/spatstat-3.4 )
	r_suggests_spatstat_model? ( >=sci-CRAN/spatstat_model-3.4 )
"
DEPEND="virtual/nlme
	>=dev-lang/R-3.5.0
	>=sci-CRAN/spatstat_geom-3.6
	>=sci-CRAN/spatstat_utils-3.2
	sci-CRAN/abind
	>=sci-CRAN/spatstat_random-3.4
	>=sci-CRAN/spatstat_univar-3.1.4
	>=sci-CRAN/spatstat_data-3.1.8
	virtual/Matrix
