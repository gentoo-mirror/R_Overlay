...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/httk_2.1.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_censregmod r_suggests_class r_suggests_colorspace
	...
	r_suggests_forcats r_suggests_ggally r_suggests_ggplot2
	r_suggests_ggrepel r_suggests_gmodels r_suggests_gplots
	r_suggests_gridextra r_suggests_knitr r_suggests_ks r_suggests_mass
	r_suggests_r_rsp r_suggests_rcolorbrewer r_suggests_reshape
