...
SRC_URI="http://cran.r-project.org/src/contrib/httk_2.5.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_colorspace r_suggests_cowplot r_suggests_dplyr
	r_suggests_envstats r_suggests_forcats r_suggests_ggrepel
	r_suggests_gmodels r_suggests_gplots r_suggests_gridextra
	r_suggests_knitr r_suggests_ks r_suggests_mass
