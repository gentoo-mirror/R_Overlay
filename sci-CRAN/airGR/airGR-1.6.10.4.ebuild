...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/airGR_1.6.10.4.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_caramel r_suggests_coda r_suggests_deoptim
	r_suggests_dplyr r_suggests_fme r_suggests_ggally r_suggests_ggmcmc
	r_suggests_ggplot2 r_suggests_hydropso r_suggests_imputets
	r_suggests_knitr r_suggests_rmalschains r_suggests_rmarkdown
	r_suggests_testthat"
R_SUGGESTS="
