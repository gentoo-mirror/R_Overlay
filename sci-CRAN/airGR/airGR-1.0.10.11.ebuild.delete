...
SRC_URI="http://cran.r-project.org/src/contrib/airGR_1.0.10.11.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_coda r_suggests_deoptim r_suggests_dplyr
	r_suggests_fme r_suggests_ggmcmc r_suggests_hydropso r_suggests_knitr
	r_suggests_rmalschains r_suggests_rmarkdown"
R_SUGGESTS="
