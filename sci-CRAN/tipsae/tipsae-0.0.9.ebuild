...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/tipsae_0.0.9.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bayesplot r_suggests_callr r_suggests_gridextra
	...
	r_suggests_shinybusy r_suggests_shinyfeedback r_suggests_shinyjs
	r_suggests_shinythemes r_suggests_shinywidgets r_suggests_spam
	r_suggests_spdep"
R_SUGGESTS="
