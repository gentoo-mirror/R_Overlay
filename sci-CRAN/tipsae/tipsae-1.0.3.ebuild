...
SRC_URI="http://cran.r-project.org/src/contrib/tipsae_1.0.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bayesplot r_suggests_callr r_suggests_dplyr
	r_suggests_dt r_suggests_gridextra r_suggests_leaflet r_suggests_loo
...
R_SUGGESTS="
	...
	r_suggests_dt? ( >=sci-CRAN/DT-0.32.1 )
