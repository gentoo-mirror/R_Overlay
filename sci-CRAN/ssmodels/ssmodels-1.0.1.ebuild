...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ssmodels_1.0.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ggplot2 r_suggests_gridextra r_suggests_kfigr
	r_suggests_knitr r_suggests_maxlik r_suggests_mvtnorm
	r_suggests_sampleselection r_suggests_testthat"
R_SUGGESTS="
