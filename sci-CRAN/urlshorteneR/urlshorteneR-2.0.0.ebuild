...
SRC_URI="http://cran.r-project.org/src/contrib/urlshorteneR_2.0.0.tar.gz"
LICENSE='Apache-2.0'

IUSE="${IUSE-} r_suggests_covr r_suggests_dotenv r_suggests_httpuv
...
R_SUGGESTS="
	...
	r_suggests_dotenv? ( >=sci-CRAN/dotenv-1.0.3 )
	...
	r_suggests_stringi? ( >=sci-CRAN/stringi-1.8.7 )
