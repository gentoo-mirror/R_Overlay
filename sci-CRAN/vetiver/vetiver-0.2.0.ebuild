...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/vetiver_0.2.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_arrow r_suggests_callr r_suggests_caret
	...
	r_suggests_mlr3data r_suggests_mlr3learners r_suggests_modeldata
	r_suggests_parsnip r_suggests_pingr r_suggests_plotly
	r_suggests_ranger r_suggests_recipes r_suggests_rmarkdown
	r_suggests_rpart r_suggests_rsconnect r_suggests_slider
