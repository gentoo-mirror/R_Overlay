...
SRC_URI="http://cran.r-project.org/src/contrib/cucumber_2.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_box r_suggests_chromote r_suggests_covr
	r_suggests_knitr r_suggests_mockery r_suggests_pkgdown
	r_suggests_pkgload r_suggests_r6 r_suggests_rmarkdown
