...
SRC_URI="http://cran.r-project.org/src/contrib/DBItest_1.8.0.tar.gz"
LICENSE='LGPL-2.1+'

IUSE="${IUSE-} r_suggests_clipr r_suggests_constructive r_suggests_debugme
	r_suggests_devtools r_suggests_dplyr r_suggests_knitr
	r_suggests_lintr r_suggests_pkgload r_suggests_rmarkdown
	r_suggests_rsqlite"
R_SUGGESTS="
