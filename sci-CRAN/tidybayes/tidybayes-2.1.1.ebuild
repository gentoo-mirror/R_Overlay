...
SRC_URI="http://cran.r-project.org/src/contrib/tidybayes_2.1.1.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_bayesplot r_suggests_bindrcpp r_suggests_broom
	...
	r_suggests_ggrepel r_suggests_gifski r_suggests_jagsui
	r_suggests_knitr r_suggests_mcmcglmm r_suggests_modelr
	r_suggests_pkgdown r_suggests_png r_suggests_rcolorbrewer
