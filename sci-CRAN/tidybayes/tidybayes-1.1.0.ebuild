...
SRC_URI="http://cran.r-project.org/src/contrib/tidybayes_1.1.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_bayesplot r_suggests_bindrcpp r_suggests_brms
	...
	r_suggests_gganimate r_suggests_ggrepel r_suggests_ggridges
...
R_SUGGESTS="
	...
	r_suggests_brms? ( >=sci-CRAN/brms-2.9.0 )
	...
	r_suggests_rstanarm? ( >=sci-CRAN/rstanarm-2.18.2 )
