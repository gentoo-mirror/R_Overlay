...
SRC_URI="http://cran.r-project.org/src/contrib/tidybayes_2.0.2.tar.gz"
LICENSE='GPL-3+'
...
R_SUGGESTS="
	...
	r_suggests_ggstance? ( >=sci-CRAN/ggstance-0.3.2 )
