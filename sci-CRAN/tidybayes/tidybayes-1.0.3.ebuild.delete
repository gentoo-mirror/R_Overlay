...
SRC_URI="http://cran.r-project.org/src/contrib/tidybayes_1.0.3.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_bayesplot r_suggests_bindrcpp r_suggests_brms
	...
	r_suggests_rstantools r_suggests_runjags r_suggests_svglite
	r_suggests_testthat r_suggests_vdiffr"
R_SUGGESTS="
	r_suggests_bayesplot? ( sci-CRAN/bayesplot )
	r_suggests_bindrcpp? ( sci-CRAN/bindrcpp )
	r_suggests_brms? ( >=sci-CRAN/brms-2.4.3 )
