...
SRC_URI="http://cran.r-project.org/src/contrib/tidybayes_3.0.6.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_bayesplot r_suggests_bindrcpp r_suggests_brms
	r_suggests_broom r_suggests_covr r_suggests_cowplot
	r_suggests_distributional r_suggests_dotwhisker r_suggests_emmeans
	r_suggests_forcats r_suggests_gganimate r_suggests_ggrepel
