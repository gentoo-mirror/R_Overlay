...
SRC_URI="http://cran.r-project.org/src/contrib/tidybayes_3.0.7.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_bayesplot r_suggests_bindrcpp r_suggests_brms
	r_suggests_broom r_suggests_covr r_suggests_cowplot
	r_suggests_distributional r_suggests_emmeans r_suggests_forcats
	r_suggests_gganimate r_suggests_ggrepel r_suggests_jagsui
	r_suggests_knitr r_suggests_mcmcglmm r_suggests_modelr
	r_suggests_pkgdown r_suggests_png r_suggests_purrr r_suggests_ragg
...
R_SUGGESTS="
	...
	r_suggests_brms? ( >=sci-CRAN/brms-2.16.0 )
	...
	r_suggests_rstanarm? ( >=sci-CRAN/rstanarm-2.19.2 )
