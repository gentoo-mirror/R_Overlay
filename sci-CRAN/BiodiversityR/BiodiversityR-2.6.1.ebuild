...
IUSE="${IUSE-} r_suggests_akima r_suggests_bootstrap r_suggests_car
	...
	r_suggests_ellipse r_suggests_gam r_suggests_gbm r_suggests_geosphere
	r_suggests_kernlab r_suggests_maptree r_suggests_mda
	r_suggests_multcomp r_suggests_permute r_suggests_presenceabsence
	r_suggests_r[-minimal] r_suggests_randomforest r_suggests_raster
...
R_SUGGESTS="
	...
	r_suggests_r[-minimal]? ( dev-lang/R[-minimal] dev-lang/R[-minimal] dev-lang/R[-minimal] dev-lang/R[-minimal] dev-lang/R[-minimal] dev-lang/R[-minimal] dev-lang/R[-minimal] )
