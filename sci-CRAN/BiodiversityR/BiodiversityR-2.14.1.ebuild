...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/BiodiversityR_2.14-1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_akima r_suggests_blockcv r_suggests_boot
	...
	r_suggests_maptools r_suggests_mass r_suggests_maxlike
	r_suggests_maxnet r_suggests_mda r_suggests_mgcv r_suggests_multcomp
	r_suggests_nnet r_suggests_party r_suggests_permute
	r_suggests_presenceabsence r_suggests_randomforest r_suggests_readxl
	r_suggests_rgeos r_suggests_rgl r_suggests_rlang r_suggests_rlof
