...
SRC_URI="http://cran.r-project.org/src/contrib/BiodiversityR_2.8-0.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_akima r_suggests_bootstrap r_suggests_car
	...
	r_suggests_effects r_suggests_ellipse r_suggests_gam r_suggests_gbm
	r_suggests_geosphere r_suggests_glmnet r_suggests_kernlab
	r_suggests_lattice r_suggests_maptools r_suggests_maptree
	r_suggests_mass r_suggests_maxlike r_suggests_mda r_suggests_mgcv
	r_suggests_multcomp r_suggests_nnet r_suggests_permute
	r_suggests_presenceabsence r_suggests_randomforest r_suggests_raster
	r_suggests_rgdal r_suggests_rpart r_suggests_sp r_suggests_spatial
	r_suggests_splancs"
R_SUGGESTS="
