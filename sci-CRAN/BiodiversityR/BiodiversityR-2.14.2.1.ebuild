...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/BiodiversityR_2.14-2.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_blockcv r_suggests_boot r_suggests_car
	...
	r_suggests_igraph r_suggests_interp r_suggests_kernlab
	r_suggests_lattice r_suggests_maptools r_suggests_mass
