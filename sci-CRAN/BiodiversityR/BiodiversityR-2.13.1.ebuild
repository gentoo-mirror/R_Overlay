...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/BiodiversityR_2.13-1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_akima r_suggests_blockcv r_suggests_boot
	...
	r_suggests_raster r_suggests_readxl r_suggests_rgeos r_suggests_rgl
	r_suggests_rlang r_suggests_rlof r_suggests_rodbc r_suggests_rpart
	r_suggests_sf r_suggests_sp r_suggests_spatial r_suggests_splancs
	r_suggests_vegan3d"
R_SUGGESTS="
