...
DESCRIPTION='GUI for biodiversity, suitabilit... (see metadata)'
SRC_URI="http://cran.r-project.org/src/contrib/BiodiversityR_2.4-1.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_akima r_suggests_car r_suggests_dismo
	...
	r_suggests_rgdal r_suggests_sp r_suggests_splancs r_suggests_vegan"
R_SUGGESTS="
	...
	r_suggests_vegan? ( >=sci-CRAN/vegan-1.17.12 )
"
DEPEND=">=dev-lang/R-3.0.0
	>=sci-CRAN/Rcmdr-1.9.4
"
