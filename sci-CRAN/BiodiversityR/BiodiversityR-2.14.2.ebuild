...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/BiodiversityR_2.14-2.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_akima r_suggests_blockcv r_suggests_boot
	r_suggests_car r_suggests_cluster r_suggests_colorspace
	r_suggests_concaveman r_suggests_dismo r_suggests_dplyr
	r_suggests_e1071 r_suggests_earth r_suggests_effects
