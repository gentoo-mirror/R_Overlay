...
SRC_URI="http://cran.r-project.org/src/contrib/BiodiversityR_2.17-3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_boot r_suggests_car r_suggests_cluster
	r_suggests_colorspace r_suggests_concaveman r_suggests_dismo
	r_suggests_dplyr r_suggests_e1071 r_suggests_earth r_suggests_effects
	r_suggests_ellipse r_suggests_enmeval r_suggests_envirem
	...
	r_suggests_permute r_suggests_presenceabsence r_suggests_pvclust
	r_suggests_randomforest r_suggests_raster r_suggests_readxl
	r_suggests_red r_suggests_rgl r_suggests_rlang r_suggests_rlof
	r_suggests_rodbc r_suggests_rpart r_suggests_sf r_suggests_sp
	r_suggests_spatial r_suggests_terra r_suggests_vegan3d"
R_SUGGESTS="
	...
	r_suggests_raster? ( >=sci-CRAN/raster-3.6.11 )
	...
	r_suggests_terra? ( >=sci-CRAN/terra-1.6.47 )
