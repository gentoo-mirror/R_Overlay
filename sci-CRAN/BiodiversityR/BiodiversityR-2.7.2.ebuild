...
SRC_URI="http://cran.r-project.org/src/contrib/BiodiversityR_2.7-2.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_akima r_suggests_bootstrap r_suggests_car
	...
	r_suggests_geosphere r_suggests_kernlab r_suggests_lattice
	r_suggests_maptree r_suggests_mass r_suggests_mda r_suggests_mgcv
