...
SRC_URI="http://cran.r-project.org/src/contrib/BiodiversityR_2.17-1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_blockcv r_suggests_boot r_suggests_car
	...
	r_suggests_envirem r_suggests_gam r_suggests_gbm r_suggests_geosphere
	r_suggests_glmnet r_suggests_igraph r_suggests_kernlab
	r_suggests_lattice r_suggests_mass r_suggests_maxlike
	r_suggests_maxnet r_suggests_mda r_suggests_mgcv r_suggests_multcomp
	r_suggests_nnet r_suggests_party r_suggests_permute
	r_suggests_presenceabsence r_suggests_pvclust r_suggests_randomforest
	r_suggests_readxl r_suggests_red r_suggests_rgl r_suggests_rlang
	r_suggests_rlof r_suggests_rodbc r_suggests_rpart r_suggests_sf
	r_suggests_sp r_suggests_spatial r_suggests_splancs
	r_suggests_vegan3d"
R_SUGGESTS="
	...
	r_suggests_envirem? ( >=sci-CRAN/envirem-3.0 )
