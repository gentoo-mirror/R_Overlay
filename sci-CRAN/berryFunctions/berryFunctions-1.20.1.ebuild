...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/berryFunctions_1.20.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ade4 r_suggests_colorspace r_suggests_gstat
	r_suggests_knitr r_suggests_pbapply r_suggests_rcolorbrewer
	r_suggests_rcurl r_suggests_rmarkdown r_suggests_spatstat_geom
