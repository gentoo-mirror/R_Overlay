...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/brokenstick_1.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_agd r_suggests_ggplot2 r_suggests_gridextra
	r_suggests_knitr r_suggests_lattice r_suggests_mass r_suggests_matrix
	r_suggests_mice r_suggests_mvtnorm r_suggests_plyr
