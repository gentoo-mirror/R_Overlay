...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/rSPDE_2.3.2.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_doparallel r_suggests_foreach r_suggests_ggplot2
	r_suggests_inlabru r_suggests_lattice r_suggests_numderiv
	r_suggests_optimparallel r_suggests_r_rsp r_suggests_rmarkdown
	r_suggests_rspectra r_suggests_scoringrules r_suggests_sn
