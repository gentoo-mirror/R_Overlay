...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/seqhandbook_0.1.1.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_ade4 r_suggests_cluster r_suggests_descriptio
	...
	r_suggests_knitr r_suggests_purrr r_suggests_questionr
	r_suggests_r_rsp r_suggests_rcolorbrewer r_suggests_rmarkdown
