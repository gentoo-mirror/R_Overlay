...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ecospat_3.5.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_alphahull r_suggests_dplyr r_suggests_igraph
	...
	r_suggests_snowfall r_suggests_terra r_suggests_xml"
R_SUGGESTS="
	...
	r_suggests_terra? ( >=sci-CRAN/terra-1.2.5 )
	r_suggests_xml? ( >=sci-CRAN/XML-3.98.1.1 )
"
DEPEND=">=sci-CRAN/poibin-1.3
	>=sci-CRAN/ks-1.12.0
