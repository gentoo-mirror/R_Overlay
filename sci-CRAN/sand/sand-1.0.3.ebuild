...
SRC_URI="http://cran.r-project.org/src/contrib/sand_1.0.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_ape r_suggests_car r_suggests_eigenmodel
	r_suggests_ergm r_suggests_fdrtool r_suggests_ggplot2
	r_suggests_go_db r_suggests_gostats r_suggests_huge
	r_suggests_kernlab r_suggests_lattice r_suggests_mixer
	r_suggests_network r_suggests_networkdynamic
	r_suggests_networktomography r_suggests_ngspatial
	r_suggests_org_sc_sgd_db r_suggests_rocr r_suggests_sna
	r_suggests_vioplot"
R_SUGGESTS="
