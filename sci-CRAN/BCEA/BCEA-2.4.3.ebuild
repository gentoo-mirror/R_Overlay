...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/BCEA_2.4.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_coda r_suggests_knitr r_suggests_markdown
	r_suggests_mcmcvis r_suggests_mgcv r_suggests_plotly
	r_suggests_rcolorbrewer r_suggests_rjags r_suggests_rmarkdown
	r_suggests_rstan r_suggests_splancs r_suggests_testthat
