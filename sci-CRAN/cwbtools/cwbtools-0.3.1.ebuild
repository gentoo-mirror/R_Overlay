...
SRC_URI="http://cran.r-project.org/src/contrib/cwbtools_0.3.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_devtools r_suggests_janeaustenr r_suggests_knitr
	r_suggests_nlp r_suggests_rmarkdown r_suggests_snowballc
	r_suggests_testthat r_suggests_tidytext r_suggests_tm
	r_suggests_tokenizers r_suggests_usethis"
R_SUGGESTS="
