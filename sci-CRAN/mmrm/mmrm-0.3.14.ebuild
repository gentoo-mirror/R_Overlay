...
SRC_URI="http://cran.r-project.org/src/contrib/mmrm_0.3.14.tar.gz"
LICENSE='Apache-2.0'

IUSE="${IUSE-} r_suggests_broom_helpers r_suggests_car r_suggests_cli
	r_suggests_clubsandwich r_suggests_cluster r_suggests_dplyr
	r_suggests_emmeans r_suggests_estimability r_suggests_ggplot2
	r_suggests_glmmtmb r_suggests_hardhat r_suggests_knitr
	r_suggests_lme4 r_suggests_mass r_suggests_mockery
	r_suggests_parallelly r_suggests_parsnip r_suggests_purrr
	r_suggests_rmarkdown r_suggests_sasr r_suggests_scales
	r_suggests_testthat r_suggests_tidymodels r_suggests_withr
	r_suggests_xml2"
R_SUGGESTS="
