...
SRC_URI="http://cran.r-project.org/src/contrib/PortfolioAnalytics_1.0.3636.tar.gz -> cran_PortfolioAnalytics_1.0.3636.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_corpcor r_suggests_deoptim r_suggests_fgarch
	r_suggests_gensa r_suggests_iterators r_suggests_nloptr
	r_suggests_pso r_suggests_quadprog r_suggests_quantmod
	r_suggests_rglpk r_suggests_robustbase r_suggests_roi
	r_suggests_testthat"
R_SUGGESTS="
