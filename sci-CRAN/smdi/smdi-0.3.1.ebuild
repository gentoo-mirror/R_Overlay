...
SRC_URI="http://cran.r-project.org/src/contrib/smdi_0.3.1.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_broom_helpers r_suggests_cardx
	...
	r_suggests_rmarkdown r_suggests_simsurv r_suggests_smd
	r_suggests_survminer r_suggests_testthat r_suggests_usethis
	r_suggests_vdiffr"
R_SUGGESTS="
