...
SRC_URI="http://cran.r-project.org/src/contrib/recipes_0.1.10.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_ddalpha r_suggests_dimred
	...
	r_suggests_pls r_suggests_rann r_suggests_rcpproll
	r_suggests_rmarkdown r_suggests_rpart r_suggests_rsample
	r_suggests_rspectra r_suggests_testthat r_suggests_xml2"
R_SUGGESTS="
