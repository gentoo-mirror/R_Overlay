...
SRC_URI="http://cran.r-project.org/src/contrib/topics_0.60.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_glmnet r_suggests_knitr
	r_suggests_rjava r_suggests_rmarkdown r_suggests_testthat
	r_suggests_text r_suggests_vdiffr"
R_SUGGESTS="
