...
SRC_URI="http://cran.r-project.org/src/contrib/redist_4.3.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_coda r_suggests_ggpattern r_suggests_knitr
	r_suggests_loo r_suggests_matrix r_suggests_rmapshaper
...
R_SUGGESTS="
	...
	r_suggests_rmapshaper? ( sci-CRAN/rmapshaper )
