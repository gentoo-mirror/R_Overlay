...
SRC_URI="http://cran.r-project.org/src/contrib/matrixpls_0.5.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_plspm r_suggests_rgcca r_suggests_runit
