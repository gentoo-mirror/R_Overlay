...
SRC_URI="http://cran.r-project.org/src/contrib/gt_1.0.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_fontawesome r_suggests_ggplot2 r_suggests_gtable
	r_suggests_katex r_suggests_knitr r_suggests_lubridate
	r_suggests_magick r_suggests_paletteer r_suggests_rcolorbrewer
