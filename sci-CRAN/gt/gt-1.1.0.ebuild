...
SRC_URI="http://cran.r-project.org/src/contrib/gt_1.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_farver r_suggests_fontawesome r_suggests_ggplot2
	r_suggests_gtable r_suggests_katex r_suggests_knitr
	r_suggests_lubridate r_suggests_magick r_suggests_paletteer
...
R_SUGGESTS="
	...
	r_suggests_fontawesome? ( >=sci-CRAN/fontawesome-0.5.2 )
	r_suggests_ggplot2? ( sci-CRAN/ggplot2 )
	r_suggests_gtable? ( >=sci-CRAN/gtable-0.3.6 )
	r_suggests_katex? ( >=sci-CRAN/katex-1.4.1 )
	...
	r_suggests_shiny? ( >=sci-CRAN/shiny-1.9.1 )
