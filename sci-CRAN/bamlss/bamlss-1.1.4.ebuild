...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/bamlss_1.1-4.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'
...
IUSE="${IUSE-} r_suggests_akima r_suggests_bayesx r_suggests_bayesxsrc
	...
	r_suggests_gamlss r_suggests_gamlss_dist r_suggests_geor
	r_suggests_glmnet r_suggests_glogis r_suggests_knitr
	r_suggests_mapdata r_suggests_maps r_suggests_maptools
	r_suggests_mass r_suggests_nnet r_suggests_r2bayesx r_suggests_rjags
