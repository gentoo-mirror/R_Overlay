...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/quanteda_3.3.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_dplyr r_suggests_formatr r_suggests_ggplot2
	r_suggests_knitr r_suggests_lda r_suggests_lsa r_suggests_purrr
	r_suggests_quanteda_textmodels r_suggests_quanteda_textplots
	r_suggests_quanteda_textstats r_suggests_rcolorbrewer
	r_suggests_rmarkdown r_suggests_slam r_suggests_spacyr
	r_suggests_spelling r_suggests_stm r_suggests_testthat
	r_suggests_text2vec r_suggests_tibble r_suggests_tidytext
	r_suggests_tm r_suggests_tokenizers r_suggests_topicmodels
	r_suggests_xtable"
R_SUGGESTS="
