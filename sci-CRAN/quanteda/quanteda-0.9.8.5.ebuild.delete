...
SRC_URI="http://cran.r-project.org/src/contrib/quanteda_0.9.8.5.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_ggplot2 r_suggests_jsonlite r_suggests_knitr
	r_suggests_lda r_suggests_rcolorbrewer r_suggests_rmarkdown
	r_suggests_slam r_suggests_streamr r_suggests_testthat r_suggests_tm
