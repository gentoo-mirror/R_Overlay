...
SRC_URI="http://cran.r-project.org/src/contrib/DatabionicSwarm_1.1.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_abcanalysis r_suggests_adaptgauss
	r_suggests_cluster r_suggests_datavisualizations r_suggests_geometry
	r_suggests_knitr r_suggests_matrix r_suggests_plotrix r_suggests_png
	r_suggests_pracma r_suggests_rgl r_suggests_rglwidget
	r_suggests_rmarkdown r_suggests_sp r_suggests_spdep"
R_SUGGESTS="
