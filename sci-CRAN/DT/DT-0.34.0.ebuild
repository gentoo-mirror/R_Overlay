...
SRC_URI="http://cran.r-project.org/src/contrib/DT_0.34.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bslib r_suggests_future r_suggests_httpuv
	r_suggests_knitr r_suggests_rmarkdown r_suggests_shiny
	r_suggests_testit r_suggests_tibble"
R_SUGGESTS="
