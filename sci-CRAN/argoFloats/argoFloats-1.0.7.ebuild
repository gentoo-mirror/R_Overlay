...
SRC_URI="http://cran.r-project.org/src/contrib/argoFloats_1.0.7.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_colourpicker r_suggests_curl r_suggests_knitr
	r_suggests_lubridate r_suggests_markdown r_suggests_ncdf4
	r_suggests_ocedata r_suggests_rmarkdown r_suggests_s2 r_suggests_sf
