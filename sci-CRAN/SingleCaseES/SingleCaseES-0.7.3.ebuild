...
SRC_URI="http://cran.r-project.org/src/contrib/SingleCaseES_0.7.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_cleanrmd r_suggests_covr r_suggests_ggplot2
	r_suggests_glue r_suggests_janitor r_suggests_kableextra
	r_suggests_kendall r_suggests_knitr r_suggests_markdown
	r_suggests_purrrlyr r_suggests_rclipboard r_suggests_readxl
