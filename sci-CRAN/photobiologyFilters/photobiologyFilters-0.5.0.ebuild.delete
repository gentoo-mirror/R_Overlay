...
DESCRIPTION='Spectral Transmittance Data for Filters'
SRC_URI="http://cran.r-project.org/src/contrib/photobiologyFilters_0.5.0.tar.gz"
LICENSE='GPL-2+'
...
_UNRESOLVED_PACKAGES=( '>=sci-CRAN/ggspectra-0.3.4' )
