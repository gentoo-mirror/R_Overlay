...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/RMixtComp_4.1.3.tar.gz"
LICENSE='AGPL-3'

IUSE="${IUSE-} r_suggests_cluster r_suggests_clusvis r_suggests_knitr
	r_suggests_rmarkdown r_suggests_rmixmod r_suggests_testthat
	r_suggests_xml2"
R_SUGGESTS="
...
DEPEND=">=sci-CRAN/RMixtCompIO-4.0.4
	>=sci-CRAN/RMixtCompUtilities-4.1.4
	sci-CRAN/plotly
	sci-CRAN/ggplot2
	sci-CRAN/scales
"
