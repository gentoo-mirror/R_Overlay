...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mark_0.1.4.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bench r_suggests_bib2df r_suggests_crayon
	r_suggests_desc r_suggests_dplyr r_suggests_knitr
	r_suggests_rcmdcheck r_suggests_spelling r_suggests_stringi
