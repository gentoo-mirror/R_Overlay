...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mark_0.5.3.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bench r_suggests_bib2df r_suggests_covr
	r_suggests_crayon r_suggests_desc r_suggests_dplyr r_suggests_haven
	r_suggests_knitr r_suggests_rcmdcheck r_suggests_spelling
...
R_SUGGESTS="
	...
	r_suggests_desc? ( >=sci-CRAN/desc-1.3.0 )
	...
	r_suggests_waldo? ( >=sci-CRAN/waldo-0.2.5 )
