...
SRC_URI="http://cran.r-project.org/src/contrib/ChemometricsWithR_0.1.9.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_als r_suggests_dtw r_suggests_e1071
	...
	r_suggests_lars r_suggests_leaps r_suggests_mclust r_suggests_ptw
	r_suggests_randomforest r_suggests_rda r_suggests_rrcov
	r_suggests_sfsmisc r_suggests_signal r_suggests_subselect
	r_suggests_timp"
R_SUGGESTS="
