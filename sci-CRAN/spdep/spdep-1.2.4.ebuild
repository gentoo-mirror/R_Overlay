...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/spdep_1.2-4.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_class r_suggests_dbscan r_suggests_foreign
	r_suggests_ggplot2 r_suggests_igraph r_suggests_knitr
	r_suggests_lattice r_suggests_maptools r_suggests_matrix
	r_suggests_rcolorbrewer r_suggests_rgeoda r_suggests_rgeos
	r_suggests_rmarkdown r_suggests_rspectra r_suggests_spam
	r_suggests_spatial r_suggests_tinytest r_suggests_tmap
	r_suggests_xtable"
R_SUGGESTS="
