...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/butcher_0.2.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_c50 r_suggests_caret r_suggests_clisymbols
	...
	r_suggests_e1071 r_suggests_earth r_suggests_flexsurv r_suggests_fs
	r_suggests_ipred r_suggests_kernlab r_suggests_kknn r_suggests_knitr
	r_suggests_mass r_suggests_mda r_suggests_modeldata r_suggests_nnet
	...
	r_suggests_usethis r_suggests_xgboost"
R_SUGGESTS="
