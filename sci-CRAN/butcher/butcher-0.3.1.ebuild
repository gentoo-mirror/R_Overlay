...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/butcher_0.3.1.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_c50 r_suggests_caret r_suggests_clisymbols
	...
	r_suggests_ddalpha r_suggests_dimred r_suggests_dplyr
	...
	r_suggests_mass r_suggests_mda r_suggests_mgcv r_suggests_modeldata
	r_suggests_nnet r_suggests_parsnip r_suggests_pkgload r_suggests_pls
