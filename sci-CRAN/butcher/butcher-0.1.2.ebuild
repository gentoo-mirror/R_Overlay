...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/butcher_0.1.2.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_c50 r_suggests_caret r_suggests_clisymbols
	...
	r_suggests_nmf r_suggests_nnet r_suggests_parsnip r_suggests_pkgload
	r_suggests_pls r_suggests_qsardata r_suggests_randomforest
	r_suggests_ranger r_suggests_rann r_suggests_recipes
	r_suggests_rmarkdown r_suggests_rpart r_suggests_rsample
	r_suggests_rspectra r_suggests_survival r_suggests_testthat
	r_suggests_th_data"
R_SUGGESTS="
