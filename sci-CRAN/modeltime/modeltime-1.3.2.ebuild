...
SRC_URI="http://cran.r-project.org/src/contrib/modeltime_1.3.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_dofuture r_suggests_earth r_suggests_future
	r_suggests_glmnet r_suggests_kernlab r_suggests_knitr
	r_suggests_lubridate r_suggests_qpdf r_suggests_randomforest
	r_suggests_recipes r_suggests_rmarkdown r_suggests_rsample
	r_suggests_rstan r_suggests_slider r_suggests_testthat
	r_suggests_thief r_suggests_tsrepr r_suggests_tune
...
"
DEPEND=">=sci-CRAN/yardstick-0.0.8
	sci-CRAN/scales
	sci-CRAN/foreach
	sci-CRAN/tibble
	sci-CRAN/purrr
