...
SRC_URI="http://cran.r-project.org/src/contrib/dynamichazard_0.1.0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_biglm r_suggests_captioner r_suggests_formatr
	r_suggests_httr r_suggests_knitr r_suggests_mgcv r_suggests_rmarkdown
	r_suggests_shiny r_suggests_testthat r_suggests_timereg"
R_SUGGESTS="
