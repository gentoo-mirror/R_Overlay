...
SRC_URI="http://cran.r-project.org/src/contrib/easystats_0.7.3.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_dharma r_suggests_dt r_suggests_flexdashboard
	r_suggests_glmmtmb r_suggests_httr r_suggests_jsonlite
	r_suggests_knitr r_suggests_mockery r_suggests_pak
