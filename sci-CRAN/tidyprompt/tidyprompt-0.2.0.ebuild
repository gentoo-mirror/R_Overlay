...
SRC_URI="http://cran.r-project.org/src/contrib/tidyprompt_0.2.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_callr r_suggests_dbi r_suggests_ellmer
	r_suggests_here r_suggests_jsonvalidate r_suggests_knitr
	r_suggests_mcptools r_suggests_rmarkdown r_suggests_skimr
	r_suggests_testthat r_suggests_tidyjson"
R_SUGGESTS="
	r_suggests_callr? ( sci-CRAN/callr )
	r_suggests_dbi? ( sci-CRAN/DBI )
	r_suggests_ellmer? ( >=sci-CRAN/ellmer-0.3.0 )
	r_suggests_here? ( sci-CRAN/here )
	r_suggests_jsonvalidate? ( sci-CRAN/jsonvalidate )
	r_suggests_knitr? ( sci-CRAN/knitr )
	r_suggests_mcptools? ( sci-CRAN/mcptools )
