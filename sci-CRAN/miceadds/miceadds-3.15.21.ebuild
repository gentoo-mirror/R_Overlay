...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/miceadds_3.15-21.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_bifiesurvey r_suggests_blme r_suggests_car
	...
	r_suggests_lme4 r_suggests_mass r_suggests_mbess r_suggests_mcmcglmm
	r_suggests_mdmb r_suggests_numderiv r_suggests_pls r_suggests_readxl
	r_suggests_sandwich r_suggests_sirt r_suggests_sjlabelled
	r_suggests_synthpop r_suggests_tam"
R_SUGGESTS="
