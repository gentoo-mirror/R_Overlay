...
SRC_URI="http://cran.r-project.org/src/contrib/evaluator_0.3.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_dt r_suggests_envstats
	...
	r_suggests_psych r_suggests_purrrlyr r_suggests_rmarkdown
	r_suggests_shiny r_suggests_statip r_suggests_testthat"
R_SUGGESTS="
