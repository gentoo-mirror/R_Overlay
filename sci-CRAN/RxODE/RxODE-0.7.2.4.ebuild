...
SRC_URI="http://cran.r-project.org/src/contrib/RxODE_0.7.2-4.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_curl r_suggests_devtools
	...
	r_suggests_nlme r_suggests_r[tk] r_suggests_rmarkdown
	r_suggests_rsympy r_suggests_scales r_suggests_shiny
