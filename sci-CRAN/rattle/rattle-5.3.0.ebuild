...
SRC_URI="http://cran.r-project.org/src/contrib/rattle_5.3.0.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_amap r_suggests_arules
	...
	r_suggests_reshape r_suggests_rggobi r_suggests_rgtk2 r_suggests_rocr
	r_suggests_rodbc r_suggests_rpart r_suggests_scales
