...
SRC_URI="http://cran.r-project.org/src/contrib/rattle_5.1.0.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_amap r_suggests_arules
	...
	r_suggests_gtools r_suggests_gwidgetsrgtk2 r_suggests_hmeasure
	r_suggests_hmisc r_suggests_kernlab r_suggests_matrix r_suggests_mice
	r_suggests_nnet r_suggests_odfweave r_suggests_party
	...
	r_suggests_rggobi r_suggests_rgtk2extras r_suggests_rocr
	r_suggests_rpart r_suggests_snowballc r_suggests_survival
	r_suggests_timedate r_suggests_tm r_suggests_verification
	r_suggests_wskm r_suggests_xgboost"
R_SUGGESTS="
