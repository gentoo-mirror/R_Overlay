...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/rattle_5.5.1.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_amap r_suggests_arules
	...
	r_suggests_fpc r_suggests_gdata r_suggests_ggdendro r_suggests_gplots
	r_suggests_gridextra r_suggests_gtools r_suggests_hmisc
	r_suggests_janitor r_suggests_kernlab r_suggests_matrix
	r_suggests_mice r_suggests_nnet r_suggests_party r_suggests_plyr
	r_suggests_pmml r_suggests_psych r_suggests_randomforest
	r_suggests_rcolorbrewer r_suggests_readxl r_suggests_reshape
	r_suggests_rgtk2 r_suggests_rocr r_suggests_rodbc r_suggests_rpart
	r_suggests_scales r_suggests_snowballc r_suggests_survival
	r_suggests_timedate r_suggests_tm r_suggests_xgboost"
R_SUGGESTS="
