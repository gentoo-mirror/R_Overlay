...
SRC_URI="http://cran.r-project.org/src/contrib/rattle_4.1.0.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_amap r_suggests_arules
	...
	r_suggests_doby r_suggests_dplyr r_suggests_e1071 r_suggests_ellipse
	r_suggests_fbasics r_suggests_foreign r_suggests_fpc r_suggests_gdata
	r_suggests_ggdendro r_suggests_ggplot2 r_suggests_gplots
	r_suggests_graph r_suggests_gridextra r_suggests_gtools
	...
	r_suggests_rgtk2extras r_suggests_rocr r_suggests_rpart
	r_suggests_rpart_plot r_suggests_snowballc r_suggests_stringr
