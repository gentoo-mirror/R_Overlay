...
SRC_URI="http://cran.r-project.org/src/contrib/gridpattern_1.2.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_ambient r_suggests_ggplot2 r_suggests_knitr
	r_suggests_magick r_suggests_ragg r_suggests_rmarkdown
