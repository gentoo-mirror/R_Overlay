...
SRC_URI="http://cran.r-project.org/src/contrib/gridpattern_1.3.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_ambient r_suggests_artsy r_suggests_ggplot2
	r_suggests_gtable r_suggests_knitr r_suggests_magick r_suggests_ragg
