...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/correlation_0.7.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bayesfactor r_suggests_dplyr r_suggests_energy
	...
	r_suggests_mbend r_suggests_polycor r_suggests_ppcor r_suggests_psych
...
"
DEPEND=">=sci-CRAN/insight-0.14.2
