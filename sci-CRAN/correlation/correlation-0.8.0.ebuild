...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/correlation_0.8.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bayesfactor r_suggests_energy r_suggests_forcats
	r_suggests_ggcorrplot r_suggests_ggplot2 r_suggests_ggraph
	r_suggests_gt r_suggests_hmisc r_suggests_knitr r_suggests_lme4
	r_suggests_mbend r_suggests_polycor r_suggests_poorman
