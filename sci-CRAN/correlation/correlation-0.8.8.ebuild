...
SRC_URI="http://cran.r-project.org/src/contrib/correlation_0.8.8.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_bayesfactor r_suggests_energy r_suggests_ggplot2
	...
	r_suggests_lme4 r_suggests_mass r_suggests_mbend r_suggests_openxlsx2
	r_suggests_polycor r_suggests_poorman r_suggests_ppcor
	r_suggests_psych r_suggests_rmarkdown r_suggests_rmcorr
	r_suggests_rstanarm r_suggests_see r_suggests_testthat
	r_suggests_tidygraph r_suggests_wdm r_suggests_wrs2"
R_SUGGESTS="
	...
	r_suggests_openxlsx2? ( >=sci-CRAN/openxlsx2-1.0 )
...
DEPEND=">=dev-lang/R-4.1
	...
	>=sci-CRAN/bayestestR-0.16.0
	>=sci-CRAN/parameters-0.26.0
"
