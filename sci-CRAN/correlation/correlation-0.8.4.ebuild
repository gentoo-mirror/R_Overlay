...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/correlation_0.8.4.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bayesfactor r_suggests_energy r_suggests_ggplot2
	...
	r_suggests_lme4 r_suggests_mass r_suggests_mbend r_suggests_polycor
	r_suggests_poorman r_suggests_ppcor r_suggests_psych
	r_suggests_rmarkdown r_suggests_rmcorr r_suggests_rstanarm
	r_suggests_see r_suggests_testthat r_suggests_tidygraph
