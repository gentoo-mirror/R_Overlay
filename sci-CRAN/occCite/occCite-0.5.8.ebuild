...
SRC_URI="http://cran.r-project.org/src/contrib/occCite_0.5.8.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_ape r_suggests_bit64 r_suggests_covr
	r_suggests_httr r_suggests_knitr r_suggests_refmanager
	r_suggests_remotes r_suggests_rmarkdown r_suggests_taxize
	r_suggests_testthat"
R_SUGGESTS="
