...
SRC_URI="http://cran.r-project.org/src/contrib/MultiATSM_1.0.0.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'

IUSE="${IUSE-} r_suggests_bookdown r_suggests_cowplot r_suggests_functional
	r_suggests_jmisc r_suggests_kableextra r_suggests_knitr
	r_suggests_magic r_suggests_magrittr r_suggests_neldermead
