...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/latrend_1.4.3.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_akmedoids r_suggests_caret r_suggests_cluster
	r_suggests_covr r_suggests_crimcv r_suggests_devtools
	r_suggests_doparallel r_suggests_dplyr r_suggests_evaluate
	r_suggests_fda r_suggests_flexmix r_suggests_funfem
	r_suggests_ggplot2 r_suggests_gridextra r_suggests_igraph
	r_suggests_kml r_suggests_knitr r_suggests_lcmm r_suggests_lintr
	r_suggests_lme4 r_suggests_longitudinaldata r_suggests_mclust
	r_suggests_mclustcomp r_suggests_mixak r_suggests_mixtools
	r_suggests_psych r_suggests_qqplotr r_suggests_rcmdcheck
	r_suggests_roxygen2 r_suggests_simtool r_suggests_testthat
