...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/GET_0.2-4.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_fda r_suggests_fda_usc r_suggests_gstat
	r_suggests_mvtnorm r_suggests_nnet r_suggests_patchwork
	r_suggests_r_rsp r_suggests_sp r_suggests_spatstat
