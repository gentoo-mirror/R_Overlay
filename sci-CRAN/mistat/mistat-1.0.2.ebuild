...
SRC_URI="http://cran.r-project.org/src/contrib/mistat_1.0-2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_acceptancesampling r_suggests_car
	r_suggests_dicedesign r_suggests_diceeval r_suggests_dicekriging
	r_suggests_diceview r_suggests_dodge r_suggests_doe_base
	r_suggests_e1071 r_suggests_frf2 r_suggests_ggplot2
	r_suggests_learnbayes r_suggests_lhs r_suggests_mvtnorm
	r_suggests_qcc r_suggests_rsm r_suggests_tseries"
R_SUGGESTS="
