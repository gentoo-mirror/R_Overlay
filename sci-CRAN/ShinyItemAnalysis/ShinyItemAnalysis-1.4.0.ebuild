...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ShinyItemAnalysis_1.4.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_data_table r_suggests_deltaplotr r_suggests_difnlr
	...
	r_suggests_knitr r_suggests_lattice r_suggests_ltm r_suggests_msm
	r_suggests_plotly r_suggests_purrr r_suggests_rmarkdown
	r_suggests_shiny r_suggests_shinybs r_suggests_shinydashboard
	r_suggests_shinyjs r_suggests_stringr r_suggests_vgam
	r_suggests_xtable"
R_SUGGESTS="
	r_suggests_data_table? ( sci-CRAN/data_table )
	r_suggests_deltaplotr? ( sci-CRAN/deltaPlotR )
	r_suggests_difnlr? ( >=sci-CRAN/difNLR-1.3.2 )
