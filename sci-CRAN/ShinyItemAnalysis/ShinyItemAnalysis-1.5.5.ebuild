...
SRC_URI="http://cran.r-project.org/src/contrib/ShinyItemAnalysis_1.5.5.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_data_table r_suggests_deltaplotr r_suggests_difnlr
	...
	r_suggests_shinyjs r_suggests_stringr r_suggests_testthat
	r_suggests_vgam r_suggests_xtable r_suggests_yaml"
R_SUGGESTS="
	r_suggests_data_table? ( sci-CRAN/data_table )
	r_suggests_deltaplotr? ( sci-CRAN/deltaPlotR )
	r_suggests_difnlr? ( >=sci-CRAN/difNLR-1.5.0 )
