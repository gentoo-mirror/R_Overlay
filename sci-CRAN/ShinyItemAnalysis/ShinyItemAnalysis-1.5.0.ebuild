...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ShinyItemAnalysis_1.5.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_data_table r_suggests_deltaplotr r_suggests_difnlr
	...
	r_suggests_shinydashboard r_suggests_shinyjs r_suggests_siamodules
	r_suggests_stringr r_suggests_testthat r_suggests_vgam
...
R_SUGGESTS="
	...
	r_suggests_siamodules? ( sci-CRAN/SIAmodules )
