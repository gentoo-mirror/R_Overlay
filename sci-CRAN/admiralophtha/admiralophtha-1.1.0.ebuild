...
SRC_URI="http://cran.r-project.org/src/contrib/admiralophtha_1.1.0.tar.gz"
...
R_SUGGESTS="
	...
	r_suggests_lintr? ( sci-CRAN/lintr sci-CRAN/lintr )
	r_suggests_miniui? ( sci-CRAN/miniUI )
	r_suggests_pharmaversesdtm? ( >=sci-CRAN/pharmaversesdtm-1.0.0 sci-CRAN/pharmaversesdtm )
	r_suggests_pkgdown? ( sci-CRAN/pkgdown sci-CRAN/pkgdown )
	r_suggests_rmarkdown? ( sci-CRAN/rmarkdown )
	r_suggests_roxygen2? ( sci-CRAN/roxygen2 )
	r_suggests_spelling? ( sci-CRAN/spelling )
	r_suggests_testthat? ( sci-CRAN/testthat >=sci-CRAN/testthat-3.0.0 )
