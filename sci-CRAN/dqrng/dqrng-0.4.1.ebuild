...
SRC_URI="http://cran.r-project.org/src/contrib/dqrng_0.4.1.tar.gz"
LICENSE='AGPL-3'

IUSE="${IUSE-} r_suggests_bench r_suggests_bh r_suggests_knitr
	r_suggests_mvtnorm r_suggests_rmarkdown r_suggests_sitmo
	r_suggests_testthat"
R_SUGGESTS="
