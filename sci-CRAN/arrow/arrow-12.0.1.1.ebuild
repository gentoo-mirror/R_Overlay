...
SRC_URI="http://cran.r-project.org/src/contrib/arrow_12.0.1.1.tar.gz"

IUSE="${IUSE-} r_suggests_blob r_suggests_cli r_suggests_dbi
	r_suggests_dbplyr r_suggests_decor r_suggests_distro r_suggests_dplyr
	r_suggests_duckdb r_suggests_hms r_suggests_knitr
