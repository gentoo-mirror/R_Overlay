...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/periscope_0.6.2.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_canvasxpress r_suggests_knitr r_suggests_openxlsx
	r_suggests_rmarkdown r_suggests_shinydashboardplus
	r_suggests_testthat"
R_SUGGESTS="
