...
SRC_URI="http://cran.r-project.org/src/contrib/visOmopResults_0.5.0.tar.gz"

IUSE="${IUSE-} r_suggests_covr r_suggests_flextable r_suggests_ggplot2
	r_suggests_gt r_suggests_knitr r_suggests_officer
