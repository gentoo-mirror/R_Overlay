...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ragtop_1.1.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_bondvaluation r_suggests_ggplot2 r_suggests_knitr
	r_suggests_mass r_suggests_quandl r_suggests_r_cache
...
R_SUGGESTS="
	r_suggests_bondvaluation? ( sci-CRAN/BondValuation )
