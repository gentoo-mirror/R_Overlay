...
SRC_URI="http://cran.r-project.org/src/contrib/GGIR_1.5-1.tar.gz"
LICENSE='|| ( LGPL-2 LGPL-2.1 )'

IUSE="${IUSE-} r_suggests_bitops r_suggests_covr r_suggests_genearead
	r_suggests_mass r_suggests_matlab r_suggests_mmap r_suggests_signal
	r_suggests_testthat r_suggests_tuner r_suggests_zoo"
R_SUGGESTS="
