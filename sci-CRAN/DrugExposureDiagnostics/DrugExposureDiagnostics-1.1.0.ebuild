...
SRC_URI="http://cran.r-project.org/src/contrib/DrugExposureDiagnostics_1.1.0.tar.gz"
...
IUSE="${IUSE-} r_suggests_dbi r_suggests_dt r_suggests_duckdb
	...
	r_suggests_pryr r_suggests_rmarkdown r_suggests_shinycssloaders
	r_suggests_shinyjs r_suggests_shinytest2 r_suggests_shinywidgets
	r_suggests_sqlrender r_suggests_testthat r_suggests_tibble
	r_suggests_tictoc r_suggests_zip"
R_SUGGESTS="
