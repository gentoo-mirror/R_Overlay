...
SRC_URI="http://cran.r-project.org/src/contrib/DrugExposureDiagnostics_1.0.10.tar.gz"
...
IUSE="${IUSE-} r_suggests_cowplot r_suggests_dbi r_suggests_diagrammersvg
	...
	r_suggests_plotly r_suggests_pryr r_suggests_rmarkdown
	r_suggests_shinytest2 r_suggests_sqlrender r_suggests_testthat
