...
SRC_URI="http://cran.r-project.org/src/contrib/PlotFTIR_1.0.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_chemospec r_suggests_ggplot2 r_suggests_ggthemes
	r_suggests_ir r_suggests_knitr r_suggests_r_utils
