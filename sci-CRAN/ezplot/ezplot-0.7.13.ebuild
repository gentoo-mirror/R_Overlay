...
SRC_URI="http://cran.r-project.org/src/contrib/ezplot_0.7.13.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_covr r_suggests_dt r_suggests_e1071
	r_suggests_ggrepel r_suggests_knitr r_suggests_miniui
	r_suggests_rmarkdown r_suggests_rocr r_suggests_shiny
	r_suggests_testthat r_suggests_tibble r_suggests_tidyr
	r_suggests_tsibble r_suggests_tsibbledata"
R_SUGGESTS="
