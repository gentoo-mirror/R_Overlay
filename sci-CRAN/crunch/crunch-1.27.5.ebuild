...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/crunch_1.27.5.tar.gz"
LICENSE='LGPL-3+'

IUSE="${IUSE-} r_suggests_covr r_suggests_crunchy r_suggests_haven
	r_suggests_httptest r_suggests_knitr r_suggests_lintr
