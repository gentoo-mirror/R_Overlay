...
SRC_URI="http://cran.r-project.org/src/contrib/crunch_1.31.1.tar.gz"
LICENSE='LGPL-3+'

IUSE="${IUSE-} r_suggests_base64enc r_suggests_covr r_suggests_devtools
	r_suggests_haven r_suggests_httptest r_suggests_knitr
	r_suggests_lintr r_suggests_magrittr r_suggests_mime
