...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/finalsize_0.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bookdown r_suggests_colorspace r_suggests_covr
	r_suggests_data_table r_suggests_ggplot2 r_suggests_ggtext
	r_suggests_knitr r_suggests_rmarkdown r_suggests_scales
	r_suggests_socialmixr r_suggests_testthat r_suggests_usethis
	r_suggests_xml2"
R_SUGGESTS="
