...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/finalsize_0.2.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_bookdown r_suggests_colorspace r_suggests_covr
	...
	r_suggests_ggtext r_suggests_knitr r_suggests_purrr
	r_suggests_rmarkdown r_suggests_scales r_suggests_socialmixr
