...
SRC_URI="http://cran.r-project.org/src/contrib/data.tree_0.3.5.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ape r_suggests_doparallel r_suggests_foreach
	r_suggests_htmlwidgets r_suggests_igraph r_suggests_jsonlite
	r_suggests_knitr r_suggests_networkd3 r_suggests_testthat
