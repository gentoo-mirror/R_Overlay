...
SRC_URI="http://cran.r-project.org/src/contrib/ivmte_1.1.0.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'

IUSE="${IUSE-} r_suggests_aer r_suggests_data_table r_suggests_knitr
	r_suggests_lpsolveapi r_suggests_matrix r_suggests_pander
	r_suggests_rmarkdown r_suggests_slam r_suggests_splines2
	r_suggests_testthat"
R_SUGGESTS="
