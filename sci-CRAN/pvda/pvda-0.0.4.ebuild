...
DESCRIPTION='Disproportionality Functions for Pharmacovigilance'
KEYWORDS="~amd64 ~x64-macos ~arm64-macos"
SRC_URI="http://cran.r-project.org/src/contrib/pvda_0.0.4.tar.gz"
LICENSE='GPL-3+'
...
R_SUGGESTS="
	...
	r_suggests_rmarkdown? ( >=sci-CRAN/rmarkdown-2.24 )
	r_suggests_testthat? ( >=sci-CRAN/testthat-3.1.10 )
	r_suggests_writexl? ( >=sci-CRAN/writexl-1.4.2 )
"
