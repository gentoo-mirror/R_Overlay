...
SRC_URI="http://cran.r-project.org/src/contrib/giscoR_0.1.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_cartography r_suggests_colorspace
	r_suggests_eurostat r_suggests_knitr r_suggests_lwgeom
