...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/SAMtool_1.4.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_abind r_suggests_caret r_suggests_covr
	r_suggests_ggplot2 r_suggests_gmisc r_suggests_knitr
	r_suggests_mvtnorm r_suggests_numderiv r_suggests_reshape2
	r_suggests_shiny r_suggests_testthat r_suggests_tmbstan
	r_suggests_usethis"
R_SUGGESTS="
