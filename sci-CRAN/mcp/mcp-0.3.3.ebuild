...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mcp_0.3.3.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_hexbin r_suggests_knitr r_suggests_purrr
