...
SRC_URI="http://cran.r-project.org/src/contrib/oolong_0.6.1.tar.gz"
LICENSE='LGPL-2.1+'

IUSE="${IUSE-} r_suggests_btm r_suggests_covr r_suggests_dplyr r_suggests_fs
	r_suggests_keyatm r_suggests_knitr r_suggests_quanteda_textmodels
	r_suggests_rmarkdown r_suggests_shinytest2 r_suggests_stm
...
R_SUGGESTS="
	...
	r_suggests_keyatm? ( >=sci-CRAN/keyATM-0.2.2 )
