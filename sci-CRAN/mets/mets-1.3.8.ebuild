...
SRC_URI="http://cran.r-project.org/src/contrib/mets_1.3.8.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_cmprsk r_suggests_icenreg r_suggests_kernsmooth
	r_suggests_knitr r_suggests_mets r_suggests_optimx r_suggests_prodlim
	r_suggests_riskregression r_suggests_rmarkdown r_suggests_tinytest
	r_suggests_ucminf"
R_SUGGESTS="
