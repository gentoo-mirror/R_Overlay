...
SRC_URI="http://cran.r-project.org/src/contrib/HSAUR_1.3-7.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ape r_suggests_coin r_suggests_flexmix
	r_suggests_gee r_suggests_lme4 r_suggests_mclust r_suggests_mvtnorm
	r_suggests_party r_suggests_randomforest r_suggests_rmeta
	r_suggests_scatterplot3d r_suggests_vcd"
R_SUGGESTS="
