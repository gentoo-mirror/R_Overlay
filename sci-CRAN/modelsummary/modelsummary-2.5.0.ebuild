...
SRC_URI="http://cran.r-project.org/src/contrib/modelsummary_2.5.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_altdoc r_suggests_amelia
	...
	r_suggests_ggplot2 r_suggests_gh r_suggests_glmmtmb r_suggests_gt
	r_suggests_gtextras r_suggests_haven r_suggests_irdisplay
	r_suggests_ivreg r_suggests_kableextra r_suggests_knitr
	r_suggests_labelled r_suggests_lavaan r_suggests_lfe r_suggests_lme4
	r_suggests_lmtest r_suggests_magick r_suggests_magrittr
	r_suggests_marginaleffects r_suggests_mass r_suggests_mgcv
	r_suggests_mice r_suggests_nlme r_suggests_nnet r_suggests_officer
	r_suggests_openxlsx r_suggests_pandoc r_suggests_pscl
	r_suggests_psych r_suggests_randomizr r_suggests_rdatasets
	r_suggests_remotes r_suggests_rmarkdown r_suggests_rstanarm
	r_suggests_sandwich r_suggests_spelling r_suggests_survey
	r_suggests_survival r_suggests_tibble r_suggests_tictoc
	r_suggests_tidyselect r_suggests_tidyverse r_suggests_tinysnapshot
...
R_SUGGESTS="
	...
	r_suggests_gt? ( >=sci-CRAN/gt-0.8.0 )
...
DEPEND=">=dev-lang/R-4.0.0
	...
	sci-CRAN/generics
	>=sci-CRAN/insight-1.4.0
	>=sci-CRAN/parameters-0.28.0
	>=sci-CRAN/performance-0.15.0
	>=sci-CRAN/tables-0.9.31
	>=sci-CRAN/tinytable-0.13.0
"
