...
SRC_URI="http://cran.r-project.org/src/contrib/modelsummary_2.3.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_altdoc r_suggests_amelia
	...
	r_suggests_knitr r_suggests_labelled r_suggests_lavaan r_suggests_lfe
	r_suggests_lme4 r_suggests_lmtest r_suggests_magick
	...
	r_suggests_pscl r_suggests_psych r_suggests_randomizr
