...
SRC_URI="http://cran.r-project.org/src/contrib/modelsummary_1.4.3.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_amelia r_suggests_betareg
	...
	r_suggests_ggdist r_suggests_ggplot2 r_suggests_gtextras
	r_suggests_haven r_suggests_irdisplay r_suggests_ivreg
	r_suggests_knitr r_suggests_lavaan r_suggests_lfe r_suggests_lme4
	r_suggests_lmtest r_suggests_magick r_suggests_marginaleffects
	r_suggests_margins r_suggests_mass r_suggests_mgcv r_suggests_mice
	r_suggests_nlme r_suggests_nnet r_suggests_officer
	r_suggests_openxlsx r_suggests_pscl r_suggests_remotes
	...
	r_suggests_tinytex r_suggests_wesanderson"
R_SUGGESTS="
...
DEPEND="sci-CRAN/glue
	...
	>=sci-CRAN/parameters-0.21.2
	>=sci-CRAN/performance-0.10.5
"
