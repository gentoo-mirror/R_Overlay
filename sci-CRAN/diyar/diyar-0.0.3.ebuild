...
SRC_URI="http://cran.r-project.org/src/contrib/diyar_0.0.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_ggplot2 r_suggests_janitor
	r_suggests_knitr r_suggests_phonics r_suggests_rmarkdown
	r_suggests_testthat"
R_SUGGESTS="
	...
	r_suggests_phonics? ( sci-CRAN/phonics )
