...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/gtreg_0.1.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_covr r_suggests_gt r_suggests_rmarkdown
