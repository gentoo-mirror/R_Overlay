...
SRC_URI="http://cran.r-project.org/src/contrib/callr_3.7.4.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_asciicast r_suggests_cli r_suggests_covr
	r_suggests_mockery r_suggests_ps r_suggests_rprojroot
	r_suggests_spelling r_suggests_testthat r_suggests_withr"
R_SUGGESTS="
	r_suggests_asciicast? ( >=sci-CRAN/asciicast-2.3.1 )
