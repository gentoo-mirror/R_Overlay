...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/basictabler_1.0.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_jsonlite r_suggests_knitr r_suggests_listviewer
	r_suggests_lubridate r_suggests_openxlsx r_suggests_rmarkdown
