...
SRC_URI="http://cran.r-project.org/src/contrib/lidR_2.2.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_crayon r_suggests_ebimage
	r_suggests_geometry r_suggests_gstat r_suggests_hexbin
