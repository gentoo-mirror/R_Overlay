...
SRC_URI="http://cran.r-project.org/src/contrib/dendextend_1.13.2.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'
...
IUSE="${IUSE-} r_suggests_ape r_suggests_circlize r_suggests_cluster
	...
	r_suggests_fpc r_suggests_gplots r_suggests_knitr r_suggests_mass
	r_suggests_microbenchmark r_suggests_profdpm r_suggests_pvclust
