...
SRC_URI="http://cran.r-project.org/src/contrib/diceR_3.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_cluster r_suggests_covr r_suggests_dbscan
	r_suggests_e1071 r_suggests_kernlab r_suggests_knitr
	r_suggests_kohonen r_suggests_nmf r_suggests_pander r_suggests_polca
	r_suggests_progress r_suggests_rcolorbrewer r_suggests_rlang
	r_suggests_rmarkdown r_suggests_rtsne r_suggests_sigclust
	r_suggests_testthat"
R_SUGGESTS="
