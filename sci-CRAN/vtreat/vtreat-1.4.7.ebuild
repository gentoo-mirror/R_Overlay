...
SRC_URI="http://cran.r-project.org/src/contrib/vtreat_1.4.7.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'
...
R_SUGGESTS="
	...
	r_suggests_rqdatatable? ( >=sci-CRAN/rqdatatable-1.2.2 )
	r_suggests_rquery? ( >=sci-CRAN/rquery-1.3.8 )
