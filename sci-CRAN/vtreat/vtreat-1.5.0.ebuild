...
SRC_URI="http://cran.r-project.org/src/contrib/vtreat_1.5.0.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'
...
R_SUGGESTS="
	...
	r_suggests_rqdatatable? ( >=sci-CRAN/rqdatatable-1.2.4 )
	r_suggests_rquery? ( >=sci-CRAN/rquery-1.4.0 )
	r_suggests_rsqlite? ( sci-CRAN/RSQLite )
	r_suggests_runit? ( sci-CRAN/RUnit )
"
DEPEND=">=dev-lang/R-3.2.1
	>=sci-CRAN/wrapr-1.9.3
"
