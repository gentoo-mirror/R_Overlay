...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/vtreat_1.6.3.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'
...
R_SUGGESTS="
	...
	r_suggests_rqdatatable? ( >=sci-CRAN/rqdatatable-1.2.9 )
	r_suggests_rquery? ( >=sci-CRAN/rquery-1.4.6 )
	r_suggests_rsqlite? ( sci-CRAN/RSQLite )
	r_suggests_tinytest? ( sci-CRAN/tinytest )
"
DEPEND=">=dev-lang/R-3.4.0
	sci-CRAN/digest
	>=sci-CRAN/wrapr-2.0.7
"
