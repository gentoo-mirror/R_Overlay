...
SRC_URI="http://cran.r-project.org/src/contrib/vtreat_1.3.5.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_data_table r_suggests_dbi r_suggests_ggplot2
	r_suggests_isotone r_suggests_knitr r_suggests_lme4 r_suggests_r_rsp
...
R_SUGGESTS="
	...
	r_suggests_rqdatatable? ( >=sci-CRAN/rqdatatable-1.1.2 )
	r_suggests_rquery? ( >=sci-CRAN/rquery-1.2.1 )
	r_suggests_rsqlite? ( sci-CRAN/RSQLite )
	r_suggests_testthat? ( sci-CRAN/testthat )
"
DEPEND=">=dev-lang/R-3.2.1
	>=sci-CRAN/wrapr-1.8.2
"
