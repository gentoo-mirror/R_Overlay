...
SRC_URI="http://cran.r-project.org/src/contrib/vtreat_1.3.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_data_table r_suggests_dbi r_suggests_ggplot2
	...
	r_suggests_rquery r_suggests_rsqlite r_suggests_testthat"
R_SUGGESTS="
	...
	r_suggests_rqdatatable? ( >=sci-CRAN/rqdatatable-0.1.4 )
	r_suggests_rquery? ( >=sci-CRAN/rquery-0.6.2 )
