...
SRC_URI="http://cran.r-project.org/src/contrib/sf_0.7-6.tar.gz"
...
IUSE="${IUSE-} r_suggests_blob r_suggests_covr r_suggests_dplyr
	...
	r_suggests_pillar r_suggests_pool r_suggests_raster r_suggests_rgdal
	r_suggests_rgeos r_suggests_rlang r_suggests_rmarkdown
	r_suggests_rpostgres r_suggests_rpostgresql r_suggests_rsqlite
	r_suggests_sp r_suggests_spatstat r_suggests_stars
