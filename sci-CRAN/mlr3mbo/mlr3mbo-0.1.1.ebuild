...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mlr3mbo_0.1.1.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_dicekriging r_suggests_knitr r_suggests_lhs
	...
	r_suggests_rpart r_suggests_spacefillr r_suggests_stringi
	r_suggests_testthat"
R_SUGGESTS="
...
"
DEPEND=">=sci-CRAN/mlr3tuning-0.14.0
	>=sci-CRAN/lgr-0.3.4
