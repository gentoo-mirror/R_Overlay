...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3mbo_0.3.2.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_dicekriging r_suggests_emoa r_suggests_fastghquad
	r_suggests_lhs r_suggests_mirai r_suggests_mlr3learners
	r_suggests_mlr3pipelines r_suggests_nloptr r_suggests_ranger
	r_suggests_rgenoud r_suggests_rpart r_suggests_stringi
	r_suggests_testthat"
R_SUGGESTS="
...
"
DEPEND=">=sci-CRAN/mlr3tuning-1.4.0
	>=dev-lang/R-3.1.0
	sci-CRAN/data_table
	>=sci-CRAN/bbotk-1.6.0
	>=sci-CRAN/checkmate-2.0.0
	>=sci-CRAN/lgr-0.3.4
	>=sci-CRAN/mlr3-0.23.0
