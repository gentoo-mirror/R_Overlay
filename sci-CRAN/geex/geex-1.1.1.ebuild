...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/geex_1.1.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_aer r_suggests_covr r_suggests_dplyr
	r_suggests_gee r_suggests_geepack r_suggests_icsnp
	r_suggests_inferference r_suggests_knitr r_suggests_mass
	r_suggests_moments r_suggests_mvtnorm r_suggests_rmarkdown
