...
SRC_URI="http://cran.r-project.org/src/contrib/tram_1.2-0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_alabama r_suggests_asht r_suggests_atr
	r_suggests_coin r_suggests_colorspace r_suggests_coxme
	r_suggests_gamlss r_suggests_geepack r_suggests_glmmtmb
	...
	r_suggests_th_data r_suggests_tramme r_suggests_trtf"
R_SUGGESTS="
