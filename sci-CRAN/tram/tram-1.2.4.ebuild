...
SRC_URI="http://cran.r-project.org/src/contrib/tram_1.2-4.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_aer r_suggests_alabama r_suggests_asht
	r_suggests_atr r_suggests_coin r_suggests_colorspace
	r_suggests_cotram r_suggests_coxme r_suggests_eha r_suggests_english
	r_suggests_flexsurv r_suggests_frailtyem r_suggests_frailtypack
	r_suggests_gamlss r_suggests_gamlss_cens r_suggests_gamlss_data
	r_suggests_geepack r_suggests_glmmtmb r_suggests_hsaur3
	...
	r_suggests_tramvs r_suggests_trtf r_suggests_xtable"
R_SUGGESTS="
