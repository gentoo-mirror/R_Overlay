...
SRC_URI="http://cran.r-project.org/src/contrib/tram_1.1-1.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_alabama r_suggests_asht r_suggests_atr
	...
	r_suggests_quantreg r_suggests_randomforestsrc r_suggests_sparsegrid
