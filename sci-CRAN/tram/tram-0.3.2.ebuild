...
SRC_URI="http://cran.r-project.org/src/contrib/tram_0.3-2.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_alabama r_suggests_atr r_suggests_colorspace
	r_suggests_coxme r_suggests_glmmsr r_suggests_gridextra
