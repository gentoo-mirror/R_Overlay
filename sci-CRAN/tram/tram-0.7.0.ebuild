...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/tram_0.7-0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_alabama r_suggests_asht r_suggests_atr
	r_suggests_coin r_suggests_colorspace r_suggests_coxme
	r_suggests_gamlss r_suggests_glmmsr r_suggests_gridextra
	r_suggests_hsaur3 r_suggests_knitr r_suggests_lattice r_suggests_lme4
	r_suggests_mass r_suggests_merderiv r_suggests_mlbench
	r_suggests_mlt_docreg r_suggests_mvtnorm r_suggests_numderiv
	r_suggests_ordinal r_suggests_ordinalcont r_suggests_quantreg
	r_suggests_sparsegrid r_suggests_th_data r_suggests_trtf"
R_SUGGESTS="
