...
SRC_URI="http://cran.r-project.org/src/contrib/RSQLite_2.3.11.tar.gz"
LICENSE='LGPL-2.1+'

IUSE="${IUSE-} r_suggests_callr r_suggests_cli r_suggests_dbitest
	r_suggests_decor r_suggests_gert r_suggests_gh r_suggests_hms
	r_suggests_knitr r_suggests_magrittr r_suggests_rmarkdown
	r_suggests_rvest r_suggests_testthat r_suggests_withr r_suggests_xml2"
R_SUGGESTS="
