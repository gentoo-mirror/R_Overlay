...
SRC_URI="http://cran.r-project.org/src/contrib/sjlabelled_1.1.2.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_dplyr r_suggests_knitr r_suggests_magrittr
	r_suggests_rlang r_suggests_rmarkdown r_suggests_sjmisc
	r_suggests_sjplot r_suggests_snakecase r_suggests_testthat"
R_SUGGESTS="
