...
SRC_URI="http://cran.r-project.org/src/contrib/DanielBiostatistics10th_0.2.0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_bsda r_suggests_car r_suggests_caret
	r_suggests_desctools r_suggests_ggfortify r_suggests_mblm
	r_suggests_psych r_suggests_reshape2 r_suggests_robslopes
	r_suggests_survival"
R_SUGGESTS="
