...
SRC_URI="http://cran.r-project.org/src/contrib/TreeDist_1.2.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_bookdown r_suggests_cluster r_suggests_kdensity
	...
	r_suggests_rdpack r_suggests_rmarkdown r_suggests_ternary
	r_suggests_testthat r_suggests_treesearch r_suggests_vdiffr"
R_SUGGESTS="
