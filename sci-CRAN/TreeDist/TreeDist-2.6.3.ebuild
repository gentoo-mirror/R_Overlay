...
SRC_URI="http://cran.r-project.org/src/contrib/TreeDist_2.6.3.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_bookdown r_suggests_cluster r_suggests_ggplot2
	...
	r_suggests_plottools r_suggests_protoclust r_suggests_quartet
