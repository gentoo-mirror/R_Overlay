...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/TreeDist_2.5.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_bookdown r_suggests_cluster r_suggests_ggplot2
	...
	r_suggests_mass r_suggests_matrix r_suggests_plotly
	r_suggests_protoclust r_suggests_quartet r_suggests_rcpp
	r_suggests_readxl r_suggests_rgl r_suggests_rmarkdown
	r_suggests_spelling r_suggests_ternary r_suggests_testthat
	r_suggests_uwot r_suggests_vdiffr"
R_SUGGESTS="
