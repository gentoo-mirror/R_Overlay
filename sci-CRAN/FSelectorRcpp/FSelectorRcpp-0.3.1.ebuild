...
SRC_URI="http://cran.r-project.org/src/contrib/FSelectorRcpp_0.3.1.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_doparallel r_suggests_dplyr
	...
	r_suggests_microbenchmark r_suggests_pbapply r_suggests_pkgdown
	r_suggests_randomforest r_suggests_rcpparmadillo r_suggests_rmarkdown
	r_suggests_rpart r_suggests_rtcga_rnaseq r_suggests_rweka
