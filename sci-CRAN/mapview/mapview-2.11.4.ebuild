...
SRC_URI="http://cran.r-project.org/src/contrib/mapview_2.11.4.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_knitr r_suggests_later r_suggests_leaflet_extras2
	r_suggests_leafsync r_suggests_lwgeom r_suggests_mapdeck
	r_suggests_plainview r_suggests_poorman r_suggests_rmarkdown
	r_suggests_rstudioapi r_suggests_s2 r_suggests_stars
	r_suggests_tinytest r_suggests_webshot2"
R_SUGGESTS="
