...
SRC_URI="http://cran.r-project.org/src/contrib/shinyInvoice_0.0.3.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_curl r_suggests_fs r_suggests_jsonlite
	r_suggests_lubridate r_suggests_pillar r_suggests_readr
	r_suggests_rhino r_suggests_rjson r_suggests_rmarkdown
	r_suggests_shinyace r_suggests_tinytex"
R_SUGGESTS="
