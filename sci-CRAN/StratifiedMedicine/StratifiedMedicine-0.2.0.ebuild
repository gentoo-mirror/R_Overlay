...
SRC_URI="http://cran.r-project.org/src/contrib/StratifiedMedicine_0.2.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bart r_suggests_coin r_suggests_grf
	r_suggests_knitr r_suggests_mass r_suggests_rmarkdown
	r_suggests_rpart r_suggests_survrm2 r_suggests_testthat
	r_suggests_th_data r_suggests_zoo"
R_SUGGESTS="
