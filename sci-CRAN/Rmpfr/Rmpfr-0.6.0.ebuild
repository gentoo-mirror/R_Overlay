...
SRC_URI="http://cran.r-project.org/src/contrib/Rmpfr_0.6-0.tar.gz -> cran_Rmpfr_0.6-0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_polynom r_suggests_r[-minimal] r_suggests_sfsmisc"
R_SUGGESTS="
