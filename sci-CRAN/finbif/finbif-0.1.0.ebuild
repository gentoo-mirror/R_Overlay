...
SRC_URI="http://cran.r-project.org/src/contrib/finbif_0.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_codemetar r_suggests_data_tree r_suggests_isocodes
	r_suggests_knitr r_suggests_ows4r r_suggests_rmarkdown r_suggests_sf
