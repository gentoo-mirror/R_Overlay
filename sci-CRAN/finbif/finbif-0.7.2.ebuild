...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/finbif_0.7.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_data_table r_suggests_dplyr r_suggests_future
	r_suggests_gert r_suggests_here r_suggests_knitr r_suggests_readods
	r_suggests_readxl r_suggests_rmarkdown r_suggests_testthat
	r_suggests_tidyr r_suggests_vcr r_suggests_webfakes"
R_SUGGESTS="
