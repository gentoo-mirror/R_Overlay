...
SRC_URI="http://cran.r-project.org/src/contrib/familiar_1.5.0.tar.gz"
LICENSE='EUPL-1.1'

IUSE="${IUSE-} r_suggests_bart r_suggests_callr r_suggests_cluster
	r_suggests_corelearn r_suggests_coro r_suggests_dynamictreecut
	r_suggests_e1071 r_suggests_ecdat r_suggests_fastglm
	r_suggests_ggplot2 r_suggests_glmnet r_suggests_gtable
	r_suggests_harmonicmeanp r_suggests_isotree r_suggests_knitr
	r_suggests_labeling r_suggests_lagp r_suggests_mass
	r_suggests_maxstat r_suggests_mboost r_suggests_nnet
	r_suggests_partykit r_suggests_power_transform r_suggests_praznik
	r_suggests_proxy r_suggests_qvalue r_suggests_randomforestsrc
	r_suggests_ranger r_suggests_rmarkdown r_suggests_scales
	r_suggests_testthat r_suggests_vgam r_suggests_xgboost
	r_suggests_xml2"
R_SUGGESTS="
	...
	r_suggests_power_transform? ( sci-CRAN/power_transform )
