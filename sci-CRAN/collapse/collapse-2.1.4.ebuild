...
SRC_URI="http://cran.r-project.org/src/contrib/collapse_2.1.4.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_bit64 r_suggests_covr r_suggests_data_table
	r_suggests_dplyr r_suggests_fastverse r_suggests_fixest
	r_suggests_ggplot2 r_suggests_kit r_suggests_knitr
	r_suggests_magrittr r_suggests_plm r_suggests_rcpparmadillo
	r_suggests_rcppeigen r_suggests_rmarkdown r_suggests_scales
	r_suggests_testthat r_suggests_tibble r_suggests_vars
