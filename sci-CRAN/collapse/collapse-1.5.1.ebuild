...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/collapse_1.5.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_covr r_suggests_data_table r_suggests_dplyr
	r_suggests_fixest r_suggests_ggplot2 r_suggests_kit r_suggests_lfe
	r_suggests_magrittr r_suggests_matrix r_suggests_plm
	r_suggests_rcpparmadillo r_suggests_rcppeigen r_suggests_scales
	r_suggests_testthat r_suggests_vars r_suggests_weights"
R_SUGGESTS="
