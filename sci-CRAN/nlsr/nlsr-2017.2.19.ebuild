...
SRC_URI="http://cran.r-project.org/src/contrib/nlsr_2017.2.19.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_deriv r_suggests_knitr r_suggests_minpack_lm
	r_suggests_nlmrt r_suggests_numderiv r_suggests_optimr
	r_suggests_rcgmin r_suggests_rmarkdown r_suggests_rvmmin
	r_suggests_ryacas"
R_SUGGESTS="
	r_suggests_deriv? ( sci-CRAN/Deriv )
	r_suggests_knitr? ( sci-CRAN/knitr )
	r_suggests_minpack_lm? ( sci-CRAN/minpack_lm )
	r_suggests_nlmrt? ( sci-CRAN/nlmrt )
