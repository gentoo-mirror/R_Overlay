...
SRC_URI="http://cran.r-project.org/src/contrib/ggstatsplot_0.12.2.tar.gz"
LICENSE='GPL-3'
...
R_SUGGESTS="
	...
	r_suggests_bayesfactor? ( >=sci-CRAN/BayesFactor-0.9.12.4.5 )
	...
	r_suggests_pmcmrplus? ( >=sci-CRAN/PMCMRplus-1.9.9 )
