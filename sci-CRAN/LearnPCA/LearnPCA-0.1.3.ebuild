...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/LearnPCA_0.1.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_ade4 r_suggests_bookdown r_suggests_chemometrics
	r_suggests_chemospec r_suggests_htmlwidgets r_suggests_knitr
	r_suggests_latex2exp r_suggests_plot3d r_suggests_plotly
	r_suggests_plotrix r_suggests_rmarkdown r_suggests_roxut
	r_suggests_tinytest r_suggests_xtable"
R_SUGGESTS="
