...
SRC_URI="http://cran.r-project.org/src/contrib/UCSCXenaShiny_2.2.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_covr r_suggests_cowplot r_suggests_dt
	r_suggests_funkyheatmap r_suggests_furrr r_suggests_future
	r_suggests_ggrepel r_suggests_ggstatsplot r_suggests_glue
	r_suggests_knitr r_suggests_pacman r_suggests_plotly r_suggests_plyr
	r_suggests_rcolorbrewer r_suggests_readr r_suggests_rmarkdown
	r_suggests_rtsne r_suggests_scales r_suggests_survival
	r_suggests_survminer r_suggests_testthat r_suggests_umap"
R_SUGGESTS="
	r_suggests_covr? ( >=sci-CRAN/covr-3.2.1 )
	r_suggests_cowplot? ( sci-CRAN/cowplot )
	r_suggests_dt? ( >=sci-CRAN/DT-0.5 )
	r_suggests_funkyheatmap? ( sci-CRAN/funkyheatmap )
