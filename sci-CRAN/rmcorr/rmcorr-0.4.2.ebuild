...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/rmcorr_0.4.2.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_ggplot2 r_suggests_knitr r_suggests_lme4
	r_suggests_mertools r_suggests_pacman r_suggests_plotrix
	r_suggests_pwr r_suggests_rmarkdown"
R_SUGGESTS="
