...
SRC_URI="http://cran.r-project.org/src/contrib/rmcorr_0.7.0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_aiccmodavg r_suggests_cocor r_suggests_corrplot
	r_suggests_covr r_suggests_dplyr r_suggests_esc r_suggests_ggextra
	r_suggests_gglm r_suggests_ggplot2 r_suggests_knitr r_suggests_lme4
	r_suggests_mertools r_suggests_pals r_suggests_patchwork
