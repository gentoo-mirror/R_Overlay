...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/rmcorr_0.5.4.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_aiccmodavg r_suggests_cocor r_suggests_corrplot
	r_suggests_covr r_suggests_ggplot2 r_suggests_knitr r_suggests_lme4
	r_suggests_mertools r_suggests_pals r_suggests_plotrix r_suggests_pwr
