...
SRC_URI="http://cran.r-project.org/src/contrib/heatwaveR_0.5.4.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_covr r_suggests_doparallel r_suggests_dplyr
	r_suggests_ggpubr r_suggests_knitr r_suggests_lubridate
	r_suggests_ncdf4 r_suggests_plyr r_suggests_rerddap
	r_suggests_rmarkdown r_suggests_stringr r_suggests_testthat
	r_suggests_tibble r_suggests_tidync r_suggests_tidyr"
R_SUGGESTS="
