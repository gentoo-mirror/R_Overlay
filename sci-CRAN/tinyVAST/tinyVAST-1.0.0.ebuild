...
SRC_URI="http://cran.r-project.org/src/contrib/tinyVAST_1.0.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_dharma r_suggests_dsem r_suggests_ggplot2
	r_suggests_glmmtmb r_suggests_knitr r_suggests_lattice
	r_suggests_mvtnorm r_suggests_pdp r_suggests_plyr
...
R_SUGGESTS="
	...
	r_suggests_dsem? ( >=sci-CRAN/dsem-1.1.0 )
