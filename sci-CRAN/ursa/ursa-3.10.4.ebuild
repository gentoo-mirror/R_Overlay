...
SRC_URI="http://cran.r-project.org/src/contrib/ursa_3.10.4.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_catools r_suggests_fasterize r_suggests_gdalraster
	...
	r_suggests_magick r_suggests_ncdf4 r_suggests_proj4 r_suggests_ragg
	r_suggests_raster r_suggests_rcolorbrewer r_suggests_rmarkdown
	r_suggests_rsqlite r_suggests_shiny r_suggests_sp r_suggests_stars
	r_suggests_sys r_suggests_terra r_suggests_tk r_suggests_vapour
