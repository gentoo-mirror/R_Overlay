...
SRC_URI="http://cran.r-project.org/src/contrib/ursa_3.9.1.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_cairo r_suggests_catools r_suggests_fasterize
	...
	r_suggests_irdisplay r_suggests_knitr r_suggests_leafem
	r_suggests_leaflet r_suggests_leaflet_providers r_suggests_leafpop
	r_suggests_locfit r_suggests_ncdf4 r_suggests_proj4 r_suggests_raster
	r_suggests_rcolorbrewer r_suggests_rgeos r_suggests_rmarkdown
	r_suggests_sf r_suggests_shiny r_suggests_sp r_suggests_tk
	r_suggests_webp r_suggests_widgetframe"
R_SUGGESTS="
