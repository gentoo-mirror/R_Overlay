...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/MatchIt_4.5.0.tar.gz"
LICENSE='GPL-2+'
...
R_SUGGESTS="
	...
	r_suggests_marginaleffects? ( >=sci-CRAN/marginaleffects-0.8.0 )
	r_suggests_matching? ( sci-CRAN/Matching )
	r_suggests_mgcv? ( virtual/mgcv )
	r_suggests_nnet? ( virtual/nnet )
	r_suggests_optmatch? ( >=sci-CRAN/optmatch-0.10.0 )
