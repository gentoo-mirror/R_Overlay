...
SRC_URI="http://cran.r-project.org/src/contrib/MatchIt_3.0.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_cem r_suggests_mgcv r_suggests_nnet
	r_suggests_optmatch r_suggests_r_rsp r_suggests_rpart
	r_suggests_testthat r_suggests_whatif"
R_SUGGESTS="
