...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/MatchIt_4.0.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_boot r_suggests_cbps r_suggests_cem
	r_suggests_cobalt r_suggests_dbarts r_suggests_knitr
	r_suggests_lmtest r_suggests_matching r_suggests_mgcv r_suggests_nnet
