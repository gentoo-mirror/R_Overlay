...
SRC_URI="http://cran.r-project.org/src/contrib/caret_6.0-86.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_bradleyterry2 r_suggests_covr r_suggests_cubist
	r_suggests_dplyr r_suggests_e1071 r_suggests_earth r_suggests_ellipse
	...
	r_suggests_rpart r_suggests_spls r_suggests_subselect
