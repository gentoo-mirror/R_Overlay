...
SRC_URI="http://cran.r-project.org/src/contrib/caret_6.0-79.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_bradleyterry2 r_suggests_cubist r_suggests_e1071
	...
	r_suggests_ipred r_suggests_kernlab r_suggests_klar r_suggests_knitr
	r_suggests_mass r_suggests_mda r_suggests_mgcv r_suggests_mlbench
