...
SRC_URI="http://cran.r-project.org/src/contrib/caret_6.0-35.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_e1071 r_suggests_earth r_suggests_ellipse
	r_suggests_fastica r_suggests_gam r_suggests_ipred r_suggests_kernlab
	r_suggests_klar r_suggests_mda r_suggests_mlbench r_suggests_party
