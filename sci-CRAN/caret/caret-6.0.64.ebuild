...
SRC_URI="http://cran.r-project.org/src/contrib/caret_6.0-64.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_bradleyterry2 r_suggests_cubist r_suggests_e1071
	...
	r_suggests_ipred r_suggests_kernlab r_suggests_klar r_suggests_mda
	r_suggests_mlbench r_suggests_pamr r_suggests_party r_suggests_pls
	r_suggests_proc r_suggests_proxy r_suggests_r[-minimal]
