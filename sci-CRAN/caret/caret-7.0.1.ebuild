...
SRC_URI="http://cran.r-project.org/src/contrib/caret_7.0-1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_bradleyterry2 r_suggests_covr r_suggests_cubist
	r_suggests_dplyr r_suggests_earth r_suggests_ellipse
	r_suggests_fastica r_suggests_gam r_suggests_ipred r_suggests_kernlab
	r_suggests_klar r_suggests_knitr r_suggests_mass r_suggests_matrix
	r_suggests_mda r_suggests_mgcv r_suggests_mlbench
	r_suggests_mlmetrics r_suggests_nnet r_suggests_pamr r_suggests_party
	r_suggests_pls r_suggests_proxy r_suggests_randomforest
	r_suggests_rann r_suggests_rmarkdown r_suggests_rpart r_suggests_spls
	r_suggests_superpc r_suggests_testthat r_suggests_themis"
R_SUGGESTS="
	...
	r_suggests_themis? ( >=sci-CRAN/themis-0.1.3 )
"
