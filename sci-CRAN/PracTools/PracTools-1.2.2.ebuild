...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/PracTools_1.2.2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_doby r_suggests_foreign r_suggests_knitr
	r_suggests_lpsolve r_suggests_plyr r_suggests_pps r_suggests_rcpp
	r_suggests_reshape r_suggests_rmarkdown r_suggests_sampling
	r_suggests_samplingbook r_suggests_survey"
R_SUGGESTS="
