...
SRC_URI="http://cran.r-project.org/src/contrib/SpaDES.core_2.1.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_circstats r_suggests_codetools r_suggests_covr
	...
	r_suggests_knitr r_suggests_lattice r_suggests_logging
	r_suggests_magrittr r_suggests_pkgload r_suggests_png
	r_suggests_raster r_suggests_rcolorbrewer r_suggests_rmarkdown
	r_suggests_roxygen2 r_suggests_rsqlite r_suggests_rstudioapi
	r_suggests_sp r_suggests_spades_tools r_suggests_testthat
	r_suggests_tk r_suggests_withr"
R_SUGGESTS="
