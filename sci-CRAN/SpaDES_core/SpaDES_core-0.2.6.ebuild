...
SRC_URI="http://cran.r-project.org/src/contrib/SpaDES.core_0.2.6.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_archivist r_suggests_covr r_suggests_devtools
	...
	r_suggests_rcolorbrewer r_suggests_rgdal r_suggests_rgenoud
	r_suggests_rmarkdown r_suggests_sf r_suggests_spades_tools
	r_suggests_testthat"
R_SUGGESTS="
