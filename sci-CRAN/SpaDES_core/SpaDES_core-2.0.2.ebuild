...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/SpaDES.core_2.0.2.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_circstats r_suggests_codetools r_suggests_covr
	r_suggests_diagrammer r_suggests_dplyr r_suggests_future
	r_suggests_future_callr r_suggests_ggplot2 r_suggests_ggplotify
