...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/TempStable_0.1.0.tar.gz"
LICENSE='GPL-2+'
...
"
DEPEND=">=sci-CRAN/doParallel-1.0.17
	>=sci-CRAN/stabledist-0.7.1
	>=sci-CRAN/moments-0.14.1
	>=sci-CRAN/numDeriv-2016.8.1.1
	>=sci-CRAN/foreach-1.5.2
	>=sci-CRAN/StableEstim-2.1
	>=sci-CRAN/rootSolve-1.8.2.3
	>=sci-CRAN/VGAM-1.1.7
"
RDEPEND="${DEPEND-} ${R_SUGGESTS-}"

_UNRESOLVED_PACKAGES=( '>=sci-CRAN/V8-4.2.2' )
