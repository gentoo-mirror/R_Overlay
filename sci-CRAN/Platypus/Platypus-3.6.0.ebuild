...
SRC_URI="http://cran.r-project.org/src/contrib/Platypus_3.6.0.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_annotationdbi r_suggests_ape
	...
	r_suggests_ggrepel r_suggests_ggridges r_suggests_gridextra
	r_suggests_harmony r_suggests_igraph r_suggests_inext r_suggests_kmer
	r_suggests_limma r_suggests_msigdbr r_suggests_phangorn
	r_suggests_pheatmap r_suggests_phytools r_suggests_purrr
	r_suggests_readr r_suggests_readxl r_suggests_rstudioapi
	r_suggests_rtsne r_suggests_scales r_suggests_sf r_suggests_testthat
