...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/Platypus_3.3.5.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_annotationdbi r_suggests_ape r_suggests_circlize
	r_suggests_data_table r_suggests_doparallel r_suggests_fda_usc
	r_suggests_fgsea r_suggests_ggalluvial r_suggests_ggrepel
	r_suggests_ggridges r_suggests_ggseqlogo r_suggests_ggtree
	r_suggests_gridextra r_suggests_harmony r_suggests_igraph
	r_suggests_iranges r_suggests_limma r_suggests_msigdbr
	r_suggests_pheatmap r_suggests_phytools r_suggests_purrr
	r_suggests_readr r_suggests_readxl r_suggests_reticulate
