...
SRC_URI="http://cran.r-project.org/src/contrib/rice_1.2.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_copernicusmarine r_suggests_devtools
	r_suggests_htmltools r_suggests_knitr r_suggests_leaflet
	r_suggests_remotes r_suggests_rmarkdown r_suggests_rnaturalearthdata
	r_suggests_sf r_suggests_testthat r_suggests_utf8"
R_SUGGESTS="
