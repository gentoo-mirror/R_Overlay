...
SRC_URI="http://cran.r-project.org/src/contrib/fuzzySim_4.36.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aod r_suggests_geodist r_suggests_phylolm
	r_suggests_raster r_suggests_terra"
R_SUGGESTS="
