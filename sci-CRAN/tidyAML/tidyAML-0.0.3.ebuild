...
SRC_URI="http://cran.r-project.org/src/contrib/tidyAML_0.0.3.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_baguette r_suggests_bonsai r_suggests_censored
	r_suggests_dbarts r_suggests_flexsurv r_suggests_gee
	r_suggests_glmnet r_suggests_kknn r_suggests_knitr
	r_suggests_liblinear r_suggests_multilevelmod r_suggests_poissonreg
	r_suggests_randomforest r_suggests_ranger r_suggests_recipes
	r_suggests_rmarkdown r_suggests_roxygen2 r_suggests_rstanarm
	r_suggests_rules r_suggests_stringr r_suggests_tibble"
R_SUGGESTS="
