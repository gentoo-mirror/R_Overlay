...
SRC_URI="http://cran.r-project.org/src/contrib/tidyAML_0.0.5.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_baguette r_suggests_bonsai r_suggests_censored
	...
	r_suggests_rmarkdown r_suggests_rstanarm r_suggests_rules
	r_suggests_sda r_suggests_sparsediscrim r_suggests_stringr
	r_suggests_tibble"
R_SUGGESTS="
