...
SRC_URI="http://cran.r-project.org/src/contrib/tinyarray_2.3.3.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_annoprobe r_suggests_biobase r_suggests_circlize
	...
	r_suggests_hmisc r_suggests_knitr r_suggests_labeling
	r_suggests_rmarkdown r_suggests_rtsne r_suggests_scatterplot3d
