...
SRC_URI="http://cran.r-project.org/src/contrib/tidyclust_0.1.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_cluster r_suggests_covr r_suggests_knitr
	r_suggests_modeldata r_suggests_rcpphungarian r_suggests_recipes
	r_suggests_rmarkdown r_suggests_testthat r_suggests_workflows"
R_SUGGESTS="
