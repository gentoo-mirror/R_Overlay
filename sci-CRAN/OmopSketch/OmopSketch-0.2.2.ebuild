...
SRC_URI="http://cran.r-project.org/src/contrib/OmopSketch_0.2.2.tar.gz"
...
IUSE="${IUSE-} r_suggests_codelistgenerator r_suggests_covr r_suggests_dbi
	...
	r_suggests_odbc r_suggests_omock r_suggests_remotes
	r_suggests_rmarkdown r_suggests_rpostgres r_suggests_testthat
	r_suggests_visomopresults r_suggests_withr"
R_SUGGESTS="
...
"
DEPEND=">=sci-CRAN/PatientProfiles-1.2.1
	sci-CRAN/stringr
	>=dev-lang/R-4.1
	sci-CRAN/clock
	sci-CRAN/cli
