...
SRC_URI="http://cran.r-project.org/src/contrib/OmopSketch_0.4.0.tar.gz"
...
IUSE="${IUSE-} r_suggests_codelistgenerator r_suggests_cohortcharacteristics
	...
	r_suggests_rpostgres r_suggests_testthat r_suggests_visomopresults
	r_suggests_withr"
R_SUGGESTS="
	...
	r_suggests_omopviewer? ( sci-CRAN/OmopViewer )
