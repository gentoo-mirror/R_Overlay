...
SRC_URI="http://cran.r-project.org/src/contrib/OmopSketch_0.3.0.tar.gz"

IUSE="${IUSE-} r_suggests_codelistgenerator r_suggests_covr r_suggests_dbi
	r_suggests_dt r_suggests_duckdb r_suggests_flextable
	r_suggests_ggplot2 r_suggests_gt r_suggests_here r_suggests_knitr
	r_suggests_lubridate r_suggests_odbc r_suggests_omock
	r_suggests_remotes r_suggests_rmarkdown r_suggests_rpostgres
...
"
DEPEND=">=sci-CRAN/omopgenerics-0.4.1
	sci-CRAN/lifecycle
	sci-CRAN/glue
	sci-CRAN/stringr
	sci-CRAN/tidyr
	...
	sci-CRAN/dplyr
	sci-CRAN/tibble
	>=sci-CRAN/PatientProfiles-1.2.1
"
