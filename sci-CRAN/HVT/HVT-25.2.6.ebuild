...
SRC_URI="http://cran.r-project.org/src/contrib/HVT_25.2.6.tar.gz"
LICENSE='Apache-2.0'

IUSE="${IUSE-} r_suggests_conf_design r_suggests_corrplot
	r_suggests_data_table r_suggests_dataexplorer r_suggests_devtools
	r_suggests_dt r_suggests_furrr r_suggests_future r_suggests_geozoo
	r_suggests_gganimate r_suggests_gtable r_suggests_hmisc
