...
SRC_URI="http://cran.r-project.org/src/contrib/dplyr_0.7.5.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_bit64 r_suggests_callr r_suggests_covr
	...
	r_suggests_hms r_suggests_lahman r_suggests_lubridate r_suggests_mgcv
...
R_SUGGESTS="
	...
	r_suggests_mgcv? ( >=sci-CRAN/mgcv-1.8.23 )
...
"
DEPEND=">=sci-CRAN/pkgconfig-2.0.1
	>=sci-CRAN/R6-2.2.2
	>=sci-CRAN/glue-1.1.1
