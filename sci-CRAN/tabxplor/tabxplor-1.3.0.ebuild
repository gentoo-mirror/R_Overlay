...
SRC_URI="http://cran.r-project.org/src/contrib/tabxplor_1.3.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_cowplot r_suggests_fansi r_suggests_ggplot2
	r_suggests_ggpubr r_suggests_gtable r_suggests_htmltools
	r_suggests_jmvcore r_suggests_knitr r_suggests_labelled
	r_suggests_openxlsx r_suggests_r6 r_suggests_rmarkdown
...
R_SUGGESTS="
	...
	r_suggests_labelled? ( >=sci-CRAN/labelled-2.0.0 )
