...
SRC_URI="http://cran.r-project.org/src/contrib/sense_1.1.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_care r_suggests_e1071 r_suggests_fselectorrcpp
	...
	r_suggests_rpart r_suggests_xgboost"
R_SUGGESTS="
...
"
DEPEND=">=sci-CRAN/mlr3tuning-0.8.0
