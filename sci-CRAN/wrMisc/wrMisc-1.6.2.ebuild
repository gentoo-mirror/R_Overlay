...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/wrMisc_1.6.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bbmisc r_suggests_boot r_suggests_coin
	...
	r_suggests_nbclust r_suggests_preprocesscore r_suggests_qvalue
	r_suggests_rcolorbrewer r_suggests_rcpp r_suggests_readxl
	r_suggests_rmarkdown r_suggests_som r_suggests_stringi
	r_suggests_vgam r_suggests_vsn r_suggests_wrgraph"
R_SUGGESTS="
