...
SRC_URI="http://cran.r-project.org/src/contrib/DBI_1.2.0.tar.gz"
LICENSE='LGPL-2.1+'

IUSE="${IUSE-} r_suggests_blob r_suggests_covr r_suggests_dbitest
	r_suggests_dbplyr r_suggests_downlit r_suggests_dplyr r_suggests_glue
	r_suggests_hms r_suggests_knitr r_suggests_magrittr
	r_suggests_nanoarrow r_suggests_rmarkdown r_suggests_rprojroot
