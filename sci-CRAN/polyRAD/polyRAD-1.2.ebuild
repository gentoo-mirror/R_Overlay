...
SRC_URI="http://cran.r-project.org/src/contrib/polyRAD_1.2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_biocgenerics r_suggests_biostrings
	r_suggests_genomeinfodb r_suggests_genomicfeatures
	r_suggests_genomicranges r_suggests_ggplot2 r_suggests_iranges
	r_suggests_knitr r_suggests_qqman r_suggests_rmarkdown
	r_suggests_rrblup r_suggests_rsamtools r_suggests_s4vectors
