...
SRC_URI="http://cran.r-project.org/src/contrib/lava_1.6.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_ascii r_suggests_data_table r_suggests_ellipse
	...
	r_suggests_matrix r_suggests_mets r_suggests_optimx
	r_suggests_quantreg r_suggests_rgl r_suggests_testthat
