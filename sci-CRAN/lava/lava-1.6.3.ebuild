...
SRC_URI="http://cran.r-project.org/src/contrib/lava_1.6.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_ascii r_suggests_data_table r_suggests_ellipse
	r_suggests_fields r_suggests_foreach r_suggests_geepack
	r_suggests_gof r_suggests_graph r_suggests_igraph
	r_suggests_kernsmooth r_suggests_lava_tobit r_suggests_lme4
	r_suggests_matrix r_suggests_mets r_suggests_nlme r_suggests_optimx
	r_suggests_polycor r_suggests_quantreg r_suggests_rgl
	r_suggests_rgraphviz r_suggests_testthat r_suggests_visnetwork
	r_suggests_zoo"
R_SUGGESTS="
