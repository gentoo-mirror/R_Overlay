...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/lava_1.6.8.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bookdown r_suggests_data_table r_suggests_ellipse
	...
	r_suggests_graph r_suggests_igraph r_suggests_kernsmooth
	r_suggests_knitr r_suggests_lavasearch2 r_suggests_lme4
	r_suggests_magrittr r_suggests_matrix r_suggests_mets r_suggests_nlme
	r_suggests_optimx r_suggests_polycor r_suggests_quantreg
	r_suggests_r_rsp r_suggests_rgl r_suggests_rgraphviz
