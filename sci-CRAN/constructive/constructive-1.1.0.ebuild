...
SRC_URI="http://cran.r-project.org/src/contrib/constructive_1.1.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_bit64 r_suggests_blob r_suggests_clipr
	...
	r_suggests_dm r_suggests_dplyr r_suggests_forcats r_suggests_ggplot2
	r_suggests_knitr r_suggests_lubridate r_suggests_pixarfilms
	r_suggests_prettycode r_suggests_r6 r_suggests_reprex
	r_suggests_rmarkdown r_suggests_roxygen2 r_suggests_rstudioapi
	r_suggests_scales r_suggests_sf r_suggests_testthat r_suggests_tibble
	r_suggests_tidyselect r_suggests_vctrs r_suggests_withr
