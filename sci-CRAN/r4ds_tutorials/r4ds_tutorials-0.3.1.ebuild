...
SRC_URI="http://cran.r-project.org/src/contrib/r4ds.tutorials_0.3.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_arrow r_suggests_babynames r_suggests_dbplyr
	r_suggests_dplyr r_suggests_duckdb r_suggests_gert
	r_suggests_gghighlight r_suggests_ggrepel r_suggests_ggridges
	r_suggests_ggthemes r_suggests_gitcreds r_suggests_gt
	...
	r_suggests_reprex r_suggests_repurrrsive r_suggests_rsconnect
	r_suggests_rvest r_suggests_testthat r_suggests_tidymodels
