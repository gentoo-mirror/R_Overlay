...
SRC_URI="http://cran.r-project.org/src/contrib/r4ds.tutorials_0.3.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_babynames r_suggests_dbplyr r_suggests_dplyr
	...
	r_suggests_gitcreds r_suggests_hexbin r_suggests_janitor
	r_suggests_lahman r_suggests_learnr r_suggests_maps
