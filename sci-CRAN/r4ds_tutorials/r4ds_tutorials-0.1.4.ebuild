...
SRC_URI="http://cran.r-project.org/src/contrib/r4ds.tutorials_0.1.4.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_arrow r_suggests_babynames r_suggests_dbplyr
	r_suggests_dplyr r_suggests_duckdb r_suggests_dygraphs
	r_suggests_gghighlight r_suggests_ggrepel r_suggests_ggthemes
	r_suggests_hexbin r_suggests_janitor r_suggests_lahman
	r_suggests_leaflet r_suggests_learnr r_suggests_maps
	r_suggests_nycflights13 r_suggests_palmerpenguins
	r_suggests_patchwork r_suggests_plotly r_suggests_readxl
