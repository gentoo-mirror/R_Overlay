...
SRC_URI="http://cran.r-project.org/src/contrib/iml_0.2.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_caret r_suggests_e1071 r_suggests_gower
	r_suggests_lime r_suggests_mass r_suggests_mlr
