...
SRC_URI="http://cran.r-project.org/src/contrib/estimatr_0.24.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_car r_suggests_clubsandwich
	...
	r_suggests_ivpack r_suggests_lfe r_suggests_margins
	r_suggests_modelsummary r_suggests_prediction r_suggests_randomizr
