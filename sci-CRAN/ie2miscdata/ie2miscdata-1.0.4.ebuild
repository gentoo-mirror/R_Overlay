...
SRC_URI="http://cran.r-project.org/src/contrib/ie2miscdata_1.0.4.tar.gz"
LICENSE='CC0-1.0'

IUSE="${IUSE-} r_suggests_data_table r_suggests_ggplot2 r_suggests_gotop
	r_suggests_knitr r_suggests_lubridate r_suggests_mgsub
	r_suggests_reader r_suggests_rmarkdown r_suggests_rvest r_suggests_sf
	r_suggests_spatstat_geom r_suggests_spelling r_suggests_stringi
