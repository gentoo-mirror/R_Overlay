...
SRC_URI="http://cran.r-project.org/src/contrib/rtables_0.6.10.tar.gz"
LICENSE='Apache-2.0'
...
R_SUGGESTS="
	r_suggests_broom? ( >=sci-CRAN/broom-1.0.6 )
	r_suggests_car? ( >=sci-CRAN/car-3.0.13 )
	r_suggests_dplyr? ( >=sci-CRAN/dplyr-1.0.5 )
	r_suggests_flextable? ( >=sci-CRAN/flextable-0.9.6 )
	r_suggests_knitr? ( >=sci-CRAN/knitr-1.42 )
	r_suggests_officer? ( >=sci-CRAN/officer-0.6.6 )
...
"
DEPEND=">=sci-CRAN/formatters-0.5.9
