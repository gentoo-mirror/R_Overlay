...
SRC_URI="http://cran.r-project.org/src/contrib/dataquieR_2.1.0.tar.gz"
LICENSE='BSD-2'
...
IUSE="${IUSE-} r_suggests_anytime r_suggests_callr r_suggests_cli
	...
	r_suggests_future r_suggests_ggally r_suggests_ggvenn
	r_suggests_htmltools r_suggests_htmlwidgets r_suggests_knitr
	r_suggests_markdown r_suggests_mgcv r_suggests_parallelly
	r_suggests_pkgload r_suggests_plotly r_suggests_processx
	r_suggests_r6 r_suggests_rdpack r_suggests_rjava r_suggests_rmarkdown
	r_suggests_rstudioapi r_suggests_rvest r_suggests_shiny
	r_suggests_testthat r_suggests_textutils r_suggests_tibble
	r_suggests_vdiffr r_suggests_whoami r_suggests_xml2"
R_SUGGESTS="
