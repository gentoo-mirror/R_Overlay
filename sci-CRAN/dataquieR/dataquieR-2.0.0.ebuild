...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/dataquieR_2.0.0.tar.gz"
LICENSE='BSD-2'

IUSE="${IUSE-} r_suggests_anytime r_suggests_callr r_suggests_cli
	r_suggests_colorspace r_suggests_cowplot r_suggests_digest
	r_suggests_dt r_suggests_flexdashboard r_suggests_flexsiteboard
	r_suggests_ggvenn r_suggests_htmltools r_suggests_htmlwidgets
	r_suggests_knitr r_suggests_lifecycle r_suggests_markdown
	r_suggests_pkgload r_suggests_plotly r_suggests_rdpack
	r_suggests_rmarkdown r_suggests_rstudioapi r_suggests_testthat
	r_suggests_tibble r_suggests_vdiffr r_suggests_whoami
	r_suggests_withr"
R_SUGGESTS="
