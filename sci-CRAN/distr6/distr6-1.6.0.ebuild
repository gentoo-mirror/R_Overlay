...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/distr6_1.6.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_actuar r_suggests_cubature r_suggests_extradistr
	...
	r_suggests_plotly r_suggests_pracma r_suggests_r62s3
...
R_SUGGESTS="
	...
	r_suggests_r62s3? ( >=sci-CRAN/R62S3-1.4.0 )
	r_suggests_rmarkdown? ( sci-CRAN/rmarkdown )
	r_suggests_testthat? ( sci-CRAN/testthat )
"
DEPEND=">=sci-CRAN/param6-0.2.1
	sci-CRAN/R6
	sci-CRAN/checkmate
	sci-CRAN/Rcpp
	sci-CRAN/data_table
