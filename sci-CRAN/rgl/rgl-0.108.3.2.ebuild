...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/rgl_0.108.3.2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_akima r_suggests_alphashape3d r_suggests_crosstalk
	r_suggests_deldir r_suggests_downlit r_suggests_extrafont
	r_suggests_interp r_suggests_js r_suggests_lattice r_suggests_magick
	r_suggests_markdown r_suggests_mass r_suggests_misc3d
	r_suggests_orientlib r_suggests_plotrix r_suggests_rmarkdown
	r_suggests_rstudio r_suggests_shiny r_suggests_testthat r_suggests_tk
	r_suggests_tripack"
R_SUGGESTS="
