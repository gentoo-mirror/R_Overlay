...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/rgl_1.2.1.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_alphashape3d r_suggests_chromote
	...
	r_suggests_plotrix r_suggests_png r_suggests_rmarkdown
	r_suggests_rstudio r_suggests_shiny r_suggests_testthat r_suggests_tk
	r_suggests_tripack r_suggests_v8 r_suggests_webshot2"
R_SUGGESTS="
