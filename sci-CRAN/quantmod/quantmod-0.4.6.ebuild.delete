...
SRC_URI="http://cran.r-project.org/src/contrib/quantmod_0.4-6.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_dbi r_suggests_downloader r_suggests_its
	r_suggests_jsonlite r_suggests_rmysql r_suggests_rsqlite
