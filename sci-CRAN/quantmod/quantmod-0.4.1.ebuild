...
SRC_URI="http://cran.r-project.org/src/contrib/quantmod_0.4-1.tar.gz -> cran_quantmod_0.4-1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_dbi r_suggests_defaults r_suggests_its
