...
DESCRIPTION='High Performance, Low Friction L... (see metadata)'
KEYWORDS="~amd64 ~x64-macos ~arm64-macos"
SRC_URI="http://cran.r-project.org/src/contrib/gander_0.1.0.tar.gz"
LICENSE='MIT'
...
"
DEPEND="sci-CRAN/treesitter
	sci-CRAN/treesitter_r
	>=dev-lang/R-4.3.0
	>=sci-CRAN/glue-1.8.0
	>=sci-CRAN/miniUI-0.1.1.1
	>=sci-CRAN/ellmer-0.1.0
	>=sci-CRAN/cli-3.6.3
