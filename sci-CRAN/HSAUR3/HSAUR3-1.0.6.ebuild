...
SRC_URI="http://cran.r-project.org/src/contrib/HSAUR3_1.0-6.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_alr3 r_suggests_ape r_suggests_boot
	r_suggests_coin r_suggests_flexmix r_suggests_formula
	r_suggests_gamair r_suggests_gamlss_data r_suggests_gee
...
R_SUGGESTS="
	...
	r_suggests_boot? ( >=sci-CRAN/boot-1.3.9 )
	...
	r_suggests_rpart? ( >=sci-CRAN/rpart-4.1.4 )
	...
	r_suggests_survival? ( >=sci-CRAN/survival-2.37.4 )
