...
SRC_URI="http://cran.r-project.org/src/contrib/HSAUR3_1.0-3.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_alr3 r_suggests_ape r_suggests_coin
	...
	r_suggests_sp r_suggests_th_data r_suggests_tm r_suggests_vcd
...
_UNRESOLVED_PACKAGES=( 'gamlss.data (>= 4.2.6)' )
