...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/HSAUR3_1.0-14.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_ape r_suggests_boot r_suggests_coin
	...
	r_suggests_maps r_suggests_mass r_suggests_mboost r_suggests_mclust
	r_suggests_mgcv r_suggests_mice r_suggests_mlbench
...
_UNRESOLVED_PACKAGES=( '>=sci-CRAN/sf-1.0.9' )
