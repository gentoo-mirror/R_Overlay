...
SRC_URI="http://cran.r-project.org/src/contrib/babelmixr2_0.1.4.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_dplyr r_suggests_knitr r_suggests_nlmixr2data
