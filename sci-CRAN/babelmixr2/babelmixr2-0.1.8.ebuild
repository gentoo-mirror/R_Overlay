...
SRC_URI="http://cran.r-project.org/src/contrib/babelmixr2_0.1.8.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_devtools r_suggests_dplyr r_suggests_memoise
	r_suggests_nlme r_suggests_pknca r_suggests_poped
