...
SRC_URI="http://cran.r-project.org/src/contrib/pulsar_0.3.4.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_batchtools r_suggests_checkmate r_suggests_cluster
	r_suggests_fs r_suggests_glmnet r_suggests_huge r_suggests_knitr
	r_suggests_mass r_suggests_network r_suggests_orca r_suggests_quic
