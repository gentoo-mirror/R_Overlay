...
SRC_URI="http://cran.r-project.org/src/contrib/NetLogoR_1.0.6.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_circstats r_suggests_covr r_suggests_knitr
	...
	r_suggests_spades_core r_suggests_spades_tools r_suggests_testthat
	r_suggests_withr"
R_SUGGESTS="
	...
	r_suggests_spades_core? ( >=sci-CRAN/SpaDES_core-2.0.3 )
