...
SRC_URI="http://cran.r-project.org/src/contrib/psycModel_0.5.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_correlation r_suggests_covr r_suggests_cowplot
	...
	r_suggests_lavasearch2 r_suggests_nfactors r_suggests_nlme
	r_suggests_pagedown r_suggests_qqplotr r_suggests_rmarkdown
	r_suggests_roxygen2 r_suggests_sandwich r_suggests_see
	r_suggests_semplot r_suggests_spelling r_suggests_testthat"
R_SUGGESTS="
