...
SRC_URI="http://cran.r-project.org/src/contrib/riskRegression_2019.11.03.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_boot r_suggests_coxboost r_suggests_flexsurv
	r_suggests_gbm r_suggests_glmnetutils r_suggests_ipw r_suggests_mets
	r_suggests_mstate r_suggests_party r_suggests_pec
	r_suggests_penalized r_suggests_proc r_suggests_publish
