...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/easyalluvial_0.3.1.tar.gz"
LICENSE='CC0-1.0'
...
IUSE="${IUSE-} r_suggests_caret r_suggests_covr r_suggests_e1071
	...
	r_suggests_parsnip r_suggests_rpart r_suggests_testthat
	r_suggests_vdiffr r_suggests_vip r_suggests_workflows
	r_suggests_xgboost"
R_SUGGESTS="
