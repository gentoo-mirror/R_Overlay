...
SRC_URI="http://cran.r-project.org/src/contrib/tidydann_1.0.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_dann r_suggests_dplyr r_suggests_magrittr
	r_suggests_mlbench r_suggests_modeldata r_suggests_recipes
	r_suggests_rlang r_suggests_rsample r_suggests_scales
	r_suggests_testthat r_suggests_tune r_suggests_workflows
