...
SRC_URI="http://cran.r-project.org/src/contrib/dodgr_0.4.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bench r_suggests_dplyr r_suggests_ggplot2
	r_suggests_igraph r_suggests_igraphdata r_suggests_jsonlite
	r_suggests_knitr r_suggests_markdown r_suggests_rmarkdown
	r_suggests_sf r_suggests_testthat r_suggests_tidygraph"
R_SUGGESTS="
