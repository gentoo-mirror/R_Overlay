...
SRC_URI="http://cran.r-project.org/src/contrib/meta_8.0-1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_biasedurn r_suggests_brglm2 r_suggests_estmeansd
	r_suggests_knitr r_suggests_netmeta r_suggests_pimeta
	r_suggests_rmarkdown r_suggests_robvis r_suggests_writexl"
R_SUGGESTS="
