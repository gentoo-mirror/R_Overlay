...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/tvthemes_1.3.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_cowplot r_suggests_dplyr r_suggests_gapminder
	r_suggests_glue r_suggests_knitr r_suggests_png r_suggests_rmarkdown
...
R_SUGGESTS="
	...
	r_suggests_glue? ( >=sci-CRAN/glue-1.3.1 )
