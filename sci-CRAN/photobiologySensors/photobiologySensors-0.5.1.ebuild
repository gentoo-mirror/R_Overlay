...
DESCRIPTION='Response Data for Light Sensors'
KEYWORDS="~amd64 ~x64-macos ~arm64-macos"
SRC_URI="http://cran.r-project.org/src/contrib/photobiologySensors_0.5.1.tar.gz"
LICENSE='GPL-2+'
...
R_SUGGESTS="
	...
	r_suggests_photobiologywavebands? ( >=sci-CRAN/photobiologyWavebands-0.5.0 )
