...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3_0.1.8.tar.gz"
LICENSE='LGPL-3'
...
IUSE="${IUSE-} r_suggests_bibtex r_suggests_callr r_suggests_evaluate
	...
	r_suggests_matrix r_suggests_progressr r_suggests_rpart
