...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3_1.2.0.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_callr r_suggests_codetools r_suggests_future_callr
	r_suggests_mlr3data r_suggests_progressr r_suggests_remotes
	r_suggests_rhpcblasctl r_suggests_rpart r_suggests_testthat"
R_SUGGESTS="
...
"
DEPEND=">=sci-CRAN/future_apply-1.5.0
	>=sci-CRAN/R6-2.4.1
	sci-CRAN/future
	>=sci-CRAN/lgr-0.3.4
	...
	>=sci-CRAN/mirai-2.4.1
	>=sci-CRAN/checkmate-2.0.0
	>=sci-CRAN/evaluate-1.0.4
	>=sci-CRAN/mlr3misc-0.19.0
	sci-CRAN/parallelly
	sci-CRAN/uuid
