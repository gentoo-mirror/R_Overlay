...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3_0.1.1.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_callr r_suggests_devtools r_suggests_evaluate
