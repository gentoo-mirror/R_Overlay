...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/pkgdepends_0.6.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_asciicast r_suggests_covr r_suggests_debugme
...
"
DEPEND=">=sci-CRAN/prettyunits-1.1.1
	sci-CRAN/rprojroot
	>=dev-lang/R-3.4
	sci-CRAN/ps
	>=sci-CRAN/cli-3.6.0
