...
SRC_URI="http://cran.r-project.org/src/contrib/pkgdepends_0.9.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_asciicast r_suggests_codetools r_suggests_covr
	r_suggests_debugme r_suggests_fansi r_suggests_fs r_suggests_gh
	r_suggests_gitcreds r_suggests_glue r_suggests_htmlwidgets
	r_suggests_mockery r_suggests_pak r_suggests_pingr
...
"
DEPEND=">=sci-CRAN/pkgcache-2.2.0
	sci-CRAN/R6
	sci-CRAN/ps
	sci-CRAN/curl
	>=sci-CRAN/cli-3.6.0
