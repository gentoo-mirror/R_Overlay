...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/pkgdepends_0.3.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_asciicast r_suggests_covr r_suggests_debugme
	r_suggests_digest r_suggests_fansi r_suggests_fs
	r_suggests_htmlwidgets r_suggests_mockery r_suggests_pingr
