...
SRC_URI="http://cran.r-project.org/src/contrib/nestedcv_0.6.9.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_boruta r_suggests_corelearn r_suggests_fastshap
	...
	r_suggests_pbapply r_suggests_randomforest r_suggests_ranger
	r_suggests_rcppeigen r_suggests_rmarkdown r_suggests_superlearner"
R_SUGGESTS="
