...
SRC_URI="http://cran.r-project.org/src/contrib/WeightIt_0.3.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ate r_suggests_cbps r_suggests_ebal
	r_suggests_mlogit r_suggests_mnp r_suggests_slam r_suggests_twang"
R_SUGGESTS="
	r_suggests_ate? ( >=sci-CRAN/ATE-0.2.0 )
	r_suggests_cbps? ( >=sci-CRAN/CBPS-0.15 )
