...
SRC_URI="http://cran.r-project.org/src/contrib/WeightIt_0.8.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ate r_suggests_boot r_suggests_brglm2
	r_suggests_cbps r_suggests_cobalt r_suggests_ebal r_suggests_gbm
	r_suggests_jtools r_suggests_knitr r_suggests_mass r_suggests_misaem
	r_suggests_mlogit r_suggests_mnp r_suggests_optweight
	r_suggests_rmarkdown r_suggests_superlearner r_suggests_survey
	r_suggests_twang"
R_SUGGESTS="
	r_suggests_ate? ( >=sci-CRAN/ATE-0.2.0 )
	r_suggests_boot? ( virtual/boot )
	r_suggests_brglm2? ( >=sci-CRAN/brglm2-0.5.1 )
	...
	r_suggests_misaem? ( sci-CRAN/misaem )
