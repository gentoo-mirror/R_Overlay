...
SRC_URI="http://cran.r-project.org/src/contrib/WeightIt_0.3.2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ate r_suggests_boot r_suggests_cbps
	r_suggests_ebal r_suggests_jtools r_suggests_knitr r_suggests_mlogit
	r_suggests_mnp r_suggests_rmarkdown r_suggests_survey
	r_suggests_twang"
R_SUGGESTS="
