...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/WeightIt_0.13.1.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_ate r_suggests_boot r_suggests_brglm2
	...
	r_suggests_mass r_suggests_mclogit r_suggests_misaem
	r_suggests_mlogit r_suggests_mnp r_suggests_optweight r_suggests_osqp
