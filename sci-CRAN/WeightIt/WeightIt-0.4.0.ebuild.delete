...
SRC_URI="http://cran.r-project.org/src/contrib/WeightIt_0.4.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ate r_suggests_boot r_suggests_cbps
	r_suggests_ebal r_suggests_gbm r_suggests_jtools r_suggests_knitr
	r_suggests_mlogit r_suggests_mnp r_suggests_rmarkdown
