...
SRC_URI="http://cran.r-project.org/src/contrib/WeightIt_1.0.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_brglm2 r_suggests_cbps r_suggests_dbarts
	r_suggests_fwb r_suggests_gbm r_suggests_knitr
	r_suggests_marginaleffects r_suggests_mass r_suggests_mclogit
	r_suggests_misaem r_suggests_mnp r_suggests_optweight r_suggests_osqp
	r_suggests_rmarkdown r_suggests_rootsolve r_suggests_sandwich
	r_suggests_superlearner r_suggests_survival"
R_SUGGESTS="
