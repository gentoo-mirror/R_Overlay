...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/bcmaps_1.0.3.tar.gz"
LICENSE='Apache-2.0'
...
IUSE="${IUSE-} r_suggests_future r_suggests_future_apply r_suggests_ggplot2
	...
	r_suggests_rgeos r_suggests_rmarkdown r_suggests_sp r_suggests_stars
...
DEPEND=">=sci-CRAN/sf-0.9
	...
	>=sci-CRAN/bcdata-0.3.0
	sci-CRAN/xml2
	>=sci-CRAN/jsonlite-1.7.0
"
RDEPEND="${DEPEND-} ${R_SUGGESTS-}"

_UNRESOLVED_PACKAGES=( '>=sci-CRAN/rgdal-1.2.13' )
