...
SRC_URI="http://cran.r-project.org/src/contrib/easybio_1.2.3.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_edger r_suggests_fgsea r_suggests_geoquery
	r_suggests_ggrepel r_suggests_limma r_suggests_litedown
	r_suggests_patchwork r_suggests_seurat r_suggests_testthat"
R_SUGGESTS="
