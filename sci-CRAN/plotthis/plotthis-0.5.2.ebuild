...
SRC_URI="http://cran.r-project.org/src/contrib/plotthis_0.5.2.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_alluvial r_suggests_clustree r_suggests_concaveman
	...
	r_suggests_optimalcutpoints r_suggests_plotroc r_suggests_qqplotr
	r_suggests_scattermore r_suggests_testthat"
R_SUGGESTS="
