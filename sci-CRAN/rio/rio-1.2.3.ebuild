...
SRC_URI="http://cran.r-project.org/src/contrib/rio_1.2.3.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_arrow r_suggests_bit64 r_suggests_clipr
	...
	r_suggests_pzfx r_suggests_qs r_suggests_readods r_suggests_rmarkdown
	r_suggests_rmatio r_suggests_stringi r_suggests_testthat
