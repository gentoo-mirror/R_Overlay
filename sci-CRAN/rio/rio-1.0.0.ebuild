...
SRC_URI="http://cran.r-project.org/src/contrib/rio_1.0.0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_bit64 r_suggests_clipr r_suggests_fst
	r_suggests_hexview r_suggests_jsonlite r_suggests_knitr
	r_suggests_magrittr r_suggests_pzfx r_suggests_qs r_suggests_readods
