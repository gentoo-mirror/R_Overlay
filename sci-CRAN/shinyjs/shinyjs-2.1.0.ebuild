...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/shinyjs_2.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_htmltools r_suggests_knitr r_suggests_rmarkdown
	r_suggests_shinyace r_suggests_shinydisconnect r_suggests_testthat"
R_SUGGESTS="
	r_suggests_htmltools? ( >=sci-CRAN/htmltools-0.2.9 )
