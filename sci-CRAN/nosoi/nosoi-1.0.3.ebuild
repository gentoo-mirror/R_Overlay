...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/nosoi_1.0.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_ape r_suggests_dplyr r_suggests_gganimate
	r_suggests_ggnetwork r_suggests_ggplot2 r_suggests_igraph
	r_suggests_intergraph r_suggests_knitr r_suggests_magrittr
	r_suggests_png r_suggests_rmarkdown r_suggests_testthat
	r_suggests_tidytree r_suggests_tidyverse r_suggests_viridis"
R_SUGGESTS="
