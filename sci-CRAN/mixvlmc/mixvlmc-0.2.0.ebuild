...
SRC_URI="http://cran.r-project.org/src/contrib/mixvlmc_0.2.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_data_table r_suggests_geodist r_suggests_knitr
	r_suggests_rmarkdown r_suggests_testthat r_suggests_tibble
	r_suggests_vdiffr r_suggests_waldo"
R_SUGGESTS="
