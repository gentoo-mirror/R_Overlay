...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/crosstable_0.2.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_crayon r_suggests_desctools
	...
	r_suggests_sloop r_suggests_stringi r_suggests_systemfonts
