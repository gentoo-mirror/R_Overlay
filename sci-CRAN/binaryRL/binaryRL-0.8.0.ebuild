...
SRC_URI="http://cran.r-project.org/src/contrib/binaryRL_0.8.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_cmaes r_suggests_deoptim r_suggests_ga
	r_suggests_gensa r_suggests_lhs r_suggests_mlr r_suggests_mlrmbo
	r_suggests_paramhelpers r_suggests_pso r_suggests_smoof"
R_SUGGESTS="
