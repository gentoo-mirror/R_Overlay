...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/multiverse_0.5.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_boot r_suggests_broom r_suggests_covr
	r_suggests_cowplot r_suggests_forcats r_suggests_gganimate
	r_suggests_ggplot2 r_suggests_highr r_suggests_lubridate
