...
SRC_URI="http://cran.r-project.org/src/contrib/rddapp_0.1.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_foreign r_suggests_knitr r_suggests_rdd
	r_suggests_rddtools r_suggests_roxygen2 r_suggests_testthat"
R_SUGGESTS="
