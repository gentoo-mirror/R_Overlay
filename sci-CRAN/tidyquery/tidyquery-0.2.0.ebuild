...
SRC_URI="http://cran.r-project.org/src/contrib/tidyquery_0.2.0.tar.gz"
LICENSE='Apache-2.0'

IUSE="${IUSE-} r_suggests_covr r_suggests_dbplyr r_suggests_dtplyr
	r_suggests_nycflights13 r_suggests_rsqlite r_suggests_testthat"
R_SUGGESTS="
