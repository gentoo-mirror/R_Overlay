...
SRC_URI="http://cran.r-project.org/src/contrib/nettskjemar_1.0.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_covr r_suggests_fs r_suggests_haven
	r_suggests_knitr r_suggests_labelled r_suggests_openssl
