...
SRC_URI="http://cran.r-project.org/src/contrib/rxode2_4.1.1.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_crayon r_suggests_curl
	...
	r_suggests_ggrepel r_suggests_htmltools r_suggests_kableextra
	r_suggests_knitr r_suggests_learnr r_suggests_lifecycle
	r_suggests_matrix r_suggests_nlme r_suggests_nlmixr2data
	r_suggests_patchwork r_suggests_pillar r_suggests_pmxtools
	r_suggests_remotes r_suggests_rlang r_suggests_rmarkdown
	r_suggests_rootsolve r_suggests_rsconnect r_suggests_scales
