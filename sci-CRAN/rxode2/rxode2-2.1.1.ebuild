...
SRC_URI="http://cran.r-project.org/src/contrib/rxode2_2.1.1.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_crayon r_suggests_curl
	...
	r_suggests_knitr r_suggests_learnr r_suggests_lifecycle
	r_suggests_matrix r_suggests_nlme r_suggests_nlmixr2data
	r_suggests_patchwork r_suggests_pillar r_suggests_remotes
	r_suggests_rlang r_suggests_rmarkdown r_suggests_rsconnect
	r_suggests_scales r_suggests_shiny r_suggests_stringi
	r_suggests_symengine r_suggests_testthat r_suggests_tibble
	r_suggests_tidyr r_suggests_units r_suggests_usethis
	r_suggests_vdiffr r_suggests_withr r_suggests_xgxr"
R_SUGGESTS="
...
DEPEND="sci-CRAN/qs
	...
	>=sci-CRAN/lotri-0.4.0
	sci-CRAN/sys
	>=sci-CRAN/rxode2et-2.0.9
	>sci-CRAN/rxode2random-2.0.11
	sci-CRAN/magrittr
	>=sci-CRAN/data_table-1.12.4
	sci-CRAN/rex
	sci-CRAN/checkmate
	>=sci-CRAN/rxode2ll-2.0.9
	>sci-CRAN/rxode2parse-2.0.16
