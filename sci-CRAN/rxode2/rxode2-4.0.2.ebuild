...
SRC_URI="http://cran.r-project.org/src/contrib/rxode2_4.0.2.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_crayon r_suggests_curl
	...
	r_suggests_pmxtools r_suggests_remotes r_suggests_rlang
	r_suggests_rmarkdown r_suggests_rsconnect r_suggests_scales
	r_suggests_shiny r_suggests_stringi r_suggests_symengine
	r_suggests_testthat r_suggests_tibble r_suggests_tidyr
	r_suggests_units r_suggests_usethis r_suggests_vdiffr
	r_suggests_withr r_suggests_xgxr"
R_SUGGESTS="
