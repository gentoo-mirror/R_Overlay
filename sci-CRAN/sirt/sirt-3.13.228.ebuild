...
SRC_URI="http://cran.r-project.org/src/contrib/sirt_3.13-228.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_coda r_suggests_igraph r_suggests_lavaan
	r_suggests_mass r_suggests_matrix r_suggests_miceadds
	r_suggests_minqa r_suggests_mirt r_suggests_mvtnorm r_suggests_nloptr
	r_suggests_optimx r_suggests_pbivnorm r_suggests_pbv r_suggests_psych
