...
SRC_URI="http://cran.r-project.org/src/contrib/lsmeans_2.18.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_afex r_suggests_car r_suggests_carbayes
	r_suggests_coxme r_suggests_gee r_suggests_geepack
	r_suggests_glmmadmb r_suggests_lme4 r_suggests_mcmcglmm
