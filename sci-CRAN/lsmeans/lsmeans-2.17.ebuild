...
SRC_URI="http://cran.r-project.org/src/contrib/lsmeans_2.17.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_car r_suggests_mcmcpack r_suggests_mediation
