...
SRC_URI="http://cran.r-project.org/src/contrib/saros_1.2.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_covr r_suggests_haven r_suggests_labelled
	r_suggests_readr r_suggests_spelling r_suggests_srvyr
	r_suggests_testthat r_suggests_tibble r_suggests_vdiffr
	r_suggests_withr r_suggests_writexl"
R_SUGGESTS="
