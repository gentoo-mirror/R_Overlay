...
SRC_URI="http://cran.r-project.org/src/contrib/bigsnpr_1.12.21.tar.gz"
LICENSE='GPL-3'
...
DEPEND="sci-CRAN/bigreadr
	...
	>=sci-CRAN/bigstatsr-1.6.2
	>=sci-CRAN/bigassertr-0.1.7
	>=sci-CRAN/bigsparser-0.6
