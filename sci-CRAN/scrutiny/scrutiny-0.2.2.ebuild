...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/scrutiny_0.2.2.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_covr r_suggests_devtools r_suggests_ellipsis
	r_suggests_ggplot2 r_suggests_ggrepel r_suggests_janitor
