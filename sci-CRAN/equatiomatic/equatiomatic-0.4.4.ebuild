...
SRC_URI="http://cran.r-project.org/src/contrib/equatiomatic_0.4.4.tar.gz"
...
IUSE="${IUSE-} r_suggests_covr r_suggests_forecast r_suggests_ggplot2
	...
	r_suggests_mass r_suggests_ordinal r_suggests_parsnip
	r_suggests_recipes r_suggests_shinywidgets r_suggests_spelling
