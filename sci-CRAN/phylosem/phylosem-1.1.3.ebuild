...
SRC_URI="http://cran.r-project.org/src/contrib/phylosem_1.1.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_adephylo r_suggests_fishtree r_suggests_ggplot2
	r_suggests_knitr r_suggests_phylolm r_suggests_phylosignal
	r_suggests_phyr r_suggests_rmarkdown r_suggests_rphylopars
	r_suggests_semplot r_suggests_testthat r_suggests_treetools"
R_SUGGESTS="
