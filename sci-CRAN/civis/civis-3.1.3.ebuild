...
SRC_URI="http://cran.r-project.org/src/contrib/civis_3.1.3.tar.gz"
LICENSE='BSD'

IUSE="${IUSE-} r_suggests_feather r_suggests_ggplot2 r_suggests_knitr
	r_suggests_lifecycle r_suggests_mockery r_suggests_r_utils
