...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/jSDM_0.2.2.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bayescomm r_suggests_bookdown r_suggests_covr
	r_suggests_dplyr r_suggests_ggplot2 r_suggests_hmsc r_suggests_knitr
