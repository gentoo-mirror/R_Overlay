...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/rempsyc_0.1.2.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_boot r_suggests_broom r_suggests_correlation
	...
	r_suggests_ggplot2 r_suggests_ggpubr r_suggests_ggrepel
	r_suggests_ggsignif r_suggests_insight r_suggests_interactions
	r_suggests_knitr r_suggests_lmtest r_suggests_markdown
	r_suggests_openxlsx2 r_suggests_patchwork r_suggests_performance
	r_suggests_psych r_suggests_qqplotr r_suggests_report
...
_UNRESOLVED_PACKAGES=( '>=sci-CRAN/flextable-0.9.1' )
