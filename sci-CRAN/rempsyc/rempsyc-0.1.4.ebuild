...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/rempsyc_0.1.4.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_boot r_suggests_broom r_suggests_correlation
	...
	r_suggests_modelbased r_suggests_openxlsx2 r_suggests_patchwork
...
R_SUGGESTS="
	...
	r_suggests_effectsize? ( >=sci-CRAN/effectsize-0.8.3 )
