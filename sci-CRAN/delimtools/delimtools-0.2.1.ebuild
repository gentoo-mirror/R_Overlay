...
SRC_URI="http://cran.r-project.org/src/contrib/delimtools_0.2.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_ape r_suggests_forcats r_suggests_furrr
	r_suggests_future r_suggests_ggfun r_suggests_ggplot2
	r_suggests_gtools r_suggests_here r_suggests_knitr
	r_suggests_patchwork r_suggests_randomcolor r_suggests_rcolorbrewer
	r_suggests_readr r_suggests_rmarkdown r_suggests_scales
	r_suggests_spider r_suggests_tibble r_suggests_tidytree
