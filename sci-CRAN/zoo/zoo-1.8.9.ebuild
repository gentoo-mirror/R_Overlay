...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/zoo_1.8-9.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'

IUSE="${IUSE-} r_suggests_aer r_suggests_chron r_suggests_coda
	r_suggests_fts r_suggests_ggplot2 r_suggests_mondate
	r_suggests_scales r_suggests_stinepack r_suggests_strucchange
