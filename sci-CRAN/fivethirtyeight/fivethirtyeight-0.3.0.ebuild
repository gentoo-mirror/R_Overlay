...
SRC_URI="http://cran.r-project.org/src/contrib/fivethirtyeight_0.3.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_broom r_suggests_corrplot
	...
	r_suggests_hunspell r_suggests_igraph r_suggests_knitr
	r_suggests_lubridate r_suggests_magrittr r_suggests_rmarkdown
	r_suggests_scales r_suggests_stringr r_suggests_tidytext
	r_suggests_tidyverse r_suggests_wordcloud"
R_SUGGESTS="
