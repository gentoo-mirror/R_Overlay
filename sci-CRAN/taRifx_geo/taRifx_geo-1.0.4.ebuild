...
SRC_URI="http://cran.r-project.org/src/contrib/taRifx.geo_1.0.4.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_akima r_suggests_catools r_suggests_fields
	...
	r_suggests_maptools r_suggests_pspline r_suggests_rcurl
	r_suggests_rjsonio r_suggests_shapefiles"
R_SUGGESTS="
