...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/logger_0.2.2.tar.gz"
LICENSE='AGPL-3'
...
IUSE="${IUSE-} r_suggests_callr r_suggests_covr r_suggests_crayon
	...
	r_suggests_slackr r_suggests_syslognet r_suggests_telegram
	r_suggests_testthat r_suggests_txtq"
R_SUGGESTS="
