...
SRC_URI="http://cran.r-project.org/src/contrib/logger_0.4.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_covr r_suggests_crayon r_suggests_devtools
	r_suggests_glue r_suggests_jsonlite r_suggests_knitr r_suggests_mirai
	r_suggests_pander r_suggests_r_utils r_suggests_rmarkdown
	r_suggests_roxygen2 r_suggests_rsyslog r_suggests_shiny
