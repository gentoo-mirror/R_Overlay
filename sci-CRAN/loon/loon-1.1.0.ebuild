...
SRC_URI="http://cran.r-project.org/src/contrib/loon_1.1.0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_dplyr r_suggests_graph r_suggests_kernlab
	r_suggests_knitr r_suggests_maps r_suggests_mass r_suggests_pairviz
