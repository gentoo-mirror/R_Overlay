...
SRC_URI="http://cran.r-project.org/src/contrib/loon_1.2.2.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_elemstatlearn r_suggests_formatr r_suggests_graph
	r_suggests_kernlab r_suggests_knitr r_suggests_maps r_suggests_mass
	r_suggests_pairviz r_suggests_png r_suggests_rcolorbrewer
	r_suggests_rdrtoolbox r_suggests_rgl r_suggests_rgraphviz
	r_suggests_rmarkdown r_suggests_rnavgraphimagedata
