...
SRC_URI="http://cran.r-project.org/src/contrib/shiny.semantic_0.5.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_chromote r_suggests_covr r_suggests_dplyr
	r_suggests_dt r_suggests_gapminder r_suggests_knitr
	r_suggests_leaflet r_suggests_lintr r_suggests_markdown
	r_suggests_mockery r_suggests_plotly r_suggests_rcmdcheck
