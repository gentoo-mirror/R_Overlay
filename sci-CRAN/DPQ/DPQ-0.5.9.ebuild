...
SRC_URI="http://cran.r-project.org/src/contrib/DPQ_0.5-9.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_cobs r_suggests_dpqmpfr r_suggests_gmp
	r_suggests_interp r_suggests_mass r_suggests_mgcv r_suggests_rmpfr
