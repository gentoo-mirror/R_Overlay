...
SRC_URI="http://cran.r-project.org/src/contrib/causalCmprsk_1.0.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_bookdown r_suggests_cobalt r_suggests_dt
	r_suggests_ggalt r_suggests_ggsci r_suggests_hmisc
	r_suggests_hrbrthemes r_suggests_kableextra r_suggests_knitr
	r_suggests_modeva r_suggests_naniar r_suggests_rmarkdown
	r_suggests_summarytools r_suggests_tidyverse"
R_SUGGESTS="
