...
SRC_URI="http://cran.r-project.org/src/contrib/mvgam_1.1.593.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_coda r_suggests_collapse r_suggests_colorspace
	r_suggests_corpcor r_suggests_extradistr r_suggests_ggarrow
	r_suggests_ggpp r_suggests_ggrepel r_suggests_knitr
	r_suggests_lubridate r_suggests_matrix r_suggests_rjags
	r_suggests_rmarkdown r_suggests_runjags r_suggests_scoringrules
	r_suggests_splines2 r_suggests_testthat r_suggests_tweedie
	r_suggests_usethis r_suggests_wrswor r_suggests_xts"
R_SUGGESTS="
