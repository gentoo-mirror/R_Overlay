...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/RCzechia_1.10.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_devtools r_suggests_dplyr
	...
	r_suggests_rvest r_suggests_s2 r_suggests_scales r_suggests_stringr
	r_suggests_terra r_suggests_testthat r_suggests_units r_suggests_xml2"
R_SUGGESTS="
