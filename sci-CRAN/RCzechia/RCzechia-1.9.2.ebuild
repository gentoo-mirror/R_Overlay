...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/RCzechia_1.9.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_covr r_suggests_devtools r_suggests_dplyr
	r_suggests_ggplot2 r_suggests_knitr r_suggests_lwgeom
	r_suggests_raster r_suggests_readxl r_suggests_rmarkdown
	r_suggests_roxygen2 r_suggests_rvest r_suggests_s2 r_suggests_scales
