...
SRC_URI="http://cran.r-project.org/src/contrib/treestats_1.0.5.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_adephylo r_suggests_castor r_suggests_ddd
	r_suggests_geiger r_suggests_ggplot2 r_suggests_knitr
	r_suggests_lintr r_suggests_nltt r_suggests_phylotop
	r_suggests_picante r_suggests_rmarkdown r_suggests_rpanda
...
_UNRESOLVED_PACKAGES=( 'sci-CRAN/nodeSub' )
