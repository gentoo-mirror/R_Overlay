...
SRC_URI="http://cran.r-project.org/src/contrib/treestats_1.70.7.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_abcrf r_suggests_adephylo r_suggests_castor
	...
	r_suggests_pheatmap r_suggests_phylotop r_suggests_phytools
	r_suggests_picante r_suggests_rmarkdown r_suggests_rpanda
	r_suggests_rspectra r_suggests_testthat r_suggests_tibble"
R_SUGGESTS="
