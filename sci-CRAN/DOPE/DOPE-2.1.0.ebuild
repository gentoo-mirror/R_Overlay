...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/DOPE_2.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_conflicted r_suggests_knitr r_suggests_purrr
	r_suggests_readr r_suggests_rmarkdown r_suggests_rvest
	r_suggests_sqldf r_suggests_testthat r_suggests_tidyr
