...
SRC_URI="http://cran.r-project.org/src/contrib/dartR.base_1.0.5.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_boot r_suggests_devtools r_suggests_directlabels
	...
	r_suggests_stringi r_suggests_terra r_suggests_testthat
	r_suggests_tibble r_suggests_vcfr r_suggests_viridis r_suggests_zoo"
R_SUGGESTS="
