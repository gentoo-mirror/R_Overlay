...
SRC_URI="http://cran.r-project.org/src/contrib/dartR.base_0.49.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_boot r_suggests_devtools r_suggests_directlabels
	...
	r_suggests_leaflet r_suggests_leaflet_minicharts r_suggests_maptools
	r_suggests_markdown r_suggests_mmod r_suggests_networkd3
	r_suggests_pegas r_suggests_pheatmap r_suggests_plotly
	r_suggests_poppr r_suggests_proxy r_suggests_purrr r_suggests_qvalue
