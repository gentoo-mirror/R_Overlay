...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/sdmTMB_0.2.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bayesplot r_suggests_dharma r_suggests_dplyr
	...
	r_suggests_rstan r_suggests_sf r_suggests_splancs r_suggests_testthat
	r_suggests_tibble r_suggests_tmbstan r_suggests_visreg"
R_SUGGESTS="
