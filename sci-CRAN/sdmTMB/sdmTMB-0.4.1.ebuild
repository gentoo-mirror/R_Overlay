...
SRC_URI="http://cran.r-project.org/src/contrib/sdmTMB_0.4.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_dplyr r_suggests_effects r_suggests_emmeans
	...
	r_suggests_glmmtmb r_suggests_knitr r_suggests_rmarkdown
	r_suggests_sf r_suggests_splancs r_suggests_testthat
	r_suggests_tibble r_suggests_visreg"
R_SUGGESTS="
