...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/timetk_2.6.1.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_broom r_suggests_fracdiff r_suggests_knitr
	r_suggests_parsnip r_suggests_rmarkdown r_suggests_robets
	r_suggests_roxygen2 r_suggests_scales r_suggests_testthat
	r_suggests_tidymodels r_suggests_tidyquant r_suggests_tidyverse
