...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/timetk_2.8.2.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_broom r_suggests_covr r_suggests_fracdiff
	...
	r_suggests_tidyquant r_suggests_tidyverse r_suggests_timeseries
	r_suggests_tseries r_suggests_tune r_suggests_workflows
