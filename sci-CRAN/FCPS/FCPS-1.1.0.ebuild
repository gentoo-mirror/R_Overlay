...
SRC_URI="http://cran.r-project.org/src/contrib/FCPS_1.1.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_abcanalysis r_suggests_adpclust r_suggests_cclust
	r_suggests_cluster r_suggests_databionicswarm r_suggests_dbscan
	r_suggests_densityclust r_suggests_energy r_suggests_flexclust
	r_suggests_kernlab r_suggests_kohonen r_suggests_matrix
	r_suggests_mcl r_suggests_mstknnclust r_suggests_orclus
	r_suggests_plotly r_suggests_pracma r_suggests_protoclust
	r_suggests_r_utils r_suggests_reshape2 r_suggests_signal
