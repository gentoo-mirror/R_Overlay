...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/FCPS_1.3.3.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_abcanalysis r_suggests_adpclust r_suggests_cclust
	...
	r_suggests_mixtools r_suggests_moments r_suggests_mstknnclust
	r_suggests_networktoolbox r_suggests_orclus r_suggests_paralleldist
...
R_SUGGESTS="
	...
	r_suggests_cluster? ( virtual/cluster virtual/cluster virtual/cluster virtual/cluster virtual/cluster virtual/cluster virtual/cluster virtual/cluster )
