...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/FCPS_1.3.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_abcanalysis r_suggests_adpclust r_suggests_cclust
	r_suggests_class r_suggests_cluster r_suggests_clustrd
	r_suggests_clustvarsel r_suggests_databionicswarm r_suggests_dbscan
	r_suggests_dendextend r_suggests_densityclust r_suggests_energy
	r_suggests_flexclust r_suggests_igraph r_suggests_kernlab
	r_suggests_knitr r_suggests_kohonen r_suggests_leiden
	r_suggests_matrix r_suggests_mcl r_suggests_mixtools
	r_suggests_moments r_suggests_mstknnclust r_suggests_networktoolbox
	r_suggests_orclus r_suggests_plotly r_suggests_ppci
	r_suggests_prabclus r_suggests_pracma r_suggests_prclust
	r_suggests_protoclust r_suggests_r_utils r_suggests_reshape2
	r_suggests_rgl r_suggests_rmarkdown r_suggests_signal
	r_suggests_sparcl r_suggests_spectrum r_suggests_subspace
	r_suggests_tclust r_suggests_varsellcm r_suggests_yardstick"
R_SUGGESTS="
