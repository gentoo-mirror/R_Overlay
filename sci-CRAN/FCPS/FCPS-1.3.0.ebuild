...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/FCPS_1.3.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_abcanalysis r_suggests_adpclust r_suggests_cclust
	...
	r_suggests_flexclust r_suggests_kernlab r_suggests_knitr
	r_suggests_kohonen r_suggests_matrix r_suggests_mcl
	...
	r_suggests_tclust r_suggests_varsellcm"
R_SUGGESTS="
