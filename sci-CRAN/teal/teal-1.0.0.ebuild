...
SRC_URI="http://cran.r-project.org/src/contrib/teal_1.0.0.tar.gz"
LICENSE='Apache-2.0'

IUSE="${IUSE-} r_suggests_ggplot2 r_suggests_knitr r_suggests_mirai
	r_suggests_r6 r_suggests_renv r_suggests_rmarkdown
...
"
DEPEND=">=sci-CRAN/teal_widgets-0.5.0
	sci-CRAN/shinyjs
	>=sci-CRAN/teal_code-0.7.0
	sci-CRAN/jsonlite
	>=sci-CRAN/teal_reporter-0.5.0
	>=sci-CRAN/teal_slice-0.7.0
