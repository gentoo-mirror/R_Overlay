...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/gtsummary_1.6.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_aod r_suggests_broom_mixed r_suggests_car
	r_suggests_covr r_suggests_effectsize r_suggests_emmeans
	r_suggests_flextable r_suggests_ftextra r_suggests_geepack
...
R_SUGGESTS="
	...
	r_suggests_ftextra? ( >=sci-CRAN/ftExtra-0.4.0 )
	...
	r_suggests_parameters? ( >=sci-CRAN/parameters-0.16.0 )
