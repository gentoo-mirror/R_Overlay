...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/gtsummary_1.5.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_broom_mixed r_suggests_car r_suggests_covr
	r_suggests_effectsize r_suggests_emmeans r_suggests_flextable
	r_suggests_geepack r_suggests_ggally r_suggests_hmisc
	r_suggests_insight r_suggests_lme4 r_suggests_mgcv r_suggests_mice
	r_suggests_nnet r_suggests_officer r_suggests_parameters
	r_suggests_parsnip r_suggests_rmarkdown r_suggests_sandwich
	r_suggests_scales r_suggests_smd r_suggests_spelling
...
R_SUGGESTS="
	...
	r_suggests_effectsize? ( >=sci-CRAN/effectsize-0.4.0 )
	r_suggests_emmeans? ( >=sci-CRAN/emmeans-1.7.2 )
	r_suggests_flextable? ( >=sci-CRAN/flextable-0.5.10 )
	r_suggests_geepack? ( sci-CRAN/geepack )
	r_suggests_ggally? ( >=sci-CRAN/GGally-2.1.0 )
	r_suggests_hmisc? ( sci-CRAN/Hmisc )
	r_suggests_insight? ( >=sci-CRAN/insight-0.14.4 )
	r_suggests_lme4? ( sci-CRAN/lme4 )
	r_suggests_mgcv? ( virtual/mgcv )
	r_suggests_mice? ( >=sci-CRAN/mice-3.10.0 )
	r_suggests_nnet? ( virtual/nnet )
	r_suggests_officer? ( sci-CRAN/officer )
	r_suggests_parameters? ( >=sci-CRAN/parameters-0.6.0 )
	...
	r_suggests_workflows? ( >=sci-CRAN/workflows-0.2.3 )
"
DEPEND=">=sci-CRAN/gt-0.3.1
	>=sci-CRAN/knitr-1.29
