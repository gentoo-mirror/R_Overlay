...
SRC_URI="http://cran.r-project.org/src/contrib/gtsummary_2.3.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_aod r_suggests_broom r_suggests_broom_helpers
	r_suggests_broom_mixed r_suggests_car r_suggests_cardx
	r_suggests_cmprsk r_suggests_effectsize r_suggests_emmeans
	r_suggests_flextable r_suggests_geepack r_suggests_ggstats
	r_suggests_insight r_suggests_kableextra r_suggests_knitr
	r_suggests_lme4 r_suggests_mice r_suggests_nnet r_suggests_officer
	r_suggests_openxlsx r_suggests_parameters r_suggests_parsnip
	r_suggests_rmarkdown r_suggests_smd r_suggests_spelling
...
R_SUGGESTS="
	...
	r_suggests_broom_helpers? ( >=sci-CRAN/broom_helpers-1.20.0 )
	r_suggests_broom_mixed? ( >=sci-CRAN/broom_mixed-0.2.9 )
	r_suggests_car? ( >=sci-CRAN/car-3.0.11 )
	r_suggests_cardx? ( >=sci-CRAN/cardx-0.2.5 )
	...
	r_suggests_geepack? ( >=sci-CRAN/geepack-1.3.10 )
	...
	r_suggests_lme4? ( >=sci-CRAN/lme4-1.1.31 )
...
_UNRESOLVED_PACKAGES=( '>=sci-CRAN/huxtable-5.4.0' )
