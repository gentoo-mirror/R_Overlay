...
SRC_URI="http://cran.r-project.org/src/contrib/gtsummary_2.4.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_aod r_suggests_broom r_suggests_broom_helpers
	r_suggests_broom_mixed r_suggests_car r_suggests_cmprsk
	r_suggests_effectsize r_suggests_emmeans r_suggests_flextable
	r_suggests_geepack r_suggests_ggstats r_suggests_insight
