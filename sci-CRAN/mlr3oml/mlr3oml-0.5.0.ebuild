...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mlr3oml_0.5.0.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_farff r_suggests_foreign r_suggests_mlr3proba
	r_suggests_rweka r_suggests_testthat r_suggests_withr"
R_SUGGESTS="
