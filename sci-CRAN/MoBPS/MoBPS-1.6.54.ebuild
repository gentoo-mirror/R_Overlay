...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/MoBPS_1.6.54.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_bglr r_suggests_biomart r_suggests_dompi
	r_suggests_doparallel r_suggests_dorng r_suggests_emmreml
	r_suggests_foreach r_suggests_gplots r_suggests_jsonlite
	r_suggests_mass r_suggests_matrix r_suggests_nam r_suggests_optisel
	r_suggests_phylogram r_suggests_rcolorbrewer r_suggests_rrblup
	r_suggests_sommer r_suggests_vcfr"
R_SUGGESTS="
