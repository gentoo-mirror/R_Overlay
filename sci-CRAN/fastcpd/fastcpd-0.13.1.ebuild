...
SRC_URI="http://cran.r-project.org/src/contrib/fastcpd_0.13.1.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_abind r_suggests_breakfast r_suggests_changepoint
	...
	r_suggests_ggplot2 r_suggests_gridextra r_suggests_inspectchangepoint
	r_suggests_jointseg r_suggests_knitr r_suggests_lubridate
	r_suggests_matrix r_suggests_mcp r_suggests_mockthat r_suggests_mosum
	r_suggests_mvtnorm r_suggests_not r_suggests_numderiv
	r_suggests_rbeast r_suggests_rmarkdown r_suggests_segmented
	r_suggests_stepr r_suggests_strucchange r_suggests_testthat
	r_suggests_vardetect r_suggests_wbs r_suggests_xml2 r_suggests_zoo"
R_SUGGESTS="
