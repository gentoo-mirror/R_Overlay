...
SRC_URI="http://cran.r-project.org/src/contrib/fastcpd_0.9.9.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_abind r_suggests_desctools r_suggests_ggplot2
	r_suggests_gridextra r_suggests_knitr r_suggests_lubridate
	r_suggests_mockthat r_suggests_mvtnorm r_suggests_numderiv
