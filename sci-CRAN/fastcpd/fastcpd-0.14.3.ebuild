...
SRC_URI="http://cran.r-project.org/src/contrib/fastcpd_0.14.3.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_abind r_suggests_breakfast r_suggests_changepoint
	r_suggests_cpm r_suggests_cptnonpar r_suggests_dplyr r_suggests_fpop
	r_suggests_ggplot2 r_suggests_gridextra r_suggests_jointseg
	r_suggests_knitr r_suggests_lubridate r_suggests_matrix
	r_suggests_mockthat r_suggests_mvtnorm r_suggests_not
	r_suggests_numderiv r_suggests_rcppclock r_suggests_reshape2
	r_suggests_rmarkdown r_suggests_segmented r_suggests_stepr
	r_suggests_testthat r_suggests_vardetect r_suggests_wbs
