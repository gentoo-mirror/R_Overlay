...
SRC_URI="http://cran.r-project.org/src/contrib/metabodecon_1.6.2.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_covr r_suggests_devtools r_suggests_diffobj
	r_suggests_digest r_suggests_glue r_suggests_impute r_suggests_knitr
	r_suggests_lifecycle r_suggests_mass r_suggests_pkgbuild
	r_suggests_pkgload r_suggests_r_devices r_suggests_rcmdcheck
	r_suggests_remotes r_suggests_rmarkdown r_suggests_testthat
	r_suggests_usethis r_suggests_v8 r_suggests_vdiffr r_suggests_waldo"
R_SUGGESTS="
