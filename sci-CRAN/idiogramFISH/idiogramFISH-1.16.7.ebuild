...
SRC_URI="http://cran.r-project.org/src/contrib/idiogramFISH_1.16.7.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_badger r_suggests_ggplot2 r_suggests_ggpubr
	r_suggests_ggtree r_suggests_kableextra r_suggests_knitr
	r_suggests_phytools r_suggests_plyr r_suggests_rcurl
	r_suggests_rentrez r_suggests_rmarkdown r_suggests_rmdformats
