...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/RRphylo_2.7.0.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_car r_suggests_cluster r_suggests_ddpcr
	...
	r_suggests_pdftools r_suggests_phangorn r_suggests_phylolm
	...
	r_suggests_vegan r_suggests_webshot2"
R_SUGGESTS="
