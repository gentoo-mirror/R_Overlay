...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/RRphylo_2.6.3.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_car r_suggests_cluster r_suggests_ddpcr
	r_suggests_evolqg r_suggests_geomorph r_suggests_ggplot2
	r_suggests_inflection r_suggests_knitr r_suggests_markdown
	r_suggests_morpho r_suggests_mvmorph r_suggests_nlme
	r_suggests_pdftools r_suggests_phangorn r_suggests_picante
	r_suggests_plotrix r_suggests_qpdf r_suggests_r_utils
	r_suggests_rcolorbrewer r_suggests_rgl r_suggests_rlist
	r_suggests_rmarkdown r_suggests_rphylopars r_suggests_rstudio
	r_suggests_rvcg r_suggests_scales r_suggests_smatr r_suggests_vegan"
R_SUGGESTS="
