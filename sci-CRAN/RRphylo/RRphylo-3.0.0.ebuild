...
SRC_URI="http://cran.r-project.org/src/contrib/RRphylo_3.0.0.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_car r_suggests_cluster r_suggests_ddpcr
	...
	r_suggests_rphylopars r_suggests_rstudio r_suggests_rvcg
	r_suggests_scales r_suggests_smatr r_suggests_testthat
