...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/RRphylo_2.5.8.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_car r_suggests_cluster r_suggests_ddpcr
	...
	r_suggests_plotrix r_suggests_r_utils r_suggests_rcolorbrewer
	r_suggests_rgl r_suggests_rlist r_suggests_rmarkdown
