...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/targets_0.12.1.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_arrow r_suggests_bs4dash r_suggests_cluster
	...
	r_suggests_paws r_suggests_pingr r_suggests_pkgload
	r_suggests_processx r_suggests_reprex r_suggests_rmarkdown
