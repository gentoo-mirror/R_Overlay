...
SRC_URI="http://cran.r-project.org/src/contrib/targets_1.5.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bs4dash r_suggests_cluster r_suggests_crew
	r_suggests_curl r_suggests_dplyr r_suggests_dt r_suggests_fst
