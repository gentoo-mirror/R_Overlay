...
SRC_URI="http://cran.r-project.org/src/contrib/targets_1.4.1.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_arrow r_suggests_bs4dash r_suggests_cluster
	...
	r_suggests_pingr r_suggests_pkgload r_suggests_processx r_suggests_qs
...
R_SUGGESTS="
	...
	r_suggests_crew? ( >=sci-CRAN/crew-0.7.0 )
