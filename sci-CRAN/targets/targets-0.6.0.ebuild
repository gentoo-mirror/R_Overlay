...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/targets_0.6.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_arrow r_suggests_aws_s3 r_suggests_bs4dash
	r_suggests_cluster r_suggests_curl r_suggests_dplyr r_suggests_dt
	r_suggests_future r_suggests_future_callr r_suggests_gt
	r_suggests_knitr r_suggests_markdown r_suggests_pingr
	r_suggests_pkgload r_suggests_rmarkdown r_suggests_rstudioapi
