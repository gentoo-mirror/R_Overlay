...
SRC_URI="http://cran.r-project.org/src/contrib/targets_1.2.2.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_arrow r_suggests_bs4dash r_suggests_cluster
	...
	r_suggests_future r_suggests_future_batchtools
	r_suggests_future_callr r_suggests_gargle
	r_suggests_googlecloudstorager r_suggests_gt r_suggests_markdown
	r_suggests_parallelly r_suggests_paws_storage r_suggests_pingr
...
R_SUGGESTS="
	...
	r_suggests_bs4dash? ( >=sci-CRAN/bs4Dash-2.0.0 )
	r_suggests_cluster? ( virtual/cluster )
	r_suggests_crew? ( >=sci-CRAN/crew-0.3.0 )
	...
	r_suggests_paws_storage? ( >=sci-CRAN/paws_storage-0.2.0 )
