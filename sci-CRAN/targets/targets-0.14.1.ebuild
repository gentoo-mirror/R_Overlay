...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/targets_0.14.1.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_arrow r_suggests_bs4dash r_suggests_cluster
	...
	r_suggests_future_batchtools r_suggests_future_callr
	r_suggests_gargle r_suggests_googlecloudstorager r_suggests_gt
	r_suggests_markdown r_suggests_paws r_suggests_pingr
	r_suggests_pkgload r_suggests_processx r_suggests_qs
	r_suggests_reprex r_suggests_rmarkdown r_suggests_rstudioapi
	r_suggests_shiny r_suggests_shinybusy r_suggests_shinywidgets
	r_suggests_testthat r_suggests_usethis r_suggests_visnetwork"
R_SUGGESTS="
	...
	r_suggests_qs? ( >=sci-CRAN/qs-0.24.1 )
