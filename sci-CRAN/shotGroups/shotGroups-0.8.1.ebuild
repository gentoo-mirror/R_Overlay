...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/shotGroups_0.8.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_bs4dash r_suggests_energy r_suggests_interp
	r_suggests_jsonlite r_suggests_knitr r_suggests_mba
	r_suggests_mvoutlier r_suggests_shiny"
R_SUGGESTS="
