...
SRC_URI="http://cran.r-project.org/src/contrib/datarobot_2.14.1.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_beanplot r_suggests_car r_suggests_data_table
	...
	r_suggests_knitr r_suggests_lintr r_suggests_mass r_suggests_memoise
