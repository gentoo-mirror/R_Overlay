...
SRC_URI="http://cran.r-project.org/src/contrib/plotmo_3.3.4.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_c50 r_suggests_earth r_suggests_gbm
	r_suggests_glmnet r_suggests_mass r_suggests_neuralnet
...
_UNRESOLVED_PACKAGES=( '>=sci-CRAN/glmnetUtils-1.0.3' )
