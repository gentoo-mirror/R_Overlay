...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/spatialEco_1.3-7.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_cluster r_suggests_envstats
	...
	r_suggests_readr r_suggests_rms r_suggests_spatial r_suggests_stringr
	r_suggests_tabularaster r_suggests_terra r_suggests_yaimpute"
R_SUGGESTS="
	...
	r_suggests_tabularaster? ( sci-CRAN/tabularaster )
