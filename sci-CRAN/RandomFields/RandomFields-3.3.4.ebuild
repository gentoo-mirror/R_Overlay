...
SRC_URI="http://cran.r-project.org/src/contrib/RandomFields_3.3.4.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_colorspace r_suggests_gensa r_suggests_geor
	r_suggests_minqa r_suggests_mvtnorm r_suggests_nloptr
	r_suggests_optimx r_suggests_pso r_suggests_r[tk] r_suggests_raster
...
R_SUGGESTS="
	...
	r_suggests_r[tk]? ( dev-lang/R[tk] dev-lang/R[tk] )
