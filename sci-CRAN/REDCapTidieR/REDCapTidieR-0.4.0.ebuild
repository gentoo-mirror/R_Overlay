...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/REDCapTidieR_0.4.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_covr r_suggests_httptest r_suggests_knitr
	r_suggests_labelled r_suggests_lintr r_suggests_openxlsx2
	r_suggests_prettyunits r_suggests_readr r_suggests_rmarkdown
	r_suggests_skimr r_suggests_testthat r_suggests_withr"
R_SUGGESTS="
