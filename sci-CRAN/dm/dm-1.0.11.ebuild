...
SRC_URI="http://cran.r-project.org/src/contrib/dm_1.0.11.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_brio r_suggests_colourpicker r_suggests_covr
	...
	r_suggests_labelled r_suggests_magrittr r_suggests_nycflights13
	r_suggests_odbc r_suggests_pillar r_suggests_pixarfilms
	r_suggests_pool r_suggests_progress r_suggests_reactable
	r_suggests_rmarkdown r_suggests_rpostgres r_suggests_rsqlite
	r_suggests_rstudioapi r_suggests_shiny r_suggests_shinyace
	r_suggests_shinydashboard r_suggests_testthat r_suggests_waldo
	r_suggests_withr"
R_SUGGESTS="
