...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/dm_1.0.6.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_brio r_suggests_colourpicker r_suggests_covr
	...
	r_suggests_labelled r_suggests_mockr r_suggests_nycflights13
	r_suggests_odbc r_suggests_pixarfilms r_suggests_pool
