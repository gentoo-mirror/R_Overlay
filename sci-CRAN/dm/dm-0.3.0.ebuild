...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/dm_0.3.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_brio r_suggests_covr r_suggests_crayon
	...
	r_suggests_digest r_suggests_duckdb r_suggests_fansi
	r_suggests_forcats r_suggests_jsonlite r_suggests_knitr
	...
	r_suggests_testthat r_suggests_tidyverse r_suggests_waldo
	r_suggests_withr"
R_SUGGESTS="
