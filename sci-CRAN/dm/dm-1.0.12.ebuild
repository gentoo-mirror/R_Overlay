...
SRC_URI="http://cran.r-project.org/src/contrib/dm_1.0.12.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_brio r_suggests_colourpicker r_suggests_covr
	r_suggests_dbi r_suggests_dbplyr r_suggests_diagrammer
	r_suggests_diagrammersvg r_suggests_digest r_suggests_duckdb
	r_suggests_fansi r_suggests_forcats r_suggests_htmltools
	r_suggests_htmlwidgets r_suggests_jsonlite r_suggests_keyring
	r_suggests_knitr r_suggests_labelled r_suggests_magrittr
	r_suggests_nycflights13 r_suggests_odbc r_suggests_pillar
	r_suggests_pixarfilms r_suggests_pool r_suggests_progress
	r_suggests_reactable r_suggests_rmarkdown r_suggests_rpostgres
	r_suggests_rsqlite r_suggests_rstudioapi r_suggests_shiny
	r_suggests_shinyace r_suggests_shinydashboard r_suggests_testthat
	r_suggests_tidyverse r_suggests_waldo r_suggests_withr"
R_SUGGESTS="
	...
	r_suggests_odbc? ( >=sci-CRAN/odbc-1.4.2 )
...
_UNRESOLVED_PACKAGES=( '>=sci-CRAN/RMariaDB-1.3.3' )
