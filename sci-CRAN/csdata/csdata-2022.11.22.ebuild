...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/csdata_2022.11.22.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_broom r_suggests_crayon r_suggests_dplyr
	...
	r_suggests_rgeos r_suggests_rmarkdown r_suggests_rstudioapi
	r_suggests_sf r_suggests_sp r_suggests_stringr r_suggests_testthat
