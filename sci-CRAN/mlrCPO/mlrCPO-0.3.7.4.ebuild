...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mlrCPO_0.3.7-4.tar.gz"
LICENSE='BSD-2'

IUSE="${IUSE-} r_suggests_care r_suggests_digest r_suggests_e1071
	r_suggests_fastica r_suggests_fselector r_suggests_fselectorrcpp
	r_suggests_hmisc r_suggests_knitr r_suggests_lintr r_suggests_mlbench
	r_suggests_mrmre r_suggests_party r_suggests_praznik
	r_suggests_randomforest r_suggests_randomforestsrc r_suggests_ranger
	r_suggests_rex r_suggests_rfast r_suggests_rmarkdown r_suggests_rpart
	r_suggests_testthat"
R_SUGGESTS="
