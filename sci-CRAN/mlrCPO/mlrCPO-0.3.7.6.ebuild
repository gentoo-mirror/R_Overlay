...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mlrCPO_0.3.7-6.tar.gz"
LICENSE='BSD-2'

IUSE="${IUSE-} r_suggests_care r_suggests_digest r_suggests_e1071
	r_suggests_fastica r_suggests_fnn r_suggests_fselector
