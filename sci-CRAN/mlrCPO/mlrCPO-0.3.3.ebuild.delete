...
SRC_URI="http://cran.r-project.org/src/contrib/mlrCPO_0.3.3.tar.gz"
LICENSE='BSD-2'
...
IUSE="${IUSE-} r_suggests_care r_suggests_digest r_suggests_discriminer
	...
	r_suggests_randomforestsrc r_suggests_ranger r_suggests_rfast
...
"
DEPEND=">=sci-CRAN/checkmate-1.8.3
