...
IUSE="${IUSE-} r_suggests_descr r_suggests_epi r_suggests_futile_logger
	...
	r_suggests_korpus r_suggests_lattice r_suggests_mass
	r_suggests_memisc r_suggests_microbenchmark r_suggests_nlme
	r_suggests_randomforest r_suggests_reshape r_suggests_rms
