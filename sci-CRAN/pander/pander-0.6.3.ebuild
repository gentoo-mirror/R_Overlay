...
SRC_URI="http://cran.r-project.org/src/contrib/pander_0.6.3.tar.gz"
LICENSE='AGPL-3'
...
IUSE="${IUSE-} r_suggests_data_table r_suggests_descr r_suggests_epi
	...
	r_suggests_gtable r_suggests_knitr r_suggests_lattice r_suggests_mass
	r_suggests_memisc r_suggests_microbenchmark r_suggests_nlme
	r_suggests_randomforest r_suggests_reshape r_suggests_rmarkdown
	r_suggests_rms r_suggests_survival r_suggests_sylly
	r_suggests_sylly_en r_suggests_tables r_suggests_tseries
	r_suggests_zoo"
R_SUGGESTS="
