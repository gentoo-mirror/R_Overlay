...
IUSE="${IUSE-} r_suggests_data_table r_suggests_ie2misc
	r_suggests_ie2miscdata r_suggests_iemisc r_suggests_install_load
	r_suggests_knitr r_suggests_qdap r_suggests_rivr r_suggests_rmarkdown
	r_suggests_rvest r_suggests_stringi"
R_SUGGESTS="
