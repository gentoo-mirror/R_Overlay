...
SRC_URI="http://cran.r-project.org/src/contrib/PatientLevelPrediction_6.5.1.tar.gz"
LICENSE='Apache-2.0'

IUSE="${IUSE-} r_suggests_curl r_suggests_eunomia r_suggests_ggplot2
	r_suggests_glmnet r_suggests_iterativehardthresholding
	r_suggests_knitr r_suggests_lightgbm r_suggests_metrics
	r_suggests_mgcv r_suggests_ohdsishinyappbuilder r_suggests_pkgload
	r_suggests_polspline r_suggests_readr r_suggests_resourceselection
	r_suggests_resultmodelmanager r_suggests_reticulate
	r_suggests_rmarkdown r_suggests_rsqlite r_suggests_scoring
...
R_SUGGESTS="
	...
	r_suggests_resultmodelmanager? ( >=sci-CRAN/ResultModelManager-0.6.0 )
	r_suggests_reticulate? ( >=sci-CRAN/reticulate-1.41 )
