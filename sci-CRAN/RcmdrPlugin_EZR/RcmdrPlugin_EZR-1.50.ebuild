...
SRC_URI="http://cran.r-project.org/src/contrib/RcmdrPlugin.EZR_1.50.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_abind r_suggests_aod r_suggests_aplpack
	r_suggests_car r_suggests_clinfun r_suggests_cmprsk
	r_suggests_foreign r_suggests_lmertest r_suggests_matching
	r_suggests_meta r_suggests_metatest r_suggests_multcomp
	r_suggests_mvtnorm r_suggests_proc r_suggests_readxl
	r_suggests_survival r_suggests_survrm2 r_suggests_tableone"
R_SUGGESTS="
