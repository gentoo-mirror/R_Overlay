...
SRC_URI="http://cran.r-project.org/src/contrib/RcmdrPlugin.EZR_1.51.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_abind r_suggests_aod r_suggests_aplpack
	...
	r_suggests_mvtnorm r_suggests_netmeta r_suggests_proc
	r_suggests_readxl r_suggests_survival r_suggests_survrm2
	r_suggests_tableone"
R_SUGGESTS="
