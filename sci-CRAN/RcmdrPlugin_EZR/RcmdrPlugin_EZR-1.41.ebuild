...
SRC_URI="http://cran.r-project.org/src/contrib/RcmdrPlugin.EZR_1.41.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_abind r_suggests_aod r_suggests_aplpack
	r_suggests_car r_suggests_clinfun r_suggests_cmprsk
	r_suggests_foreign r_suggests_matching r_suggests_meta
...
R_SUGGESTS="
	...
	r_suggests_proc? ( >=sci-CRAN/pROC-1.15.3 )
