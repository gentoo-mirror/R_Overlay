...
SRC_URI="http://cran.r-project.org/src/contrib/xplorerr_0.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_blorr r_suggests_descriptr r_suggests_dt
	r_suggests_haven r_suggests_highcharter r_suggests_inferr
	r_suggests_jsonlite r_suggests_kableextra r_suggests_olsrr
	r_suggests_plotly r_suggests_rbokeh r_suggests_readr
	r_suggests_readxl r_suggests_rfm r_suggests_shinybs
