...
SRC_URI="http://cran.r-project.org/src/contrib/CodelistGenerator_3.5.0.tar.gz"

IUSE="${IUSE-} r_suggests_cdmconnector r_suggests_cohortconstructor
	r_suggests_covr r_suggests_duckdb r_suggests_flextable r_suggests_gt
	r_suggests_knitr r_suggests_odbc r_suggests_omock
