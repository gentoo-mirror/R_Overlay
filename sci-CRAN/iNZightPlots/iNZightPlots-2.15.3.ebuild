...
SRC_URI="http://cran.r-project.org/src/contrib/iNZightPlots_2.15.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_dbi r_suggests_dbplyr
	r_suggests_dplyr r_suggests_forcats r_suggests_ggbeeswarm
	r_suggests_ggmosaic r_suggests_ggplot2 r_suggests_ggridges
	r_suggests_ggtext r_suggests_ggthemes r_suggests_gridsvg
