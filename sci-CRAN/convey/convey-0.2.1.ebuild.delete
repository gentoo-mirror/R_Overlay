...
SRC_URI="http://cran.r-project.org/src/contrib/convey_0.2.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_dbi r_suggests_ic2 r_suggests_knitr
	r_suggests_monetdblite r_suggests_rmarkdown r_suggests_rodbc
	r_suggests_testthat r_suggests_vardpoor"
R_SUGGESTS="
