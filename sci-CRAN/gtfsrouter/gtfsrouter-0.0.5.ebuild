...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/gtfsrouter_0.0.5.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_alphahull r_suggests_digest r_suggests_here
	r_suggests_hms r_suggests_knitr r_suggests_leafem
