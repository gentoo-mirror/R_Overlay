...
SRC_URI="http://cran.r-project.org/src/contrib/mice_3.6.0.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'

IUSE="${IUSE-} r_suggests_agd r_suggests_bsda r_suggests_caliberrfimpute
	r_suggests_gamlss r_suggests_hsaur3 r_suggests_knitr r_suggests_lme4
