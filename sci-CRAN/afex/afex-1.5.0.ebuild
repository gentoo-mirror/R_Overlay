...
SRC_URI="http://cran.r-project.org/src/contrib/afex_1.5-0.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_brms r_suggests_cardata r_suggests_coin
	...
	r_suggests_ggpubr r_suggests_ggresidpanel r_suggests_glmmadaptive
	r_suggests_glmmtmb r_suggests_jtools r_suggests_knitr
	r_suggests_lattice r_suggests_mass r_suggests_matrix r_suggests_memss
	r_suggests_mlmrev r_suggests_multcomp r_suggests_nlme
	r_suggests_nloptr r_suggests_optimx r_suggests_performance
	r_suggests_plyr r_suggests_psychtools r_suggests_r_rsp
