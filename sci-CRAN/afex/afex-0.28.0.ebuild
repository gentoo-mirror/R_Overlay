...
SRC_URI="http://cran.r-project.org/src/contrib/afex_0.28-0.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_brms r_suggests_cardata r_suggests_coin
	...
	r_suggests_nlme r_suggests_nloptr r_suggests_optimx r_suggests_plyr
	r_suggests_psychtools r_suggests_r_rsp r_suggests_rmarkdown
	r_suggests_rstanarm r_suggests_statmod r_suggests_testthat
