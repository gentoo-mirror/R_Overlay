...
SRC_URI="http://cran.r-project.org/src/contrib/afex_0.22-1.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_cardata r_suggests_coin r_suggests_cowplot
	...
	r_suggests_ggpol r_suggests_ggpubr r_suggests_jtools r_suggests_knitr
	r_suggests_lattice r_suggests_matrix r_suggests_memss
