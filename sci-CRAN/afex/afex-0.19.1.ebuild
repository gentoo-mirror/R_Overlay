...
SRC_URI="http://cran.r-project.org/src/contrib/afex_0.19-1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_dfoptim r_suggests_dplyr r_suggests_ggplot2
	r_suggests_knitr r_suggests_lattice r_suggests_latticeextra
	r_suggests_matrix r_suggests_mlmrev r_suggests_multcomp
