...
SRC_URI="http://cran.r-project.org/src/contrib/afex_0.26-0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_brms r_suggests_cardata r_suggests_coin
	r_suggests_cowplot r_suggests_dfoptim r_suggests_dplyr
	r_suggests_effects r_suggests_emmeans r_suggests_ggbeeswarm
	...
	r_suggests_rstanarm r_suggests_testthat r_suggests_tidyr
	r_suggests_xtable"
R_SUGGESTS="
