...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/afex_0.28-1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_cardata r_suggests_coin r_suggests_cowplot
	r_suggests_dfoptim r_suggests_dplyr r_suggests_effects
	r_suggests_emmeans r_suggests_ggbeeswarm r_suggests_ggplot2
	r_suggests_ggpol r_suggests_ggpubr r_suggests_ggresidpanel
