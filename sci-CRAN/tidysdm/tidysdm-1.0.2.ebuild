...
SRC_URI="http://cran.r-project.org/src/contrib/tidysdm_1.0.2.tar.gz"
LICENSE='AGPL-3'
...
IUSE="${IUSE-} r_suggests_blockcv r_suggests_dalextra r_suggests_data_table
	...
	r_suggests_pastclim r_suggests_ranger r_suggests_rgbif
	r_suggests_rhpcblasctl r_suggests_rmarkdown r_suggests_spelling
	r_suggests_stacks r_suggests_testthat r_suggests_tidyterra
	r_suggests_vdiffr"
R_SUGGESTS="
