...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/coveffectsplot_0.0.9.1.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_bayestestr r_suggests_clipr r_suggests_formatr
	...
	r_suggests_ggstance r_suggests_knitr r_suggests_mass
	r_suggests_mrgsolve r_suggests_patchwork r_suggests_plotly
