...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/coveffectsplot_1.0.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_clipr r_suggests_formatr r_suggests_gamlss_dist
	r_suggests_ggrepel r_suggests_ggridges r_suggests_ggstance
