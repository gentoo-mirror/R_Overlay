...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/coveffectsplot_1.0.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_clipr r_suggests_dplyr r_suggests_formatr
	r_suggests_gamlss_dist r_suggests_ggally r_suggests_ggh4x
	r_suggests_ggpmisc r_suggests_ggrepel r_suggests_ggridges
	r_suggests_ggstance r_suggests_knitr r_suggests_markdown
	r_suggests_mass r_suggests_mrgsolve r_suggests_patchwork
	r_suggests_plotly r_suggests_quantreg r_suggests_rcpp
	r_suggests_rmarkdown r_suggests_scales r_suggests_shinyace
	r_suggests_shinyjs r_suggests_shinymeta r_suggests_table1
	r_suggests_tidyr"
R_SUGGESTS="
