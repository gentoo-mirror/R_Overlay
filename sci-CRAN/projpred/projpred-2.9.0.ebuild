...
SRC_URI="http://cran.r-project.org/src/contrib/projpred_2.9.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bayesplot r_suggests_brms r_suggests_dofuture
	...
	r_suggests_progressr r_suggests_rlang r_suggests_rmarkdown
	r_suggests_rstanarm r_suggests_testthat r_suggests_ucminf
	r_suggests_unix r_suggests_vdiffr"
R_SUGGESTS="
