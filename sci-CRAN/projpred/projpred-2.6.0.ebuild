...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/projpred_2.6.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bayesplot r_suggests_brms r_suggests_dofuture
	...
	r_suggests_future_callr r_suggests_ggrepel r_suggests_glmnet
	r_suggests_iterators r_suggests_knitr r_suggests_nlme
	r_suggests_optimx r_suggests_posterior r_suggests_rlang
	r_suggests_rmarkdown r_suggests_rstanarm r_suggests_testthat
	r_suggests_ucminf r_suggests_vdiffr"
R_SUGGESTS="
