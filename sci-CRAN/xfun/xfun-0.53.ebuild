...
SRC_URI="http://cran.r-project.org/src/contrib/xfun_0.53.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_codetools r_suggests_commonmark r_suggests_curl
	r_suggests_data_table r_suggests_jsonlite r_suggests_knitr
	r_suggests_litedown r_suggests_magick r_suggests_mime r_suggests_pak
	r_suggests_qs r_suggests_remotes r_suggests_rstudioapi
	r_suggests_testit r_suggests_tinytex r_suggests_xml2 r_suggests_yaml"
R_SUGGESTS="
