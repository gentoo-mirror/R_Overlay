...
SRC_URI="http://cran.r-project.org/src/contrib/lgrExtra_0.2.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_covr r_suggests_dbi r_suggests_elastic
	r_suggests_gmailr r_suggests_httr2 r_suggests_jsonlite
	r_suggests_knitr r_suggests_paws_management r_suggests_pool
...
R_SUGGESTS="
	...
	r_suggests_paws_management? ( >=sci-CRAN/paws_management-0.4.0 )
