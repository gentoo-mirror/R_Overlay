...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/see_0.6.7.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_coda r_suggests_correlation r_suggests_dplyr
	r_suggests_emmeans r_suggests_ggdist r_suggests_ggraph
	r_suggests_ggrepel r_suggests_ggside r_suggests_glmmtmb
	r_suggests_httr r_suggests_lavaan r_suggests_lme4
	...
	r_suggests_tidygraph r_suggests_tidyr r_suggests_vdiffr"
R_SUGGESTS="
	...
	r_suggests_performance? ( >=sci-CRAN/performance-0.7.1 )
