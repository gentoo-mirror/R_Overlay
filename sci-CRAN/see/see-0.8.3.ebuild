...
SRC_URI="http://cran.r-project.org/src/contrib/see_0.8.3.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_brms r_suggests_curl r_suggests_dharma
	...
	r_suggests_ggside r_suggests_glmmtmb r_suggests_httr
	r_suggests_lavaan r_suggests_lme4 r_suggests_logspline
	r_suggests_mass r_suggests_mclust r_suggests_metafor r_suggests_mgcv
...
"
DEPEND=">=sci-CRAN/modelbased-0.8.7
