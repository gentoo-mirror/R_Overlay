...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/see_0.7.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_coda r_suggests_correlation r_suggests_emmeans
	...
	r_suggests_scales r_suggests_testthat r_suggests_tidygraph
	r_suggests_vdiffr"
R_SUGGESTS="
