...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/see_0.6.4.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_coda r_suggests_correlation r_suggests_dplyr
	r_suggests_emmeans r_suggests_ggraph r_suggests_ggrepel
	r_suggests_glmmtmb r_suggests_gridextra r_suggests_httr
	r_suggests_lavaan r_suggests_lme4 r_suggests_logspline
	r_suggests_mass r_suggests_mclust r_suggests_metafor
	r_suggests_modelbased r_suggests_nbclust r_suggests_nfactors
