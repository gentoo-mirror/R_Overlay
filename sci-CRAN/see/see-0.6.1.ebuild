...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/see_0.6.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_coda r_suggests_correlation r_suggests_emmeans
	...
	r_suggests_gridextra r_suggests_lavaan r_suggests_lme4
	r_suggests_logspline r_suggests_mass r_suggests_mclust
	r_suggests_metafor r_suggests_modelbased r_suggests_nbclust
	r_suggests_nfactors r_suggests_performance r_suggests_psych
	r_suggests_randomforest r_suggests_rmarkdown r_suggests_tidygraph
	r_suggests_tidyr"
R_SUGGESTS="
