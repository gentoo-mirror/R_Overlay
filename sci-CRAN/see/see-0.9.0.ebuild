...
SRC_URI="http://cran.r-project.org/src/contrib/see_0.9.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bh r_suggests_brms r_suggests_curl
	r_suggests_dharma r_suggests_emmeans r_suggests_factoextra
	r_suggests_ggdag r_suggests_ggdist r_suggests_ggraph
	r_suggests_ggrepel r_suggests_ggridges r_suggests_ggside
	r_suggests_glmmtmb r_suggests_httr r_suggests_httr2 r_suggests_lavaan
	r_suggests_lme4 r_suggests_logspline r_suggests_mass
	r_suggests_mclust r_suggests_merderiv r_suggests_metafor
	r_suggests_mgcv r_suggests_nbclust r_suggests_nfactors
	r_suggests_patchwork r_suggests_poorman r_suggests_psych
	r_suggests_qqplotr r_suggests_randomforest r_suggests_rcppeigen
...
"
DEPEND=">=sci-CRAN/parameters-0.22.1
	>=sci-CRAN/bayestestR-0.14.0
