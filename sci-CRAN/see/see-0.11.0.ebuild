...
SRC_URI="http://cran.r-project.org/src/contrib/see_0.11.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bh r_suggests_brms r_suggests_collapse
	r_suggests_curl r_suggests_dharma r_suggests_emmeans
	r_suggests_factoextra r_suggests_formula r_suggests_ggdag
	r_suggests_ggdist r_suggests_ggraph r_suggests_ggrepel
	r_suggests_ggridges r_suggests_ggside r_suggests_glmmtmb
	r_suggests_httr2 r_suggests_lavaan r_suggests_lme4
...
"
DEPEND=">=sci-CRAN/patchwork-1.3.0
	>=dev-lang/R-4.0
	>=sci-CRAN/correlation-0.8.7
	>=sci-CRAN/bayestestR-0.15.2
	>=sci-CRAN/parameters-0.24.2
	>=sci-CRAN/datawizard-1.0.1
	>=sci-CRAN/effectsize-1.0.0
	>=sci-CRAN/ggplot2-3.5.1
	>=sci-CRAN/insight-1.1.0
	>=sci-CRAN/performance-0.13.0
	>=sci-CRAN/modelbased-0.10.0
"
