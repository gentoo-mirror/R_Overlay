...
SRC_URI="http://cran.r-project.org/src/contrib/clubSandwich_0.6.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_cardata r_suggests_covr
	r_suggests_estimatr r_suggests_fixest r_suggests_formula
	r_suggests_geepack r_suggests_ivreg r_suggests_knitr r_suggests_lme4
	r_suggests_matrix r_suggests_metadat r_suggests_metafor
	r_suggests_mlmrev r_suggests_nlme r_suggests_plm r_suggests_rmarkdown
	r_suggests_robumeta r_suggests_testthat r_suggests_zoo"
R_SUGGESTS="
