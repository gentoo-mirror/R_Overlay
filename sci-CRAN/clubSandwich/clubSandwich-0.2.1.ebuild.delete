...
SRC_URI="http://cran.r-project.org/src/contrib/clubSandwich_0.2.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_car r_suggests_formula
	r_suggests_knitr r_suggests_metafor r_suggests_mlmrev r_suggests_nlme
	r_suggests_plm r_suggests_rmarkdown r_suggests_robumeta
	r_suggests_testthat"
R_SUGGESTS="
