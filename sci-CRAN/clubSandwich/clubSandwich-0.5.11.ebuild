...
SRC_URI="http://cran.r-project.org/src/contrib/clubSandwich_0.5.11.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_cardata r_suggests_covr
	r_suggests_formula r_suggests_geepack r_suggests_ivreg
	r_suggests_knitr r_suggests_lme4 r_suggests_matrix r_suggests_metadat
