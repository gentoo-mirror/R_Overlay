...
SRC_URI="http://cran.r-project.org/src/contrib/ReporterScore_0.1.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_cluster r_suggests_dosnow r_suggests_e1071
	...
	r_suggests_metanet r_suggests_pheatmap r_suggests_plyr
	r_suggests_r_utils r_suggests_readr r_suggests_rmarkdown
	r_suggests_snow r_suggests_vegan"
R_SUGGESTS="
