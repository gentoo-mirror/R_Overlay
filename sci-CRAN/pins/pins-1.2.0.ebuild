...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/pins_1.2.0.tar.gz"
...
IUSE="${IUSE-} r_suggests_arrow r_suggests_azurestor r_suggests_covr
	...
	r_suggests_googlecloudstorager r_suggests_ids r_suggests_knitr
	r_suggests_microsoft365r r_suggests_mime r_suggests_mockery
	r_suggests_openssl r_suggests_paws_storage r_suggests_qs
	r_suggests_r_utils r_suggests_rmarkdown r_suggests_rsconnect
	r_suggests_shiny r_suggests_testthat r_suggests_webfakes
