...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/fitdistrplus_1.1-1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_actuar r_suggests_gamlss_dist
	r_suggests_generalizedhyperbolic r_suggests_ggplot2 r_suggests_knitr
	r_suggests_mc2d r_suggests_rgenoud"
R_SUGGESTS="
