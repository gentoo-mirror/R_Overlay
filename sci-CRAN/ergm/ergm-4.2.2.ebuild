...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ergm_4.2.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_ergm_count r_suggests_glpk
	...
	r_suggests_rmarkdown r_suggests_rmpi r_suggests_slam r_suggests_sna
	r_suggests_snow r_suggests_tergm r_suggests_testthat r_suggests_withr"
R_SUGGESTS="
...
"
DEPEND=">=sci-CRAN/robustbase-0.93.7
