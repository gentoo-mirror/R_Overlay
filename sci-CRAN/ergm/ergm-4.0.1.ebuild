...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ergm_4.0.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_ergm_count
	r_suggests_ergm_userterms r_suggests_knitr r_suggests_latentnet
	r_suggests_lattice r_suggests_magrittr r_suggests_networkdynamic
	r_suggests_rmarkdown r_suggests_rmpi r_suggests_sna r_suggests_snow
	r_suggests_testthat"
R_SUGGESTS="
...
_UNRESOLVED_PACKAGES=( '>=sci-CRAN/tergm-4.0.0' )
