...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/drake_7.13.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_abind r_suggests_bindr r_suggests_callr
	...
	r_suggests_progress r_suggests_rcpp r_suggests_rmarkdown
	r_suggests_rstudioapi r_suggests_styler r_suggests_testthat
	r_suggests_tibble r_suggests_txtplot r_suggests_usethis
