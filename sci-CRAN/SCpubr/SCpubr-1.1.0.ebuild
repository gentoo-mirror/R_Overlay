...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/SCpubr_1.1.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_annotationdbi r_suggests_assertthat
	r_suggests_circlize r_suggests_cluster r_suggests_colorspace
	r_suggests_covr r_suggests_dplyr r_suggests_forcats
	r_suggests_ggalluvial r_suggests_ggbeeswarm r_suggests_ggdist
	r_suggests_ggextra r_suggests_ggnewscale r_suggests_ggplot2
	r_suggests_ggplotify r_suggests_ggrepel r_suggests_ggridges
	r_suggests_ggsignif r_suggests_knitr r_suggests_magrittr
	r_suggests_matrix r_suggests_patchwork r_suggests_pheatmap
	r_suggests_plyr r_suggests_purrr r_suggests_rjags r_suggests_rlang
