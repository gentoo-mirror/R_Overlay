...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/SCpubr_1.0.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_assertthat r_suggests_circlize
	...
	r_suggests_ggdist r_suggests_ggextra r_suggests_ggplot2
	...
	r_suggests_plyr r_suggests_purrr r_suggests_qpdf r_suggests_rjags
	r_suggests_rlang r_suggests_rmarkdown r_suggests_scales
	r_suggests_scattermore r_suggests_seurat r_suggests_stringr
