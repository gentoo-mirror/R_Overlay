...
SRC_URI="http://cran.r-project.org/src/contrib/SCpubr_2.0.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_annotationdbi r_suggests_assertthat
	...
	r_suggests_knitr r_suggests_labeling r_suggests_magrittr
	r_suggests_mass r_suggests_matrix r_suggests_patchwork
	...
	r_suggests_seurat r_suggests_seuratobject r_suggests_stringr
