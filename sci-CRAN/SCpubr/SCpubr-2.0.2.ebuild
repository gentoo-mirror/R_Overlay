...
SRC_URI="http://cran.r-project.org/src/contrib/SCpubr_2.0.2.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_annotationdbi r_suggests_assertthat
	r_suggests_circlize r_suggests_cli r_suggests_cluster
	r_suggests_colorspace r_suggests_covr r_suggests_dplyr
	r_suggests_forcats r_suggests_ggalluvial r_suggests_ggbeeswarm
	r_suggests_ggdist r_suggests_ggextra r_suggests_ggh4x
	r_suggests_ggnewscale r_suggests_ggplot2 r_suggests_ggplotify
	r_suggests_ggrastr r_suggests_ggrepel r_suggests_ggridges
	r_suggests_ggsignif r_suggests_knitr r_suggests_labeling
	r_suggests_magrittr r_suggests_mass r_suggests_matrix
	r_suggests_patchwork r_suggests_pheatmap r_suggests_plyr
	r_suggests_purrr r_suggests_qpdf r_suggests_rcolorbrewer
	r_suggests_rjags r_suggests_rlang r_suggests_rmarkdown
	r_suggests_scales r_suggests_scattermore r_suggests_seurat
	r_suggests_seuratobject r_suggests_sf r_suggests_stringr
