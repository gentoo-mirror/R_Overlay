...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/SCpubr_1.0.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_assertthat r_suggests_circlize
	...
	r_suggests_ggtext r_suggests_knitr r_suggests_magrittr
	r_suggests_matrix r_suggests_patchwork r_suggests_pbapply
	r_suggests_pheatmap r_suggests_plyr r_suggests_purrr r_suggests_qpdf
	r_suggests_rjags r_suggests_rlang r_suggests_rmarkdown
	r_suggests_scales r_suggests_scattermore r_suggests_seurat
	r_suggests_seuratobject r_suggests_stringr r_suggests_svglite
