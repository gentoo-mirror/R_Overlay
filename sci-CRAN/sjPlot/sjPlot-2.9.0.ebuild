...
SRC_URI="http://cran.r-project.org/src/contrib/sjPlot_2.9.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_brms r_suggests_car r_suggests_clubsandwich
	r_suggests_cluster r_suggests_cowplot r_suggests_effects
	r_suggests_ggrepel r_suggests_ggridges r_suggests_glmmtmb
	r_suggests_gparotation r_suggests_gridextra r_suggests_haven
	r_suggests_httr r_suggests_lme4 r_suggests_mass r_suggests_nfactors
	r_suggests_pscl r_suggests_psych r_suggests_rmarkdown
...
"
DEPEND=">=sci-CRAN/datawizard-1.1.0
	sci-CRAN/knitr
