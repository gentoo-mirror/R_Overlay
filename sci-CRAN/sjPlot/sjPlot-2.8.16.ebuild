...
SRC_URI="http://cran.r-project.org/src/contrib/sjPlot_2.8.16.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_brms r_suggests_car r_suggests_clubsandwich
	...
	r_suggests_psych r_suggests_rmarkdown r_suggests_rstanarm
...
"
DEPEND=">=sci-CRAN/sjstats-0.17.8
	sci-CRAN/purrr
