...
SRC_URI="http://cran.r-project.org/src/contrib/stplanr_0.6.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bench r_suggests_cyclestreets
	r_suggests_data_table r_suggests_dodgr r_suggests_geodist
	r_suggests_knitr r_suggests_leaflet r_suggests_openxlsx
	r_suggests_osrm r_suggests_pbapply r_suggests_pct r_suggests_rgdal
