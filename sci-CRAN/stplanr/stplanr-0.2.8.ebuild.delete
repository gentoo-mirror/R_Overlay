...
SRC_URI="http://cran.r-project.org/src/contrib/stplanr_0.2.8.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_cyclestreets r_suggests_dodgr r_suggests_knitr
	r_suggests_leaflet r_suggests_pbapply r_suggests_rgdal
...
"
DEPEND=">=sci-CRAN/geosphere-1.5.7
