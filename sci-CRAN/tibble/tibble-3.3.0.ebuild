...
SRC_URI="http://cran.r-project.org/src/contrib/tibble_3.3.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bench r_suggests_bit64 r_suggests_blob
	r_suggests_brio r_suggests_callr r_suggests_diagrammer
	r_suggests_dplyr r_suggests_evaluate r_suggests_formattable
	r_suggests_ggplot2 r_suggests_here r_suggests_hms
	r_suggests_htmltools r_suggests_knitr r_suggests_lubridate
	r_suggests_nycflights13 r_suggests_pkgload r_suggests_purrr
