...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/tibble_3.1.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bench r_suggests_bit64 r_suggests_blob
	r_suggests_cli r_suggests_covr r_suggests_crayon
	r_suggests_diagrammer r_suggests_dplyr r_suggests_evaluate
	r_suggests_formattable r_suggests_ggplot2 r_suggests_hms
