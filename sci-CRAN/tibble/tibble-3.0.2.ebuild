...
SRC_URI="http://cran.r-project.org/src/contrib/tibble_3.0.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bench r_suggests_bit64 r_suggests_blob
	r_suggests_covr r_suggests_dplyr r_suggests_evaluate
	r_suggests_formattable r_suggests_hms r_suggests_htmltools
	r_suggests_import r_suggests_knitr r_suggests_lubridate
