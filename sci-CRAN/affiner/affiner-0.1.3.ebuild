...
SRC_URI="http://cran.r-project.org/src/contrib/affiner_0.1.3.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_artsy r_suggests_ggplot2 r_suggests_gridpattern
	r_suggests_gtable r_suggests_knitr r_suggests_ragg r_suggests_rgl
