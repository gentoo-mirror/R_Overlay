...
SRC_URI="http://cran.r-project.org/src/contrib/DataVisualizations_1.1.8.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_abcanalysis r_suggests_adaptgauss r_suggests_akima
	...
	r_suggests_rgl r_suggests_rmarkdown r_suggests_rowr
	r_suggests_rworldmap r_suggests_signal r_suggests_vioplot"
R_SUGGESTS="
