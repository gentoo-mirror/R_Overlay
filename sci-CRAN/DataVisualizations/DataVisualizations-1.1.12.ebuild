...
SRC_URI="http://cran.r-project.org/src/contrib/DataVisualizations_1.1.12.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_abcanalysis r_suggests_choroplethr
	r_suggests_databionicswarm r_suggests_diptest r_suggests_dplyr
	r_suggests_ggextra r_suggests_ggmap r_suggests_ggrepel
	r_suggests_htmlwidgets r_suggests_knitr r_suggests_mba
	r_suggests_moments r_suggests_plotly r_suggests_plotrix
	r_suggests_plyr r_suggests_pracma r_suggests_r6 r_suggests_reshape2
