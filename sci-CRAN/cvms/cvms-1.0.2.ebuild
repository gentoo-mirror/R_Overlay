...
SRC_URI="http://cran.r-project.org/src/contrib/cvms_1.0.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_auc r_suggests_covr r_suggests_e1071
	r_suggests_furrr r_suggests_ggimage r_suggests_groupdata2
	r_suggests_knitr r_suggests_nnet r_suggests_randomforest
...
R_SUGGESTS="
	...
	r_suggests_ggimage? ( >=sci-CRAN/ggimage-0.2.7 )
	r_suggests_groupdata2? ( >=sci-CRAN/groupdata2-1.2.0 )
