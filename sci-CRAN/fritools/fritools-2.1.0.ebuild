...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/fritools_2.1.0.tar.gz"
LICENSE='BSD-2'

IUSE="${IUSE-} r_suggests_callr r_suggests_checkmate r_suggests_desc
	r_suggests_devtools r_suggests_knitr r_suggests_packager
	r_suggests_pkgload r_suggests_reshape r_suggests_rmarkdown
	r_suggests_runit r_suggests_testthat r_suggests_whoami"
R_SUGGESTS="
