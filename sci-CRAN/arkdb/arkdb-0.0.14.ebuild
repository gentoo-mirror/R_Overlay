...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/arkdb_0.0.14.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_arrow r_suggests_covr r_suggests_dbplyr
	r_suggests_dplyr r_suggests_duckdb r_suggests_fs r_suggests_knitr
	r_suggests_nycflights13 r_suggests_progress r_suggests_r_utils
