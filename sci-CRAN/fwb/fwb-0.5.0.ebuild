...
SRC_URI="http://cran.r-project.org/src/contrib/fwb_0.5.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_boot r_suggests_cobalt r_suggests_future
	r_suggests_future_apply r_suggests_ggdist r_suggests_knitr
	r_suggests_lmtest r_suggests_mvtnorm r_suggests_nnet
	r_suggests_rmarkdown r_suggests_sandwich r_suggests_survival
...
R_SUGGESTS="
	...
	r_suggests_mvtnorm? ( >=sci-CRAN/mvtnorm-1.3.3 )
