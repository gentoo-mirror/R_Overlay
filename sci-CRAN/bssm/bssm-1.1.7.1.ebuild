...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/bssm_1.1.7-1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_covr r_suggests_dplyr r_suggests_ggplot2
	r_suggests_hmisc r_suggests_kfas r_suggests_knitr r_suggests_mass
	r_suggests_posterior r_suggests_ramcmc r_suggests_rmarkdown
	r_suggests_sde r_suggests_sitmo r_suggests_testthat"
R_SUGGESTS="
