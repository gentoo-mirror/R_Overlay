...
SRC_URI="http://cran.r-project.org/src/contrib/lme4_1.1-20.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_boot r_suggests_car r_suggests_dfoptim
	r_suggests_gamm4 r_suggests_ggplot2 r_suggests_hsaur2
