...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/SFSI_0.3.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bglr r_suggests_float r_suggests_ggplot2
	r_suggests_knitr r_suggests_matrix r_suggests_reshape
	r_suggests_rmarkdown r_suggests_rspectra r_suggests_viridis"
R_SUGGESTS="
