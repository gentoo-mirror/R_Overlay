...
SRC_URI="http://cran.r-project.org/src/contrib/sensitivity_1.21.0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_condmvnorm r_suggests_dicedesign
	r_suggests_dicekriging r_suggests_evd r_suggests_ggextra
	r_suggests_gtools r_suggests_igraph r_suggests_ks r_suggests_mass
	r_suggests_mc2d r_suggests_mvtnorm r_suggests_pracma
