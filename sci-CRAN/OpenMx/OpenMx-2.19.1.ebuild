...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/OpenMx_2.19.1.tar.gz"
LICENSE='Apache-2.0'

IUSE="${IUSE-} r_suggests_covr r_suggests_ifatools r_suggests_lme4
	r_suggests_mvtnorm r_suggests_numderiv r_suggests_rmpi
	r_suggests_roxygen2 r_suggests_rpf r_suggests_snowfall
	r_suggests_testthat r_suggests_umx"
R_SUGGESTS="
