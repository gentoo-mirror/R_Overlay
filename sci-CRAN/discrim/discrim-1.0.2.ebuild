...
SRC_URI="http://cran.r-project.org/src/contrib/discrim_1.0.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_covr r_suggests_dplyr r_suggests_earth
	r_suggests_ggplot2 r_suggests_hardhat r_suggests_klar
	r_suggests_knitr r_suggests_mass r_suggests_mda r_suggests_mlbench
	r_suggests_modeldata r_suggests_naivebayes r_suggests_rmarkdown
