...
SRC_URI="http://cran.r-project.org/src/contrib/autoslider.core_0.2.1.tar.gz"
LICENSE='Apache-2.0'

IUSE="${IUSE-} r_suggests_devtools r_suggests_filters r_suggests_formatters
	r_suggests_ggpubr r_suggests_glue r_suggests_googledrive
	r_suggests_htmltools r_suggests_httr r_suggests_knitr
	r_suggests_lubridate r_suggests_mime r_suggests_nestcolor
	r_suggests_purrr r_suggests_rmarkdown r_suggests_rvg
...
R_SUGGESTS="
	...
	r_suggests_rvg? ( >=sci-CRAN/rvg-0.2.5 )
