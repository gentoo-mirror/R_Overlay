...
SRC_URI="http://cran.r-project.org/src/contrib/autoslider.core_0.2.7.tar.gz"
LICENSE='Apache-2.0'
...
IUSE="${IUSE-} r_suggests_ellmer r_suggests_filters r_suggests_formatters
	...
	r_suggests_rmarkdown r_suggests_styler r_suggests_svglite
	r_suggests_testthat r_suggests_tmb r_suggests_withr"
R_SUGGESTS="
