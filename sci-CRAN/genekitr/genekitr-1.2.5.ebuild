...
SRC_URI="http://cran.r-project.org/src/contrib/genekitr_1.2.5.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_annotationdbi r_suggests_biocmanager
	r_suggests_complexupset r_suggests_cowplot r_suggests_data_table
	r_suggests_fgsea r_suggests_forcats r_suggests_futile_logger
	r_suggests_fuzzyjoin r_suggests_ggnewscale r_suggests_ggplotify
	r_suggests_ggrepel r_suggests_ggridges r_suggests_ggsci
	r_suggests_ggupset r_suggests_goplot r_suggests_httr r_suggests_knitr
	r_suggests_labeling r_suggests_msigdbr r_suggests_pheatmap
	r_suggests_pracma r_suggests_rappdirs r_suggests_rcolorbrewer
	r_suggests_rcurl r_suggests_reshape2 r_suggests_rio
	r_suggests_rmarkdown r_suggests_scales r_suggests_testthat
	r_suggests_tibble r_suggests_tm r_suggests_treemap
	r_suggests_wordcloud r_suggests_xml r_suggests_xml2"
R_SUGGESTS="
