...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/fakemake_1.8.1.tar.gz"
LICENSE='BSD-2'

IUSE="${IUSE-} r_suggests_cleanr r_suggests_covr r_suggests_cyclocomp
	r_suggests_hunspell r_suggests_knitr r_suggests_lintr
	r_suggests_pkgbuild r_suggests_pkgload r_suggests_rmarkdown
	r_suggests_roxygen2 r_suggests_rprojroot r_suggests_runit
