...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/plm_2.4-2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_aer r_suggests_bookdown r_suggests_car
	r_suggests_cluster r_suggests_collapse r_suggests_ecdat
	r_suggests_fixest r_suggests_foreign r_suggests_knitr r_suggests_lfe
	r_suggests_pcse r_suggests_pder r_suggests_pglm r_suggests_rmarkdown
	r_suggests_spdep r_suggests_splm r_suggests_stargazer
...
R_SUGGESTS="
	...
	r_suggests_collapse? ( >=sci-CRAN/collapse-1.6.0 )
