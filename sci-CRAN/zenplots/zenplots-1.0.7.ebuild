...
SRC_URI="http://cran.r-project.org/src/contrib/zenplots_1.0.7.tar.gz"
LICENSE='|| ( GPL-2 GPL-3 )'

IUSE="${IUSE-} r_suggests_adgoftest r_suggests_biocmanager r_suggests_copula
	r_suggests_crop r_suggests_ggplot2 r_suggests_graph r_suggests_knitr
	r_suggests_lattice r_suggests_loon r_suggests_matrix
	r_suggests_mvtnorm r_suggests_pcapp r_suggests_qqtest
