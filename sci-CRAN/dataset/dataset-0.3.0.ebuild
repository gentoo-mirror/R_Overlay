...
SRC_URI="http://cran.r-project.org/src/contrib/dataset_0.3.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_covr r_suggests_data_table r_suggests_declared
	r_suggests_dplyr r_suggests_eurostat r_suggests_here r_suggests_knitr
	r_suggests_nycflights13 r_suggests_readxl r_suggests_rmarkdown
	r_suggests_spelling r_suggests_statcodelists r_suggests_testthat
