...
SRC_URI="http://cran.r-project.org/src/contrib/ProbReco_0.1.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_dplyr r_suggests_fable r_suggests_knitr
	r_suggests_magrittr r_suggests_rdpack r_suggests_rmarkdown
	r_suggests_stringi r_suggests_tidyr"
R_SUGGESTS="
