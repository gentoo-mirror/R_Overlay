...
SRC_URI="http://cran.r-project.org/src/contrib/lgr_0.3.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_crayon r_suggests_data_table
	...
	r_suggests_rotor r_suggests_rpostgres r_suggests_rprojroot
	r_suggests_rsqlite r_suggests_sendmailr r_suggests_testthat
	r_suggests_tibble r_suggests_whoami r_suggests_yaml"
R_SUGGESTS="
