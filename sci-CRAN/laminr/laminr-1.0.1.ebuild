...
SRC_URI="http://cran.r-project.org/src/contrib/laminr_1.0.1.tar.gz"

IUSE="${IUSE-} r_suggests_anndata r_suggests_arrow r_suggests_jsonlite
	r_suggests_knitr r_suggests_nanoparquet r_suggests_readr
	r_suggests_rstudioapi r_suggests_seurat r_suggests_testthat
	r_suggests_yaml"
R_SUGGESTS="
