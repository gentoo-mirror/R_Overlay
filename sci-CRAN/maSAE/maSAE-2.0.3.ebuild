...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/maSAE_2.0.3.tar.gz"
LICENSE='BSD-2'

IUSE="${IUSE-} r_suggests_devtools r_suggests_forestinventory
	r_suggests_josae r_suggests_knitr r_suggests_nlme r_suggests_pkgload
	r_suggests_r_rsp r_suggests_rmarkdown r_suggests_rprojroot
	r_suggests_rsae r_suggests_runit r_suggests_sae r_suggests_testthat"
R_SUGGESTS="
