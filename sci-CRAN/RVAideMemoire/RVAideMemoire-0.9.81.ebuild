...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/RVAideMemoire_0.9-81.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_ape r_suggests_betareg r_suggests_dgof
	r_suggests_emmeans r_suggests_emt r_suggests_fsa r_suggests_labdsv
	r_suggests_mumin r_suggests_mvnormtest r_suggests_ordinal
	r_suggests_rgcca r_suggests_statmod r_suggests_survival"
R_SUGGESTS="
