...
SRC_URI="http://cran.r-project.org/src/contrib/ggpedigree_0.9.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_corrplot r_suggests_data_table r_suggests_discord
	r_suggests_ggrepel r_suggests_htmlwidgets r_suggests_knitr
	r_suggests_mockery r_suggests_nlsylinks r_suggests_openmx
	r_suggests_paletteer r_suggests_patchwork r_suggests_purrr
	r_suggests_readxl r_suggests_rmarkdown r_suggests_testthat
	r_suggests_tibble r_suggests_tidyverse r_suggests_viridis"
R_SUGGESTS="
