...
SRC_URI="http://cran.r-project.org/src/contrib/guideR_0.5.1.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_broom_helpers r_suggests_cardx
	r_suggests_factominer r_suggests_ggstats r_suggests_ggupset
	r_suggests_gt r_suggests_gtsummary r_suggests_nnet
	r_suggests_parameters r_suggests_spelling r_suggests_survey
