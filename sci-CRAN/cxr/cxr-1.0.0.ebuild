...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/cxr_1.0.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bb r_suggests_deoptimr r_suggests_dfoptim
	r_suggests_dplyr r_suggests_gensa r_suggests_ggplot2
	r_suggests_hydropso r_suggests_knitr r_suggests_magrittr
	r_suggests_minqa r_suggests_nloptr r_suggests_rmarkdown
