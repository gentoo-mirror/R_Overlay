...
SRC_URI="http://cran.r-project.org/src/contrib/manynet_1.5.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_biocmanager r_suggests_concaveman
	r_suggests_gganimate r_suggests_ggdendro r_suggests_ggforce
	r_suggests_graphlayouts r_suggests_knitr r_suggests_learnr
	r_suggests_netdiffuser r_suggests_patchwork r_suggests_readxl
	r_suggests_rmarkdown r_suggests_rsiena r_suggests_sna
