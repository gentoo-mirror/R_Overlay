...
SRC_URI="http://cran.r-project.org/src/contrib/manynet_1.2.6.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_biocmanager r_suggests_concaveman r_suggests_furrr
	...
	r_suggests_learnr r_suggests_multiplex r_suggests_netdiffuser
	r_suggests_patchwork r_suggests_readxl r_suggests_rmarkdown
