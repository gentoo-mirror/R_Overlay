...
SRC_URI="http://cran.r-project.org/src/contrib/manynet_0.4.4.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_biocmanager r_suggests_concaveman r_suggests_furrr
	r_suggests_future r_suggests_gganimate r_suggests_ggforce
	r_suggests_graphlayouts r_suggests_knitr r_suggests_learnr
	r_suggests_migraph r_suggests_minmse r_suggests_multiplex
	r_suggests_patchwork r_suggests_png r_suggests_readxl
	r_suggests_rmarkdown r_suggests_roxygen2 r_suggests_rsiena
