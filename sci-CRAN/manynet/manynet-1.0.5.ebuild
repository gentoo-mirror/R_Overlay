...
SRC_URI="http://cran.r-project.org/src/contrib/manynet_1.0.5.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_biocmanager r_suggests_concaveman r_suggests_furrr
	...
	r_suggests_learnr r_suggests_migraph r_suggests_multiplex
	r_suggests_netdiffuser r_suggests_oaqc r_suggests_patchwork
	r_suggests_png r_suggests_readxl r_suggests_rmarkdown
	r_suggests_roxygen2 r_suggests_rsiena r_suggests_sna
