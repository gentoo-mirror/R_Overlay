...
SRC_URI="http://cran.r-project.org/src/contrib/aifeducation_0.3.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_fs r_suggests_ggplot2 r_suggests_knitr
	r_suggests_quanteda r_suggests_quanteda_textmodels
	r_suggests_readtext r_suggests_readxl r_suggests_rmarkdown
	r_suggests_shiny r_suggests_shinydashboard r_suggests_shinyfiles
	r_suggests_shinyjs r_suggests_shinywidgets r_suggests_testthat
	r_suggests_text2vec r_suggests_tidytext r_suggests_topicmodels
	r_suggests_udpipe"
R_SUGGESTS="
...
"
DEPEND=">=sci-CRAN/iotarelr-0.1.5
	sci-CRAN/reshape2
