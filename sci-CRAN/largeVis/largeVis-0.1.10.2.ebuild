...
SRC_URI="http://cran.r-project.org/src/contrib/largeVis_0.1.10.2.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_dplyr r_suggests_knitr
	r_suggests_magrittr r_suggests_png r_suggests_rcolorbrewer
	r_suggests_rmarkdown r_suggests_testthat r_suggests_wesanderson"
R_SUGGESTS="
