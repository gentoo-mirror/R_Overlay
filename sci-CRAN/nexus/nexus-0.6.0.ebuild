...
SRC_URI="http://cran.r-project.org/src/contrib/nexus_0.6.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_cluster r_suggests_folio r_suggests_fontquiver
	r_suggests_igraph r_suggests_knitr r_suggests_markdown
