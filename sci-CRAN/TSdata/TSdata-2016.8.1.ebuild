...
IUSE="${IUSE-} r_suggests_dbi r_suggests_rjsdmx r_suggests_rmysql
	r_suggests_rpostgresql r_suggests_rsqlite r_suggests_tfplot
	r_suggests_tframe r_suggests_tframeplus r_suggests_tscompare
	r_suggests_tsdbi r_suggests_tseries r_suggests_tsmisc
