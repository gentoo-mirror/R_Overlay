...
SRC_URI="http://cran.r-project.org/src/contrib/jtools_1.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_boot r_suggests_brms r_suggests_broom
	r_suggests_cowplot r_suggests_ggstance r_suggests_glue
	r_suggests_huxtable r_suggests_knitr r_suggests_lme4
	r_suggests_lmertest r_suggests_pbkrtest r_suggests_quantreg
	r_suggests_rcolorbrewer r_suggests_rmarkdown r_suggests_rstanarm
