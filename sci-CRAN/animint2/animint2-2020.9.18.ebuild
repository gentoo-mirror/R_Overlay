...
IUSE="${IUSE-} r_suggests_devtools r_suggests_ggplot2movies r_suggests_gistr
	r_suggests_hexbin r_suggests_hmisc r_suggests_htmltools
	r_suggests_httr r_suggests_lattice r_suggests_mapproj r_suggests_maps
