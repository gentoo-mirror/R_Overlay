...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/FRESA.CAD_3.4.4.tar.gz"
LICENSE='LGPL-2+'
...
IUSE="${IUSE-} r_suggests_bess r_suggests_class r_suggests_cvtools
	...
	r_suggests_mass r_suggests_mda r_suggests_mrmre r_suggests_naivebayes
	r_suggests_nlme r_suggests_randomforest r_suggests_rcolorbrewer
	r_suggests_rfast r_suggests_robustbase r_suggests_rpart
	r_suggests_survival r_suggests_survminer r_suggests_twosamples
