...
SRC_URI="http://cran.r-project.org/src/contrib/SuperLearner_2.0-15.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_arm r_suggests_caret r_suggests_cvauc
	...
	r_suggests_rocr r_suggests_sis r_suggests_spls r_suggests_stepplr
	r_suggests_sva"
R_SUGGESTS="
