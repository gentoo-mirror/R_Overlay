...
SRC_URI="http://cran.r-project.org/src/contrib/SuperLearner_2.0-24.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_arm r_suggests_biglasso r_suggests_bigmemory
	r_suggests_caret r_suggests_class r_suggests_dbarts
	r_suggests_devtools r_suggests_e1071 r_suggests_earth
	...
	r_suggests_sva r_suggests_testthat r_suggests_xgboost"
R_SUGGESTS="
