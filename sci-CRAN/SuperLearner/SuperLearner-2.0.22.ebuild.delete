...
SRC_URI="http://cran.r-project.org/src/contrib/SuperLearner_2.0-22.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_arm r_suggests_bartmachine r_suggests_biglasso
	r_suggests_bigmemory r_suggests_caret r_suggests_class
	r_suggests_dbarts r_suggests_devtools r_suggests_e1071
	r_suggests_earth r_suggests_extratrees r_suggests_gam r_suggests_gbm
	r_suggests_genefilter r_suggests_ggplot2 r_suggests_glmnet
	r_suggests_hmisc r_suggests_ipred r_suggests_kernelknn
	r_suggests_kernlab r_suggests_knitr r_suggests_lattice
	r_suggests_logicreg r_suggests_mass r_suggests_mda r_suggests_mlbench
	r_suggests_nloptr r_suggests_nnet r_suggests_party
	r_suggests_polspline r_suggests_prettydoc r_suggests_quadprog
	r_suggests_randomforest r_suggests_ranger r_suggests_rhpcblasctl
	r_suggests_rmarkdown r_suggests_rocr r_suggests_rpart r_suggests_sis
	r_suggests_speedglm r_suggests_spls r_suggests_stepplr r_suggests_sva
