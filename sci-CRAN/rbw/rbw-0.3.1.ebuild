...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/rbw_0.3.1.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_cbps r_suggests_ebal r_suggests_ipw
	r_suggests_knitr r_suggests_rmarkdown r_suggests_survey
	r_suggests_testthat"
R_SUGGESTS="
