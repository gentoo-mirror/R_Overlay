...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/gap_1.5.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_bookdown r_suggests_bradleyterry2
	...
	r_suggests_dot r_suggests_foreign r_suggests_forestplot
	r_suggests_genetics r_suggests_haplo_stats r_suggests_htmlwidgets
	r_suggests_jsonlite r_suggests_kinship2 r_suggests_knitr
	r_suggests_lattice r_suggests_magic r_suggests_manhattanly
	...
	r_suggests_reshape r_suggests_rmarkdown r_suggests_rmeta
	r_suggests_rms r_suggests_survival"
R_SUGGESTS="
