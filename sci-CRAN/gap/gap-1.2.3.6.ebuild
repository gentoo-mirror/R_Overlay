...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/gap_1.2.3-6.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_bradleyterry2 r_suggests_calibrate
	r_suggests_circlize r_suggests_coda r_suggests_cowplot
	r_suggests_coxme r_suggests_foreign r_suggests_forestplot
	...
	r_suggests_lattice r_suggests_magic r_suggests_mass r_suggests_matrix
	r_suggests_mcmcglmm r_suggests_meta r_suggests_metafor
	r_suggests_mets r_suggests_nlme r_suggests_pedigree
	r_suggests_pedigreemm r_suggests_plotrix r_suggests_reshape
