...
SRC_URI="http://cran.r-project.org/src/contrib/gap_1.1-10.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_bradleyterry2 r_suggests_coxme
	r_suggests_haplo_stats r_suggests_kinship2 r_suggests_magic
	r_suggests_ncbi2r r_suggests_pedigree r_suggests_pedigreemm
	r_suggests_regress r_suggests_rms"
R_SUGGESTS="
