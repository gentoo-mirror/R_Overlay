...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/gap_1.3-1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_bradleyterry2 r_suggests_calibrate
	r_suggests_circlize r_suggests_coda r_suggests_cowplot
	r_suggests_coxme r_suggests_diagrammer r_suggests_dot
	r_suggests_foreign r_suggests_forestplot r_suggests_genetics
