...
SRC_URI="http://cran.r-project.org/src/contrib/ggrepel_0.9.6.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_devtools r_suggests_dplyr r_suggests_ggbeeswarm
	r_suggests_ggpp r_suggests_gridextra r_suggests_knitr
	r_suggests_magrittr r_suggests_patchwork r_suggests_prettydoc
