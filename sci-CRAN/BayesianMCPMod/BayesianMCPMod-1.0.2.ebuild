...
SRC_URI="http://cran.r-project.org/src/contrib/BayesianMCPMod_1.0.2.tar.gz"

IUSE="${IUSE-} r_suggests_clindr r_suggests_data_table r_suggests_dofuture
	r_suggests_dorng r_suggests_dplyr r_suggests_kableextra
	r_suggests_knitr r_suggests_mcpmodpack r_suggests_reactable
