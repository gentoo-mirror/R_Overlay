...
SRC_URI="http://cran.r-project.org/src/contrib/ggeffects_1.7.2.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_aod r_suggests_bayestestr
	...
	r_suggests_htmltools r_suggests_httr r_suggests_jsonlite
	r_suggests_knitr r_suggests_lme4 r_suggests_logistf
