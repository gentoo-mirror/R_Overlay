...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ggeffects_1.1.5.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_aod r_suggests_betareg
	...
	r_suggests_haven r_suggests_httr r_suggests_knitr r_suggests_lme4
	...
	r_suggests_mice r_suggests_nlme r_suggests_ordinal
	r_suggests_parameters r_suggests_patchwork r_suggests_prediction
