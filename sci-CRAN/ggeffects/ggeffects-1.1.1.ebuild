...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ggeffects_1.1.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_aod r_suggests_betareg
	...
	r_suggests_magrittr r_suggests_margins r_suggests_matrix
	r_suggests_mcmcglmm r_suggests_mgcv r_suggests_mice r_suggests_nlme
	r_suggests_ordinal r_suggests_parameters r_suggests_prediction
	r_suggests_pscl r_suggests_quantreg r_suggests_rmarkdown
	r_suggests_rms r_suggests_robustbase r_suggests_sandwich
	r_suggests_see r_suggests_sjmisc r_suggests_sjstats r_suggests_survey
