...
SRC_URI="http://cran.r-project.org/src/contrib/ggeffects_2.0.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_gt r_suggests_haven r_suggests_htmltools r_suggests_httr2
	r_suggests_jsonlite r_suggests_knitr r_suggests_lme4
	r_suggests_logistf r_suggests_marginaleffects r_suggests_mass
	r_suggests_matrix r_suggests_mclogit r_suggests_mcmcglmm
	r_suggests_mgcv r_suggests_mice r_suggests_mlogit r_suggests_mumin
	r_suggests_nestedlogit r_suggests_nlme r_suggests_nnet
	r_suggests_ordinal r_suggests_parameters r_suggests_parsnip
	r_suggests_patchwork r_suggests_plm r_suggests_pscl
	r_suggests_quantreg r_suggests_rmarkdown r_suggests_rms
	r_suggests_robustbase r_suggests_rstanarm r_suggests_rstantools
	r_suggests_sandwich r_suggests_sdmtmb r_suggests_see
	r_suggests_sjlabelled r_suggests_sjstats r_suggests_speedglm
	r_suggests_survey r_suggests_survival r_suggests_testthat
	r_suggests_tibble r_suggests_tinytable r_suggests_vdiffr
...
R_SUGGESTS="
	...
	r_suggests_marginaleffects? ( >=sci-CRAN/marginaleffects-0.24.0 )
