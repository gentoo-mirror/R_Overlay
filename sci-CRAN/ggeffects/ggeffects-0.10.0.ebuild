...
SRC_URI="http://cran.r-project.org/src/contrib/ggeffects_0.10.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_betareg r_suggests_brms
	...
	r_suggests_lme4 r_suggests_logistf r_suggests_matrix
	...
	r_suggests_rstantools r_suggests_sandwich r_suggests_sjstats
