...
SRC_URI="http://cran.r-project.org/src/contrib/ggeffects_1.3.2.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_aod r_suggests_bayestestr
	r_suggests_betareg r_suggests_brglm2 r_suggests_brms r_suggests_broom
	r_suggests_car r_suggests_cardata r_suggests_clubsandwich
	r_suggests_datawizard r_suggests_effects r_suggests_emmeans
	r_suggests_gam r_suggests_gamlss r_suggests_gamm4 r_suggests_gee
	r_suggests_geepack r_suggests_ggplot2 r_suggests_ggrepel
	r_suggests_glmmadaptive r_suggests_glmmtmb r_suggests_gridextra
	r_suggests_haven r_suggests_httr r_suggests_jsonlite r_suggests_knitr
	r_suggests_lme4 r_suggests_logistf r_suggests_magrittr
	r_suggests_marginaleffects r_suggests_margins r_suggests_mass
	r_suggests_matrix r_suggests_mcmcglmm r_suggests_mgcv r_suggests_mice
	r_suggests_nestedlogit r_suggests_nlme r_suggests_ordinal
	r_suggests_parameters r_suggests_patchwork r_suggests_pscl
	r_suggests_quantreg r_suggests_rmarkdown r_suggests_rms
	r_suggests_robustbase r_suggests_rstanarm r_suggests_rstantools
	r_suggests_sandwich r_suggests_see r_suggests_sjlabelled
	r_suggests_sjmisc r_suggests_sjstats r_suggests_survey
...
R_SUGGESTS="
	...
	r_suggests_datawizard? ( >=sci-CRAN/datawizard-0.9.0 )
	r_suggests_effects? ( >=sci-CRAN/effects-4.2.2 )
	r_suggests_emmeans? ( >=sci-CRAN/emmeans-1.8.8 )
