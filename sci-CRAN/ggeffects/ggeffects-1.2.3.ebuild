...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ggeffects_1.2.3.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_aod r_suggests_bayestestr
	...
	r_suggests_glmmtmb r_suggests_gridextra r_suggests_haven
	r_suggests_httr r_suggests_jsonlite r_suggests_knitr r_suggests_lme4
	...
	r_suggests_survival r_suggests_testthat r_suggests_vgam"
R_SUGGESTS="
