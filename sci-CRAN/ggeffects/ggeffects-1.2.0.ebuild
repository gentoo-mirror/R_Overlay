...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/ggeffects_1.2.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_aod r_suggests_betareg
	r_suggests_brms r_suggests_clubsandwich r_suggests_effects
	r_suggests_emmeans r_suggests_gam r_suggests_gamlss r_suggests_gamm4
	...
	r_suggests_nlme r_suggests_ordinal r_suggests_parameters
	...
	r_suggests_see r_suggests_sjlabelled r_suggests_sjmisc
