...
SRC_URI="http://cran.r-project.org/src/contrib/ggeffects_1.3.4.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_aod r_suggests_bayestestr
	...
	r_suggests_gridextra r_suggests_haven r_suggests_httr
	r_suggests_jsonlite r_suggests_knitr r_suggests_lme4
	r_suggests_logistf r_suggests_magrittr r_suggests_marginaleffects
	r_suggests_margins r_suggests_mass r_suggests_matrix
	r_suggests_mcmcglmm r_suggests_mgcv r_suggests_mice
	r_suggests_nestedlogit r_suggests_nlme r_suggests_nnet
	r_suggests_ordinal r_suggests_parameters r_suggests_parsnip
	r_suggests_patchwork r_suggests_pscl r_suggests_quantreg
	r_suggests_rmarkdown r_suggests_rms r_suggests_robustbase
	r_suggests_rstanarm r_suggests_rstantools r_suggests_sandwich
	r_suggests_sdmtmb r_suggests_see r_suggests_sjlabelled
	r_suggests_sjstats r_suggests_survey r_suggests_survival
	r_suggests_testthat r_suggests_tibble r_suggests_vgam
	r_suggests_withr"
R_SUGGESTS="
