...
SRC_URI="http://cran.r-project.org/src/contrib/amt_0.1.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_adehabitatlt r_suggests_bcpa r_suggests_devtools
	r_suggests_ggplot2 r_suggests_knitr r_suggests_move
	r_suggests_movehmm r_suggests_rmarkdown r_suggests_sessioninfo
	r_suggests_spacetime r_suggests_tinytest r_suggests_trajectories"
R_SUGGESTS="
