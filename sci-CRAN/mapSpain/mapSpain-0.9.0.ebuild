...
SRC_URI="http://cran.r-project.org/src/contrib/mapSpain_0.9.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_ggplot2 r_suggests_knitr r_suggests_leaflet
	r_suggests_png r_suggests_rmarkdown r_suggests_slippymath
...
"
DEPEND=">=sci-CRAN/rappdirs-0.3.0
