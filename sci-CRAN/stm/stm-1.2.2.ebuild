...
SRC_URI="http://cran.r-project.org/src/contrib/stm_1.2.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_clue r_suggests_geometry r_suggests_huge
	r_suggests_igraph r_suggests_kernsmooth r_suggests_ldavis
	r_suggests_nlp r_suggests_rtsne r_suggests_snowballc
	r_suggests_testthat r_suggests_tm r_suggests_wordcloud"
R_SUGGESTS="
