...
SRC_URI="http://cran.r-project.org/src/contrib/selenider_0.1.2.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_chromote r_suggests_jsonlite r_suggests_knitr
	...
	r_suggests_rvest r_suggests_shiny r_suggests_shinytest2
	r_suggests_showimage r_suggests_testthat r_suggests_wdman
	r_suggests_xml2"
R_SUGGESTS="
