...
SRC_URI="http://cran.r-project.org/src/contrib/googleVis_0.6.6.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_data_table r_suggests_httpuv
	r_suggests_knitcitations r_suggests_knitr r_suggests_markdown
