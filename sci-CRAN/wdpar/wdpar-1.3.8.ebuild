...
SRC_URI="http://cran.r-project.org/src/contrib/wdpar_1.3.8.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_dplyr r_suggests_ggmap r_suggests_ggplot2
	r_suggests_knitr r_suggests_ps r_suggests_rmarkdown
...
_UNRESOLVED_PACKAGES=( 'prepr (>= 0.3.0)' )
