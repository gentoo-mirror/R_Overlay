...
SRC_URI="http://cran.r-project.org/src/contrib/dartR_2.9.7.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_boot r_suggests_devtools r_suggests_directlabels
	...
	r_suggests_plotly r_suggests_poppr r_suggests_proxy r_suggests_purrr
	r_suggests_qvalue r_suggests_rcolorbrewer r_suggests_rcpp
	r_suggests_rgl r_suggests_rmarkdown r_suggests_rrblup
	r_suggests_scales r_suggests_seqinr r_suggests_shinybs
	r_suggests_shinyjs r_suggests_shinythemes r_suggests_shinywidgets
	r_suggests_siber r_suggests_snpstats r_suggests_stringi
	r_suggests_terra r_suggests_testthat r_suggests_tibble
	r_suggests_vcfr r_suggests_viridis r_suggests_zoo"
R_SUGGESTS="
