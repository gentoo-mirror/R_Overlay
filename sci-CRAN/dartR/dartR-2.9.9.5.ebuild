...
SRC_URI="http://cran.r-project.org/src/contrib/dartR_2.9.9.5.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_boot r_suggests_devtools r_suggests_directlabels
	...
	r_suggests_gdistance r_suggests_gganimate r_suggests_ggrepel
	r_suggests_ggtern r_suggests_ggthemes r_suggests_gplots
	r_suggests_gtable r_suggests_hardyweinberg r_suggests_hierfstat
	r_suggests_igraph r_suggests_iterpc r_suggests_knitr
	r_suggests_label_switching r_suggests_lattice r_suggests_leaflet
	r_suggests_leaflet_minicharts r_suggests_markdown r_suggests_mmod
	r_suggests_networkd3 r_suggests_pegas r_suggests_pheatmap
	r_suggests_plotly r_suggests_poppr r_suggests_proxy r_suggests_qvalue
	r_suggests_rcolorbrewer r_suggests_rcpp r_suggests_rgl
	r_suggests_rmarkdown r_suggests_rrblup r_suggests_scales
	r_suggests_seqinr r_suggests_shinybs r_suggests_shinyjs
	r_suggests_shinythemes r_suggests_shinywidgets r_suggests_siber
	r_suggests_snpstats r_suggests_stringi r_suggests_terra
	r_suggests_tibble r_suggests_vcfr r_suggests_vegan r_suggests_viridis
	r_suggests_zoo"
R_SUGGESTS="
