...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/rock_0.6.7.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_googlesheets4 r_suggests_haven
	...
	r_suggests_openxlsx r_suggests_pdftools r_suggests_preregr
	r_suggests_readxl r_suggests_rena r_suggests_rmarkdown
