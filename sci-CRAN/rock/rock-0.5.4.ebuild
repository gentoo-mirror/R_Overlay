...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/rock_0.5.4.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_googlesheets4 r_suggests_haven
	...
	r_suggests_openxlsx r_suggests_preregr r_suggests_readxl
	r_suggests_rena r_suggests_rmarkdown r_suggests_rstudioapi
	r_suggests_testthat r_suggests_textreadr r_suggests_writexl
...
R_SUGGESTS="
	...
	r_suggests_limonaid? ( sci-CRAN/limonaid )
	...
	r_suggests_textreadr? ( sci-CRAN/textreadr )
