...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/rock_0.4.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_haven r_suggests_justifier
	r_suggests_knitr r_suggests_openxlsx r_suggests_rena
