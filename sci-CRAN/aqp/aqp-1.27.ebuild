...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/aqp_1.27.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_ape r_suggests_colorspace r_suggests_compositions
	r_suggests_digest r_suggests_farver r_suggests_foreign
	r_suggests_gmedian r_suggests_gower r_suggests_hmisc
