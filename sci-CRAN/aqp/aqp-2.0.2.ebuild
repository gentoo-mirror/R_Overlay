...
SRC_URI="http://cran.r-project.org/src/contrib/aqp_2.0.2.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_ape r_suggests_colorspace r_suggests_compositions
	...
	r_suggests_scales r_suggests_sf r_suggests_sharpshootr
	r_suggests_soildb r_suggests_soiltexture r_suggests_tactile
