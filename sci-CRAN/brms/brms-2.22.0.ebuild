...
SRC_URI="http://cran.r-project.org/src/contrib/brms_2.22.0.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_ape r_suggests_arm r_suggests_diffobj
	...
	r_suggests_priorsense r_suggests_processx r_suggests_projpred
	r_suggests_r_rsp r_suggests_rmarkdown r_suggests_rtdists
	r_suggests_rwiener r_suggests_shiny r_suggests_shinystan
...
R_SUGGESTS="
	...
	r_suggests_priorsense? ( >=sci-CRAN/priorsense-1.0.0 )
