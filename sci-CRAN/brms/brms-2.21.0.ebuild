...
SRC_URI="http://cran.r-project.org/src/contrib/brms_2.21.0.tar.gz"
LICENSE='GPL-2'
...
IUSE="${IUSE-} r_suggests_ape r_suggests_arm r_suggests_diffobj
	...
	r_suggests_shiny r_suggests_shinystan r_suggests_spdep
	r_suggests_splines2 r_suggests_statmod r_suggests_testthat"
R_SUGGESTS="
