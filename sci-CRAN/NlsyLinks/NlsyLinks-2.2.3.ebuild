...
SRC_URI="http://cran.r-project.org/src/contrib/NlsyLinks_2.2.3.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_covr r_suggests_devtools r_suggests_dplyr
	r_suggests_ggplot2 r_suggests_knitr r_suggests_readr
	r_suggests_rmarkdown r_suggests_scales r_suggests_spelling
	r_suggests_testit r_suggests_testthat r_suggests_xtable"
R_SUGGESTS="
