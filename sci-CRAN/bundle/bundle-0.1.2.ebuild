...
SRC_URI="http://cran.r-project.org/src/contrib/bundle_0.1.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bonsai r_suggests_butcher r_suggests_callr
	r_suggests_caret r_suggests_covr r_suggests_dbarts r_suggests_embed
	r_suggests_h2o r_suggests_kernlab r_suggests_knitr r_suggests_mass
	r_suggests_modeldata r_suggests_parsnip r_suggests_recipes
	r_suggests_renv r_suggests_rmarkdown r_suggests_stacks
	r_suggests_testthat r_suggests_uwot r_suggests_vetiver
...
R_SUGGESTS="
	...
	r_suggests_xgboost? ( >=sci-CRAN/xgboost-1.6.0.1 )
"
