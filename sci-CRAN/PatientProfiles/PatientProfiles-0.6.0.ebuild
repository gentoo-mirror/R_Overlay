...
SRC_URI="http://cran.r-project.org/src/contrib/PatientProfiles_0.6.0.tar.gz"
...
IUSE="${IUSE-} r_suggests_codelistgenerator r_suggests_covr
	...
	r_suggests_ggplot2 r_suggests_ggraph r_suggests_glue r_suggests_here
...
"
DEPEND=">=sci-CRAN/CDMConnector-1.3.0
	sci-CRAN/checkmate
	sci-CRAN/cli
	sci-CRAN/rlang
	sci-CRAN/magrittr
