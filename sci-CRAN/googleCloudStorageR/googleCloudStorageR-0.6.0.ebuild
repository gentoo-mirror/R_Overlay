...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/googleCloudStorageR_0.6.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_cli r_suggests_fs r_suggests_googlecomputeenginer
