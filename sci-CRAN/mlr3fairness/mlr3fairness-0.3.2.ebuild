...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mlr3fairness_0.3.2.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_fairml r_suggests_iml r_suggests_knitr
	r_suggests_linprog r_suggests_mlr3viz r_suggests_patchwork
	r_suggests_posterdown r_suggests_ranger r_suggests_rmarkdown
