...
SRC_URI="http://cran.r-project.org/src/contrib/rstanarm_2.13.1.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_arm r_suggests_gridextra r_suggests_hsaur3
	r_suggests_kernsmooth r_suggests_knitr r_suggests_mass
	r_suggests_mgcv r_suggests_rmarkdown r_suggests_roxygen2
	r_suggests_testthat"
R_SUGGESTS="
