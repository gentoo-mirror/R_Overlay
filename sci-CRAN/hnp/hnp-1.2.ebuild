...
SRC_URI="http://cran.r-project.org/src/contrib/hnp_1.2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_aods3 r_suggests_gamlss r_suggests_gamlss_dist
	r_suggests_glmmadmb r_suggests_latticeextra r_suggests_lme4
	r_suggests_pscl r_suggests_r[-minimal] r_suggests_vgam"
R_SUGGESTS="
