...
SRC_URI="http://cran.r-project.org/src/contrib/TreeTools_1.16.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_knitr r_suggests_phangorn r_suggests_purrr
	r_suggests_rcpp r_suggests_rlang r_suggests_rmarkdown
	r_suggests_spelling r_suggests_testthat r_suggests_treedist
	r_suggests_vdiffr"
R_SUGGESTS="
	...
	r_suggests_treedist? ( sci-CRAN/TreeDist )
...
_UNRESOLVED_PACKAGES=( 'sci-CRAN/TreeSearch' )
