...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/Hmisc_5.1-0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_abind r_suggests_acepack r_suggests_chron
	r_suggests_digest r_suggests_gt r_suggests_htmlwidgets
	r_suggests_jsonlite r_suggests_lattice r_suggests_leaps
	r_suggests_mice r_suggests_pcapp r_suggests_plotly r_suggests_plyr
