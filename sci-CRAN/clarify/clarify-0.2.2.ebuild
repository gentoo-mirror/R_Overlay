...
SRC_URI="http://cran.r-project.org/src/contrib/clarify_0.2.2.tar.gz"
LICENSE='GPL-3+'
...
R_SUGGESTS="
	...
	r_suggests_weightit? ( >=sci-CRAN/WeightIt-1.3.2 )
	r_suggests_withr? ( sci-CRAN/withr )
"
DEPEND=">=dev-lang/R-4.1.0
	>=sci-CRAN/chk-0.10.0
	>=sci-CRAN/pbapply-1.7.4
	>=sci-CRAN/ggplot2-3.5.0
	>=sci-CRAN/rlang-1.1.6
	>=sci-CRAN/insight-1.4.2
	>=sci-CRAN/marginaleffects-0.30.0
"
