...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/thematic_0.1.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_cairo r_suggests_curl r_suggests_htmltools
	r_suggests_jsonlite r_suggests_knitr r_suggests_lattice
	r_suggests_rmarkdown r_suggests_shiny r_suggests_showtext
	r_suggests_svglite r_suggests_sysfonts r_suggests_systemfonts
