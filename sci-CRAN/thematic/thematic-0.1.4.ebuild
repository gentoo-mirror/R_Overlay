...
SRC_URI="http://cran.r-project.org/src/contrib/thematic_0.1.4.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bslib r_suggests_cairo r_suggests_curl
	r_suggests_gganimate r_suggests_ggiraph r_suggests_htmltools
	r_suggests_httpgd r_suggests_jsonlite r_suggests_knitr
	r_suggests_lattice r_suggests_ragg r_suggests_rmarkdown
...
R_SUGGESTS="
	...
	r_suggests_httpgd? ( sci-CRAN/httpgd )
