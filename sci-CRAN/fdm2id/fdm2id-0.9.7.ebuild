...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/fdm2id_0.9.7.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_arulesviz r_suggests_car r_suggests_caret
	r_suggests_class r_suggests_cluster r_suggests_e1071 r_suggests_fds
