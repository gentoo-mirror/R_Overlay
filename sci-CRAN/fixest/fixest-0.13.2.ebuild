...
SRC_URI="http://cran.r-project.org/src/contrib/fixest_0.13.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_data_table r_suggests_emmeans
	...
	r_suggests_lfe r_suggests_mass r_suggests_matrix r_suggests_pander
	r_suggests_pdftools r_suggests_plm r_suggests_rmarkdown
	r_suggests_tinytex"
R_SUGGESTS="
