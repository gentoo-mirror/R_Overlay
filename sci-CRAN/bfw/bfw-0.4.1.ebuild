...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/bfw_0.4.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_circlize r_suggests_covr r_suggests_data_table
	r_suggests_dplyr r_suggests_ggplot2 r_suggests_knitr
	r_suggests_lavaan r_suggests_magrittr r_suggests_officer
	r_suggests_plyr r_suggests_png r_suggests_psych r_suggests_rmarkdown
	r_suggests_rvg r_suggests_scales r_suggests_testthat"
R_SUGGESTS="
