...
SRC_URI="http://cran.r-project.org/src/contrib/GauPro_0.2.16.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_contourfunctions r_suggests_dplyr
	...
	r_suggests_testthat r_suggests_testthatmulti"
R_SUGGESTS="
	...
	r_suggests_testthatmulti? ( sci-CRAN/testthatmulti )
"
