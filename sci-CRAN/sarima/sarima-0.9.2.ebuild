...
SRC_URI="http://cran.r-project.org/src/contrib/sarima_0.9.2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_fgarch r_suggests_fitarma r_suggests_fkf
	r_suggests_forecast r_suggests_kfas r_suggests_testthat"
R_SUGGESTS="
