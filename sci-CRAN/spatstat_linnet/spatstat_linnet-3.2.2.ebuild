...
SRC_URI="http://cran.r-project.org/src/contrib/spatstat.linnet_3.2-2.tar.gz"
LICENSE='GPL-2+'
...
"
DEPEND=">=sci-CRAN/spatstat_sparse-3.1.0
	>=sci-CRAN/spatstat_explore-3.3.2
	>=dev-lang/R-3.5.0
	>=sci-CRAN/spatstat_utils-3.1.0
	>=sci-CRAN/spatstat_model-3.3.1
	>=sci-CRAN/spatstat_data-3.1.2
	>=sci-CRAN/spatstat_univar-3.0.1
