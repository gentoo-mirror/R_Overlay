...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/optmatch_0.10.3.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_arm r_suggests_biglm r_suggests_boot
	r_suggests_brglm r_suggests_knitr r_suggests_markdown
	r_suggests_pander r_suggests_ritools r_suggests_rmarkdown
	r_suggests_roxygen2 r_suggests_survey r_suggests_testthat
	r_suggests_xtable"
R_SUGGESTS="
