...
SRC_URI="http://cran.r-project.org/src/contrib/pctax_0.1.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_ade4 r_suggests_ape r_suggests_aplot
	r_suggests_bbmle r_suggests_clipr r_suggests_dosnow r_suggests_edger
	r_suggests_foreach r_suggests_geosphere r_suggests_ggnewscale
	r_suggests_ggpmisc r_suggests_ggpubr r_suggests_ggrepel
	r_suggests_ggtree r_suggests_hmisc r_suggests_jsonlite
	r_suggests_knitr r_suggests_limma r_suggests_mass r_suggests_metanet
	r_suggests_mfuzz r_suggests_minpack_lm r_suggests_mixomics
	r_suggests_nst r_suggests_patchwork r_suggests_permute
	r_suggests_pheatmap r_suggests_phyloseq r_suggests_phyloseqgraphtest
	r_suggests_picante r_suggests_plotly r_suggests_prettydoc
	r_suggests_randomforest r_suggests_rmarkdown r_suggests_rtsne
