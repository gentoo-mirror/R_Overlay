...
SRC_URI="http://cran.r-project.org/src/contrib/pctax_0.1.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_ape r_suggests_aplot r_suggests_bbmle
	...
	r_suggests_ggpmisc r_suggests_ggtree r_suggests_hmisc
	...
	r_suggests_rmarkdown r_suggests_rtsne r_suggests_snow
	r_suggests_tidytree r_suggests_umap r_suggests_vctrs
