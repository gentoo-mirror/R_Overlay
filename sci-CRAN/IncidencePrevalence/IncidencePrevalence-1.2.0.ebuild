...
SRC_URI="http://cran.r-project.org/src/contrib/IncidencePrevalence_1.2.0.tar.gz"

IUSE="${IUSE-} r_suggests_binom r_suggests_dbi r_suggests_dbplyr
	r_suggests_duckdb r_suggests_epitools r_suggests_flextable
	r_suggests_ggplot2 r_suggests_gt r_suggests_here r_suggests_hmisc
	r_suggests_knitr r_suggests_odbc r_suggests_patchwork
