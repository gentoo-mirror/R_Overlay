...
SRC_URI="http://cran.r-project.org/src/contrib/glmmTMB_1.0.0.tar.gz"
LICENSE='AGPL-3'
...
IUSE="${IUSE-} r_suggests_bbmle r_suggests_boot r_suggests_broom
	...
	r_suggests_huxtable r_suggests_knitr r_suggests_lattice
...
"
DEPEND=">=sci-CRAN/lme4-1.1.18.9000
	>=dev-lang/R-3.2.0
	virtual/nlme
	>=sci-CRAN/TMB-1.7.14
	virtual/Matrix
