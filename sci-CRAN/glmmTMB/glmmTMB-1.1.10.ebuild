...
SRC_URI="http://cran.r-project.org/src/contrib/glmmTMB_1.1.10.tar.gz"
LICENSE='AGPL-3'

IUSE="${IUSE-} r_suggests_ade4 r_suggests_ape r_suggests_bbmle
	r_suggests_blme r_suggests_boot r_suggests_broom
	r_suggests_broom_mixed r_suggests_car r_suggests_coda
	r_suggests_dharma r_suggests_dotwhisker r_suggests_dplyr
	r_suggests_effects r_suggests_emmeans r_suggests_estimability
	r_suggests_ggplot2 r_suggests_gsl r_suggests_knitr r_suggests_lattice
	r_suggests_mass r_suggests_mlmrev r_suggests_multcomp
	r_suggests_mumin r_suggests_plyr r_suggests_png r_suggests_pscl
