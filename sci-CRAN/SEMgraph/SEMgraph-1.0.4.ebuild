...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/SEMgraph_1.0.4.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_huge r_suggests_pcalg r_suggests_rontotools"
R_SUGGESTS="
	r_suggests_huge? ( sci-CRAN/huge )
	r_suggests_pcalg? ( sci-CRAN/pcalg )
	r_suggests_rontotools? ( sci-BIOC/ROntoTools )
"
DEPEND=">=sci-CRAN/igraph-1.2.1
	>=sci-CRAN/flip-2.5.0
