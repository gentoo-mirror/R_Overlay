...
SRC_URI="http://cran.r-project.org/src/contrib/flacco_1.3.tar.gz"
LICENSE='BSD-2'
...
IUSE="${IUSE-} r_suggests_devtools r_suggests_e1071 r_suggests_expm
	...
	r_suggests_mlbench r_suggests_mlr r_suggests_numderiv
	r_suggests_parallelmap r_suggests_plyr r_suggests_rann
	r_suggests_rpart r_suggests_shape r_suggests_smoof
	r_suggests_testthat"
R_SUGGESTS="
