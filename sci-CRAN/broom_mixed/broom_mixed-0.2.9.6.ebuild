...
SRC_URI="http://cran.r-project.org/src/contrib/broom.mixed_0.2.9.6.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_brms r_suggests_dotwhisker r_suggests_gamlss
	...
	r_suggests_mediation r_suggests_mgcv r_suggests_ordinal
	r_suggests_pander r_suggests_pbkrtest r_suggests_posterior
	r_suggests_rmarkdown r_suggests_rstan r_suggests_rstanarm
	r_suggests_rstantools r_suggests_testthat r_suggests_tmb"
R_SUGGESTS="
