...
SRC_URI="http://cran.r-project.org/src/contrib/broom.mixed_0.2.9.5.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_brms r_suggests_dotwhisker r_suggests_gamlss
	...
	r_suggests_mediation r_suggests_mgcv r_suggests_pander
	r_suggests_pbkrtest r_suggests_posterior r_suggests_rmarkdown
