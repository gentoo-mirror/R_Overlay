...
SRC_URI="http://cran.r-project.org/src/contrib/nlmixr2est_2.2.2.tar.gz"
LICENSE='GPL-3+'
...
R_SUGGESTS="
	...
	r_suggests_rxode2parse? ( >=sci-CRAN/rxode2parse-2.0.19 )
	r_suggests_rxode2random? ( >=sci-CRAN/rxode2random-2.1.0 )
