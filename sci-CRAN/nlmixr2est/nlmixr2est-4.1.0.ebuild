...
SRC_URI="http://cran.r-project.org/src/contrib/nlmixr2est_4.1.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_broom_mixed r_suggests_crayon
	r_suggests_data_table r_suggests_devtools r_suggests_digest
	r_suggests_dplyr r_suggests_fastghquad r_suggests_generics
	r_suggests_minpack_lm r_suggests_nloptr r_suggests_qs
	r_suggests_remotes r_suggests_sfsmisc r_suggests_sys
