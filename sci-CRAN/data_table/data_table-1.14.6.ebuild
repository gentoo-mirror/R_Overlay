...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/data.table_1.14.6.tar.gz"
LICENSE='MPL-2.0'

IUSE="${IUSE-} r_suggests_bit r_suggests_bit64 r_suggests_curl
	r_suggests_knitr r_suggests_r_utils r_suggests_rmarkdown
