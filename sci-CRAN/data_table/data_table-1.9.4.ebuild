...
SRC_URI="http://cran.r-project.org/src/contrib/data.table_1.9.4.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_bit64 r_suggests_fastmatch r_suggests_ggplot2
	r_suggests_hexbin r_suggests_plyr r_suggests_reshape
