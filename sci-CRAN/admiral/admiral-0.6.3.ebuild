...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/admiral_0.6.3.tar.gz"

IUSE="${IUSE-} r_suggests_covr r_suggests_devtools r_suggests_diffdf
	r_suggests_dt r_suggests_knitr r_suggests_lifecycle r_suggests_lintr
