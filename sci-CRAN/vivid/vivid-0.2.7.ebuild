...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/vivid_0.2.7.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_e1071 r_suggests_gridextra
	...
	r_suggests_sna r_suggests_testthat r_suggests_tidymodels
	r_suggests_vip r_suggests_xgboost r_suggests_zenplots"
R_SUGGESTS="
