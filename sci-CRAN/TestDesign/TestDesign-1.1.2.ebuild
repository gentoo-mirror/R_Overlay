...
SRC_URI="http://cran.r-project.org/src/contrib/TestDesign_1.1.2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_dt r_suggests_glpk r_suggests_kableextra
	r_suggests_knitr r_suggests_lpsymphony r_suggests_mirt
	r_suggests_pkgdown r_suggests_progress r_suggests_rmarkdown
