...
SRC_URI="http://cran.r-project.org/src/contrib/TestDesign_1.6.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_dt r_suggests_glpk r_suggests_kableextra
	r_suggests_knitr r_suggests_mirt r_suggests_mirtcat
	r_suggests_pkgdown r_suggests_pkgload r_suggests_progress
