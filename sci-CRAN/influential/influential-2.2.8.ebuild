...
SRC_URI="http://cran.r-project.org/src/contrib/influential_2.2.8.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_colourpicker r_suggests_dt r_suggests_hmisc
	...
	r_suggests_nortest r_suggests_readr r_suggests_rmarkdown
	r_suggests_shiny r_suggests_shinycssloaders r_suggests_shinyjs
	r_suggests_shinythemes r_suggests_shinywidgets"
R_SUGGESTS="
