...
SRC_URI="http://cran.r-project.org/src/contrib/DatabaseConnector_7.0.0.tar.gz"

IUSE="${IUSE-} r_suggests_andromeda r_suggests_aws_s3 r_suggests_azurestor
	r_suggests_bigrquery r_suggests_dbitest r_suggests_dplyr
	r_suggests_duckdb r_suggests_knitr r_suggests_odbc
