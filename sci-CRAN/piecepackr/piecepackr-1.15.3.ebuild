...
SRC_URI="http://cran.r-project.org/src/contrib/piecepackr_1.15.3.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_animation r_suggests_ggplot2 r_suggests_magick
	r_suggests_pdftools r_suggests_rayrender r_suggests_rayvertex
	r_suggests_readobj r_suggests_rgl r_suggests_scales
	r_suggests_systemfonts r_suggests_testthat r_suggests_tweenr
	r_suggests_vdiffr r_suggests_xml r_suggests_xmpdf"
R_SUGGESTS="
