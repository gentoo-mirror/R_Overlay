...
SRC_URI="http://cran.r-project.org/src/contrib/sigminer_1.0.7.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_biobase r_suggests_biostrings r_suggests_bsgenome
	r_suggests_circlize r_suggests_covr r_suggests_dofuture
	r_suggests_flexmix r_suggests_genomicranges r_suggests_gensa
	r_suggests_ggalluvial r_suggests_ggfittext r_suggests_ggplotify
	r_suggests_iranges r_suggests_knitr r_suggests_patchwork
	r_suggests_pheatmap r_suggests_pracma r_suggests_quadprog
