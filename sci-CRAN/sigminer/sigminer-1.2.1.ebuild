...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/sigminer_1.2.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_biobase r_suggests_biostrings r_suggests_circlize
	r_suggests_cluster r_suggests_covr r_suggests_digest
	r_suggests_dofuture r_suggests_flexmix r_suggests_gensa
	...
	r_suggests_knitr r_suggests_markdown r_suggests_matrix
	r_suggests_nnls r_suggests_patchwork r_suggests_pheatmap
	r_suggests_quadprog r_suggests_r_utils r_suggests_rcolorbrewer
	r_suggests_reticulate r_suggests_rmarkdown r_suggests_roxygen2
	r_suggests_scales r_suggests_synchronicity r_suggests_testthat
	r_suggests_tibble r_suggests_ucscxenatools"
R_SUGGESTS="
