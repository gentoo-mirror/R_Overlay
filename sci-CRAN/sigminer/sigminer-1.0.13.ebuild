...
SRC_URI="http://cran.r-project.org/src/contrib/sigminer_1.0.13.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_biobase r_suggests_biostrings r_suggests_bsgenome
	...
	r_suggests_ggplotify r_suggests_iranges r_suggests_knitr
	r_suggests_markdown r_suggests_patchwork r_suggests_pheatmap
	r_suggests_pracma r_suggests_quadprog r_suggests_r_utils
