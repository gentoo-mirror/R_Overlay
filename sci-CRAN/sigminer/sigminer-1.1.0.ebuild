...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/sigminer_1.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_biobase r_suggests_biostrings r_suggests_circlize
	r_suggests_cluster r_suggests_covr r_suggests_dofuture
	r_suggests_flexmix r_suggests_gensa r_suggests_ggalluvial
	r_suggests_ggcorrplot r_suggests_ggfittext r_suggests_ggplotify
	r_suggests_ggrepel r_suggests_iranges r_suggests_knitr
	r_suggests_markdown r_suggests_matrix r_suggests_nnls
