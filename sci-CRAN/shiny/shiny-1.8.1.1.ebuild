...
SRC_URI="http://cran.r-project.org/src/contrib/shiny_1.8.1.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_cairo r_suggests_dt r_suggests_dygraphs
	r_suggests_future r_suggests_ggplot2 r_suggests_knitr
	r_suggests_magrittr r_suggests_markdown r_suggests_ragg
	r_suggests_reactlog r_suggests_rmarkdown r_suggests_sass
	r_suggests_showtext r_suggests_testthat r_suggests_yaml"
R_SUGGESTS="
