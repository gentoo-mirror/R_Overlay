...
IUSE="${IUSE-} r_suggests_actuar r_suggests_ald r_suggests_benchden
	...
	r_suggests_hyperbolicdist r_suggests_ihs r_suggests_kscorrect
	r_suggests_loglognorm r_suggests_marg r_suggests_mc2d
	r_suggests_minimax r_suggests_msm r_suggests_ncdunnett
	r_suggests_normallaplace r_suggests_normalp
...
R_SUGGESTS="
	...
	r_suggests_ncdunnett? ( sci-CRAN/nCDunnett )
