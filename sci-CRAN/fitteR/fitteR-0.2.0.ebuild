...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/fitteR_0.2.0.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_actuar r_suggests_ald r_suggests_benchden
	...
	r_suggests_envstats r_suggests_evd r_suggests_evir r_suggests_extdist
...
R_SUGGESTS="
	...
	r_suggests_extdist? ( sci-CRAN/ExtDist )
