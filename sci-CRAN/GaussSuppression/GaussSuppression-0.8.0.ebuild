...
SRC_URI="http://cran.r-project.org/src/contrib/GaussSuppression_0.8.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_formattable r_suggests_glpk r_suggests_kableextra
	r_suggests_knitr r_suggests_lpsolve r_suggests_rmarkdown
	r_suggests_rsymphony r_suggests_slam r_suggests_testthat"
R_SUGGESTS="
