...
SRC_URI="http://cran.r-project.org/src/contrib/scDiffCom_1.0.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_biomart r_suggests_covr r_suggests_dt
	r_suggests_ggplot2 r_suggests_igraph r_suggests_keggrest
	r_suggests_knitr r_suggests_ontologyindex r_suggests_ontoproc
	r_suggests_pkgdown r_suggests_plotly r_suggests_rcolorbrewer
