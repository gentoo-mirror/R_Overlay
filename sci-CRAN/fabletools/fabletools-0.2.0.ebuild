...
SRC_URI="http://cran.r-project.org/src/contrib/fabletools_0.2.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_crayon r_suggests_digest
	r_suggests_fable r_suggests_feasts r_suggests_future_apply
	r_suggests_knitr r_suggests_lubridate r_suggests_pillar
	r_suggests_rmarkdown r_suggests_scales r_suggests_sparsem
