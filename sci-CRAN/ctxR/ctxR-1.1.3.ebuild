...
SRC_URI="http://cran.r-project.org/src/contrib/ctxR_1.1.3.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_countcolors r_suggests_devtools r_suggests_dt
	r_suggests_ggplot2 r_suggests_htmltable r_suggests_httptest
	r_suggests_kableextra r_suggests_knitr r_suggests_prettydoc
	r_suggests_rmarkdown r_suggests_rmdformats r_suggests_testthat
	r_suggests_xml"
R_SUGGESTS="
