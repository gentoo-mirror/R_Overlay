...
SRC_URI="http://cran.r-project.org/src/contrib/agridat_1.13.tar.gz"
...
IUSE="${IUSE-} r_suggests_aer r_suggests_agricolae r_suggests_betareg
	...
	r_suggests_equivalence r_suggests_frf2 r_suggests_gam r_suggests_gge
	r_suggests_ggplot2 r_suggests_gnm r_suggests_gstat r_suggests_hh
	r_suggests_knitr r_suggests_lattice r_suggests_latticeextra
	r_suggests_lme4 r_suggests_lsmeans r_suggests_lucid
	r_suggests_mapproj r_suggests_maps r_suggests_mass
	r_suggests_mcmcglmm r_suggests_metafor r_suggests_mgcv
	r_suggests_nada r_suggests_nlme r_suggests_nullabor
	...
	r_suggests_rgdal r_suggests_sp r_suggests_spats r_suggests_survival
