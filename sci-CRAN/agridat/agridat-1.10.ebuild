...
SRC_URI="http://cran.r-project.org/src/contrib/agridat_1.10.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_agricolae r_suggests_car r_suggests_coin
	r_suggests_corrgram r_suggests_equivalence r_suggests_frf2
	r_suggests_gam r_suggests_gstat r_suggests_hh r_suggests_knitr
	r_suggests_latticeextra r_suggests_lme4 r_suggests_lucid
	r_suggests_mapproj r_suggests_maps r_suggests_mcmcglmm r_suggests_pls
	r_suggests_pscl r_suggests_sp r_suggests_vcd"
R_SUGGESTS="
