...
SRC_URI="http://cran.r-project.org/src/contrib/viridis_0.4.1.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_colorspace r_suggests_covr r_suggests_dichromat
	...
	r_suggests_mass r_suggests_rastervis r_suggests_rgdal
	r_suggests_rmarkdown r_suggests_scales r_suggests_svglite
