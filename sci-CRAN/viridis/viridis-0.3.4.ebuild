...
SRC_URI="http://cran.r-project.org/src/contrib/viridis_0.3.4.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_colorspace r_suggests_dichromat r_suggests_hexbin
	r_suggests_httr r_suggests_knitr r_suggests_mapproj r_suggests_mass
	r_suggests_rastervis r_suggests_scales"
R_SUGGESTS="
