...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/reproducible_2.0.5.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_crayon r_suggests_dbi
	r_suggests_fastdigest r_suggests_future r_suggests_geodata
	r_suggests_glue r_suggests_googledrive r_suggests_httr
	r_suggests_knitr r_suggests_qs r_suggests_rcurl r_suggests_rlang
