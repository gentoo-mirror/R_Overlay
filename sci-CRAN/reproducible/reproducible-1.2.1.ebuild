...
SRC_URI="http://cran.r-project.org/src/contrib/reproducible_1.2.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_crayon r_suggests_fastdigest
	r_suggests_fasterize r_suggests_future r_suggests_gdalutils
	r_suggests_googledrive r_suggests_httr r_suggests_knitr r_suggests_qs
