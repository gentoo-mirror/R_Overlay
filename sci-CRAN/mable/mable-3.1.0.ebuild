...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mable_3.1.0.tar.gz"
LICENSE='|| ( LGPL-2 LGPL-2.1 )'

IUSE="${IUSE-} r_suggests_coxinterval r_suggests_icsurv r_suggests_knitr
	r_suggests_ks r_suggests_markdown r_suggests_mixtools
	r_suggests_multimode r_suggests_pbapply r_suggests_rmarkdown"
R_SUGGESTS="
