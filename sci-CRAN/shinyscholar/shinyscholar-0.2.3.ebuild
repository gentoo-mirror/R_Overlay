...
SRC_URI="http://cran.r-project.org/src/contrib/shinyscholar_0.2.3.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bslib r_suggests_dplyr r_suggests_dt
	r_suggests_future r_suggests_httr2 r_suggests_knitcitations
	r_suggests_leaflet_extras r_suggests_markdown r_suggests_promises
	r_suggests_r6 r_suggests_rcolorbrewer r_suggests_renv
	r_suggests_rintrojs r_suggests_rmarkdown r_suggests_shinyace
	r_suggests_shinyalert r_suggests_shinybusy r_suggests_shinyjs
