...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/shinymeta_0.2.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_clipr r_suggests_cranlogs r_suggests_dplyr
	r_suggests_ggplot2 r_suggests_knitr r_suggests_rmarkdown
	r_suggests_shinyace r_suggests_stringr r_suggests_testthat
	r_suggests_xfun r_suggests_zoo"
R_SUGGESTS="
