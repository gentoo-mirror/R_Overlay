...
SRC_URI="http://cran.r-project.org/src/contrib/bayesplot_1.1.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_arm r_suggests_gridextra r_suggests_knitr
	r_suggests_rmarkdown r_suggests_rstan r_suggests_rstanarm
	r_suggests_rstantools r_suggests_shinystan r_suggests_testthat"
R_SUGGESTS="
	...
	r_suggests_rstan? ( >=sci-CRAN/rstan-2.13.2 )
	r_suggests_rstanarm? ( >=sci-CRAN/rstanarm-2.13.1 )
	r_suggests_rstantools? ( >=sci-CRAN/rstantools-1.0.0 )
