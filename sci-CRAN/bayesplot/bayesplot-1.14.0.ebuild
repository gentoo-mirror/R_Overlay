...
SRC_URI="http://cran.r-project.org/src/contrib/bayesplot_1.14.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_ggdist r_suggests_ggfortify r_suggests_hexbin
