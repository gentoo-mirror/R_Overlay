...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/REddyProc_1.3.2.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ggplot2 r_suggests_knitr r_suggests_lognorm
	r_suggests_markdown r_suggests_minpack_lm r_suggests_mlegp
	r_suggests_rmarkdown r_suggests_segmented r_suggests_testthat
	r_suggests_tidyr"
R_SUGGESTS="
