...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/flextable_0.7.2.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bookdown r_suggests_broom r_suggests_broom_mixed
	r_suggests_cluster r_suggests_commonmark r_suggests_ggplot2
	r_suggests_lme4 r_suggests_magick r_suggests_mgcv r_suggests_nlme
