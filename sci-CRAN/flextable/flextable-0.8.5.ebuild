...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/flextable_0.8.5.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bookdown r_suggests_broom r_suggests_broom_mixed
	...
	r_suggests_scales r_suggests_testthat r_suggests_webshot2
	r_suggests_xtable"
R_SUGGESTS="
...
DEPEND="sci-CRAN/rmarkdown
	...
	sci-CRAN/base64enc
	sci-CRAN/knitr
	>=sci-CRAN/officer-0.5.2
	sci-CRAN/htmltools
	>=sci-CRAN/data_table-1.13.0
	>=sci-CRAN/uuid-0.1.4
	>=sci-CRAN/gdtools-0.3.0
	sci-CRAN/rlang
"
