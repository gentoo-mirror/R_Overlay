...
SRC_URI="http://cran.r-project.org/src/contrib/flextable_0.9.4.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bookdown r_suggests_broom r_suggests_broom_mixed
	...
	r_suggests_ggplot2 r_suggests_lme4 r_suggests_magick r_suggests_mgcv
	r_suggests_nlme r_suggests_officedown r_suggests_pdftools
	r_suggests_pkgdown r_suggests_scales r_suggests_svglite
	r_suggests_tables r_suggests_testthat r_suggests_webshot2
	r_suggests_xtable"
R_SUGGESTS="
	r_suggests_bookdown? ( >=sci-CRAN/bookdown-0.34 )
