...
SRC_URI="http://cran.r-project.org/src/contrib/mcmcsae_0.7.6.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bayeslogit r_suggests_bayesplot r_suggests_coda
	...
	r_suggests_posterior r_suggests_rmarkdown r_suggests_roxygen2
	r_suggests_sf r_suggests_spdep r_suggests_survey r_suggests_testthat"
R_SUGGESTS="
