...
SRC_URI="http://cran.r-project.org/src/contrib/hyperSpec_0.98-20150304.tar.gz -> hyperSpec_0.98-20150304-r1.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_baseline r_suggests_deldir r_suggests_fastcluster
	r_suggests_inline r_suggests_mass r_suggests_plotrix r_suggests_pls
