...
SRC_URI="http://cran.r-project.org/src/contrib/soilDB_2.5.8.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_ggplot2 r_suggests_gridextra r_suggests_httr
	...
	r_suggests_rcurl r_suggests_rgdal r_suggests_rgeos r_suggests_rodbc
	r_suggests_rvest r_suggests_sf r_suggests_stringr r_suggests_testthat
