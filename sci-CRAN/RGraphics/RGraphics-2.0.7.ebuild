...
SRC_URI="http://cran.r-project.org/src/contrib/RGraphics_2.0-7.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_agricolae r_suggests_animation
	...
	r_suggests_gridsvg r_suggests_grimport r_suggests_gwidgetsrgtk2
	r_suggests_hexbin r_suggests_hmisc r_suggests_igraph
	r_suggests_iplots r_suggests_ipred r_suggests_latticeextra
	r_suggests_latticist r_suggests_mapdata r_suggests_maps
	r_suggests_maptools r_suggests_misc3d r_suggests_munsell
