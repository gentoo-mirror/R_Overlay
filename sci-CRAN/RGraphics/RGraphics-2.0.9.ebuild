...
SRC_URI="http://cran.r-project.org/src/contrib/RGraphics_2.0-9.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_agricolae r_suggests_animation
	...
	r_suggests_hexbin r_suggests_hmisc r_suggests_hypergraph
	r_suggests_igraph r_suggests_iplots r_suggests_ipred
	r_suggests_latticeextra r_suggests_latticist r_suggests_mapdata
	...
	r_suggests_raster r_suggests_rcmdr r_suggests_rcolorbrewer
	r_suggests_rgdal r_suggests_rggobi r_suggests_rgl
	r_suggests_rgraphics r_suggests_scatterplot3d r_suggests_soiltexture
	r_suggests_sp r_suggests_svgannotation r_suggests_symbols
	r_suggests_teachingdemos r_suggests_vcd r_suggests_vcdextra
	r_suggests_venneuler r_suggests_vrmlgen"
R_SUGGESTS="
