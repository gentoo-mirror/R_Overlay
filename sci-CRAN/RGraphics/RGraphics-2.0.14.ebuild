...
SRC_URI="http://cran.r-project.org/src/contrib/RGraphics_2.0-14.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_agricolae r_suggests_animation
	r_suggests_circstats r_suggests_circular r_suggests_cluster
	r_suggests_colorspace r_suggests_diagram r_suggests_dichromat
	r_suggests_gplots r_suggests_graph r_suggests_gridbase
	r_suggests_gridextra r_suggests_gridsvg r_suggests_grimport
	r_suggests_gwidgets r_suggests_gwidgetsrgtk2 r_suggests_hexbin
	r_suggests_hmisc r_suggests_hypergraph r_suggests_igraph
	r_suggests_iplots r_suggests_ipred r_suggests_latticeextra
	r_suggests_mapdata r_suggests_maps r_suggests_maptools
	r_suggests_mass r_suggests_misc3d r_suggests_munsell
	r_suggests_network r_suggests_openair r_suggests_oz r_suggests_party
	r_suggests_pixmap r_suggests_playwith r_suggests_plotrix
	r_suggests_pmg r_suggests_png r_suggests_quantmod r_suggests_raster
	r_suggests_rcmdr r_suggests_rcolorbrewer r_suggests_rgdal
	r_suggests_rggobi r_suggests_rgl r_suggests_rgraphics
	r_suggests_scatterplot3d r_suggests_soiltexture r_suggests_sp
	r_suggests_svgannotation r_suggests_symbols r_suggests_teachingdemos
	r_suggests_vcd r_suggests_vcdextra r_suggests_venneuler
	r_suggests_vrmlgen r_suggests_xml"
R_SUGGESTS="
