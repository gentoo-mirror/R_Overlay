...
SRC_URI="http://cran.r-project.org/src/contrib/TreatmentPatterns_2.6.7.tar.gz"
LICENSE='Apache-2.0'

IUSE="${IUSE-} r_suggests_cdmconnector r_suggests_circer
	r_suggests_databaseconnector r_suggests_dbi r_suggests_duckdb
	r_suggests_eunomia r_suggests_ggplot2 r_suggests_knitr
