...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/drtmle_1.1.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_earth r_suggests_foreach
	r_suggests_future_batchtools r_suggests_gam r_suggests_knitr
