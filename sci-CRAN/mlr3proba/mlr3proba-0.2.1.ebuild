...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3proba_0.2.1.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_bibtex r_suggests_ggplot2 r_suggests_knitr
	r_suggests_lgr r_suggests_matrix r_suggests_mlr3pipelines
	r_suggests_mlr3tuning r_suggests_pracma r_suggests_rmarkdown
	r_suggests_rpart r_suggests_set6 r_suggests_simsurv
...
R_SUGGESTS="
	...
	r_suggests_mlr3pipelines? ( >=sci-CRAN/mlr3pipelines-0.2.1 )
