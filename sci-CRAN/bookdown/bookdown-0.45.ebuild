...
SRC_URI="http://cran.r-project.org/src/contrib/bookdown_0.45.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bslib r_suggests_curl r_suggests_downlit
	r_suggests_htmlwidgets r_suggests_jsonlite r_suggests_miniui
	r_suggests_rsconnect r_suggests_rstudioapi r_suggests_servr
	r_suggests_shiny r_suggests_testit r_suggests_testthat
	r_suggests_tibble r_suggests_tufte r_suggests_withr r_suggests_xml2"
R_SUGGESTS="
