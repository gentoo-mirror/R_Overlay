...
SRC_URI="http://cran.r-project.org/src/contrib/ade4_1.7-3.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ade4tkgui r_suggests_adegraphics r_suggests_ape
	r_suggests_circstats r_suggests_deldir r_suggests_maptools
	r_suggests_pixmap r_suggests_r[-minimal] r_suggests_sp
