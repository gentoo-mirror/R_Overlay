...
SRC_URI="http://cran.r-project.org/src/contrib/pacta.loanbook_0.1.1.tar.gz"
LICENSE='MIT'
...
"
DEPEND=">=sci-CRAN/r2dii_data-0.6.0
	>=sci-CRAN/r2dii_plot-0.5.2
	>=sci-CRAN/r2dii_match-0.4.1
	sci-CRAN/tibble
	sci-CRAN/rstudioapi
	sci-CRAN/rlang
	>=dev-lang/R-4.1
