...
SRC_URI="http://cran.r-project.org/src/contrib/ChemoSpecUtils_0.3.60.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_amap r_suggests_chemospec r_suggests_chemospec2d
	r_suggests_irlba r_suggests_multiway r_suggests_rcolorbrewer
	r_suggests_robustbase r_suggests_threeway r_suggests_tinytest"
R_SUGGESTS="
