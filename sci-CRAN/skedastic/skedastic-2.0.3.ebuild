...
SRC_URI="http://cran.r-project.org/src/contrib/skedastic_2.0.3.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_arrangements r_suggests_boot r_suggests_car
	r_suggests_cmna r_suggests_cubature r_suggests_devtools
	r_suggests_expm r_suggests_gmp r_suggests_knitr r_suggests_lmtest
	r_suggests_mlbench r_suggests_mvtnorm r_suggests_quantreg
	r_suggests_rmarkdown r_suggests_rmpfr r_suggests_sandwich
	r_suggests_testthat r_suggests_tibble r_suggests_tseries"
R_SUGGESTS="
	r_suggests_arrangements? ( sci-CRAN/arrangements )
	r_suggests_boot? ( virtual/boot )
	r_suggests_car? ( sci-CRAN/car )
	r_suggests_cmna? ( sci-CRAN/cmna )
