...
SRC_URI="http://cran.r-project.org/src/contrib/io_0.3.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_jsonlite r_suggests_testthat r_suggests_xml
	r_suggests_yaml"
R_SUGGESTS="
...
_UNRESOLVED_PACKAGES=( '>=sci-BIOC/rhdf5-2.23.4' )
