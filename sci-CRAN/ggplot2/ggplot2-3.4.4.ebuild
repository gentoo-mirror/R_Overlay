...
SRC_URI="http://cran.r-project.org/src/contrib/ggplot2_3.4.4.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_dplyr r_suggests_ggplot2movies
	...
	r_suggests_multcomp r_suggests_munsell r_suggests_nlme
	r_suggests_profvis r_suggests_quantreg r_suggests_ragg
