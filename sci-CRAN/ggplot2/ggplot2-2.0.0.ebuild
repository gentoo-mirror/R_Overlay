...
SRC_URI="http://cran.r-project.org/src/contrib/ggplot2_2.0.0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_ggplot2movies r_suggests_hexbin r_suggests_hmisc
	r_suggests_knitr r_suggests_mapproj r_suggests_maps
	r_suggests_maptools r_suggests_multcomp r_suggests_quantreg
