...
SRC_URI="http://cran.r-project.org/src/contrib/ggplot2_4.0.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_broom r_suggests_covr r_suggests_dplyr
	r_suggests_ggplot2movies r_suggests_hexbin r_suggests_hmisc
	r_suggests_knitr r_suggests_mapproj r_suggests_maps r_suggests_mass
	r_suggests_mgcv r_suggests_multcomp r_suggests_munsell
	r_suggests_nlme r_suggests_profvis r_suggests_quantreg
	r_suggests_ragg r_suggests_rcolorbrewer r_suggests_rmarkdown
	r_suggests_roxygen2 r_suggests_rpart r_suggests_sf r_suggests_svglite
