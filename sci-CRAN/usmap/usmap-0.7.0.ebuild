...
SRC_URI="http://cran.r-project.org/src/contrib/usmap_0.7.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_covr r_suggests_ggplot2 r_suggests_ggrepel
	r_suggests_knitr r_suggests_proto r_suggests_rmarkdown
	r_suggests_scales r_suggests_sf r_suggests_testthat r_suggests_vdiffr"
R_SUGGESTS="
