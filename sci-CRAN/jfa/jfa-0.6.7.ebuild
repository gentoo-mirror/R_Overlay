...
SRC_URI="http://cran.r-project.org/src/contrib/jfa_0.6.7.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_benford_analysis r_suggests_benfordtests
	r_suggests_beyondbenford r_suggests_knitr r_suggests_mus
	r_suggests_rmarkdown r_suggests_samplingbook r_suggests_testthat"
R_SUGGESTS="
