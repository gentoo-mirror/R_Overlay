...
SRC_URI="http://cran.r-project.org/src/contrib/heemod_0.9.2.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_bcea r_suggests_diagram r_suggests_flexsurv
	r_suggests_hmisc r_suggests_knitr r_suggests_logitnorm
	r_suggests_lpsolve r_suggests_mgcv r_suggests_optimx
	r_suggests_readxl r_suggests_rgho r_suggests_rmarkdown
	r_suggests_stringr r_suggests_survival r_suggests_testthat
	r_suggests_triangle r_suggests_xlconnect"
R_SUGGESTS="
