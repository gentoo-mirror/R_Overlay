...
SRC_URI="http://cran.r-project.org/src/contrib/heemod_0.9.1.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_diagram r_suggests_flexsurv r_suggests_hmisc
	r_suggests_knitr r_suggests_logitnorm r_suggests_mgcv
