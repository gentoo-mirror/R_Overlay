...
SRC_URI="http://cran.r-project.org/src/contrib/heemod_0.8.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_diagram r_suggests_flexsurv r_suggests_formatr
	...
	r_suggests_mgcv r_suggests_readxl r_suggests_rmarkdown
	r_suggests_survival r_suggests_testthat r_suggests_triangle"
R_SUGGESTS="
