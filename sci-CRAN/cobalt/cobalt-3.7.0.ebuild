...
SRC_URI="http://cran.r-project.org/src/contrib/cobalt_3.7.0.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_cbps r_suggests_designmatch r_suggests_ebal
	r_suggests_knitr r_suggests_matching r_suggests_matchit
	r_suggests_mice r_suggests_mlogit r_suggests_optmatch
	r_suggests_optweight r_suggests_rmarkdown r_suggests_twang
	r_suggests_weightit"
R_SUGGESTS="
