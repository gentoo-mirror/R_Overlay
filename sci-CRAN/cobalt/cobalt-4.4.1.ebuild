...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/cobalt_4.4.1.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_cbps r_suggests_cem r_suggests_designmatch
	...
	r_suggests_sbw r_suggests_testthat r_suggests_twang
	r_suggests_twangcontinuous r_suggests_weightit"
R_SUGGESTS="
