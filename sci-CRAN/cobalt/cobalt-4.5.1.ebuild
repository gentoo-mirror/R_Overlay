...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/cobalt_4.5.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_brglm2 r_suggests_cbps r_suggests_cem
	r_suggests_designmatch r_suggests_ebal r_suggests_gbm
...
R_SUGGESTS="
	...
	r_suggests_weightit? ( >=sci-CRAN/WeightIt-0.14.0 )
"
DEPEND=">=sci-CRAN/chk-0.8.1
	sci-CRAN/crayon
