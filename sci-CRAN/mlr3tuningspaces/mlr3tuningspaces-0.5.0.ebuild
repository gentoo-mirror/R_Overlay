...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3tuningspaces_0.5.0.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_bbotk r_suggests_e1071 r_suggests_glmnet
	r_suggests_kknn r_suggests_mlr3learners r_suggests_ranger
