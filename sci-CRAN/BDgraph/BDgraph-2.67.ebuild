...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/BDgraph_2.67.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ggplot2 r_suggests_huge r_suggests_knitr
	r_suggests_proc r_suggests_rmarkdown r_suggests_skimr
