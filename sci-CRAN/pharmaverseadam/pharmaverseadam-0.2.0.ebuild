...
SRC_URI="http://cran.r-project.org/src/contrib/pharmaverseadam_0.2.0.tar.gz"

IUSE="${IUSE-} r_suggests_covr r_suggests_devtools r_suggests_diffdf
	r_suggests_dt r_suggests_knitr r_suggests_lintr r_suggests_metacore
	r_suggests_metatools r_suggests_miniui r_suggests_pkgdown
