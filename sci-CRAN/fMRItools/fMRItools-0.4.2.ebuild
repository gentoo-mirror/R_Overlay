...
SRC_URI="http://cran.r-project.org/src/contrib/fMRItools_0.4.2.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_ciftitools r_suggests_corpcor r_suggests_covr
	r_suggests_expm r_suggests_fda r_suggests_gifti r_suggests_gsignal
	r_suggests_knitr r_suggests_oro_nifti r_suggests_pesel
	r_suggests_quantreg r_suggests_rmarkdown r_suggests_rnifti
	r_suggests_robustbase r_suggests_testthat"
R_SUGGESTS="
...
_UNRESOLVED_PACKAGES=( '>=sci-CRAN/templateICAr-0.8.0' )
