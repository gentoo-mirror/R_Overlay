...
SRC_URI="http://cran.r-project.org/src/contrib/blackbox_1.1.2.tar.gz"
LICENSE='CeCILL-2'

IUSE="${IUSE-} r_suggests_ff r_suggests_foreach r_suggests_igraph
	r_suggests_lbfgsb3 r_suggests_minqa r_suggests_testthat"
R_SUGGESTS="
