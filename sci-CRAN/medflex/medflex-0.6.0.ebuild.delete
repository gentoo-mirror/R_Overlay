...
SRC_URI="http://cran.r-project.org/src/contrib/medflex_0.6-0.tar.gz"
LICENSE='GPL-2'

IUSE="${IUSE-} r_suggests_arm r_suggests_gam r_suggests_glmnet
	r_suggests_mice r_suggests_mitools r_suggests_superlearner
	r_suggests_vgam"
R_SUGGESTS="
...
"
DEPEND=">=sci-CRAN/sandwich-2.3.2
