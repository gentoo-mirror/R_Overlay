...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/qra_0.2.6.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bookdown r_suggests_dfoptim r_suggests_dharma
	...
	r_suggests_mass r_suggests_optimx r_suggests_plotrix
	r_suggests_prettydoc r_suggests_robustlmm r_suggests_vgam"
R_SUGGESTS="
