...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/aum_2023.6.14.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_directlabels r_suggests_ggplot2
	r_suggests_ggrepel r_suggests_kernlab r_suggests_knitr
	r_suggests_lattice r_suggests_markdown r_suggests_mlbench
	r_suggests_nc r_suggests_penaltylearning r_suggests_testthat
