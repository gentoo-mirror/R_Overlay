...
SRC_URI="http://cran.r-project.org/src/contrib/gratia_0.11.1.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_carrier r_suggests_curl r_suggests_distributional
	r_suggests_forcats r_suggests_gamair r_suggests_gamm4
	r_suggests_ggdist r_suggests_gjrm r_suggests_glmmtmb
	r_suggests_hexbin r_suggests_knitr r_suggests_lme4
	r_suggests_marginaleffects r_suggests_mass r_suggests_readr
	r_suggests_rmarkdown r_suggests_scam r_suggests_sf r_suggests_svglite
