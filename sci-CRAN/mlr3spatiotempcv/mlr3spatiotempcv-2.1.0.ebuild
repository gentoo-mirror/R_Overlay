...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mlr3spatiotempcv_2.1.0.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_bbotk r_suggests_caret r_suggests_ggsci
	r_suggests_ggtext r_suggests_here r_suggests_knitr r_suggests_lgr
	...
	r_suggests_rpart r_suggests_sf r_suggests_sperrorest r_suggests_terra
