...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3spatiotempcv_2.3.4.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_bbotk r_suggests_blockcv r_suggests_caret
	r_suggests_cast r_suggests_ggsci r_suggests_ggtext r_suggests_here
	r_suggests_knitr r_suggests_lgr r_suggests_mlr3filters
	r_suggests_mlr3pipelines r_suggests_mlr3tuning r_suggests_patchwork
	r_suggests_plotly r_suggests_rmarkdown r_suggests_rpart r_suggests_sf
...
R_SUGGESTS="
	...
	r_suggests_blockcv? ( >=sci-CRAN/blockCV-3.1.2 )
