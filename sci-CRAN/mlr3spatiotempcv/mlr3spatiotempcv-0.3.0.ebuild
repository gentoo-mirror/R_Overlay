...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mlr3spatiotempcv_0.3.0.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_bbotk r_suggests_blockcv r_suggests_cast
	r_suggests_ggsci r_suggests_ggtext r_suggests_knitr r_suggests_lgr
	r_suggests_mlr3filters r_suggests_mlr3pipelines r_suggests_mlr3tuning
	r_suggests_patchwork r_suggests_plotly r_suggests_raster
	r_suggests_rmarkdown r_suggests_rpart r_suggests_sf
	r_suggests_skmeans r_suggests_testthat r_suggests_vdiffr
	r_suggests_withr"
R_SUGGESTS="
