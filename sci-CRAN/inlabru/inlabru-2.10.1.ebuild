...
SRC_URI="http://cran.r-project.org/src/contrib/inlabru_2.10.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_covr r_suggests_diagrammer r_suggests_ggmap
	r_suggests_ggplot2 r_suggests_knitr r_suggests_maps r_suggests_mgcv
	r_suggests_patchwork r_suggests_raster r_suggests_rcolorbrewer
	r_suggests_rgl r_suggests_rmarkdown r_suggests_scales
	r_suggests_shiny r_suggests_sn r_suggests_spatstat_data
