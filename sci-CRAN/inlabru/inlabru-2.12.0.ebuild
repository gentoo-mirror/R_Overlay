...
SRC_URI="http://cran.r-project.org/src/contrib/inlabru_2.12.0.tar.gz"
LICENSE='GPL-2+'
...
IUSE="${IUSE-} r_suggests_covr r_suggests_diagrammer r_suggests_ggplot2
	...
	r_suggests_sp r_suggests_spatstat_data r_suggests_spatstat_geom
	r_suggests_sphereplot r_suggests_splancs r_suggests_terra
