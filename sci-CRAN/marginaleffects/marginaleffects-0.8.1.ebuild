...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.8.1.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	r_suggests_bench r_suggests_betareg r_suggests_bh r_suggests_bife
	r_suggests_biglm r_suggests_brglm2 r_suggests_brms
	r_suggests_brmsmargins r_suggests_broom r_suggests_collapse
	r_suggests_conflicted r_suggests_covr r_suggests_crch
	r_suggests_datawizard r_suggests_dplyr r_suggests_emmeans
	r_suggests_estimatr r_suggests_fixest r_suggests_future
	r_suggests_future_apply r_suggests_gam r_suggests_gamlss
	r_suggests_gamlss_dist r_suggests_geepack r_suggests_ggbeeswarm
	r_suggests_ggdag r_suggests_ggdist r_suggests_ggplot2
	...
	r_suggests_polspline r_suggests_posterior r_suggests_prediction
	r_suggests_pscl r_suggests_quantreg r_suggests_rcppeigen
	r_suggests_remotes r_suggests_rlang r_suggests_rmarkdown
	r_suggests_rms r_suggests_robust r_suggests_robustbase
	r_suggests_robustlmm r_suggests_rstanarm r_suggests_rstantools
	r_suggests_sampleselection r_suggests_sandwich r_suggests_scam
	r_suggests_speedglm r_suggests_spelling r_suggests_survey
	r_suggests_survival r_suggests_systemfonts r_suggests_tidymodels
	r_suggests_tidyr r_suggests_tidyverse r_suggests_tinytest
