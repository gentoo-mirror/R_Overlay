...
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.17.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_altdoc
	...
	r_suggests_cardata r_suggests_causaldata r_suggests_collapse
	r_suggests_conflicted r_suggests_covr r_suggests_crch
	r_suggests_dalextra r_suggests_dbarts r_suggests_dcchoice
	...
	r_suggests_rcmdcheck r_suggests_remotes r_suggests_rmarkdown
