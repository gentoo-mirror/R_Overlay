...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.13.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_amelia
	...
	r_suggests_crch r_suggests_distributional r_suggests_dplyr
	r_suggests_emmeans r_suggests_equivalence r_suggests_estimatr
	r_suggests_fixest r_suggests_future r_suggests_fwb r_suggests_gam
