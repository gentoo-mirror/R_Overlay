...
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.29.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_altdoc
	r_suggests_amelia r_suggests_aod r_suggests_bayestestr
	...
	r_suggests_brms r_suggests_brmsmargins r_suggests_broom
	r_suggests_car r_suggests_cardata r_suggests_causaldata
	r_suggests_cjoint r_suggests_clarify r_suggests_cobalt
	r_suggests_collapse r_suggests_conflicted r_suggests_countrycode
	r_suggests_covr r_suggests_crch r_suggests_dalextra r_suggests_dbarts
	...
	r_suggests_fmeffects r_suggests_fontquiver r_suggests_future
	r_suggests_future_apply r_suggests_fwb r_suggests_gam
	r_suggests_gamlss r_suggests_gamlss_dist r_suggests_geepack
	r_suggests_ggdist r_suggests_ggokabeito r_suggests_ggplot2
	r_suggests_ggrepel r_suggests_glmmtmb r_suggests_glmtoolbox
	r_suggests_glmx r_suggests_haven r_suggests_here r_suggests_itsadug
	r_suggests_ivreg r_suggests_kableextra r_suggests_knitr
	r_suggests_lme4 r_suggests_lmertest r_suggests_logistf
	r_suggests_magrittr r_suggests_margins r_suggests_mass
	r_suggests_matchit r_suggests_mclogit r_suggests_mcmcglmm
	r_suggests_mgcv r_suggests_mhurdle r_suggests_mice
	r_suggests_miceadds r_suggests_missranger r_suggests_mlogit
	r_suggests_mlr3verse r_suggests_modelbased r_suggests_modelsummary
	r_suggests_multcomp r_suggests_mvgam r_suggests_mvtnorm
	r_suggests_nanoparquet r_suggests_nlme r_suggests_nnet
	r_suggests_numderiv r_suggests_nycflights13 r_suggests_optmatch
	r_suggests_ordbetareg r_suggests_ordinal r_suggests_parameters
	r_suggests_parsnip r_suggests_partykit r_suggests_patchwork
	r_suggests_pbapply r_suggests_phylolm r_suggests_pkgdown
	r_suggests_plm r_suggests_polspline r_suggests_posterior
	r_suggests_pscl r_suggests_purrr r_suggests_quantreg
	r_suggests_rchoice r_suggests_rcmdcheck r_suggests_rdatasets
	...
	r_suggests_rstudioapi r_suggests_sampleselection r_suggests_sandwich
	r_suggests_scam r_suggests_speedglm r_suggests_spelling
	r_suggests_survey r_suggests_survival r_suggests_svglite
	r_suggests_systemfit r_suggests_systemfonts r_suggests_tibble
...
R_SUGGESTS="
	...
	r_suggests_mvgam? ( sci-CRAN/mvgam )
	...
	r_suggests_tinysnapshot? ( >=sci-CRAN/tinysnapshot-0.0.7 )
