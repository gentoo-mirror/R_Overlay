...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.3.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_aod r_suggests_bench
	...
	r_suggests_knitr r_suggests_lme4 r_suggests_magrittr
	r_suggests_margins r_suggests_mass r_suggests_mgcv r_suggests_nlme
	...
	r_suggests_tidyverse r_suggests_truncreg r_suggests_vdiffr"
R_SUGGESTS="
