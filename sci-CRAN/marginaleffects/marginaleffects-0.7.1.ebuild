...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.7.1.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_robustlmm r_suggests_sampleselection r_suggests_sandwich
	r_suggests_scam r_suggests_speedglm r_suggests_spelling
	r_suggests_survey r_suggests_survival r_suggests_systemfonts
	r_suggests_tidymodels r_suggests_tidyr r_suggests_tidyverse
