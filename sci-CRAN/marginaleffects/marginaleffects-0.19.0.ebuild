...
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.19.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_altdoc
	...
	r_suggests_cardata r_suggests_causaldata r_suggests_clarify
	...
	r_suggests_fixest r_suggests_flexsurv r_suggests_fmeffects
	r_suggests_fontquiver r_suggests_future r_suggests_future_apply
	r_suggests_fwb r_suggests_gam r_suggests_gamlss
	r_suggests_gamlss_dist r_suggests_geepack r_suggests_ggdist
	r_suggests_ggokabeito r_suggests_ggplot2 r_suggests_ggrepel
	r_suggests_glmmtmb r_suggests_glmx r_suggests_haven r_suggests_here
	r_suggests_itsadug r_suggests_ivreg r_suggests_kableextra
	...
	r_suggests_remotes r_suggests_rendo r_suggests_rmarkdown
	r_suggests_rms r_suggests_robust r_suggests_robustbase
	r_suggests_robustlmm r_suggests_rsample r_suggests_rstanarm
	r_suggests_rstantools r_suggests_sampleselection r_suggests_sandwich
...
R_SUGGESTS="
	...
	r_suggests_tinytable? ( >=sci-CRAN/tinytable-0.2.0 )
