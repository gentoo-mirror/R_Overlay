...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.7.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_ggplot2 r_suggests_ggrepel r_suggests_glmx
	...
	r_suggests_plm r_suggests_prediction r_suggests_pscl
	...
	r_suggests_systemfonts r_suggests_tidymodels r_suggests_tidyverse
	r_suggests_tinytest r_suggests_truncreg r_suggests_tsmodel
