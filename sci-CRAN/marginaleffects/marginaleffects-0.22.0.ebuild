...
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.22.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_altdoc
	...
	r_suggests_rstantools r_suggests_rstpm2 r_suggests_sampleselection
...
R_SUGGESTS="
	...
	r_suggests_tinytable? ( >=sci-CRAN/tinytable-0.4.0 )
