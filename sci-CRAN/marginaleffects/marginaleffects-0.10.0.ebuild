...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.10.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_amelia
	...
	r_suggests_broom r_suggests_collapse r_suggests_conflicted
	r_suggests_covr r_suggests_crch r_suggests_distributional
	...
	r_suggests_mhurdle r_suggests_mice r_suggests_miceadds
	r_suggests_missranger r_suggests_mlogit r_suggests_modelbased
