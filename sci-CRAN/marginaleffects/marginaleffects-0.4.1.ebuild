...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.4.1.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_aod r_suggests_bench
	...
	r_suggests_glmx r_suggests_haven r_suggests_itsadug r_suggests_ivreg
...
"
DEPEND=">=sci-CRAN/insight-0.16.0
	>=dev-lang/R-3.5.0
	sci-CRAN/generics
	sci-CRAN/checkmate
"
