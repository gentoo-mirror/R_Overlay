...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.6.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	r_suggests_bench r_suggests_betareg r_suggests_bh r_suggests_bife
	r_suggests_brglm2 r_suggests_broom r_suggests_covr r_suggests_crch
	...
	r_suggests_tinytest r_suggests_tobit1 r_suggests_truncreg
	r_suggests_tsmodel r_suggests_vdiffr r_suggests_withr"
R_SUGGESTS="
