...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.12.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_amelia
	...
	r_suggests_broom r_suggests_car r_suggests_collapse
	r_suggests_conflicted r_suggests_covr r_suggests_crch
	...
	r_suggests_nnet r_suggests_numderiv r_suggests_optmatch
	r_suggests_ordinal r_suggests_parameters r_suggests_patchwork
	r_suggests_phylolm r_suggests_plm r_suggests_polspline
	r_suggests_poorman r_suggests_posterior r_suggests_prediction
	r_suggests_pscl r_suggests_purrr r_suggests_quantreg
	r_suggests_rchoice r_suggests_remotes r_suggests_rmarkdown
