...
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.26.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_altdoc
	...
	r_suggests_modelbased r_suggests_modelsummary r_suggests_multcomp
	r_suggests_mvtnorm r_suggests_nanoparquet r_suggests_nlme
	...
	r_suggests_patchwork r_suggests_pbapply r_suggests_phylolm
