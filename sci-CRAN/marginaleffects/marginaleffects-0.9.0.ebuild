...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.9.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_aod
	...
	r_suggests_fixest r_suggests_future r_suggests_future_apply
	r_suggests_fwb r_suggests_gam r_suggests_gamlss
	...
	r_suggests_mclogit r_suggests_mgcv r_suggests_mhurdle r_suggests_mice
	r_suggests_mlogit r_suggests_modelbased r_suggests_nlme
	r_suggests_nnet r_suggests_ordinal r_suggests_parameters
	r_suggests_patchwork r_suggests_plm r_suggests_polspline
	r_suggests_posterior r_suggests_prediction r_suggests_pscl
	r_suggests_quantreg r_suggests_rcppeigen r_suggests_remotes
	...
	r_suggests_systemfonts r_suggests_tibble r_suggests_tidymodels
