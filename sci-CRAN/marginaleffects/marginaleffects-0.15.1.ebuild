...
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.15.1.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_amelia
	...
	r_suggests_covr r_suggests_crch r_suggests_dcchoice
	r_suggests_distributional r_suggests_dplyr r_suggests_emmeans
	r_suggests_equivalence r_suggests_estimatr r_suggests_fixest
	r_suggests_fontquiver r_suggests_future r_suggests_fwb r_suggests_gam
	r_suggests_gamlss r_suggests_gamlss_dist r_suggests_geepack
	r_suggests_ggdag r_suggests_ggdist r_suggests_ggokabeito
	...
	r_suggests_mlogit r_suggests_modelbased r_suggests_modelsummary
	r_suggests_nlme r_suggests_nnet r_suggests_numderiv
	r_suggests_optmatch r_suggests_ordinal r_suggests_parameters
	r_suggests_patchwork r_suggests_phylolm r_suggests_pkgdown
	r_suggests_plm r_suggests_polspline r_suggests_poorman
	r_suggests_posterior r_suggests_prediction r_suggests_pscl
	r_suggests_purrr r_suggests_quantreg r_suggests_rchoice
	r_suggests_remotes r_suggests_rmarkdown r_suggests_rms
	r_suggests_robust r_suggests_robustbase r_suggests_robustlmm
	r_suggests_rsample r_suggests_rstanarm r_suggests_rstantools
	r_suggests_sampleselection r_suggests_sandwich r_suggests_scam
	r_suggests_speedglm r_suggests_spelling r_suggests_survey
	r_suggests_survival r_suggests_svglite r_suggests_systemfonts
	r_suggests_testthat r_suggests_tibble r_suggests_tidymodels
	r_suggests_tidyr r_suggests_tidyverse r_suggests_tinysnapshot
	r_suggests_tinytest r_suggests_titanic r_suggests_truncreg
	r_suggests_tsmodel r_suggests_withr r_suggests_yaml"
R_SUGGESTS="
