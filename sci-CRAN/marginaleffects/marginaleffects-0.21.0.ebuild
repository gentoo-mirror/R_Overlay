...
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.21.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_altdoc
	...
	r_suggests_ivreg r_suggests_kableextra r_suggests_lme4
	...
	r_suggests_nycflights13 r_suggests_optmatch r_suggests_ordinal
