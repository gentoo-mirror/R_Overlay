...
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.25.1.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_altdoc
	...
	r_suggests_magrittr r_suggests_mass r_suggests_matchit
	...
	r_suggests_modelsummary r_suggests_multcomp r_suggests_nanoparquet
	r_suggests_nlme r_suggests_nnet r_suggests_numderiv
	r_suggests_nycflights13 r_suggests_optmatch r_suggests_ordbetareg
	r_suggests_ordinal r_suggests_parameters r_suggests_parsnip
	r_suggests_partykit r_suggests_patchwork r_suggests_phylolm
	r_suggests_pkgdown r_suggests_plm r_suggests_polspline
	...
	r_suggests_systemfit r_suggests_systemfonts r_suggests_testthat
	r_suggests_tibble r_suggests_tictoc r_suggests_tidymodels
	r_suggests_tidyr r_suggests_tidyverse r_suggests_tinysnapshot
	r_suggests_tinytable r_suggests_tinytest r_suggests_titanic
	r_suggests_truncreg r_suggests_tsmodel r_suggests_withr
	r_suggests_workflows r_suggests_xgboost r_suggests_yaml"
R_SUGGESTS="
