...
SRC_URI="http://cran.r-project.org/src/contrib/marginaleffects_0.25.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_altdoc
	...
	r_suggests_kableextra r_suggests_knitr r_suggests_lme4
	r_suggests_lmertest r_suggests_logistf r_suggests_magrittr
	...
	r_suggests_multcomp r_suggests_nanoparquet r_suggests_nlme
	...
	r_suggests_rchoice r_suggests_rcmdcheck r_suggests_remotes
	r_suggests_rendo r_suggests_reticulate r_suggests_rmarkdown
	r_suggests_rms r_suggests_robust r_suggests_robustbase
	r_suggests_robustlmm r_suggests_rsample r_suggests_rstanarm
	r_suggests_rstantools r_suggests_rstpm2 r_suggests_rstudioapi
