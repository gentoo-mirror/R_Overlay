...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mlr3pipelines_0.4.1.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_bbotk r_suggests_evaluate r_suggests_fastica
	r_suggests_future r_suggests_gensa r_suggests_ggplot2
	r_suggests_glmnet r_suggests_igraph r_suggests_kernlab
	r_suggests_kknn r_suggests_knitr r_suggests_lme4 r_suggests_mass
