...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3pipelines_0.3.0.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_bbotk r_suggests_bestnormalize r_suggests_bibtex
	r_suggests_evaluate r_suggests_fastica r_suggests_gensa
	...
	r_suggests_nmf r_suggests_rmarkdown r_suggests_rpart
	r_suggests_smotefamily r_suggests_stopwords r_suggests_testthat
	r_suggests_visnetwork r_suggests_vtreat"
R_SUGGESTS="
	r_suggests_bbotk? ( >=sci-CRAN/bbotk-0.2.0 )
