...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3pipelines_0.5.0-2.tar.gz"
LICENSE='LGPL-3'
...
IUSE="${IUSE-} r_suggests_bbotk r_suggests_bestnormalize r_suggests_evaluate
	...
	r_suggests_kernlab r_suggests_kknn r_suggests_knitr r_suggests_lme4
	...
	r_suggests_nmf r_suggests_quanteda r_suggests_rmarkdown
	r_suggests_rpart r_suggests_smotefamily r_suggests_stopwords
	r_suggests_testthat r_suggests_visnetwork r_suggests_vtreat"
R_SUGGESTS="
