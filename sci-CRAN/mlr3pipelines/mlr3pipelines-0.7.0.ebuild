...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3pipelines_0.7.0.tar.gz"
LICENSE='LGPL-3'
...
IUSE="${IUSE-} r_suggests_bbotk r_suggests_bestnormalize r_suggests_evaluate
	...
	r_suggests_quanteda r_suggests_ranger r_suggests_rmarkdown
	r_suggests_rpart r_suggests_smotefamily r_suggests_stopwords
	r_suggests_testthat r_suggests_themis r_suggests_visnetwork
	r_suggests_vtreat"
R_SUGGESTS="
