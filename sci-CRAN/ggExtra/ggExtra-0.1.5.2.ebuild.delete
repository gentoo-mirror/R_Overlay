...
SRC_URI="http://cran.r-project.org/src/contrib/ggExtra_0.1.5.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_gridextra r_suggests_knitr r_suggests_shiny
	r_suggests_shinyjs"
R_SUGGESTS="
	r_suggests_gridextra? ( >=sci-CRAN/gridExtra-0.9.1 )
	r_suggests_knitr? ( >=sci-CRAN/knitr-1.7 )
	r_suggests_shiny? ( >=sci-CRAN/shiny-0.11.0 )
	r_suggests_shinyjs? ( >=sci-CRAN/shinyjs-0.0.4.0 )
"
