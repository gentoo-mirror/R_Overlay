...
SRC_URI="http://cran.r-project.org/src/contrib/bayestestR_0.14.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_bayesfactor r_suggests_bayesplot
	...
	r_suggests_curl r_suggests_effectsize r_suggests_emmeans
	r_suggests_gamm4 r_suggests_ggdist r_suggests_ggplot2
	r_suggests_glmmtmb r_suggests_httr r_suggests_httr2
	...
	r_suggests_ordbetareg r_suggests_parameters r_suggests_patchwork
