...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/bayestestR_0.7.5.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bayesfactor r_suggests_bayesqr
	r_suggests_bridgesampling r_suggests_broom r_suggests_covr
	r_suggests_dplyr r_suggests_effectsize r_suggests_emmeans
	r_suggests_ggally r_suggests_ggplot2 r_suggests_ggridges
