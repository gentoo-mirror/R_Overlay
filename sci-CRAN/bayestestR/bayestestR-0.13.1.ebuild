...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/bayestestR_0.13.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bayesfactor r_suggests_bayesplot
	r_suggests_bayesqr r_suggests_bh r_suggests_blavaan
	r_suggests_bridgesampling r_suggests_brms r_suggests_curl
	r_suggests_effectsize r_suggests_emmeans r_suggests_gamm4
	r_suggests_ggdist r_suggests_ggplot2 r_suggests_glmmtmb
	r_suggests_httr r_suggests_kernsmooth r_suggests_knitr
	r_suggests_lavaan r_suggests_lme4 r_suggests_logspline
	r_suggests_mass r_suggests_mclust r_suggests_mediation
	r_suggests_modelbased r_suggests_parameters r_suggests_patchwork
	r_suggests_performance r_suggests_posterior r_suggests_quadprog
	r_suggests_rcppeigen r_suggests_rmarkdown r_suggests_rstan
	r_suggests_rstanarm r_suggests_see r_suggests_testthat
	r_suggests_tweedie"
R_SUGGESTS="
