...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/bayestestR_0.13.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bayesfactor r_suggests_bayesplot
	r_suggests_bayesqr r_suggests_bh r_suggests_bridgesampling
	...
	r_suggests_rcppeigen r_suggests_rmarkdown r_suggests_see
	r_suggests_testthat r_suggests_tweedie"
R_SUGGESTS="
