...
SRC_URI="http://cran.r-project.org/src/contrib/bayestestR_0.5.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bayesfactor r_suggests_bridgesampling
	r_suggests_brms r_suggests_broom r_suggests_covr r_suggests_dplyr
	r_suggests_emmeans r_suggests_ggally r_suggests_ggplot2
	r_suggests_ggridges r_suggests_kernsmooth r_suggests_knitr
	r_suggests_lme4 r_suggests_logspline r_suggests_mass
	r_suggests_mclust r_suggests_modelbased r_suggests_performance
	r_suggests_rmarkdown r_suggests_rstan r_suggests_rstanarm
	r_suggests_see r_suggests_stringr r_suggests_testthat
	r_suggests_tidyr r_suggests_tweedie"
R_SUGGESTS="
