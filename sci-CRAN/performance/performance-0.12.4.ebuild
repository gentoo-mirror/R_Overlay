...
SRC_URI="http://cran.r-project.org/src/contrib/performance_0.12.4.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_bayesfactor
	...
	r_suggests_cplm r_suggests_dagitty r_suggests_dbscan
	r_suggests_dharma r_suggests_estimatr r_suggests_fixest
	r_suggests_flextable r_suggests_forecast r_suggests_ftextra
	r_suggests_gamm4 r_suggests_ggdag r_suggests_glmmtmb r_suggests_hmisc
