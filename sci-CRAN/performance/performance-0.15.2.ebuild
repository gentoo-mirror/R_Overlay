...
SRC_URI="http://cran.r-project.org/src/contrib/performance_0.15.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_bayesfactor
	...
	r_suggests_cardata r_suggests_compquadform r_suggests_correlation
	r_suggests_cplm r_suggests_curl r_suggests_dagitty r_suggests_dbscan
	r_suggests_dharma r_suggests_discovr r_suggests_estimatr
	r_suggests_fixest r_suggests_flextable r_suggests_forecast
	r_suggests_ftextra r_suggests_gamm4 r_suggests_ggdag
	r_suggests_glmmtmb r_suggests_gparotation r_suggests_hmisc
	r_suggests_httr2 r_suggests_ics r_suggests_icsoutlier r_suggests_islr
	r_suggests_ivreg r_suggests_lavaan r_suggests_lme4 r_suggests_lmtest
	r_suggests_loo r_suggests_mass r_suggests_matrix r_suggests_mclogit
	r_suggests_mclust r_suggests_metadat r_suggests_metafor
	r_suggests_mgcv r_suggests_mlogit r_suggests_modelbased
	r_suggests_multimode r_suggests_nestedlogit r_suggests_nlme
	r_suggests_nnet r_suggests_nonnest2 r_suggests_ordinal
	r_suggests_parameters r_suggests_patchwork r_suggests_pscl
	r_suggests_psych r_suggests_psychtools r_suggests_qqplotr
	r_suggests_quantreg r_suggests_randomforest r_suggests_rcppeigen
	r_suggests_reformulas r_suggests_rempsyc r_suggests_rmarkdown
...
R_SUGGESTS="
	...
	r_suggests_dharma? ( >=sci-CRAN/DHARMa-0.4.7 )
	...
	r_suggests_glmmtmb? ( >=sci-CRAN/glmmTMB-1.1.12 )
	...
	r_suggests_modelbased? ( >=sci-CRAN/modelbased-0.12.0 )
	...
	r_suggests_parameters? ( >=sci-CRAN/parameters-0.28.0 )
	...
	r_suggests_reformulas? ( sci-CRAN/reformulas )
