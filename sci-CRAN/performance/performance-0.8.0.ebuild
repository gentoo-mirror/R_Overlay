...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/performance_0.8.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_bayesfactor
	...
	r_suggests_mclust r_suggests_metafor r_suggests_mgcv
	r_suggests_mlogit r_suggests_multimode r_suggests_nlme
