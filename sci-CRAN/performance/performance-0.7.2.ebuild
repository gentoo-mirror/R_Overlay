...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/performance_0.7.2.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_bayesfactor
	r_suggests_betareg r_suggests_bigutilsr r_suggests_car
	r_suggests_compquadform r_suggests_correlation r_suggests_cplm
	r_suggests_dbscan r_suggests_fixest r_suggests_forecast
	r_suggests_gamm4 r_suggests_ggplot2 r_suggests_glmmtmb
	r_suggests_gridextra r_suggests_ics r_suggests_icsoutlier
	r_suggests_islr r_suggests_lavaan r_suggests_lme4 r_suggests_lmtest
	r_suggests_loo r_suggests_magrittr r_suggests_mass r_suggests_matrix
	r_suggests_metafor r_suggests_mgcv r_suggests_mlogit r_suggests_nlme
	r_suggests_nonnest2 r_suggests_ordinal r_suggests_parameters
	r_suggests_pscl r_suggests_psych r_suggests_randomforest
	r_suggests_rmarkdown r_suggests_sandwich r_suggests_see
