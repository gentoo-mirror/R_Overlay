...
SRC_URI="http://cran.r-project.org/src/contrib/performance_0.12.2.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_bayesfactor
	...
	r_suggests_cplm r_suggests_dbscan r_suggests_dharma
	r_suggests_estimatr r_suggests_fixest r_suggests_flextable
	r_suggests_forecast r_suggests_ftextra r_suggests_gamm4
	r_suggests_ggplot2 r_suggests_glmmtmb r_suggests_hmisc
	...
	r_suggests_nestedlogit r_suggests_nlme r_suggests_nonnest2
	r_suggests_ordinal r_suggests_parameters r_suggests_patchwork
	r_suggests_pscl r_suggests_psych r_suggests_qqplotr
	r_suggests_quantreg r_suggests_randomforest r_suggests_rcppeigen
	r_suggests_rempsyc r_suggests_rmarkdown r_suggests_rstanarm
	r_suggests_rstantools r_suggests_sandwich r_suggests_see
	r_suggests_survey r_suggests_survival r_suggests_testthat
	r_suggests_tweedie r_suggests_vgam r_suggests_withr"
R_SUGGESTS="
	...
	r_suggests_parameters? ( >=sci-CRAN/parameters-0.21.6 )
	...
	r_suggests_see? ( >=sci-CRAN/see-0.8.2 )
