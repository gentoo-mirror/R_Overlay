...
SRC_URI="http://cran.r-project.org/src/contrib/performance_0.5.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_betareg r_suggests_bigutilsr
	...
	r_suggests_fixest r_suggests_forecast r_suggests_ggplot2
	r_suggests_glmmtmb r_suggests_gridextra r_suggests_ics
	r_suggests_icsoutlier r_suggests_lavaan r_suggests_lme4
	r_suggests_loo r_suggests_mass r_suggests_matrix r_suggests_metafor
	r_suggests_mlogit r_suggests_nlme r_suggests_ordinal
	r_suggests_parameters r_suggests_pscl r_suggests_psych
	r_suggests_randomforest r_suggests_rmarkdown r_suggests_rstanarm
	r_suggests_rstantools r_suggests_see r_suggests_spelling
