...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/performance_0.6.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_bayesfactor r_suggests_betareg
	r_suggests_bigutilsr r_suggests_car r_suggests_correlation
	r_suggests_covr r_suggests_cplm r_suggests_dbscan r_suggests_fixest
