...
SRC_URI="http://cran.r-project.org/src/contrib/performance_0.5.1.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_bayesfactor r_suggests_betareg
	r_suggests_bigutilsr r_suggests_brms r_suggests_car r_suggests_covr
	r_suggests_cplm r_suggests_dbscan r_suggests_fixest
	r_suggests_forecast r_suggests_ggplot2 r_suggests_glmmtmb
	r_suggests_gridextra r_suggests_ics r_suggests_icsoutlier
	r_suggests_lavaan r_suggests_lme4 r_suggests_loo r_suggests_mass
	r_suggests_matrix r_suggests_metafor r_suggests_mlogit
...
"
DEPEND=">=sci-CRAN/insight-0.10.0
	>=dev-lang/R-3.5
