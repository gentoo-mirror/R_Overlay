...
SRC_URI="http://cran.r-project.org/src/contrib/performance_0.3.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_aer r_suggests_betareg r_suggests_brms
	r_suggests_covr r_suggests_glmmtmb r_suggests_ics
	...
	r_suggests_nlme r_suggests_ordinal r_suggests_pscl r_suggests_psych
