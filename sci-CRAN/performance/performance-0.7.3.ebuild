...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/performance_0.7.3.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_bayesfactor
	...
	r_suggests_dbscan r_suggests_dplyr r_suggests_fixest
	r_suggests_forecast r_suggests_gamm4 r_suggests_ggplot2
	r_suggests_glmmtmb r_suggests_ics r_suggests_icsoutlier
	...
	r_suggests_patchwork r_suggests_pscl r_suggests_psych
	r_suggests_randomforest r_suggests_rmarkdown r_suggests_sandwich
	r_suggests_see r_suggests_spelling r_suggests_survey
