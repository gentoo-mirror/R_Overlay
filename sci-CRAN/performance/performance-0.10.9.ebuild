...
SRC_URI="http://cran.r-project.org/src/contrib/performance_0.10.9.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_bayesfactor
	...
	r_suggests_ftextra r_suggests_gamm4 r_suggests_ggplot2
	...
	r_suggests_quantreg r_suggests_randomforest r_suggests_rempsyc
...
R_SUGGESTS="
	...
	r_suggests_parameters? ( >=sci-CRAN/parameters-0.21.4 )
