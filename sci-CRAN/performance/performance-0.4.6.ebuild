...
SRC_URI="http://cran.r-project.org/src/contrib/performance_0.4.6.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_betareg r_suggests_bigutilsr
	...
	r_suggests_fixest r_suggests_forecast r_suggests_glmmtmb
	r_suggests_ics r_suggests_icsoutlier r_suggests_lavaan
	r_suggests_lme4 r_suggests_loo r_suggests_mass r_suggests_matrix
	r_suggests_metafor r_suggests_mlogit r_suggests_nlme
	...
	r_suggests_solitude r_suggests_spelling r_suggests_survey
...
R_SUGGESTS="
	...
	r_suggests_parameters? ( >=sci-CRAN/parameters-0.5.0 )
