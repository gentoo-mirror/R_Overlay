...
SRC_URI="http://cran.r-project.org/src/contrib/performance_0.14.0.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_afex r_suggests_bayesfactor
	...
	r_suggests_psych r_suggests_qqplotr r_suggests_quantreg
	r_suggests_randomforest r_suggests_rcppeigen r_suggests_reformulas
...
R_SUGGESTS="
	...
	r_suggests_parameters? ( >=sci-CRAN/parameters-0.22.0 )
