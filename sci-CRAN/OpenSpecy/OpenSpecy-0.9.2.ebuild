...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/OpenSpecy_0.9.2.tar.gz"

IUSE="${IUSE-} r_suggests_config r_suggests_curl r_suggests_data_table
	r_suggests_dt r_suggests_ggplot2 r_suggests_knitr r_suggests_loggit
	r_suggests_plotly r_suggests_rdrop2 r_suggests_rmarkdown
	r_suggests_shinybs r_suggests_shinyjs r_suggests_shinythemes
