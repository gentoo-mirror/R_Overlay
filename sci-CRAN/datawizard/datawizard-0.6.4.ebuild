...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/datawizard_0.6.4.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_bayestestr r_suggests_boot r_suggests_brms
	r_suggests_data_table r_suggests_dplyr r_suggests_effectsize
