...
SRC_URI="http://cran.r-project.org/src/contrib/datawizard_1.3.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_bayestestr r_suggests_bh r_suggests_boot
	r_suggests_brms r_suggests_curl r_suggests_data_table
	r_suggests_dplyr r_suggests_effectsize r_suggests_emmeans
	r_suggests_gamm4 r_suggests_ggplot2 r_suggests_gt r_suggests_haven
	r_suggests_httr r_suggests_knitr r_suggests_lme4 r_suggests_mediation
	r_suggests_modelbased r_suggests_nanoparquet r_suggests_parameters
	...
	r_suggests_tinytable r_suggests_withr"
R_SUGGESTS="
	...
	r_suggests_dplyr? ( >=sci-CRAN/dplyr-1.1 )
	...
	r_suggests_parameters? ( >=sci-CRAN/parameters-0.21.7 )
	r_suggests_performance? ( >=sci-CRAN/performance-0.14.0 )
	r_suggests_poorman? ( >=sci-CRAN/poorman-0.2.7 )
	...
	r_suggests_tinytable? ( >=sci-CRAN/tinytable-0.13.0 )
