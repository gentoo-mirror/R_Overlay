...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/datawizard_0.4.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_bayestestr r_suggests_boot r_suggests_effectsize
	r_suggests_gamm4 r_suggests_ggplot2 r_suggests_knitr r_suggests_lme4
	r_suggests_mass r_suggests_modelbased r_suggests_parameters
