...
SRC_URI="http://cran.r-project.org/src/contrib/datawizard_1.0.1.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_bayestestr r_suggests_boot r_suggests_brms
	...
	r_suggests_ggplot2 r_suggests_gt r_suggests_haven r_suggests_httr
	r_suggests_knitr r_suggests_lme4 r_suggests_mediation
