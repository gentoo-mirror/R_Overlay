...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/datawizard_0.5.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_bayestestr r_suggests_boot r_suggests_data_table
	...
	r_suggests_lme4 r_suggests_mediation r_suggests_parameters
	r_suggests_poorman r_suggests_psych r_suggests_readr
	r_suggests_readxl r_suggests_rio r_suggests_rmarkdown r_suggests_see
