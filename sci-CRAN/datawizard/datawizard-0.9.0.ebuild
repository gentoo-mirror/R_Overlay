...
SRC_URI="http://cran.r-project.org/src/contrib/datawizard_0.9.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_bayestestr r_suggests_boot r_suggests_brms
	...
	r_suggests_emmeans r_suggests_gamm4 r_suggests_ggplot2 r_suggests_gt
	r_suggests_haven r_suggests_htmltools r_suggests_httr
