...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/DoubleML_0.3.0.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_aer r_suggests_bbotk r_suggests_covr
	...
	r_suggests_paradox r_suggests_patrick r_suggests_ranger
	r_suggests_rmarkdown r_suggests_rpart r_suggests_sandwich
	r_suggests_testthat"
R_SUGGESTS="
