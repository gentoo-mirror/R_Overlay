...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/DoubleML_0.1.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_aer r_suggests_bbotk r_suggests_dplyr
	r_suggests_glmnet r_suggests_knitr r_suggests_lgr
	r_suggests_mlr3learners r_suggests_paradox r_suggests_patrick
...
R_SUGGESTS="
	...
	r_suggests_mlr3learners? ( >=sci-CRAN/mlr3learners-0.3.0 )
