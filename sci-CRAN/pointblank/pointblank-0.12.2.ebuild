...
SRC_URI="http://cran.r-project.org/src/contrib/pointblank_0.12.2.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_arrow r_suggests_bigrquery r_suggests_data_table
...
DEPEND=">=sci-CRAN/scales-1.2.1
	...
	>=sci-CRAN/yaml-2.3.7
	>=sci-CRAN/gt-0.9.0
	>=sci-CRAN/blastula-0.3.3
	>=sci-CRAN/tidyr-1.3.0
	>=sci-CRAN/cli-3.6.0
	>=sci-CRAN/dplyr-1.0.10
	sci-CRAN/magrittr
	>=sci-CRAN/testthat-3.1.6
"
