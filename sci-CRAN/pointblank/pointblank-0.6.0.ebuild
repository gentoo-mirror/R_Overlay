...
SRC_URI="http://cran.r-project.org/src/contrib/pointblank_0.6.0.tar.gz"
LICENSE='MIT'

IUSE="${IUSE-} r_suggests_covr r_suggests_dittodb r_suggests_duckdb
	r_suggests_lubridate r_suggests_odbc r_suggests_readr
	r_suggests_rmariadb r_suggests_rmarkdown r_suggests_rmysql
