...
SRC_URI="http://cran.r-project.org/src/contrib/webfakes_1.3.1.tar.gz"
LICENSE='MIT'
...
IUSE="${IUSE-} r_suggests_brotli r_suggests_callr r_suggests_covr
	...
	r_suggests_httr r_suggests_jsonlite r_suggests_processx
	r_suggests_testthat r_suggests_withr r_suggests_xml2 r_suggests_zip"
R_SUGGESTS="
