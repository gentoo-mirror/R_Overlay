...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/domir_1.0.1.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_dplyr r_suggests_forcats r_suggests_formula
	r_suggests_ggplot2 r_suggests_knitr r_suggests_parameters
	r_suggests_performance r_suggests_purrr r_suggests_relaimpo
