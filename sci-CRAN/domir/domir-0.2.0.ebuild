...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/domir_0.2.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_dominanceanalysis r_suggests_knitr
	r_suggests_relaimpo r_suggests_rmarkdown r_suggests_testthat
	r_suggests_yhat"
R_SUGGESTS="
