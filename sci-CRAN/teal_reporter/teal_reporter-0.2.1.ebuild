...
SRC_URI="http://cran.r-project.org/src/contrib/teal.reporter_0.2.1.tar.gz"
LICENSE='Apache-2.0'

IUSE="${IUSE-} r_suggests_dt r_suggests_ggplot2 r_suggests_lattice
	r_suggests_png r_suggests_rtables r_suggests_testthat
	r_suggests_tinytex"
R_SUGGESTS="
