...
SRC_URI="http://cran.r-project.org/src/contrib/broom.helpers_1.14.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_betareg r_suggests_biglm r_suggests_biglmm
	...
	r_suggests_mass r_suggests_mgcv r_suggests_mice r_suggests_multgee
	r_suggests_nnet r_suggests_ordinal r_suggests_parameters
	r_suggests_parsnip r_suggests_patchwork r_suggests_plm
	r_suggests_pscl r_suggests_rmarkdown r_suggests_rstanarm
