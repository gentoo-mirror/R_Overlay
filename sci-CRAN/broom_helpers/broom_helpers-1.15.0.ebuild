...
SRC_URI="http://cran.r-project.org/src/contrib/broom.helpers_1.15.0.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_betareg r_suggests_biglm r_suggests_biglmm
	r_suggests_brms r_suggests_broom_mixed r_suggests_cmprsk
	r_suggests_covr r_suggests_effects r_suggests_emmeans
	r_suggests_fixest r_suggests_forcats r_suggests_gam r_suggests_gee
	r_suggests_geepack r_suggests_ggeffects r_suggests_ggplot2
	r_suggests_ggstats r_suggests_glmmtmb r_suggests_glue r_suggests_gt
	r_suggests_knitr r_suggests_lavaan r_suggests_lfe r_suggests_lme4
	r_suggests_logitr r_suggests_marginaleffects r_suggests_margins
	r_suggests_mass r_suggests_mgcv r_suggests_mice r_suggests_mmrm
	r_suggests_multgee r_suggests_nnet r_suggests_ordinal
	r_suggests_parameters r_suggests_parsnip r_suggests_patchwork
	r_suggests_plm r_suggests_pscl r_suggests_rmarkdown
	r_suggests_rstanarm r_suggests_scales r_suggests_spelling
	r_suggests_survey r_suggests_survival r_suggests_testthat
	r_suggests_tidycmprsk r_suggests_vgam"
R_SUGGESTS="
	r_suggests_betareg? ( sci-CRAN/betareg )
	r_suggests_biglm? ( sci-CRAN/biglm )
	r_suggests_biglmm? ( sci-CRAN/biglmm )
...
_UNRESOLVED_PACKAGES=( '>=sci-CRAN/gtsummary-1.6.3' )
