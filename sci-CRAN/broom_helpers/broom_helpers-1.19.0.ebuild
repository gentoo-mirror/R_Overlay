...
SRC_URI="http://cran.r-project.org/src/contrib/broom.helpers_1.19.0.tar.gz"
LICENSE='GPL-3+'
...
IUSE="${IUSE-} r_suggests_betareg r_suggests_biglm r_suggests_brms
	...
	r_suggests_gt r_suggests_knitr r_suggests_lavaan r_suggests_lfe
	r_suggests_lme4 r_suggests_logitr r_suggests_marginaleffects
	r_suggests_margins r_suggests_mass r_suggests_mgcv r_suggests_mice
	r_suggests_mmrm r_suggests_multgee r_suggests_nnet r_suggests_ordinal
