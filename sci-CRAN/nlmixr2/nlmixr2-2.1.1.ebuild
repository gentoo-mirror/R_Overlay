...
SRC_URI="http://cran.r-project.org/src/contrib/nlmixr2_2.1.1.tar.gz"
LICENSE='GPL-3+'

IUSE="${IUSE-} r_suggests_devtools r_suggests_ggplot2 r_suggests_knitr
	r_suggests_n1qn1 r_suggests_rmarkdown r_suggests_rxode2parse
...
"
DEPEND=">=sci-CRAN/rxode2-2.1.1
	sci-CRAN/lotri
	>=sci-CRAN/nlmixr2est-2.2.0
