...
SRC_URI="http://cran.r-project.org/src/contrib/Rcmdr_2.2-5.tar.gz"
LICENSE='GPL-2+'
...
R_SUGGESTS="
	...
	r_suggests_e1071? ( sci-R/e1071 )
	r_suggests_effects? ( >=sci-R/effects-3.0.1 )
	...
	r_suggests_multcomp? ( >=sci-R/multcomp-0.991.2 )
	r_suggests_nlme? ( virtual/nlme )
	r_suggests_nnet? ( virtual/nnet )
	r_suggests_readxl? ( sci-CRAN/readxl )
	r_suggests_rgl? ( sci-CRAN/rgl )
	r_suggests_rglwidget? ( sci-CRAN/rglwidget )
	r_suggests_sem? ( >=sci-R/sem-2.1.1 )
"
DEPEND=">=sci-R/car-2.1.2
	>=sci-R/tcltk2-1.2.6
	sci-R/abind
	>=dev-lang/R-3.2.0
	>=sci-R/RcmdrMisc-1.0.3
