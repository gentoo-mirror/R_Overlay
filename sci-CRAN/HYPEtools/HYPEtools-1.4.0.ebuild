...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/HYPEtools_1.4.0.tar.gz"
LICENSE='LGPL-3'

IUSE="${IUSE-} r_suggests_dt r_suggests_htmlwidgets r_suggests_knitr
	r_suggests_leaflet r_suggests_leaflet_extras r_suggests_plotly
	r_suggests_randomcolor r_suggests_rmarkdown r_suggests_sf
	r_suggests_shiny r_suggests_shinyalert r_suggests_shinyfiles
