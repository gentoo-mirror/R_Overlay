...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/simstudy_0.6.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_dplyr r_suggests_formatr
	r_suggests_gee r_suggests_ggplot2 r_suggests_gridextra
	r_suggests_gtsummary r_suggests_hedgehog r_suggests_katex
	r_suggests_knitr r_suggests_magrittr r_suggests_matrix
	r_suggests_mgcv r_suggests_ordinal r_suggests_pracma
