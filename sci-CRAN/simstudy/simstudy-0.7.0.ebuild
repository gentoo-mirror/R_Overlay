...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/simstudy_0.7.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_covr r_suggests_dirmult r_suggests_dplyr
	r_suggests_formatr r_suggests_gee r_suggests_ggplot2
