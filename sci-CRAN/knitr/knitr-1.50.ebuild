...
SRC_URI="http://cran.r-project.org/src/contrib/knitr_1.50.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_bslib r_suggests_codetools r_suggests_dbi
	r_suggests_digest r_suggests_formatr r_suggests_gridsvg
	r_suggests_htmlwidgets r_suggests_jpeg r_suggests_litedown
...
R_SUGGESTS="
	...
	r_suggests_tinytex? ( >=sci-CRAN/tinytex-0.56 )
"
