...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/knitr_1.43.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_bslib r_suggests_codetools r_suggests_curl
	r_suggests_dbi r_suggests_digest r_suggests_formatr
	r_suggests_gridsvg r_suggests_htmlwidgets r_suggests_jpeg
	r_suggests_magick r_suggests_markdown r_suggests_png
	r_suggests_reticulate r_suggests_rgl r_suggests_rlang
	r_suggests_rmarkdown r_suggests_rstudioapi r_suggests_sass
	r_suggests_showtext r_suggests_styler r_suggests_targets
