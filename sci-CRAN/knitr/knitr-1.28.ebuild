...
SRC_URI="http://cran.r-project.org/src/contrib/knitr_1.28.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_codetools r_suggests_dbi r_suggests_digest
	r_suggests_formatr r_suggests_gifski r_suggests_htmlwidgets
	r_suggests_httr r_suggests_jpeg r_suggests_magick r_suggests_png
	r_suggests_reticulate r_suggests_rgl r_suggests_rmarkdown
	r_suggests_sass r_suggests_showtext r_suggests_styler
	r_suggests_testit r_suggests_tibble r_suggests_tikzdevice
	r_suggests_tinytex r_suggests_xml2"
R_SUGGESTS="
