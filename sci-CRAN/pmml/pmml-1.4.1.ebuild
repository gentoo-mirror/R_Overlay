...
SRC_URI="http://cran.r-project.org/src/contrib/pmml_1.4.1.tar.gz"
LICENSE='GPL-2+'

IUSE="${IUSE-} r_suggests_ada r_suggests_arules r_suggests_e1071
	r_suggests_glmnet r_suggests_kernlab r_suggests_mlbench
	r_suggests_pmmltransformations r_suggests_randomforest
	r_suggests_randomforestsrc"
R_SUGGESTS="
