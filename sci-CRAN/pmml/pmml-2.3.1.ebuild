...
SRC_URI="http://cran.r-project.org/src/contrib/pmml_2.3.1.tar.gz"
LICENSE='GPL-3'
...
IUSE="${IUSE-} r_suggests_ada r_suggests_amap r_suggests_arules
	...
	r_suggests_randomforest r_suggests_rattle r_suggests_rmarkdown
...
_UNRESOLVED_PACKAGES=( '<=sci-CRAN/randomForestSRC-2.5.0' )
