...
SRC_URI="http://cran.r-project.org/src/contrib/pmml_1.5.7.tar.gz"
...
IUSE="${IUSE-} r_suggests_ada r_suggests_amap r_suggests_arules
	...
	r_suggests_knitr r_suggests_neighbr r_suggests_nnet
	r_suggests_pmmltransformations r_suggests_randomforest
	r_suggests_randomforestsrc r_suggests_rmarkdown r_suggests_rpart
