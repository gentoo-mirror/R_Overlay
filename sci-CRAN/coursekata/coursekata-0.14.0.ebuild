...
SRC_URI="http://cran.r-project.org/src/contrib/coursekata_0.14.0.tar.gz"
LICENSE='AGPL-3'

IUSE="${IUSE-} r_suggests_fivethirtyeight r_suggests_lubridate
	r_suggests_mockery r_suggests_mockr r_suggests_readr
...
DEPEND=">=sci-CRAN/dslabs-0.7.4
	...
	>=sci-CRAN/Lock5withR-1.2.2
	>=sci-CRAN/mosaic-1.8.3
	>=sci-CRAN/purrr-0.3.4
	>=sci-CRAN/yesno-0.1.2
"
