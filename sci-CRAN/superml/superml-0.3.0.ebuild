...
SRC_URI="http://cran.r-project.org/src/contrib/superml_0.3.0.tar.gz"
LICENSE='GPL-3'

IUSE="${IUSE-} r_suggests_caret r_suggests_cluster r_suggests_fnn
	r_suggests_glmnet r_suggests_kableextra r_suggests_knitr
	r_suggests_liquidsvm r_suggests_matrix r_suggests_naivebayes
	r_suggests_ranger r_suggests_rlang r_suggests_rmarkdown
	r_suggests_testthat r_suggests_tm r_suggests_xgboost"
R_SUGGESTS="
	...
	r_suggests_liquidsvm? ( >=sci-CRAN/liquidSVM-1.2 )
