...
SRC_URI="http://cran.r-project.org/src/contrib/mlr3viz_0.10.0.tar.gz"
LICENSE='LGPL-3'
...
IUSE="${IUSE-} r_suggests_bbotk r_suggests_cluster r_suggests_ggally
	...
	r_suggests_mlr3filters r_suggests_mlr3fselect r_suggests_mlr3learners
	r_suggests_mlr3tuning r_suggests_paradox r_suggests_partykit
	r_suggests_patchwork r_suggests_precrec r_suggests_ranger
	r_suggests_rpart r_suggests_survminer r_suggests_testthat
	r_suggests_vdiffr r_suggests_xgboost"
R_SUGGESTS="
	...
	r_suggests_mlr3fselect? ( >=sci-CRAN/mlr3fselect-1.0.0 )
