...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mlr3viz_0.5.8.tar.gz"
LICENSE='LGPL-3'
...
IUSE="${IUSE-} r_suggests_bbotk r_suggests_cluster r_suggests_distr6
	...
	r_suggests_mlr3proba r_suggests_mlr3tuning r_suggests_paradox
	r_suggests_partykit r_suggests_patchwork r_suggests_precrec
	r_suggests_ranger r_suggests_rpart r_suggests_survival
