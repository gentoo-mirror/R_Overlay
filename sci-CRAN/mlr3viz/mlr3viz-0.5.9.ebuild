...
KEYWORDS="~amd64"
SRC_URI="http://cran.r-project.org/src/contrib/mlr3viz_0.5.9.tar.gz"
LICENSE='LGPL-3'
...
IUSE="${IUSE-} r_suggests_bbotk r_suggests_cluster r_suggests_distr6
	...
	r_suggests_ggparty r_suggests_glmnet r_suggests_knitr r_suggests_lgr
	r_suggests_mlr3 r_suggests_mlr3filters r_suggests_mlr3learners
	r_suggests_mlr3tuning r_suggests_paradox r_suggests_partykit
	r_suggests_patchwork r_suggests_precrec r_suggests_ranger
	r_suggests_rpart r_suggests_testthat r_suggests_vdiffr
	r_suggests_xgboost"
R_SUGGESTS="
	r_suggests_bbotk? ( sci-CRAN/bbotk )
	r_suggests_cluster? ( virtual/cluster virtual/cluster )
	r_suggests_distr6? ( >=sci-CRAN/distr6-1.6.9 )
